...
static_assert(sizeof(UBloodChargePlayerComponent) == 0x0002D0, "Wrong size on UBloodChargePlayerComponent");
static_assert(offsetof(UBloodChargePlayerComponent, _bloodChargeLimitSurvivor) == 0x0001E0, "Member 'UBloodChargePlayerComponent::_bloodChargeLimitSurvivor' has a wrong offset!");
static_assert(offsetof(UBloodChargePlayerComponent, _bloodChargeLimitKiller) == 0x000208, "Member 'UBloodChargePlayerComponent::_bloodChargeLimitKiller' has a wrong offset!");
static_assert(offsetof(UBloodChargePlayerComponent, _bloodChargeStartAmountKiller) == 0x000230, "Member 'UBloodChargePlayerComponent::_bloodChargeStartAmountKiller' has a wrong offset!");
static_assert(offsetof(UBloodChargePlayerComponent, _bloodChargeAmount) == 0x000258, "Member 'UBloodChargePlayerComponent::_bloodChargeAmount' has a wrong offset!");
static_assert(offsetof(UBloodChargePlayerComponent, _lastChargeChangeFromStealing) == 0x00025C, "Member 'UBloodChargePlayerComponent::_lastChargeChangeFromStealing' has a wrong offset!");
...
static_assert(sizeof(UBloodReceptacleOutlineUpdateStrategy) == 0x000178, "Wrong size on UBloodReceptacleOutlineUpdateStrategy");
static_assert(offsetof(UBloodReceptacleOutlineUpdateStrategy, _revealTimeExtensionWithOffering) == 0x0000E0, "Member 'UBloodReceptacleOutlineUpdateStrategy::_revealTimeExtensionWithOffering' has a wrong offset!");
static_assert(offsetof(UBloodReceptacleOutlineUpdateStrategy, _baseRevealTime) == 0x000108, "Member 'UBloodReceptacleOutlineUpdateStrategy::_baseRevealTime' has a wrong offset!");
static_assert(offsetof(UBloodReceptacleOutlineUpdateStrategy, _offeringEffectTypeNeeded) == 0x000130, "Member 'UBloodReceptacleOutlineUpdateStrategy::_offeringEffectTypeNeeded' has a wrong offset!");
static_assert(offsetof(UBloodReceptacleOutlineUpdateStrategy, _outlineColor) == 0x000134, "Member 'UBloodReceptacleOutlineUpdateStrategy::_outlineColor' has a wrong offset!");
...
static_assert(sizeof(UBloodZoneOutlineUpdateStrategy) == 0x0000F8, "Wrong size on UBloodZoneOutlineUpdateStrategy");
static_assert(offsetof(UBloodZoneOutlineUpdateStrategy, _outlineColor) == 0x0000E0, "Member 'UBloodZoneOutlineUpdateStrategy::_outlineColor' has a wrong offset!");
...
static_assert(sizeof(UBloodZoneTrackerPlayerComponent) == 0x000130, "Wrong size on UBloodZoneTrackerPlayerComponent");
static_assert(offsetof(UBloodZoneTrackerPlayerComponent, _authority_bloodZonesInRange) == 0x0000B8, "Member 'UBloodZoneTrackerPlayerComponent::_authority_bloodZonesInRange' has a wrong offset!");
static_assert(offsetof(UBloodZoneTrackerPlayerComponent, _isInBloodZone) == 0x0000E0, "Member 'UBloodZoneTrackerPlayerComponent::_isInBloodZone' has a wrong offset!");
...
static_assert(sizeof(USpring2024EventCheatComponent) == 0x0000C8, "Wrong size on USpring2024EventCheatComponent");
static_assert(offsetof(USpring2024EventCheatComponent, _bloodZoneClass) == 0x0000B8, "Member 'USpring2024EventCheatComponent::_bloodZoneClass' has a wrong offset!");
static_assert(offsetof(USpring2024EventCheatComponent, _bloodReceptacleClass) == 0x0000C0, "Member 'USpring2024EventCheatComponent::_bloodReceptacleClass' has a wrong offset!");
...
static_assert(sizeof(USpring2024EventComponent) == 0x000168, "Wrong size on USpring2024EventComponent");
static_assert(offsetof(USpring2024EventComponent, _survivorEventStatusEffect) == 0x0000B8, "Member 'USpring2024EventComponent::_survivorEventStatusEffect' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _killerEventStatusEffect) == 0x0000C0, "Member 'USpring2024EventComponent::_killerEventStatusEffect' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _offeringStatusEffect) == 0x0000C8, "Member 'USpring2024EventComponent::_offeringStatusEffect' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _dreamLevelBonusValue) == 0x0000D0, "Member 'USpring2024EventComponent::_dreamLevelBonusValue' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _bloodZoneClassToSpawn) == 0x0000E0, "Member 'USpring2024EventComponent::_bloodZoneClassToSpawn' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _bloodZoneSpawnDistance) == 0x0000E8, "Member 'USpring2024EventComponent::_bloodZoneSpawnDistance' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _bloodZoneHeight) == 0x000110, "Member 'USpring2024EventComponent::_bloodZoneHeight' has a wrong offset!");
static_assert(offsetof(USpring2024EventComponent, _eventCheatComponentClass) == 0x000138, "Member 'USpring2024EventComponent::_eventCheatComponentClass' has a wrong offset!");
...
static_assert(sizeof(USpring2024HuskVFXComponent) == 0x000150, "Wrong size on USpring2024HuskVFXComponent");
static_assert(offsetof(USpring2024HuskVFXComponent, _owningHusk) == 0x0000B8, "Member 'USpring2024HuskVFXComponent::_owningHusk' has a wrong offset!");
...
static_assert(sizeof(USpring2024StatusEffect) == 0x0003D8, "Wrong size on USpring2024StatusEffect");
...
static_assert(sizeof(USpring2024KillerStatusEffect) == 0x000438, "Wrong size on USpring2024KillerStatusEffect");
static_assert(offsetof(USpring2024KillerStatusEffect, _lungeAttackCooldownModifier) == 0x0003D8, "Member 'USpring2024KillerStatusEffect::_lungeAttackCooldownModifier' has a wrong offset!");
static_assert(offsetof(USpring2024KillerStatusEffect, _activationTimerDuration) == 0x000430, "Member 'USpring2024KillerStatusEffect::_activationTimerDuration' has a wrong offset!");
...
static_assert(sizeof(USpring2024MapComponent) == 0x0000E0, "Wrong size on USpring2024MapComponent");
static_assert(offsetof(USpring2024MapComponent, _spring2024MapStatusEffect) == 0x0000B8, "Member 'USpring2024MapComponent::_spring2024MapStatusEffect' has a wrong offset!");
static_assert(offsetof(USpring2024MapComponent, _bloodTrailSettings) == 0x0000C0, "Member 'USpring2024MapComponent::_bloodTrailSettings' has a wrong offset!");
...
static_assert(sizeof(USpring2024SurvivorStatusEffect) == 0x0004A0, "Wrong size on USpring2024SurvivorStatusEffect");
static_assert(offsetof(USpring2024SurvivorStatusEffect, _injuredVoiceLevelModifier) == 0x0003D8, "Member 'USpring2024SurvivorStatusEffect::_injuredVoiceLevelModifier' has a wrong offset!");
static_assert(offsetof(USpring2024SurvivorStatusEffect, _bloodDecalDurationModifier) == 0x000400, "Member 'USpring2024SurvivorStatusEffect::_bloodDecalDurationModifier' has a wrong offset!");
static_assert(offsetof(USpring2024SurvivorStatusEffect, _crouchedInjuredVoiceLevelModifier) == 0x000428, "Member 'USpring2024SurvivorStatusEffect::_crouchedInjuredVoiceLevelModifier' has a wrong offset!");
static_assert(offsetof(USpring2024SurvivorStatusEffect, _crouchedBloodDecalDurationModifier) == 0x000450, "Member 'USpring2024SurvivorStatusEffect::_crouchedBloodDecalDurationModifier' has a wrong offset!");
