...
static_assert(sizeof(UARComponent) == 0x000350, "Wrong size on UARComponent");
static_assert(offsetof(UARComponent, NativeID) == 0x0002D0, "Member 'UARComponent::NativeID' has a wrong offset!");
static_assert(offsetof(UARComponent, bUseDefaultReplication) == 0x000310, "Member 'UARComponent::bUseDefaultReplication' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultMeshMaterial) == 0x000318, "Member 'UARComponent::DefaultMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, DefaultWireframeMeshMaterial) == 0x000320, "Member 'UARComponent::DefaultWireframeMeshMaterial' has a wrong offset!");
static_assert(offsetof(UARComponent, MRMeshComponent) == 0x000328, "Member 'UARComponent::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(UARComponent, MyTrackedGeometry) == 0x000330, "Member 'UARComponent::MyTrackedGeometry' has a wrong offset!");
...
static_assert(sizeof(UARPlaneComponent) == 0x000420, "Wrong size on UARPlaneComponent");
static_assert(offsetof(UARPlaneComponent, ReplicatedPayload) == 0x000350, "Member 'UARPlaneComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARPointComponent) == 0x000360, "Wrong size on UARPointComponent");
static_assert(offsetof(UARPointComponent, ReplicatedPayload) == 0x000350, "Member 'UARPointComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARFaceComponent) == 0x0003E0, "Wrong size on UARFaceComponent");
static_assert(offsetof(UARFaceComponent, TransformSetting) == 0x000350, "Member 'UARFaceComponent::TransformSetting' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bUpdateVertexNormal) == 0x000351, "Member 'UARFaceComponent::bUpdateVertexNormal' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, bFaceOutOfScreen) == 0x000352, "Member 'UARFaceComponent::bFaceOutOfScreen' has a wrong offset!");
static_assert(offsetof(UARFaceComponent, ReplicatedPayload) == 0x000358, "Member 'UARFaceComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARImageComponent) == 0x0003F0, "Wrong size on UARImageComponent");
static_assert(offsetof(UARImageComponent, ReplicatedPayload) == 0x000350, "Member 'UARImageComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARQRCodeComponent) == 0x000400, "Wrong size on UARQRCodeComponent");
static_assert(offsetof(UARQRCodeComponent, ReplicatedPayload) == 0x000350, "Member 'UARQRCodeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARPoseComponent) == 0x0003C0, "Wrong size on UARPoseComponent");
static_assert(offsetof(UARPoseComponent, ReplicatedPayload) == 0x000350, "Member 'UARPoseComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentProbeComponent) == 0x0003B0, "Wrong size on UAREnvironmentProbeComponent");
static_assert(offsetof(UAREnvironmentProbeComponent, ReplicatedPayload) == 0x000350, "Member 'UAREnvironmentProbeComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARObjectComponent) == 0x0003B0, "Wrong size on UARObjectComponent");
static_assert(offsetof(UARObjectComponent, ReplicatedPayload) == 0x000350, "Member 'UARObjectComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARMeshComponent) == 0x0003E0, "Wrong size on UARMeshComponent");
static_assert(offsetof(UARMeshComponent, ReplicatedPayload) == 0x000350, "Member 'UARMeshComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARGeoAnchorComponent) == 0x0003F0, "Wrong size on UARGeoAnchorComponent");
static_assert(offsetof(UARGeoAnchorComponent, ReplicatedPayload) == 0x000350, "Member 'UARGeoAnchorComponent::ReplicatedPayload' has a wrong offset!");
...
static_assert(sizeof(UARLifeCycleComponent) == 0x000300, "Wrong size on UARLifeCycleComponent");
static_assert(offsetof(UARLifeCycleComponent, OnARActorSpawnedDelegate) == 0x0002D0, "Member 'UARLifeCycleComponent::OnARActorSpawnedDelegate' has a wrong offset!");
static_assert(offsetof(UARLifeCycleComponent, OnARActorToBeDestroyedDelegate) == 0x0002E0, "Member 'UARLifeCycleComponent::OnARActorToBeDestroyedDelegate' has a wrong offset!");
...
static_assert(offsetof(UARPin, OnARTrackingStateChanged) == 0x000128, "Member 'UARPin::OnARTrackingStateChanged' has a wrong offset!");
static_assert(offsetof(UARPin, OnARTransformUpdated) == 0x000138, "Member 'UARPin::OnARTransformUpdated' has a wrong offset!");
...
static_assert(offsetof(UARPlaneGeometry, Orientation) == 0x000160, "Member 'UARPlaneGeometry::Orientation' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, Center) == 0x000168, "Member 'UARPlaneGeometry::Center' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, Extent) == 0x000180, "Member 'UARPlaneGeometry::Extent' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, BoundaryPolygon) == 0x000198, "Member 'UARPlaneGeometry::BoundaryPolygon' has a wrong offset!");
static_assert(offsetof(UARPlaneGeometry, SubsumedBy) == 0x0001A8, "Member 'UARPlaneGeometry::SubsumedBy' has a wrong offset!");
...
static_assert(sizeof(UARTrackedImage) == 0x000180, "Wrong size on UARTrackedImage");
static_assert(offsetof(UARTrackedImage, DetectedImage) == 0x000160, "Member 'UARTrackedImage::DetectedImage' has a wrong offset!");
static_assert(offsetof(UARTrackedImage, EstimatedSize) == 0x000168, "Member 'UARTrackedImage::EstimatedSize' has a wrong offset!");
...
static_assert(offsetof(UARTrackedQRCode, QRCode) == 0x000178, "Member 'UARTrackedQRCode::QRCode' has a wrong offset!");
static_assert(offsetof(UARTrackedQRCode, Version) == 0x000188, "Member 'UARTrackedQRCode::Version' has a wrong offset!");
...
static_assert(offsetof(UARFaceGeometry, LookAtTarget) == 0x000160, "Member 'UARFaceGeometry::LookAtTarget' has a wrong offset!");
static_assert(offsetof(UARFaceGeometry, bIsTracked) == 0x000178, "Member 'UARFaceGeometry::bIsTracked' has a wrong offset!");
static_assert(offsetof(UARFaceGeometry, BlendShapes) == 0x000180, "Member 'UARFaceGeometry::BlendShapes' has a wrong offset!");
...
static_assert(offsetof(UAREnvironmentCaptureProbe, Extent) == 0x000160, "Member 'UAREnvironmentCaptureProbe::Extent' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbe, EnvironmentCaptureTexture) == 0x000178, "Member 'UAREnvironmentCaptureProbe::EnvironmentCaptureTexture' has a wrong offset!");
...
static_assert(sizeof(UARTrackedObject) == 0x000170, "Wrong size on UARTrackedObject");
static_assert(offsetof(UARTrackedObject, DetectedObject) == 0x000160, "Member 'UARTrackedObject::DetectedObject' has a wrong offset!");
...
static_assert(offsetof(UARTrackedPose, TrackedPose) == 0x000160, "Member 'UARTrackedPose::TrackedPose' has a wrong offset!");
