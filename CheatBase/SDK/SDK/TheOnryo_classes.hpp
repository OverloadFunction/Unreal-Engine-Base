...
static_assert(sizeof(UAddon_K27Power_01) == 0x000300, "Wrong size on UAddon_K27Power_01");
...
static_assert(sizeof(UAddon_K27Power_09) == 0x000308, "Wrong size on UAddon_K27Power_09");
static_assert(offsetof(UAddon_K27Power_09, _addonStatusEffect) == 0x000300, "Member 'UAddon_K27Power_09::_addonStatusEffect' has a wrong offset!");
...
static_assert(sizeof(UAddon_K27Power_09StatusEffect) == 0x0003B0, "Wrong size on UAddon_K27Power_09StatusEffect");
static_assert(offsetof(UAddon_K27Power_09StatusEffect, _condemnNeededForBlind) == 0x000398, "Member 'UAddon_K27Power_09StatusEffect::_condemnNeededForBlind' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_09StatusEffect, _blindnessEffect) == 0x0003A0, "Member 'UAddon_K27Power_09StatusEffect::_blindnessEffect' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_09StatusEffect, _blindnessStatusEffectClass) == 0x0003A8, "Member 'UAddon_K27Power_09StatusEffect::_blindnessStatusEffectClass' has a wrong offset!");
...
static_assert(sizeof(UAddon_K27Power_16) == 0x000340, "Wrong size on UAddon_K27Power_16");
static_assert(offsetof(UAddon_K27Power_16, _distanceOfSightFromSurvivorToKiller) == 0x000310, "Member 'UAddon_K27Power_16::_distanceOfSightFromSurvivorToKiller' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_16, _survivorScreamRevealDuration) == 0x000314, "Member 'UAddon_K27Power_16::_survivorScreamRevealDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_16, _screamRevealComponentClass) == 0x000318, "Member 'UAddon_K27Power_16::_screamRevealComponentClass' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_16, _cachedScreamRevealComponents) == 0x000320, "Member 'UAddon_K27Power_16::_cachedScreamRevealComponents' has a wrong offset!");
...
static_assert(sizeof(UAddon_K27Power_17) == 0x000320, "Wrong size on UAddon_K27Power_17");
static_assert(offsetof(UAddon_K27Power_17, _survivorImposedEffectClass) == 0x000310, "Member 'UAddon_K27Power_17::_survivorImposedEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_17, _survivorInRangeDistance) == 0x000318, "Member 'UAddon_K27Power_17::_survivorInRangeDistance' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_17, _hinderedSeconds) == 0x00031C, "Member 'UAddon_K27Power_17::_hinderedSeconds' has a wrong offset!");
...
static_assert(sizeof(UAddon_K27Power_18) == 0x000378, "Wrong size on UAddon_K27Power_18");
static_assert(offsetof(UAddon_K27Power_18, _vhsCollectableBP) == 0x000300, "Member 'UAddon_K27Power_18::_vhsCollectableBP' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_18, _revealTime) == 0x000308, "Member 'UAddon_K27Power_18::_revealTime' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_18, _revealAuraToKillerEffectClass) == 0x000310, "Member 'UAddon_K27Power_18::_revealAuraToKillerEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_18, _revealAuraToKillerPerSurvivor) == 0x000318, "Member 'UAddon_K27Power_18::_revealAuraToKillerPerSurvivor' has a wrong offset!");
...
static_assert(sizeof(UAddon_K27Power_19) == 0x000330, "Wrong size on UAddon_K27Power_19");
static_assert(offsetof(UAddon_K27Power_19, _distanceFromSurvivorToTVToRevealAura) == 0x000310, "Member 'UAddon_K27Power_19::_distanceFromSurvivorToTVToRevealAura' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_19, _heightOffsetLowerBoundToRevealAura) == 0x000314, "Member 'UAddon_K27Power_19::_heightOffsetLowerBoundToRevealAura' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_19, _heightOffsetUpperBoundToRevealAura) == 0x000318, "Member 'UAddon_K27Power_19::_heightOffsetUpperBoundToRevealAura' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_19, _survivorAuraRevealDuration) == 0x00031C, "Member 'UAddon_K27Power_19::_survivorAuraRevealDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_19, _revealSurvivorsAroundPoweredTVs) == 0x000320, "Member 'UAddon_K27Power_19::_revealSurvivorsAroundPoweredTVs' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_19, _revealSurvivorsAroundTurnedOffTVs) == 0x000321, "Member 'UAddon_K27Power_19::_revealSurvivorsAroundTurnedOffTVs' has a wrong offset!");
static_assert(offsetof(UAddon_K27Power_19, _timedRevealToKillerEffect) == 0x000328, "Member 'UAddon_K27Power_19::_timedRevealToKillerEffect' has a wrong offset!");
...
static_assert(sizeof(UAddon_K27Power_20) == 0x000300, "Wrong size on UAddon_K27Power_20");
...
static_assert(sizeof(UCondemnedComponent) == 0x000518, "Wrong size on UCondemnedComponent");
static_assert(offsetof(UCondemnedComponent, _condemnedRangeWhenTeleport) == 0x000120, "Member 'UCondemnedComponent::_condemnedRangeWhenTeleport' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _maxCondemnedLevel) == 0x0001A8, "Member 'UCondemnedComponent::_maxCondemnedLevel' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _killerInstinctRevealDurationOnFullyCondemned) == 0x0001D0, "Member 'UCondemnedComponent::_killerInstinctRevealDurationOnFullyCondemned' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _stacksOnTurnOffTV) == 0x0001F8, "Member 'UCondemnedComponent::_stacksOnTurnOffTV' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _stacksOnRetrieveVHS) == 0x000220, "Member 'UCondemnedComponent::_stacksOnRetrieveVHS' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _stacksRemovedOnInsert) == 0x000248, "Member 'UCondemnedComponent::_stacksRemovedOnInsert' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _stacksOnOnryoTeleport) == 0x000270, "Member 'UCondemnedComponent::_stacksOnOnryoTeleport' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _reducedAddonStacksOnOnryoTeleport) == 0x000298, "Member 'UCondemnedComponent::_reducedAddonStacksOnOnryoTeleport' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _stacksOnPlayerHooked) == 0x0002C0, "Member 'UCondemnedComponent::_stacksOnPlayerHooked' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _maxLockInStacksPerHook) == 0x0002E8, "Member 'UCondemnedComponent::_maxLockInStacksPerHook' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _condemnedStackPerSecond) == 0x000310, "Member 'UCondemnedComponent::_condemnedStackPerSecond' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _analyticScoreTag) == 0x000398, "Member 'UCondemnedComponent::_analyticScoreTag' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _condemnedLevel) == 0x0003A8, "Member 'UCondemnedComponent::_condemnedLevel' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _lockedCondemnedLevel) == 0x0003AC, "Member 'UCondemnedComponent::_lockedCondemnedLevel' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _previousReasonForCondemn) == 0x0003B0, "Member 'UCondemnedComponent::_previousReasonForCondemn' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _isHoldingVHS) == 0x0003B1, "Member 'UCondemnedComponent::_isHoldingVHS' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _condemnKillerInstinctEffectClass) == 0x0003F0, "Member 'UCondemnedComponent::_condemnKillerInstinctEffectClass' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _condemnKillerInstinctEffect) == 0x0003F8, "Member 'UCondemnedComponent::_condemnKillerInstinctEffect' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _reactivateCondemnProgressEvents) == 0x000410, "Member 'UCondemnedComponent::_reactivateCondemnProgressEvents' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _rangeToStopCondemnProgressAfterChase) == 0x000458, "Member 'UCondemnedComponent::_rangeToStopCondemnProgressAfterChase' has a wrong offset!");
static_assert(offsetof(UCondemnedComponent, _timeAwayFromKillerToResumeCondemn) == 0x000480, "Member 'UCondemnedComponent::_timeAwayFromKillerToResumeCondemn' has a wrong offset!");
...
static_assert(sizeof(UCondemnMoriInteraction) == 0x0009E0, "Wrong size on UCondemnMoriInteraction");
...
static_assert(sizeof(UK27Addon_16_ScreamRevealComponent) == 0x000118, "Wrong size on UK27Addon_16_ScreamRevealComponent");
...
static_assert(offsetof(UK27Addon_16_ScreamRevealComponent, _revealAuraToKillerEffectClass) == 0x0000C0, "Member 'UK27Addon_16_ScreamRevealComponent::_revealAuraToKillerEffectClass' has a wrong offset!");
static_assert(offsetof(UK27Addon_16_ScreamRevealComponent, _revealAuraToKillerPerSurvivor) == 0x0000C8, "Member 'UK27Addon_16_ScreamRevealComponent::_revealAuraToKillerPerSurvivor' has a wrong offset!");
...
static_assert(sizeof(UK27P01) == 0x000488, "Wrong size on UK27P01");
static_assert(offsetof(UK27P01, _survivorAuraRevealDuration) == 0x000470, "Member 'UK27P01::_survivorAuraRevealDuration' has a wrong offset!");
static_assert(offsetof(UK27P01, _timedRevealToKillerEffectClass) == 0x000480, "Member 'UK27P01::_timedRevealToKillerEffectClass' has a wrong offset!");
...
static_assert(sizeof(UK27P02) == 0x000518, "Wrong size on UK27P02");
static_assert(offsetof(UK27P02, _activePerkDuration) == 0x000460, "Member 'UK27P02::_activePerkDuration' has a wrong offset!");
static_assert(offsetof(UK27P02, _regressionModifier) == 0x00046C, "Member 'UK27P02::_regressionModifier' has a wrong offset!");
static_assert(offsetof(UK27P02, _authority_affectedGeneratorsAndActiveTimers) == 0x000478, "Member 'UK27P02::_authority_affectedGeneratorsAndActiveTimers' has a wrong offset!");
static_assert(offsetof(UK27P02, _gameplayModifierHandles) == 0x0004C8, "Member 'UK27P02::_gameplayModifierHandles' has a wrong offset!");
...
static_assert(sizeof(UK27P03) == 0x000528, "Wrong size on UK27P03");
static_assert(offsetof(UK27P03, _generatorBlockedAuraColorForKiller) == 0x000460, "Member 'UK27P03::_generatorBlockedAuraColorForKiller' has a wrong offset!");
static_assert(offsetof(UK27P03, _generatorProgressionActivation) == 0x000470, "Member 'UK27P03::_generatorProgressionActivation' has a wrong offset!");
static_assert(offsetof(UK27P03, _generatorBlockedDuration) == 0x00047C, "Member 'UK27P03::_generatorBlockedDuration' has a wrong offset!");
static_assert(offsetof(UK27P03, _authority_blockedGeneratorsAndTimeToUnblock) == 0x000488, "Member 'UK27P03::_authority_blockedGeneratorsAndTimeToUnblock' has a wrong offset!");
static_assert(offsetof(UK27P03, _authority_affectedRepairersAndTheirGenerators) == 0x0004D8, "Member 'UK27P03::_authority_affectedRepairersAndTheirGenerators' has a wrong offset!");
...
static_assert(sizeof(UManifestationComponent) == 0x0004D0, "Wrong size on UManifestationComponent");
static_assert(offsetof(UManifestationComponent, _unmanifestedUndetectableStatusEffectClass) == 0x0000B8, "Member 'UManifestationComponent::_unmanifestedUndetectableStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _lingeringFlickerDuration) == 0x0000C0, "Member 'UManifestationComponent::_lingeringFlickerDuration' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _maxTrackedTimeSinceManifest) == 0x000140, "Member 'UManifestationComponent::_maxTrackedTimeSinceManifest' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _manifestInteractionUndetectableLingerTime) == 0x000168, "Member 'UManifestationComponent::_manifestInteractionUndetectableLingerTime' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _teleportManifestUndetectableLingeringDuration) == 0x0001E8, "Member 'UManifestationComponent::_teleportManifestUndetectableLingeringDuration' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _lingeringUndetectableDurationFromOtherSources) == 0x000268, "Member 'UManifestationComponent::_lingeringUndetectableDurationFromOtherSources' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _scorePercent) == 0x0002E8, "Member 'UManifestationComponent::_scorePercent' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _onryoVisibilityComponent) == 0x000398, "Member 'UManifestationComponent::_onryoVisibilityComponent' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _onryoVisibilityComponentClass) == 0x0003A0, "Member 'UManifestationComponent::_onryoVisibilityComponentClass' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _isManifested) == 0x0003A8, "Member 'UManifestationComponent::_isManifested' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _lingeringUndetectableEndTimeStamp) == 0x0003AC, "Member 'UManifestationComponent::_lingeringUndetectableEndTimeStamp' has a wrong offset!");
static_assert(offsetof(UManifestationComponent, _unmanifestStatusEffect) == 0x000478, "Member 'UManifestationComponent::_unmanifestStatusEffect' has a wrong offset!");
...
static_assert(sizeof(UNearPoweredTelevisionWithLingerTime) == 0x000188, "Wrong size on UNearPoweredTelevisionWithLingerTime");
static_assert(offsetof(UNearPoweredTelevisionWithLingerTime, _distanceFromTelevision) == 0x0000F0, "Member 'UNearPoweredTelevisionWithLingerTime::_distanceFromTelevision' has a wrong offset!");
static_assert(offsetof(UNearPoweredTelevisionWithLingerTime, _lingerDuration) == 0x0000F4, "Member 'UNearPoweredTelevisionWithLingerTime::_lingerDuration' has a wrong offset!");
static_assert(offsetof(UNearPoweredTelevisionWithLingerTime, _heightRange) == 0x0000F8, "Member 'UNearPoweredTelevisionWithLingerTime::_heightRange' has a wrong offset!");
...
static_assert(sizeof(UOnryoAfterImageComponent) == 0x0001F8, "Wrong size on UOnryoAfterImageComponent");
static_assert(offsetof(UOnryoAfterImageComponent, _isAllowedToSpawnImages) == 0x0000B8, "Member 'UOnryoAfterImageComponent::_isAllowedToSpawnImages' has a wrong offset!");
static_assert(offsetof(UOnryoAfterImageComponent, _hideAfterImageDuringInteractions) == 0x0001E1, "Member 'UOnryoAfterImageComponent::_hideAfterImageDuringInteractions' has a wrong offset!");
...
static_assert(sizeof(AOnryoPower) == 0x000668, "Wrong size on AOnryoPower");
static_assert(offsetof(AOnryoPower, _condemnedComponentClass) == 0x000568, "Member 'AOnryoPower::_condemnedComponentClass' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _manifestationComponentClass) == 0x000570, "Member 'AOnryoPower::_manifestationComponentClass' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _effects) == 0x000578, "Member 'AOnryoPower::_effects' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _teleportCooldownTime) == 0x000588, "Member 'AOnryoPower::_teleportCooldownTime' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _effectSpawner) == 0x0005B0, "Member 'AOnryoPower::_effectSpawner' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _televisionTargeter) == 0x000638, "Member 'AOnryoPower::_televisionTargeter' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _manifestationComponent) == 0x000640, "Member 'AOnryoPower::_manifestationComponent' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _televisions) == 0x000648, "Member 'AOnryoPower::_televisions' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _televisionClass) == 0x000658, "Member 'AOnryoPower::_televisionClass' has a wrong offset!");
static_assert(offsetof(AOnryoPower, _onryoPowerCooldownInteraction) == 0x000660, "Member 'AOnryoPower::_onryoPowerCooldownInteraction' has a wrong offset!");
...
static_assert(offsetof(UOnryoPowerPresentationComponent, _cooldownState) == 0x0000C0, "Member 'UOnryoPowerPresentationComponent::_cooldownState' has a wrong offset!");
...
static_assert(sizeof(AOnryoSurvivorCosmeticHelperActor) == 0x0003C8, "Wrong size on AOnryoSurvivorCosmeticHelperActor");
static_assert(offsetof(AOnryoSurvivorCosmeticHelperActor, _condemnedComponent) == 0x000358, "Member 'AOnryoSurvivorCosmeticHelperActor::_condemnedComponent' has a wrong offset!");
...
static_assert(sizeof(UOnryoUnmanifestCooldownInteraction) == 0x0007A0, "Wrong size on UOnryoUnmanifestCooldownInteraction");
static_assert(offsetof(UOnryoUnmanifestCooldownInteraction, _onryoPowerCooldownTime) == 0x000768, "Member 'UOnryoUnmanifestCooldownInteraction::_onryoPowerCooldownTime' has a wrong offset!");
static_assert(offsetof(UOnryoUnmanifestCooldownInteraction, _playedCooldownSpeedCurve) == 0x000790, "Member 'UOnryoUnmanifestCooldownInteraction::_playedCooldownSpeedCurve' has a wrong offset!");
...
static_assert(sizeof(UOnryoVisibilityComponent) == 0x000250, "Wrong size on UOnryoVisibilityComponent");
static_assert(offsetof(UOnryoVisibilityComponent, _isKillerVisibleDuringFlicker) == 0x0000B8, "Member 'UOnryoVisibilityComponent::_isKillerVisibleDuringFlicker' has a wrong offset!");
...
static_assert(offsetof(UOnryoVisibilityComponent, _flickerFadeInOutDuration) == 0x0000F8, "Member 'UOnryoVisibilityComponent::_flickerFadeInOutDuration' has a wrong offset!");
static_assert(offsetof(UOnryoVisibilityComponent, _flickerSettings) == 0x000120, "Member 'UOnryoVisibilityComponent::_flickerSettings' has a wrong offset!");
static_assert(offsetof(UOnryoVisibilityComponent, _isInIntroPhase) == 0x000171, "Member 'UOnryoVisibilityComponent::_isInIntroPhase' has a wrong offset!");
static_assert(offsetof(UOnryoVisibilityComponent, _isManifested) == 0x000172, "Member 'UOnryoVisibilityComponent::_isManifested' has a wrong offset!");
static_assert(offsetof(UOnryoVisibilityComponent, _isInManifestingTransition) == 0x000173, "Member 'UOnryoVisibilityComponent::_isInManifestingTransition' has a wrong offset!");
...
static_assert(sizeof(UTelevisionOutlineUpdateStrategy) == 0x0001E8, "Wrong size on UTelevisionOutlineUpdateStrategy");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _distanceToRevealAura) == 0x0000E0, "Member 'UTelevisionOutlineUpdateStrategy::_distanceToRevealAura' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _survivorAuraNearColor) == 0x000164, "Member 'UTelevisionOutlineUpdateStrategy::_survivorAuraNearColor' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _survivorAuraTapeTargetColor) == 0x000174, "Member 'UTelevisionOutlineUpdateStrategy::_survivorAuraTapeTargetColor' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _slasherPoweredColor) == 0x000184, "Member 'UTelevisionOutlineUpdateStrategy::_slasherPoweredColor' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _revealedByMapColor) == 0x000194, "Member 'UTelevisionOutlineUpdateStrategy::_revealedByMapColor' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _slasherUnpoweredDefaultColor) == 0x0001A4, "Member 'UTelevisionOutlineUpdateStrategy::_slasherUnpoweredDefaultColor' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _slasherUnpoweredVisibleColor) == 0x0001B4, "Member 'UTelevisionOutlineUpdateStrategy::_slasherUnpoweredVisibleColor' has a wrong offset!");
static_assert(offsetof(UTelevisionOutlineUpdateStrategy, _slasherTeleportTargetColor) == 0x0001C4, "Member 'UTelevisionOutlineUpdateStrategy::_slasherTeleportTargetColor' has a wrong offset!");
