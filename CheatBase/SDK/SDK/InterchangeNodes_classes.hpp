...
static_assert(sizeof(UInterchangeAnimationTrackSetInstanceNode) == 0x0000A8, "Wrong size on UInterchangeAnimationTrackSetInstanceNode");
...
static_assert(sizeof(UInterchangeAnimationTrackNode) == 0x0000A8, "Wrong size on UInterchangeAnimationTrackNode");
...
static_assert(sizeof(UInterchangeTransformAnimationTrackNode) == 0x0000B8, "Wrong size on UInterchangeTransformAnimationTrackNode");
...
static_assert(sizeof(UInterchangeSkeletalAnimationTrackNode) == 0x0001A8, "Wrong size on UInterchangeSkeletalAnimationTrackNode");
...
static_assert(alignof(UInterchangeCameraNode) == 0x000008, "Wrong alignment on UInterchangeCameraNode");
static_assert(sizeof(UInterchangeCameraNode) == 0x000098, "Wrong size on UInterchangeCameraNode");
...
static_assert(sizeof(UInterchangeBaseLightNode) == 0x000098, "Wrong size on UInterchangeBaseLightNode");
...
static_assert(sizeof(UInterchangeLightNode) == 0x0000C0, "Wrong size on UInterchangeLightNode");
...
static_assert(sizeof(UInterchangePointLightNode) == 0x0000D8, "Wrong size on UInterchangePointLightNode");
...
static_assert(sizeof(UInterchangeSpotLightNode) == 0x0000F0, "Wrong size on UInterchangeSpotLightNode");
...
static_assert(sizeof(UInterchangeRectLightNode) == 0x0000D8, "Wrong size on UInterchangeRectLightNode");
...
static_assert(sizeof(UInterchangeDirectionalLightNode) == 0x000098, "Wrong size on UInterchangeDirectionalLightNode");
...
static_assert(sizeof(UInterchangeMeshNode) == 0x0001D0, "Wrong size on UInterchangeMeshNode");
...
static_assert(sizeof(UInterchangeSceneNode) == 0x000290, "Wrong size on UInterchangeSceneNode");
...
static_assert(sizeof(UInterchangeShaderGraphNode) == 0x0000A0, "Wrong size on UInterchangeShaderGraphNode");
...
static_assert(sizeof(UInterchangeTexture2DNode) == 0x000120, "Wrong size on UInterchangeTexture2DNode");
