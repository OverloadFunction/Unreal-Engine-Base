...
static_assert(sizeof(UNiagaraDataChannel) == 0x000148, "Wrong size on UNiagaraDataChannel");
...
static_assert(offsetof(UNiagaraDataChannel, Variables) == 0x000040, "Member 'UNiagaraDataChannel::Variables' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, bKeepPreviousFrameData) == 0x000050, "Member 'UNiagaraDataChannel::bKeepPreviousFrameData' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, CompiledData) == 0x000058, "Member 'UNiagaraDataChannel::CompiledData' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, CompiledDataGPU) == 0x0000A0, "Member 'UNiagaraDataChannel::CompiledDataGPU' has a wrong offset!");
static_assert(offsetof(UNiagaraDataChannel, GameDataLayout) == 0x0000E8, "Member 'UNiagaraDataChannel::GameDataLayout' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataChannel_Global) == 0x000148, "Wrong size on UNiagaraDataChannel_Global");
...
static_assert(sizeof(UNiagaraDataInterfaceDataChannelSpawn) == 0x0000D0, "Wrong size on UNiagaraDataInterfaceDataChannelSpawn");
...
static_assert(offsetof(UNiagaraDataInterfaceDataChannelSpawn, bOverrideSpawnGroupToDataChannelIndex) == 0x0000C8, "Member 'UNiagaraDataInterfaceDataChannelSpawn::bOverrideSpawnGroupToDataChannelIndex' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSettings, PositionPinTypeColor) == 0x000078, "Member 'UNiagaraSettings::PositionPinTypeColor' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuMaxInfluences) == 0x0000F8, "Member 'UNiagaraSettings::NDISkelMesh_GpuMaxInfluences' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_GpuUniformSamplingFormat) == 0x0000F9, "Member 'UNiagaraSettings::NDISkelMesh_GpuUniformSamplingFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDISkelMesh_AdjacencyTriangleIndexFormat) == 0x0000FA, "Member 'UNiagaraSettings::NDISkelMesh_AdjacencyTriangleIndexFormat' has a wrong offset!");
static_assert(offsetof(UNiagaraSettings, NDIStaticMesh_AllowDistanceFields) == 0x0000FB, "Member 'UNiagaraSettings::NDIStaticMesh_AllowDistanceFields' has a wrong offset!");
...
static_assert(sizeof(UNiagaraBaselineController) == 0x000080, "Wrong size on UNiagaraBaselineController");
...
static_assert(sizeof(UNiagaraBaselineController_Basic) == 0x000098, "Wrong size on UNiagaraBaselineController_Basic");
static_assert(offsetof(UNiagaraBaselineController_Basic, NumInstances) == 0x000080, "Member 'UNiagaraBaselineController_Basic::NumInstances' has a wrong offset!");
static_assert(offsetof(UNiagaraBaselineController_Basic, SpawnedComponents) == 0x000088, "Member 'UNiagaraBaselineController_Basic::SpawnedComponents' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDataInterfacePhysicsAsset) == 0x0000C0, "Wrong size on UNiagaraDataInterfacePhysicsAsset");
...
static_assert(offsetof(UNiagaraDataInterfacePhysicsAsset, MeshUserParameter) == 0x000080, "Member 'UNiagaraDataInterfacePhysicsAsset::MeshUserParameter' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSimCache, StartSeconds) == 0x000078, "Member 'UNiagaraSimCache::StartSeconds' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, DurationSeconds) == 0x00007C, "Member 'UNiagaraSimCache::DurationSeconds' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CreateParameters) == 0x000080, "Member 'UNiagaraSimCache::CreateParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, bNeedsReadComponentMappingRecache) == 0x0000D8, "Member 'UNiagaraSimCache::bNeedsReadComponentMappingRecache' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CacheLayout) == 0x0000E0, "Member 'UNiagaraSimCache::CacheLayout' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, CacheFrames) == 0x0001A8, "Member 'UNiagaraSimCache::CacheFrames' has a wrong offset!");
static_assert(offsetof(UNiagaraSimCache, DataInterfaceStorage) == 0x0001B8, "Member 'UNiagaraSimCache::DataInterfaceStorage' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, SourceComponent) == 0x000088, "Member 'UNiagaraDataInterfaceStaticMesh::SourceComponent' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, SectionFilter) == 0x000090, "Member 'UNiagaraDataInterfaceStaticMesh::SectionFilter' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, bUsePhysicsBodyVelocity) == 0x0000A0, "Member 'UNiagaraDataInterfaceStaticMesh::bUsePhysicsBodyVelocity' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, bAllowSamplingFromStreamingLODs) == 0x0000A1, "Member 'UNiagaraDataInterfaceStaticMesh::bAllowSamplingFromStreamingLODs' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, LODIndex) == 0x0000A4, "Member 'UNiagaraDataInterfaceStaticMesh::LODIndex' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceStaticMesh, LODIndexUserParameter) == 0x0000A8, "Member 'UNiagaraDataInterfaceStaticMesh::LODIndexUserParameter' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x0005A0, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, TickBehavior) == 0x0005A8, "Member 'UNiagaraComponent::TickBehavior' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, RandomSeedOffset) == 0x0005AC, "Member 'UNiagaraComponent::RandomSeedOffset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x0005B0, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickCount) == 0x00068C, "Member 'UNiagaraComponent::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, WarmupTickDelta) == 0x000690, "Member 'UNiagaraComponent::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x0006CC, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OnSystemFinished) == 0x0006D8, "Member 'UNiagaraComponent::OnSystemFinished' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachParent) == 0x0006E8, "Member 'UNiagaraComponent::AutoAttachParent' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachSocketName) == 0x0006F0, "Member 'UNiagaraComponent::AutoAttachSocketName' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachLocationRule) == 0x0006FC, "Member 'UNiagaraComponent::AutoAttachLocationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachRotationRule) == 0x0006FD, "Member 'UNiagaraComponent::AutoAttachRotationRule' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, AutoAttachScaleRule) == 0x0006FE, "Member 'UNiagaraComponent::AutoAttachScaleRule' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, ComponentTags) == 0x000080, "Member 'UNiagaraDataInterfaceSkeletalMesh::ComponentTags' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SourceComponent) == 0x000090, "Member 'UNiagaraDataInterfaceSkeletalMesh::SourceComponent' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, MeshUserParameter) == 0x000098, "Member 'UNiagaraDataInterfaceSkeletalMesh::MeshUserParameter' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SkinningMode) == 0x0000B8, "Member 'UNiagaraDataInterfaceSkeletalMesh::SkinningMode' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SamplingRegions) == 0x0000C0, "Member 'UNiagaraDataInterfaceSkeletalMesh::SamplingRegions' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, WholeMeshLOD) == 0x0000D0, "Member 'UNiagaraDataInterfaceSkeletalMesh::WholeMeshLOD' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, FilteredBones) == 0x0000D8, "Member 'UNiagaraDataInterfaceSkeletalMesh::FilteredBones' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, FilteredSockets) == 0x0000E8, "Member 'UNiagaraDataInterfaceSkeletalMesh::FilteredSockets' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, ExcludeBoneName) == 0x0000F8, "Member 'UNiagaraDataInterfaceSkeletalMesh::ExcludeBoneName' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, UvSetIndex) == 0x000108, "Member 'UNiagaraDataInterfaceSkeletalMesh::UvSetIndex' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, bRequireCurrentFrameData) == 0x00010C, "Member 'UNiagaraDataInterfaceSkeletalMesh::bRequireCurrentFrameData' has a wrong offset!");
...
static_assert(sizeof(UNiagaraDecalRendererProperties) == 0x000458, "Wrong size on UNiagaraDecalRendererProperties");
...
static_assert(offsetof(UNiagaraDecalRendererProperties, SourceMode) == 0x000100, "Member 'UNiagaraDecalRendererProperties::SourceMode' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, RendererVisibility) == 0x000104, "Member 'UNiagaraDecalRendererProperties::RendererVisibility' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalScreenSizeFade) == 0x000108, "Member 'UNiagaraDecalRendererProperties::DecalScreenSizeFade' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, PositionBinding) == 0x000110, "Member 'UNiagaraDecalRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalOrientationBinding) == 0x000168, "Member 'UNiagaraDecalRendererProperties::DecalOrientationBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalSizeBinding) == 0x0001C0, "Member 'UNiagaraDecalRendererProperties::DecalSizeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalFadeBinding) == 0x000218, "Member 'UNiagaraDecalRendererProperties::DecalFadeBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalSortOrderBinding) == 0x000270, "Member 'UNiagaraDecalRendererProperties::DecalSortOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalColorBinding) == 0x0002C8, "Member 'UNiagaraDecalRendererProperties::DecalColorBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, DecalVisibleBinding) == 0x000320, "Member 'UNiagaraDecalRendererProperties::DecalVisibleBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, RendererVisibilityTagBinding) == 0x000378, "Member 'UNiagaraDecalRendererProperties::RendererVisibilityTagBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraDecalRendererProperties, MaterialParameters) == 0x0003D0, "Member 'UNiagaraDecalRendererProperties::MaterialParameters' has a wrong offset!");
