...
static_assert(alignof(FShotByRank) == 0x000008, "Wrong alignment on FShotByRank");
static_assert(sizeof(FShotByRank) == 0x000018, "Wrong size on FShotByRank");
static_assert(offsetof(FShotByRank, SelectedShot) == 0x000000, "Member 'FShotByRank::SelectedShot' has a wrong offset!");
static_assert(offsetof(FShotByRank, Shots) == 0x000008, "Member 'FShotByRank::Shots' has a wrong offset!");
