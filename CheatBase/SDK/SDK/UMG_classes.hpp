...
static_assert(offsetof(UWidget, PixelSnappingMethod) == 0x00010C, "Member 'UWidget::PixelSnappingMethod' has a wrong offset!");
static_assert(offsetof(UWidget, AccessibleWidgetData) == 0x000110, "Member 'UWidget::AccessibleWidgetData' has a wrong offset!");
static_assert(offsetof(UWidget, Navigation) == 0x000118, "Member 'UWidget::Navigation' has a wrong offset!");
static_assert(offsetof(UWidget, NativeBindings) == 0x000140, "Member 'UWidget::NativeBindings' has a wrong offset!");
...
static_assert(sizeof(UListViewBase) == 0x000288, "Wrong size on UListViewBase");
...
static_assert(offsetof(UListViewBase, EntryWidgetClass) == 0x000190, "Member 'UListViewBase::EntryWidgetClass' has a wrong offset!");
static_assert(offsetof(UListViewBase, WheelScrollMultiplier) == 0x000198, "Member 'UListViewBase::WheelScrollMultiplier' has a wrong offset!");
static_assert(offsetof(UListViewBase, bEnableScrollAnimation) == 0x00019C, "Member 'UListViewBase::bEnableScrollAnimation' has a wrong offset!");
...
static_assert(offsetof(UListViewBase, bEnableFixedLineOffset) == 0x00019F, "Member 'UListViewBase::bEnableFixedLineOffset' has a wrong offset!");
static_assert(offsetof(UListViewBase, FixedLineScrollOffset) == 0x0001A0, "Member 'UListViewBase::FixedLineScrollOffset' has a wrong offset!");
static_assert(offsetof(UListViewBase, bAllowDragging) == 0x0001A4, "Member 'UListViewBase::bAllowDragging' has a wrong offset!");
static_assert(offsetof(UListViewBase, BP_OnEntryReleased) == 0x0001A8, "Member 'UListViewBase::BP_OnEntryReleased' has a wrong offset!");
static_assert(offsetof(UListViewBase, EntryWidgetPool) == 0x0001B8, "Member 'UListViewBase::EntryWidgetPool' has a wrong offset!");
...
static_assert(sizeof(UListView) == 0x000C50, "Wrong size on UListView");
static_assert(offsetof(UListView, WidgetStyle) == 0x000360, "Member 'UListView::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UListView, ScrollBarStyle) == 0x000440, "Member 'UListView::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UListView, Orientation) == 0x000BB0, "Member 'UListView::Orientation' has a wrong offset!");
static_assert(offsetof(UListView, SelectionMode) == 0x000BB1, "Member 'UListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UListView, ConsumeMouseWheel) == 0x000BB2, "Member 'UListView::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UListView, bClearSelectionOnClick) == 0x000BB3, "Member 'UListView::bClearSelectionOnClick' has a wrong offset!");
static_assert(offsetof(UListView, bIsFocusable) == 0x000BB4, "Member 'UListView::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UListView, EntrySpacing) == 0x000BB8, "Member 'UListView::EntrySpacing' has a wrong offset!");
static_assert(offsetof(UListView, bReturnFocusToSelection) == 0x000BBC, "Member 'UListView::bReturnFocusToSelection' has a wrong offset!");
static_assert(offsetof(UListView, ListItems) == 0x000BC0, "Member 'UListView::ListItems' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnEntryInitialized) == 0x000BE0, "Member 'UListView::BP_OnEntryInitialized' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemClicked) == 0x000BF0, "Member 'UListView::BP_OnItemClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemDoubleClicked) == 0x000C00, "Member 'UListView::BP_OnItemDoubleClicked' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemIsHoveredChanged) == 0x000C10, "Member 'UListView::BP_OnItemIsHoveredChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemSelectionChanged) == 0x000C20, "Member 'UListView::BP_OnItemSelectionChanged' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnItemScrolledIntoView) == 0x000C30, "Member 'UListView::BP_OnItemScrolledIntoView' has a wrong offset!");
static_assert(offsetof(UListView, BP_OnListViewScrolled) == 0x000C40, "Member 'UListView::BP_OnListViewScrolled' has a wrong offset!");
...
static_assert(sizeof(UTreeView) == 0x000CB0, "Wrong size on UTreeView");
static_assert(offsetof(UTreeView, BP_OnGetItemChildren) == 0x000C60, "Member 'UTreeView::BP_OnGetItemChildren' has a wrong offset!");
static_assert(offsetof(UTreeView, BP_OnItemExpansionChanged) == 0x000C78, "Member 'UTreeView::BP_OnItemExpansionChanged' has a wrong offset!");
...
static_assert(sizeof(UScrollBox) == 0x000CE0, "Wrong size on UScrollBox");
...
static_assert(sizeof(UUserWidget) == 0x0002A8, "Wrong size on UUserWidget");
...
static_assert(offsetof(UUserWidget, Padding) == 0x0001F0, "Member 'UUserWidget::Padding' has a wrong offset!");
static_assert(offsetof(UUserWidget, Priority) == 0x000200, "Member 'UUserWidget::Priority' has a wrong offset!");
static_assert(offsetof(UUserWidget, ActiveSequencePlayers) == 0x000208, "Member 'UUserWidget::ActiveSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationTickManager) == 0x000218, "Member 'UUserWidget::AnimationTickManager' has a wrong offset!");
static_assert(offsetof(UUserWidget, StoppedSequencePlayers) == 0x000220, "Member 'UUserWidget::StoppedSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, NamedSlotBindings) == 0x000230, "Member 'UUserWidget::NamedSlotBindings' has a wrong offset!");
static_assert(offsetof(UUserWidget, Extensions) == 0x000240, "Member 'UUserWidget::Extensions' has a wrong offset!");
static_assert(offsetof(UUserWidget, WidgetTree) == 0x000250, "Member 'UUserWidget::WidgetTree' has a wrong offset!");
static_assert(offsetof(UUserWidget, TickFrequency) == 0x000270, "Member 'UUserWidget::TickFrequency' has a wrong offset!");
static_assert(offsetof(UUserWidget, InputComponent) == 0x000278, "Member 'UUserWidget::InputComponent' has a wrong offset!");
static_assert(offsetof(UUserWidget, AnimationCallbacks) == 0x000280, "Member 'UUserWidget::AnimationCallbacks' has a wrong offset!");
...
static_assert(sizeof(UButton) == 0x000640, "Wrong size on UButton");
...
static_assert(offsetof(UButton, OnLongPress) == 0x000608, "Member 'UButton::OnLongPress' has a wrong offset!");
static_assert(offsetof(UButton, LongPressTimerHandle) == 0x000618, "Member 'UButton::LongPressTimerHandle' has a wrong offset!");
...
static_assert(sizeof(UComboBoxString) == 0x001DF0, "Wrong size on UComboBoxString");
...
static_assert(offsetof(UComboBoxString, OnSelectionChanged) == 0x001D78, "Member 'UComboBoxString::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnOpening) == 0x001D88, "Member 'UComboBoxString::OnOpening' has a wrong offset!");
...
static_assert(offsetof(UEditableTextBox, HintTextDelegate) == 0x001038, "Member 'UEditableTextBox::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsReadOnly) == 0x00104C, "Member 'UEditableTextBox::IsReadOnly' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsPassword) == 0x00104D, "Member 'UEditableTextBox::IsPassword' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, MinimumDesiredWidth) == 0x001050, "Member 'UEditableTextBox::MinimumDesiredWidth' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsCaretMovedWhenGainFocus) == 0x001054, "Member 'UEditableTextBox::IsCaretMovedWhenGainFocus' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextWhenFocused) == 0x001055, "Member 'UEditableTextBox::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, RevertTextOnEscape) == 0x001056, "Member 'UEditableTextBox::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ClearKeyboardFocusOnCommit) == 0x001057, "Member 'UEditableTextBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextOnCommit) == 0x001058, "Member 'UEditableTextBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, AllowContextMenu) == 0x001059, "Member 'UEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, KeyboardType) == 0x00105A, "Member 'UEditableTextBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardOptions) == 0x00105B, "Member 'UEditableTextBox::VirtualKeyboardOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardTrigger) == 0x00105C, "Member 'UEditableTextBox::VirtualKeyboardTrigger' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, VirtualKeyboardDismissAction) == 0x00105D, "Member 'UEditableTextBox::VirtualKeyboardDismissAction' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Justification) == 0x00105E, "Member 'UEditableTextBox::Justification' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OverflowPolicy) == 0x00105F, "Member 'UEditableTextBox::OverflowPolicy' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x001060, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
...
static_assert(offsetof(UImage, ColorAndOpacity) == 0x000254, "Member 'UImage::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacityDelegate) == 0x000264, "Member 'UImage::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UImage, bFlipForRightToLeftFlowDirection) == 0x000278, "Member 'UImage::bFlipForRightToLeftFlowDirection' has a wrong offset!");
static_assert(offsetof(UImage, OnMouseButtonDownEvent) == 0x00027C, "Member 'UImage::OnMouseButtonDownEvent' has a wrong offset!");
...
static_assert(offsetof(UCheckBox, CheckedStateDelegate) == 0x00018C, "Member 'UCheckBox::CheckedStateDelegate' has a wrong offset!");
...
static_assert(offsetof(USlider, ValueDelegate) == 0x000174, "Member 'USlider::ValueDelegate' has a wrong offset!");
...
static_assert(offsetof(USlider, Orientation) == 0x000690, "Member 'USlider::Orientation' has a wrong offset!");
static_assert(offsetof(USlider, SliderBarColor) == 0x000694, "Member 'USlider::SliderBarColor' has a wrong offset!");
static_assert(offsetof(USlider, SliderHandleColor) == 0x0006A4, "Member 'USlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USlider, IndentHandle) == 0x0006B4, "Member 'USlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USlider, Locked) == 0x0006B5, "Member 'USlider::Locked' has a wrong offset!");
static_assert(offsetof(USlider, MouseUsesStep) == 0x0006B6, "Member 'USlider::MouseUsesStep' has a wrong offset!");
static_assert(offsetof(USlider, RequiresControllerLock) == 0x0006B7, "Member 'USlider::RequiresControllerLock' has a wrong offset!");
static_assert(offsetof(USlider, StepSize) == 0x0006B8, "Member 'USlider::StepSize' has a wrong offset!");
static_assert(offsetof(USlider, IsFocusable) == 0x0006BC, "Member 'USlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USlider, OnMouseCaptureBegin) == 0x0006C0, "Member 'USlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnMouseCaptureEnd) == 0x0006D0, "Member 'USlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureBegin) == 0x0006E0, "Member 'USlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureEnd) == 0x0006F0, "Member 'USlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnValueChanged) == 0x000700, "Member 'USlider::OnValueChanged' has a wrong offset!");
static_assert(offsetof(USlider, OnHover) == 0x000710, "Member 'USlider::OnHover' has a wrong offset!");
static_assert(offsetof(USlider, OnUnhover) == 0x000720, "Member 'USlider::OnUnhover' has a wrong offset!");
...
static_assert(offsetof(UTextBlock, MinDesiredWidth) == 0x000354, "Member 'UTextBlock::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(UTextBlock, bWrapWithInvalidationPanel) == 0x000358, "Member 'UTextBlock::bWrapWithInvalidationPanel' has a wrong offset!");
static_assert(offsetof(UTextBlock, TextTransformPolicy) == 0x000359, "Member 'UTextBlock::TextTransformPolicy' has a wrong offset!");
static_assert(offsetof(UTextBlock, TextOverflowPolicy) == 0x00035A, "Member 'UTextBlock::TextOverflowPolicy' has a wrong offset!");
static_assert(offsetof(UTextBlock, bSimpleTextMode) == 0x00035B, "Member 'UTextBlock::bSimpleTextMode' has a wrong offset!");
...
static_assert(offsetof(UBorder, ContentColorAndOpacityDelegate) == 0x00019C, "Member 'UBorder::ContentColorAndOpacityDelegate' has a wrong offset!");
...
static_assert(offsetof(UBorder, BackgroundDelegate) == 0x000290, "Member 'UBorder::BackgroundDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColor) == 0x0002A4, "Member 'UBorder::BrushColor' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColorDelegate) == 0x0002B4, "Member 'UBorder::BrushColorDelegate' has a wrong offset!");
...
static_assert(offsetof(UBorder, OnMouseButtonUpEvent) == 0x0002F0, "Member 'UBorder::OnMouseButtonUpEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseMoveEvent) == 0x000304, "Member 'UBorder::OnMouseMoveEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseDoubleClickEvent) == 0x000318, "Member 'UBorder::OnMouseDoubleClickEvent' has a wrong offset!");
...
static_assert(sizeof(UComboBox) == 0x000920, "Wrong size on UComboBox");
static_assert(offsetof(UComboBox, ScrollBarStyle) == 0x000170, "Member 'UComboBox::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UComboBox, Items) == 0x0008E0, "Member 'UComboBox::Items' has a wrong offset!");
static_assert(offsetof(UComboBox, OnGenerateWidgetEvent) == 0x0008F0, "Member 'UComboBox::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBox, bIsFocusable) == 0x000904, "Member 'UComboBox::bIsFocusable' has a wrong offset!");
...
static_assert(sizeof(UComboBoxKey) == 0x001D70, "Wrong size on UComboBoxKey");
static_assert(offsetof(UComboBoxKey, Options) == 0x000170, "Member 'UComboBoxKey::Options' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, SelectedOption) == 0x000180, "Member 'UComboBoxKey::SelectedOption' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, WidgetStyle) == 0x000190, "Member 'UComboBoxKey::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ItemStyle) == 0x000810, "Member 'UComboBoxKey::ItemStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ScrollBarStyle) == 0x001560, "Member 'UComboBoxKey::ScrollBarStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ForegroundColor) == 0x001CD0, "Member 'UComboBoxKey::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, ContentPadding) == 0x001CE4, "Member 'UComboBoxKey::ContentPadding' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, MaxListHeight) == 0x001CF4, "Member 'UComboBoxKey::MaxListHeight' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, bHasDownArrow) == 0x001CF8, "Member 'UComboBoxKey::bHasDownArrow' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, bEnableGamepadNavigationMode) == 0x001CF9, "Member 'UComboBoxKey::bEnableGamepadNavigationMode' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, bIsFocusable) == 0x001CFA, "Member 'UComboBoxKey::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnGenerateContentWidget) == 0x001CFC, "Member 'UComboBoxKey::OnGenerateContentWidget' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnGenerateItemWidget) == 0x001D10, "Member 'UComboBoxKey::OnGenerateItemWidget' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnSelectionChanged) == 0x001D28, "Member 'UComboBoxKey::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxKey, OnOpening) == 0x001D38, "Member 'UComboBoxKey::OnOpening' has a wrong offset!");
...
static_assert(offsetof(UDynamicEntryBoxBase, EntrySpacing) == 0x000170, "Member 'UDynamicEntryBoxBase::EntrySpacing' has a wrong offset!");
...
static_assert(offsetof(UDynamicEntryBoxBase, EntryBoxType) == 0x000190, "Member 'UDynamicEntryBoxBase::EntryBoxType' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntrySizeRule) == 0x000194, "Member 'UDynamicEntryBoxBase::EntrySizeRule' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntryHorizontalAlignment) == 0x00019C, "Member 'UDynamicEntryBoxBase::EntryHorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntryVerticalAlignment) == 0x00019D, "Member 'UDynamicEntryBoxBase::EntryVerticalAlignment' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, MaxElementSize) == 0x0001A0, "Member 'UDynamicEntryBoxBase::MaxElementSize' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, RadialBoxSettings) == 0x0001A4, "Member 'UDynamicEntryBoxBase::RadialBoxSettings' has a wrong offset!");
static_assert(offsetof(UDynamicEntryBoxBase, EntryWidgetPool) == 0x0001C8, "Member 'UDynamicEntryBoxBase::EntryWidgetPool' has a wrong offset!");
...
static_assert(offsetof(UInputKeySelector, Margin) == 0x0008D8, "Member 'UInputKeySelector::Margin' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, KeySelectionText) == 0x0008E8, "Member 'UInputKeySelector::KeySelectionText' has a wrong offset!");
...
static_assert(offsetof(UInputKeySelector, bAllowModifierKeys) == 0x000918, "Member 'UInputKeySelector::bAllowModifierKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowGamepadKeys) == 0x000919, "Member 'UInputKeySelector::bAllowGamepadKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, EscapeKeys) == 0x000920, "Member 'UInputKeySelector::EscapeKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnKeySelected) == 0x000930, "Member 'UInputKeySelector::OnKeySelected' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnIsSelectingKeyChanged) == 0x000940, "Member 'UInputKeySelector::OnIsSelectingKeyChanged' has a wrong offset!");
...
static_assert(sizeof(UProgressBar) == 0x000460, "Wrong size on UProgressBar");
static_assert(offsetof(UProgressBar, WidgetStyle) == 0x000170, "Member 'UProgressBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UProgressBar, Percent) == 0x000400, "Member 'UProgressBar::Percent' has a wrong offset!");
static_assert(offsetof(UProgressBar, BarFillType) == 0x000404, "Member 'UProgressBar::BarFillType' has a wrong offset!");
static_assert(offsetof(UProgressBar, BarFillStyle) == 0x000405, "Member 'UProgressBar::BarFillStyle' has a wrong offset!");
static_assert(offsetof(UProgressBar, bIsMarquee) == 0x000406, "Member 'UProgressBar::bIsMarquee' has a wrong offset!");
static_assert(offsetof(UProgressBar, BorderPadding) == 0x000408, "Member 'UProgressBar::BorderPadding' has a wrong offset!");
static_assert(offsetof(UProgressBar, PercentDelegate) == 0x000418, "Member 'UProgressBar::PercentDelegate' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacity) == 0x00042C, "Member 'UProgressBar::FillColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacityDelegate) == 0x00043C, "Member 'UProgressBar::FillColorAndOpacityDelegate' has a wrong offset!");
...
static_assert(sizeof(UScrollBar) == 0x000920, "Wrong size on UScrollBar");
static_assert(offsetof(UScrollBar, WidgetStyle) == 0x000170, "Member 'UScrollBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbar) == 0x0008E0, "Member 'UScrollBar::bAlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbarTrack) == 0x0008E1, "Member 'UScrollBar::bAlwaysShowScrollbarTrack' has a wrong offset!");
static_assert(offsetof(UScrollBar, Orientation) == 0x0008E2, "Member 'UScrollBar::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBar, Thickness) == 0x0008E8, "Member 'UScrollBar::Thickness' has a wrong offset!");
static_assert(offsetof(UScrollBar, Padding) == 0x0008F8, "Member 'UScrollBar::Padding' has a wrong offset!");
...
static_assert(offsetof(USpinBox, ValueDelegate) == 0x000174, "Member 'USpinBox::ValueDelegate' has a wrong offset!");
...
static_assert(offsetof(UStackBox, Orientation) == 0x000188, "Member 'UStackBox::Orientation' has a wrong offset!");
...
static_assert(sizeof(UTileView) == 0x000C70, "Wrong size on UTileView");
static_assert(offsetof(UTileView, EntryHeight) == 0x000C50, "Member 'UTileView::EntryHeight' has a wrong offset!");
static_assert(offsetof(UTileView, EntryWidth) == 0x000C54, "Member 'UTileView::EntryWidth' has a wrong offset!");
static_assert(offsetof(UTileView, TileAlignment) == 0x000C58, "Member 'UTileView::TileAlignment' has a wrong offset!");
static_assert(offsetof(UTileView, bWrapHorizontalNavigation) == 0x000C59, "Member 'UTileView::bWrapHorizontalNavigation' has a wrong offset!");
...
static_assert(offsetof(UWidgetComponent, space) == 0x000600, "Member 'UWidgetComponent::space' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TimingPolicy) == 0x000601, "Member 'UWidgetComponent::TimingPolicy' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WidgetClass) == 0x000608, "Member 'UWidgetComponent::WidgetClass' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, DrawSize) == 0x000610, "Member 'UWidgetComponent::DrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bManuallyRedraw) == 0x000618, "Member 'UWidgetComponent::bManuallyRedraw' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bRedrawRequested) == 0x000619, "Member 'UWidgetComponent::bRedrawRequested' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RedrawTime) == 0x00061C, "Member 'UWidgetComponent::RedrawTime' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CurrentDrawSize) == 0x000628, "Member 'UWidgetComponent::CurrentDrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bDrawAtDesiredSize) == 0x000630, "Member 'UWidgetComponent::bDrawAtDesiredSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Pivot) == 0x000638, "Member 'UWidgetComponent::Pivot' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bReceiveHardwareInput) == 0x000648, "Member 'UWidgetComponent::bReceiveHardwareInput' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bWindowFocusable) == 0x000649, "Member 'UWidgetComponent::bWindowFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WindowVisibility) == 0x00064A, "Member 'UWidgetComponent::WindowVisibility' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bApplyGammaCorrection) == 0x00064B, "Member 'UWidgetComponent::bApplyGammaCorrection' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OwnerPlayer) == 0x000650, "Member 'UWidgetComponent::OwnerPlayer' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BackgroundColor) == 0x000658, "Member 'UWidgetComponent::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TintColorAndOpacity) == 0x000668, "Member 'UWidgetComponent::TintColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpacityFromTexture) == 0x000678, "Member 'UWidgetComponent::OpacityFromTexture' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BlendMode) == 0x00067C, "Member 'UWidgetComponent::BlendMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bIsTwoSided) == 0x00067D, "Member 'UWidgetComponent::bIsTwoSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickWhenOffscreen) == 0x00067E, "Member 'UWidgetComponent::TickWhenOffscreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BodySetup) == 0x000680, "Member 'UWidgetComponent::BodySetup' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial) == 0x000688, "Member 'UWidgetComponent::TranslucentMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial_OneSided) == 0x000690, "Member 'UWidgetComponent::TranslucentMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial) == 0x000698, "Member 'UWidgetComponent::OpaqueMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial_OneSided) == 0x0006A0, "Member 'UWidgetComponent::OpaqueMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial) == 0x0006A8, "Member 'UWidgetComponent::MaskedMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial_OneSided) == 0x0006B0, "Member 'UWidgetComponent::MaskedMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RenderTarget) == 0x0006B8, "Member 'UWidgetComponent::RenderTarget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaterialInstance) == 0x0006C0, "Member 'UWidgetComponent::MaterialInstance' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bAddedToScreen) == 0x0006C8, "Member 'UWidgetComponent::bAddedToScreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bEditTimeUsable) == 0x0006C9, "Member 'UWidgetComponent::bEditTimeUsable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, SharedLayerName) == 0x0006CC, "Member 'UWidgetComponent::SharedLayerName' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x0006D8, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x0006DC, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x0006E0, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickMode) == 0x0006E4, "Member 'UWidgetComponent::TickMode' has a wrong offset!");
...
static_assert(offsetof(UWidgetInteractionComponent, DebugSphereLineThickness) == 0x000304, "Member 'UWidgetInteractionComponent::DebugSphereLineThickness' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugLineThickness) == 0x000308, "Member 'UWidgetInteractionComponent::DebugLineThickness' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugColor) == 0x00030C, "Member 'UWidgetInteractionComponent::DebugColor' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, CustomHitResult) == 0x000398, "Member 'UWidgetInteractionComponent::CustomHitResult' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LocalHitLocation) == 0x000488, "Member 'UWidgetInteractionComponent::LocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastLocalHitLocation) == 0x000498, "Member 'UWidgetInteractionComponent::LastLocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, HoveredWidgetComponent) == 0x0004A8, "Member 'UWidgetInteractionComponent::HoveredWidgetComponent' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastHitResult) == 0x0004B0, "Member 'UWidgetInteractionComponent::LastHitResult' has a wrong offset!");
...
static_assert(offsetof(UWrapBox, WrapSize) == 0x000198, "Member 'UWrapBox::WrapSize' has a wrong offset!");
static_assert(offsetof(UWrapBox, bExplicitWrapSize) == 0x00019C, "Member 'UWrapBox::bExplicitWrapSize' has a wrong offset!");
static_assert(offsetof(UWrapBox, HorizontalAlignment) == 0x00019D, "Member 'UWrapBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UWrapBox, Orientation) == 0x00019E, "Member 'UWrapBox::Orientation' has a wrong offset!");
