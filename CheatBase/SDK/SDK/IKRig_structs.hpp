...
static_assert(offsetof(FAnimNode_IKRig, AlphaScaleBiasClamp) == 0x0000E4, "Member 'FAnimNode_IKRig::AlphaScaleBiasClamp' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_RetargetPoseFromMesh) == 0x000260, "Wrong size on FAnimNode_RetargetPoseFromMesh");
