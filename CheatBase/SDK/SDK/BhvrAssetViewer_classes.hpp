...
static_assert(offsetof(UBhvrAssetLightGroup, Lights) == 0x000038, "Member 'UBhvrAssetLightGroup::Lights' has a wrong offset!");
...
static_assert(offsetof(ABhvrAssetViewCamera, AssetSocket) == 0x0003D0, "Member 'ABhvrAssetViewCamera::AssetSocket' has a wrong offset!");
...
static_assert(sizeof(ABhvrAssetViewCameraSequenceSystem) == 0x000350, "Wrong size on ABhvrAssetViewCameraSequenceSystem");
...
static_assert(offsetof(ABhvrAssetViewCameraSequenceSystem, SelectedSequence) == 0x000310, "Member 'ABhvrAssetViewCameraSequenceSystem::SelectedSequence' has a wrong offset!");
static_assert(offsetof(ABhvrAssetViewCameraSequenceSystem, SelectedCameraSequence) == 0x000330, "Member 'ABhvrAssetViewCameraSequenceSystem::SelectedCameraSequence' has a wrong offset!");
static_assert(offsetof(ABhvrAssetViewCameraSequenceSystem, PlaybackPosition) == 0x000340, "Member 'ABhvrAssetViewCameraSequenceSystem::PlaybackPosition' has a wrong offset!");
static_assert(offsetof(ABhvrAssetViewCameraSequenceSystem, MaxPlaybackPosition) == 0x000344, "Member 'ABhvrAssetViewCameraSequenceSystem::MaxPlaybackPosition' has a wrong offset!");
static_assert(offsetof(ABhvrAssetViewCameraSequenceSystem, bIsLooping) == 0x000348, "Member 'ABhvrAssetViewCameraSequenceSystem::bIsLooping' has a wrong offset!");
...
static_assert(sizeof(UBhvrAssetViewSpringArmComponent) == 0x0003E0, "Wrong size on UBhvrAssetViewSpringArmComponent");
...
static_assert(sizeof(UBhvrWatermarkComponent) == 0x000610, "Wrong size on UBhvrWatermarkComponent");
static_assert(offsetof(UBhvrWatermarkComponent, WatermarkLocation) == 0x0005C8, "Member 'UBhvrWatermarkComponent::WatermarkLocation' has a wrong offset!");
static_assert(offsetof(UBhvrWatermarkComponent, WatermarkOffset) == 0x0005E0, "Member 'UBhvrWatermarkComponent::WatermarkOffset' has a wrong offset!");
static_assert(offsetof(UBhvrWatermarkComponent, WatermarkSize) == 0x0005F8, "Member 'UBhvrWatermarkComponent::WatermarkSize' has a wrong offset!");
static_assert(offsetof(UBhvrWatermarkComponent, bIsWatermarkHidden) == 0x000600, "Member 'UBhvrWatermarkComponent::bIsWatermarkHidden' has a wrong offset!");
