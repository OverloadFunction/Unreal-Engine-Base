...
static_assert(offsetof(TormentAttackTrailController_OnTrailPointRemovedCosmetic, Index_0) == 0x000000, "Member 'TormentAttackTrailController_OnTrailPointRemovedCosmetic::Index_0' has a wrong offset!");
