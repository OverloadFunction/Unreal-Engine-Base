...
static_assert(offsetof(CrownPlayerComponent_Cosmetic_SetVFXParticlesVisibility, IsVisible_0) == 0x000000, "Member 'CrownPlayerComponent_Cosmetic_SetVFXParticlesVisibility::IsVisible_0' has a wrong offset!");
...
static_assert(alignof(InvitationTargetComponent_Multicast_SetTargetGameObject) == 0x000008, "Wrong alignment on InvitationTargetComponent_Multicast_SetTargetGameObject");
static_assert(sizeof(InvitationTargetComponent_Multicast_SetTargetGameObject) == 0x000008, "Wrong size on InvitationTargetComponent_Multicast_SetTargetGameObject");
static_assert(offsetof(InvitationTargetComponent_Multicast_SetTargetGameObject, Target) == 0x000000, "Member 'InvitationTargetComponent_Multicast_SetTargetGameObject::Target' has a wrong offset!");
