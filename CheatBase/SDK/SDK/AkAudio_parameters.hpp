...
static_assert(sizeof(AkGameObject_PostAkEvent) == 0x000028, "Wrong size on AkGameObject_PostAkEvent");
...
static_assert(offsetof(AkGameObject_PostAkEvent, ReturnValue) == 0x000020, "Member 'AkGameObject_PostAkEvent::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AkComponent_PostAkEventAndWaitForEnd) == 0x000030, "Wrong size on AkComponent_PostAkEventAndWaitForEnd");
...
static_assert(offsetof(AkComponent_PostAkEventAndWaitForEnd, ReturnValue) == 0x000028, "Member 'AkComponent_PostAkEventAndWaitForEnd::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AkAudioEvent_IsLoaded) == 0x000001, "Wrong alignment on AkAudioEvent_IsLoaded");
static_assert(sizeof(AkAudioEvent_IsLoaded) == 0x000001, "Wrong size on AkAudioEvent_IsLoaded");
static_assert(offsetof(AkAudioEvent_IsLoaded, ReturnValue) == 0x000000, "Member 'AkAudioEvent_IsLoaded::ReturnValue' has a wrong offset!");
...
static_assert(alignof(AkEGSInitializationSettings_MigrateMultiCoreRendering) == 0x000001, "Wrong alignment on AkEGSInitializationSettings_MigrateMultiCoreRendering");
static_assert(sizeof(AkEGSInitializationSettings_MigrateMultiCoreRendering) == 0x000001, "Wrong size on AkEGSInitializationSettings_MigrateMultiCoreRendering");
static_assert(offsetof(AkEGSInitializationSettings_MigrateMultiCoreRendering, NewValue) == 0x000000, "Member 'AkEGSInitializationSettings_MigrateMultiCoreRendering::NewValue' has a wrong offset!");
...
static_assert(offsetof(AkGameplayStatics_PostEvent, ReturnValue) == 0x00002C, "Member 'AkGameplayStatics_PostEvent::ReturnValue' has a wrong offset!");
