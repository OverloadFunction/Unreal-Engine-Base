...
static_assert(alignof(K30Power_GetCurrentGuardIndex) == 0x000004, "Wrong alignment on K30Power_GetCurrentGuardIndex");
static_assert(sizeof(K30Power_GetCurrentGuardIndex) == 0x000004, "Wrong size on K30Power_GetCurrentGuardIndex");
static_assert(offsetof(K30Power_GetCurrentGuardIndex, ReturnValue) == 0x000000, "Member 'K30Power_GetCurrentGuardIndex::ReturnValue' has a wrong offset!");
...
static_assert(alignof(GuardFlag_Multicast_OnSurvivorCapturedFlag) == 0x000008, "Wrong alignment on GuardFlag_Multicast_OnSurvivorCapturedFlag");
static_assert(sizeof(GuardFlag_Multicast_OnSurvivorCapturedFlag) == 0x000008, "Wrong size on GuardFlag_Multicast_OnSurvivorCapturedFlag");
static_assert(offsetof(GuardFlag_Multicast_OnSurvivorCapturedFlag, HuntedSurvivor) == 0x000000, "Member 'GuardFlag_Multicast_OnSurvivorCapturedFlag::HuntedSurvivor' has a wrong offset!");
...
static_assert(sizeof(KnightGuard_Multicast_OnOrderEnded) == 0x000010, "Wrong size on KnightGuard_Multicast_OnOrderEnded");
...
static_assert(offsetof(KnightGuard_Multicast_OnOrderEnded, startCooldown) == 0x000008, "Member 'KnightGuard_Multicast_OnOrderEnded::startCooldown' has a wrong offset!");
