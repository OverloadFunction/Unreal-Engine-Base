...
static_assert(sizeof(US42P01) == 0x0004C0, "Wrong size on US42P01");
static_assert(offsetof(US42P01, _generatorHuskInteraction) == 0x000468, "Member 'US42P01::_generatorHuskInteraction' has a wrong offset!");
static_assert(offsetof(US42P01, _totemHuskInteraction) == 0x000470, "Member 'US42P01::_totemHuskInteraction' has a wrong offset!");
static_assert(offsetof(US42P01, _chestHuskInteraction) == 0x000478, "Member 'US42P01::_chestHuskInteraction' has a wrong offset!");
static_assert(offsetof(US42P01, _escapeDoorHuskInteraction) == 0x000480, "Member 'US42P01::_escapeDoorHuskInteraction' has a wrong offset!");
static_assert(offsetof(US42P01, _survivorHuskClass) == 0x000488, "Member 'US42P01::_survivorHuskClass' has a wrong offset!");
static_assert(offsetof(US42P01, _huskDuration) == 0x000490, "Member 'US42P01::_huskDuration' has a wrong offset!");
static_assert(offsetof(US42P01, _generatorRepairPercentCondition) == 0x00049C, "Member 'US42P01::_generatorRepairPercentCondition' has a wrong offset!");
static_assert(offsetof(US42P01, _husk) == 0x0004A0, "Member 'US42P01::_husk' has a wrong offset!");
static_assert(offsetof(US42P01, _generatorsRepairProgression) == 0x0004A8, "Member 'US42P01::_generatorsRepairProgression' has a wrong offset!");
static_assert(offsetof(US42P01, _generatorBeingRepaired) == 0x0004AC, "Member 'US42P01::_generatorBeingRepaired' has a wrong offset!");
static_assert(offsetof(US42P01, _huskInteraction) == 0x0004B8, "Member 'US42P01::_huskInteraction' has a wrong offset!");
...
static_assert(sizeof(US42P01HuskInteraction) == 0x0007A0, "Wrong size on US42P01HuskInteraction");
static_assert(offsetof(US42P01HuskInteraction, _isIllusionActive) == 0x000769, "Member 'US42P01HuskInteraction::_isIllusionActive' has a wrong offset!");
...
static_assert(sizeof(US42P01GeneratorHuskInteraction) == 0x0007A0, "Wrong size on US42P01GeneratorHuskInteraction");
...
static_assert(sizeof(US42P01TotemHuskInteraction) == 0x0007A0, "Wrong size on US42P01TotemHuskInteraction");
...
static_assert(sizeof(US42P01ChestHuskInteraction) == 0x0007A0, "Wrong size on US42P01ChestHuskInteraction");
...
static_assert(sizeof(US42P01EscapeDoorHuskInteraction) == 0x0007A0, "Wrong size on US42P01EscapeDoorHuskInteraction");
...
static_assert(sizeof(US42P02) == 0x0005B0, "Wrong size on US42P02");
static_assert(offsetof(US42P02, _performanceInteraction) == 0x000460, "Member 'US42P02::_performanceInteraction' has a wrong offset!");
static_assert(offsetof(US42P02, _performanceInteractionDuration) == 0x000468, "Member 'US42P02::_performanceInteractionDuration' has a wrong offset!");
static_assert(offsetof(US42P02, _cooldownDuration) == 0x00046C, "Member 'US42P02::_cooldownDuration' has a wrong offset!");
static_assert(offsetof(US42P02, _diceAnimationDuration) == 0x000478, "Member 'US42P02::_diceAnimationDuration' has a wrong offset!");
static_assert(offsetof(US42P02, _diceAnimationDelay) == 0x00047C, "Member 'US42P02::_diceAnimationDelay' has a wrong offset!");
static_assert(offsetof(US42P02, _screamDuration) == 0x000480, "Member 'US42P02::_screamDuration' has a wrong offset!");
static_assert(offsetof(US42P02, _s42p02StatusEffectClass) == 0x000488, "Member 'US42P02::_s42p02StatusEffectClass' has a wrong offset!");
static_assert(offsetof(US42P02, _statusEffectRange) == 0x000490, "Member 'US42P02::_statusEffectRange' has a wrong offset!");
static_assert(offsetof(US42P02, _basicSuccessProgress) == 0x000494, "Member 'US42P02::_basicSuccessProgress' has a wrong offset!");
static_assert(offsetof(US42P02, _mediumSuccessProgress) == 0x000498, "Member 'US42P02::_mediumSuccessProgress' has a wrong offset!");
static_assert(offsetof(US42P02, _criticalSuccessProgress) == 0x00049C, "Member 'US42P02::_criticalSuccessProgress' has a wrong offset!");
static_assert(offsetof(US42P02, _diceMinValue) == 0x0004A0, "Member 'US42P02::_diceMinValue' has a wrong offset!");
static_assert(offsetof(US42P02, _diceMaxValue) == 0x0004A4, "Member 'US42P02::_diceMaxValue' has a wrong offset!");
static_assert(offsetof(US42P02, _criticalFailThreshold) == 0x0004A8, "Member 'US42P02::_criticalFailThreshold' has a wrong offset!");
static_assert(offsetof(US42P02, _basicSuccessThreshold) == 0x0004D0, "Member 'US42P02::_basicSuccessThreshold' has a wrong offset!");
static_assert(offsetof(US42P02, _mediumSuccessThreshold) == 0x0004F8, "Member 'US42P02::_mediumSuccessThreshold' has a wrong offset!");
static_assert(offsetof(US42P02, _criticalSuccessThreshold) == 0x000520, "Member 'US42P02::_criticalSuccessThreshold' has a wrong offset!");
static_assert(offsetof(US42P02, _trackSelectionManager) == 0x000548, "Member 'US42P02::_trackSelectionManager' has a wrong offset!");
static_assert(offsetof(US42P02, _diceRandomValue) == 0x000550, "Member 'US42P02::_diceRandomValue' has a wrong offset!");
static_assert(offsetof(US42P02, _interactionAttacherComponent) == 0x000558, "Member 'US42P02::_interactionAttacherComponent' has a wrong offset!");
static_assert(offsetof(US42P02, _interaction) == 0x000560, "Member 'US42P02::_interaction' has a wrong offset!");
static_assert(offsetof(US42P02, _spawnedStatusEffects) == 0x000568, "Member 'US42P02::_spawnedStatusEffects' has a wrong offset!");
static_assert(offsetof(US42P02, _S42P02ChargeableComponent) == 0x000578, "Member 'US42P02::_S42P02ChargeableComponent' has a wrong offset!");
...
static_assert(sizeof(US42P03) == 0x000480, "Wrong size on US42P03");
static_assert(offsetof(US42P03, _requiredTimeToRemainStillBeforeActivation) == 0x000460, "Member 'US42P03::_requiredTimeToRemainStillBeforeActivation' has a wrong offset!");
static_assert(offsetof(US42P03, _revealRange) == 0x00046C, "Member 'US42P03::_revealRange' has a wrong offset!");
static_assert(offsetof(US42P03, _revealEffect) == 0x000470, "Member 'US42P03::_revealEffect' has a wrong offset!");
static_assert(offsetof(US42P03, _stillnessStartTime) == 0x000478, "Member 'US42P03::_stillnessStartTime' has a wrong offset!");
