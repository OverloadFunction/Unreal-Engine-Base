...
static_assert(sizeof(UBaseGroundDetectorComponent) == 0x000278, "Wrong size on UBaseGroundDetectorComponent");
static_assert(offsetof(UBaseGroundDetectorComponent, _startTransformName) == 0x0001E0, "Member 'UBaseGroundDetectorComponent::_startTransformName' has a wrong offset!");
static_assert(offsetof(UBaseGroundDetectorComponent, _walkableCollisionChannel) == 0x0001EC, "Member 'UBaseGroundDetectorComponent::_walkableCollisionChannel' has a wrong offset!");
static_assert(offsetof(UBaseGroundDetectorComponent, _traceComplex) == 0x0001ED, "Member 'UBaseGroundDetectorComponent::_traceComplex' has a wrong offset!");
static_assert(offsetof(UBaseGroundDetectorComponent, _extraTraceDistance) == 0x0001F0, "Member 'UBaseGroundDetectorComponent::_extraTraceDistance' has a wrong offset!");
static_assert(offsetof(UBaseGroundDetectorComponent, _skinnedMeshComponent) == 0x0001F8, "Member 'UBaseGroundDetectorComponent::_skinnedMeshComponent' has a wrong offset!");
static_assert(offsetof(UBaseGroundDetectorComponent, _startSlopeTransformName) == 0x000208, "Member 'UBaseGroundDetectorComponent::_startSlopeTransformName' has a wrong offset!");
...
static_assert(sizeof(UDetectionFanComponent) == 0x000340, "Wrong size on UDetectionFanComponent");
static_assert(offsetof(UDetectionFanComponent, _angleRange) == 0x0002D0, "Member 'UDetectionFanComponent::_angleRange' has a wrong offset!");
static_assert(offsetof(UDetectionFanComponent, _originWorldOffset) == 0x0002E0, "Member 'UDetectionFanComponent::_originWorldOffset' has a wrong offset!");
static_assert(offsetof(UDetectionFanComponent, _numberOfSpots) == 0x0002F8, "Member 'UDetectionFanComponent::_numberOfSpots' has a wrong offset!");
static_assert(offsetof(UDetectionFanComponent, _defaultRingRadius) == 0x0002FC, "Member 'UDetectionFanComponent::_defaultRingRadius' has a wrong offset!");
static_assert(offsetof(UDetectionFanComponent, _collisionChannel) == 0x000300, "Member 'UDetectionFanComponent::_collisionChannel' has a wrong offset!");
static_assert(offsetof(UDetectionFanComponent, _meshComponent) == 0x000308, "Member 'UDetectionFanComponent::_meshComponent' has a wrong offset!");
...
static_assert(sizeof(UArmDetectionFanComponent) == 0x0003F0, "Wrong size on UArmDetectionFanComponent");
static_assert(offsetof(UArmDetectionFanComponent, _shoulderBone) == 0x000340, "Member 'UArmDetectionFanComponent::_shoulderBone' has a wrong offset!");
static_assert(offsetof(UArmDetectionFanComponent, _elbowBone) == 0x00034C, "Member 'UArmDetectionFanComponent::_elbowBone' has a wrong offset!");
static_assert(offsetof(UArmDetectionFanComponent, _handBone) == 0x000358, "Member 'UArmDetectionFanComponent::_handBone' has a wrong offset!");
static_assert(offsetof(UArmDetectionFanComponent, _indexBone) == 0x000364, "Member 'UArmDetectionFanComponent::_indexBone' has a wrong offset!");
static_assert(offsetof(UArmDetectionFanComponent, _hipBone) == 0x000370, "Member 'UArmDetectionFanComponent::_hipBone' has a wrong offset!");
...
static_assert(sizeof(UFootGroundDetectorComponent) == 0x0002B8, "Wrong size on UFootGroundDetectorComponent");
static_assert(offsetof(UFootGroundDetectorComponent, _hipTransformName) == 0x000278, "Member 'UFootGroundDetectorComponent::_hipTransformName' has a wrong offset!");
static_assert(offsetof(UFootGroundDetectorComponent, _slopeStartOffset) == 0x000288, "Member 'UFootGroundDetectorComponent::_slopeStartOffset' has a wrong offset!");
static_assert(offsetof(UFootGroundDetectorComponent, _footLength) == 0x0002A0, "Member 'UFootGroundDetectorComponent::_footLength' has a wrong offset!");
static_assert(offsetof(UFootGroundDetectorComponent, _traceRadius) == 0x0002A4, "Member 'UFootGroundDetectorComponent::_traceRadius' has a wrong offset!");
static_assert(offsetof(UFootGroundDetectorComponent, _maxWalkableSlopeAngle) == 0x0002A8, "Member 'UFootGroundDetectorComponent::_maxWalkableSlopeAngle' has a wrong offset!");
static_assert(offsetof(UFootGroundDetectorComponent, _movementComp) == 0x0002B0, "Member 'UFootGroundDetectorComponent::_movementComp' has a wrong offset!");
...
static_assert(sizeof(UFromBoneGroundDetectorComponent) == 0x000290, "Wrong size on UFromBoneGroundDetectorComponent");
static_assert(offsetof(UFromBoneGroundDetectorComponent, _startOffset) == 0x000278, "Member 'UFromBoneGroundDetectorComponent::_startOffset' has a wrong offset!");
...
static_assert(alignof(IGroundDetectorActorInterface) == 0x000001, "Wrong alignment on IGroundDetectorActorInterface");
static_assert(sizeof(IGroundDetectorActorInterface) == 0x000001, "Wrong size on IGroundDetectorActorInterface");
...
static_assert(alignof(ISleepableSkeletalMesh) == 0x000001, "Wrong alignment on ISleepableSkeletalMesh");
static_assert(sizeof(ISleepableSkeletalMesh) == 0x000001, "Wrong size on ISleepableSkeletalMesh");
...
static_assert(sizeof(UMoveComponentToComponent) == 0x000130, "Wrong size on UMoveComponentToComponent");
