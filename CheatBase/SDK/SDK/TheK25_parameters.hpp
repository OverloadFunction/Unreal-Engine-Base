...
static_assert(alignof(K25Utilities_GetK25Killer) == 0x000008, "Wrong alignment on K25Utilities_GetK25Killer");
static_assert(sizeof(K25Utilities_GetK25Killer) == 0x000010, "Wrong size on K25Utilities_GetK25Killer");
static_assert(offsetof(K25Utilities_GetK25Killer, WorldContextObject) == 0x000000, "Member 'K25Utilities_GetK25Killer::WorldContextObject' has a wrong offset!");
static_assert(offsetof(K25Utilities_GetK25Killer, ReturnValue) == 0x000008, "Member 'K25Utilities_GetK25Killer::ReturnValue' has a wrong offset!");
...
static_assert(alignof(LamentConfiguration_Cosmetic_BeginSolvingCube) == 0x000008, "Wrong alignment on LamentConfiguration_Cosmetic_BeginSolvingCube");
static_assert(sizeof(LamentConfiguration_Cosmetic_BeginSolvingCube) == 0x000008, "Wrong size on LamentConfiguration_Cosmetic_BeginSolvingCube");
static_assert(offsetof(LamentConfiguration_Cosmetic_BeginSolvingCube, Killer) == 0x000000, "Member 'LamentConfiguration_Cosmetic_BeginSolvingCube::Killer' has a wrong offset!");
...
static_assert(alignof(LamentConfiguration_Cosmetic_EndSolvingCube) == 0x000008, "Wrong alignment on LamentConfiguration_Cosmetic_EndSolvingCube");
static_assert(sizeof(LamentConfiguration_Cosmetic_EndSolvingCube) == 0x000010, "Wrong size on LamentConfiguration_Cosmetic_EndSolvingCube");
static_assert(offsetof(LamentConfiguration_Cosmetic_EndSolvingCube, Killer) == 0x000000, "Member 'LamentConfiguration_Cosmetic_EndSolvingCube::Killer' has a wrong offset!");
static_assert(offsetof(LamentConfiguration_Cosmetic_EndSolvingCube, hasBeenSolved) == 0x000008, "Member 'LamentConfiguration_Cosmetic_EndSolvingCube::hasBeenSolved' has a wrong offset!");
...
static_assert(alignof(LamentConfiguration_OnSurvivorEscaped) == 0x000008, "Wrong alignment on LamentConfiguration_OnSurvivorEscaped");
static_assert(sizeof(LamentConfiguration_OnSurvivorEscaped) == 0x000040, "Wrong size on LamentConfiguration_OnSurvivorEscaped");
static_assert(offsetof(LamentConfiguration_OnSurvivorEscaped, gameEventType) == 0x000000, "Member 'LamentConfiguration_OnSurvivorEscaped::gameEventType' has a wrong offset!");
static_assert(offsetof(LamentConfiguration_OnSurvivorEscaped, GameEventData) == 0x000010, "Member 'LamentConfiguration_OnSurvivorEscaped::GameEventData' has a wrong offset!");
...
static_assert(alignof(K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects) == 0x000008, "Wrong alignment on K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects");
static_assert(sizeof(K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects) == 0x000010, "Wrong size on K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects");
static_assert(offsetof(K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects, Killer) == 0x000000, "Member 'K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects::Killer' has a wrong offset!");
static_assert(offsetof(K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects, transitionTime) == 0x000008, "Member 'K25ChainStrikeInteraction_Cosmetic_TriggerGatewayPossessionEffects::transitionTime' has a wrong offset!");
...
static_assert(alignof(K25ControlledProjectile_Cosmetic_OnKillerPossessProjectileEffects) == 0x000008, "Wrong alignment on K25ControlledProjectile_Cosmetic_OnKillerPossessProjectileEffects");
static_assert(sizeof(K25ControlledProjectile_Cosmetic_OnKillerPossessProjectileEffects) == 0x000008, "Wrong size on K25ControlledProjectile_Cosmetic_OnKillerPossessProjectileEffects");
static_assert(offsetof(K25ControlledProjectile_Cosmetic_OnKillerPossessProjectileEffects, Killer) == 0x000000, "Member 'K25ControlledProjectile_Cosmetic_OnKillerPossessProjectileEffects::Killer' has a wrong offset!");
...
static_assert(alignof(K25P03_OnSurvivorUnhookedFromScourgeHook) == 0x000008, "Wrong alignment on K25P03_OnSurvivorUnhookedFromScourgeHook");
static_assert(sizeof(K25P03_OnSurvivorUnhookedFromScourgeHook) == 0x000030, "Wrong size on K25P03_OnSurvivorUnhookedFromScourgeHook");
static_assert(offsetof(K25P03_OnSurvivorUnhookedFromScourgeHook, GameEventData) == 0x000000, "Member 'K25P03_OnSurvivorUnhookedFromScourgeHook::GameEventData' has a wrong offset!");
