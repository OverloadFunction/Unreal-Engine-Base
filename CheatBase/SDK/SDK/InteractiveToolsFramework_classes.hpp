...
static_assert(sizeof(UGizmoBaseComponent) == 0x0005D0, "Wrong size on UGizmoBaseComponent");
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0005A0, "Member 'UGizmoBaseComponent::Color' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, HoverSizeMultiplier) == 0x0005B0, "Member 'UGizmoBaseComponent::HoverSizeMultiplier' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, PixelHitDistanceThreshold) == 0x0005B4, "Member 'UGizmoBaseComponent::PixelHitDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UGizmoBaseComponent, GizmoViewContext) == 0x0005C0, "Member 'UGizmoBaseComponent::GizmoViewContext' has a wrong offset!");
...
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x0005D0, "Member 'UGizmoArrowComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Gap) == 0x0005E8, "Member 'UGizmoArrowComponent::Gap' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Length) == 0x0005EC, "Member 'UGizmoArrowComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoArrowComponent, Thickness) == 0x0005F0, "Member 'UGizmoArrowComponent::Thickness' has a wrong offset!");
...
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x0005D0, "Member 'UGizmoBoxComponent::Origin' has a wrong offset!");
...
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x0005D0, "Member 'UGizmoCircleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Radius) == 0x0005E8, "Member 'UGizmoCircleComponent::Radius' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, Thickness) == 0x0005EC, "Member 'UGizmoCircleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, NumSides) == 0x0005F0, "Member 'UGizmoCircleComponent::NumSides' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bViewAligned) == 0x0005F4, "Member 'UGizmoCircleComponent::bViewAligned' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bDrawFullCircle) == 0x0005F5, "Member 'UGizmoCircleComponent::bDrawFullCircle' has a wrong offset!");
static_assert(offsetof(UGizmoCircleComponent, bOnlyAllowFrontFacingHits) == 0x0005F6, "Member 'UGizmoCircleComponent::bOnlyAllowFrontFacingHits' has a wrong offset!");
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x000610, "Wrong size on UGizmoLineHandleComponent");
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x0005D0, "Member 'UGizmoLineHandleComponent::Normal' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, HandleSize) == 0x0005E8, "Member 'UGizmoLineHandleComponent::HandleSize' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Thickness) == 0x0005EC, "Member 'UGizmoLineHandleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x0005F0, "Member 'UGizmoLineHandleComponent::Direction' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, Length) == 0x000608, "Member 'UGizmoLineHandleComponent::Length' has a wrong offset!");
static_assert(offsetof(UGizmoLineHandleComponent, bImageScale) == 0x00060C, "Member 'UGizmoLineHandleComponent::bImageScale' has a wrong offset!");
...
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x0005D0, "Member 'UGizmoRectangleComponent::DirectionX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x0005E8, "Member 'UGizmoRectangleComponent::DirectionY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, bOrientYAccordingToCamera) == 0x000600, "Member 'UGizmoRectangleComponent::bOrientYAccordingToCamera' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetX) == 0x000604, "Member 'UGizmoRectangleComponent::OffsetX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, OffsetY) == 0x000608, "Member 'UGizmoRectangleComponent::OffsetY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthX) == 0x00060C, "Member 'UGizmoRectangleComponent::LengthX' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, LengthY) == 0x000610, "Member 'UGizmoRectangleComponent::LengthY' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, Thickness) == 0x000614, "Member 'UGizmoRectangleComponent::Thickness' has a wrong offset!");
static_assert(offsetof(UGizmoRectangleComponent, SegmentFlags) == 0x000618, "Member 'UGizmoRectangleComponent::SegmentFlags' has a wrong offset!");
