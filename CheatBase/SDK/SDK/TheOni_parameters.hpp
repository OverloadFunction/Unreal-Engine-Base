...
static_assert(alignof(BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged) == 0x000001, "Wrong alignment on BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged");
static_assert(sizeof(BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged) == 0x000002, "Wrong size on BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged, oldState) == 0x000000, "Member 'BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged::oldState' has a wrong offset!");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged, newState) == 0x000001, "Member 'BloodOrbDropperComponent_Authority_OnOwningSurvivorDamageStateChanged::newState' has a wrong offset!");
...
static_assert(alignof(BloodOrbDropperComponent_Authority_OnSurvivorCrouched) == 0x000008, "Wrong alignment on BloodOrbDropperComponent_Authority_OnSurvivorCrouched");
static_assert(sizeof(BloodOrbDropperComponent_Authority_OnSurvivorCrouched) == 0x000040, "Wrong size on BloodOrbDropperComponent_Authority_OnSurvivorCrouched");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnSurvivorCrouched, GameEvent) == 0x000000, "Member 'BloodOrbDropperComponent_Authority_OnSurvivorCrouched::GameEvent' has a wrong offset!");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnSurvivorCrouched, GameEventData) == 0x000010, "Member 'BloodOrbDropperComponent_Authority_OnSurvivorCrouched::GameEventData' has a wrong offset!");
...
static_assert(alignof(BloodOrbDropperComponent_Authority_OnSurvivorUnhooked) == 0x000008, "Wrong alignment on BloodOrbDropperComponent_Authority_OnSurvivorUnhooked");
static_assert(sizeof(BloodOrbDropperComponent_Authority_OnSurvivorUnhooked) == 0x000040, "Wrong size on BloodOrbDropperComponent_Authority_OnSurvivorUnhooked");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnSurvivorUnhooked, GameEvent) == 0x000000, "Member 'BloodOrbDropperComponent_Authority_OnSurvivorUnhooked::GameEvent' has a wrong offset!");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnSurvivorUnhooked, GameEventData) == 0x000010, "Member 'BloodOrbDropperComponent_Authority_OnSurvivorUnhooked::GameEventData' has a wrong offset!");
...
static_assert(alignof(BloodOrbDropperComponent_Authority_OnSurvivorHooked) == 0x000008, "Wrong alignment on BloodOrbDropperComponent_Authority_OnSurvivorHooked");
static_assert(sizeof(BloodOrbDropperComponent_Authority_OnSurvivorHooked) == 0x000040, "Wrong size on BloodOrbDropperComponent_Authority_OnSurvivorHooked");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnSurvivorHooked, GameEvent) == 0x000000, "Member 'BloodOrbDropperComponent_Authority_OnSurvivorHooked::GameEvent' has a wrong offset!");
static_assert(offsetof(BloodOrbDropperComponent_Authority_OnSurvivorHooked, GameEventData) == 0x000010, "Member 'BloodOrbDropperComponent_Authority_OnSurvivorHooked::GameEventData' has a wrong offset!");
...
static_assert(alignof(DemonModeComponent_GetMaxCharge) == 0x000004, "Wrong alignment on DemonModeComponent_GetMaxCharge");
static_assert(sizeof(DemonModeComponent_GetMaxCharge) == 0x000004, "Wrong size on DemonModeComponent_GetMaxCharge");
static_assert(offsetof(DemonModeComponent_GetMaxCharge, ReturnValue) == 0x000000, "Member 'DemonModeComponent_GetMaxCharge::ReturnValue' has a wrong offset!");
