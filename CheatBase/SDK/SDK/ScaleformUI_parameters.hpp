...
static_assert(offsetof(GFxMoviePlayer_Invoke, params) == 0x000020, "Member 'GFxMoviePlayer_Invoke::params' has a wrong offset!");
...
static_assert(offsetof(GFxObject_Invoke, params) == 0x000010, "Member 'GFxObject_Invoke::params' has a wrong offset!");
...
static_assert(offsetof(ScaleformBlueprintLibrary_Invoke, params) == 0x000018, "Member 'ScaleformBlueprintLibrary_Invoke::params' has a wrong offset!");
