...
static_assert(sizeof(US37P01) == 0x0004B8, "Wrong size on US37P01");
static_assert(offsetof(US37P01, _killerRevealedTime) == 0x000460, "Member 'US37P01::_killerRevealedTime' has a wrong offset!");
static_assert(offsetof(US37P01, _chaseLingeringTimer) == 0x00046C, "Member 'US37P01::_chaseLingeringTimer' has a wrong offset!");
static_assert(offsetof(US37P01, _revealKillerStatusEffectClass) == 0x000478, "Member 'US37P01::_revealKillerStatusEffectClass' has a wrong offset!");
static_assert(offsetof(US37P01, _revealGeneratorStatusEffectClass) == 0x000480, "Member 'US37P01::_revealGeneratorStatusEffectClass' has a wrong offset!");
static_assert(offsetof(US37P01, _revealGeneratorStatusEffect) == 0x000488, "Member 'US37P01::_revealGeneratorStatusEffect' has a wrong offset!");
...
static_assert(sizeof(US37P02) == 0x000490, "Wrong size on US37P02");
static_assert(offsetof(US37P02, _enduranceStatusEffect) == 0x000460, "Member 'US37P02::_enduranceStatusEffect' has a wrong offset!");
static_assert(offsetof(US37P02, _hasteStatusEffect) == 0x000468, "Member 'US37P02::_hasteStatusEffect' has a wrong offset!");
static_assert(offsetof(US37P02, _enduranceEffectTimer) == 0x000470, "Member 'US37P02::_enduranceEffectTimer' has a wrong offset!");
static_assert(offsetof(US37P02, _hasteSpeedAmount) == 0x00047C, "Member 'US37P02::_hasteSpeedAmount' has a wrong offset!");
...
static_assert(sizeof(US37P03) == 0x0004A0, "Wrong size on US37P03");
static_assert(offsetof(US37P03, _maxTokens) == 0x000460, "Member 'US37P03::_maxTokens' has a wrong offset!");
static_assert(offsetof(US37P03, _repairSpeedDebuffTime) == 0x000464, "Member 'US37P03::_repairSpeedDebuffTime' has a wrong offset!");
static_assert(offsetof(US37P03, _repairSpeedDebuffAmount) == 0x000470, "Member 'US37P03::_repairSpeedDebuffAmount' has a wrong offset!");
static_assert(offsetof(US37P03, _allowSearchChestForToolboxEffectClass) == 0x000478, "Member 'US37P03::_allowSearchChestForToolboxEffectClass' has a wrong offset!");
static_assert(offsetof(US37P03, _repairSpeedDebuffEffectClass) == 0x000480, "Member 'US37P03::_repairSpeedDebuffEffectClass' has a wrong offset!");
static_assert(offsetof(US37P03, _allowSearchChestForToolboxEffect) == 0x000488, "Member 'US37P03::_allowSearchChestForToolboxEffect' has a wrong offset!");
