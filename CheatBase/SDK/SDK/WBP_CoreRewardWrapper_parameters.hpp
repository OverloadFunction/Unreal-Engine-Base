...
static_assert(alignof(WBP_CoreRewardWrapper_C_SetSizeOverride) == 0x000008, "Wrong alignment on WBP_CoreRewardWrapper_C_SetSizeOverride");
static_assert(sizeof(WBP_CoreRewardWrapper_C_SetSizeOverride) == 0x000020, "Wrong size on WBP_CoreRewardWrapper_C_SetSizeOverride");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetSizeOverride, SizeX) == 0x000000, "Member 'WBP_CoreRewardWrapper_C_SetSizeOverride::SizeX' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetSizeOverride, SizeY) == 0x000008, "Member 'WBP_CoreRewardWrapper_C_SetSizeOverride::SizeY' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetSizeOverride, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000010, "Member 'WBP_CoreRewardWrapper_C_SetSizeOverride::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetSizeOverride, CallFunc_Greater_DoubleDouble_ReturnValue_1) == 0x000011, "Member 'WBP_CoreRewardWrapper_C_SetSizeOverride::CallFunc_Greater_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetSizeOverride, CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast) == 0x000014, "Member 'WBP_CoreRewardWrapper_C_SetSizeOverride::CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetSizeOverride, CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast) == 0x000018, "Member 'WBP_CoreRewardWrapper_C_SetSizeOverride::CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(WBP_CoreRewardWrapper_C_SetWidgetSize) == 0x0000A0, "Wrong size on WBP_CoreRewardWrapper_C_SetWidgetSize");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, ItemType_0) == 0x000000, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::ItemType_0' has a wrong offset!");
...
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, Temp_struct_Variable_4) == 0x000048, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::Temp_struct_Variable_4' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, Temp_struct_Variable_5) == 0x000058, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::Temp_struct_Variable_5' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, CallFunc_MakeVector2D_ReturnValue) == 0x000068, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, K2Node_Select_Default) == 0x000078, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, CallFunc_BreakVector2D_X) == 0x000088, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, CallFunc_BreakVector2D_Y) == 0x000090, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast) == 0x000098, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::CallFunc_SetWidthOverride_InWidthOverride_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_CoreRewardWrapper_C_SetWidgetSize, CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast) == 0x00009C, "Member 'WBP_CoreRewardWrapper_C_SetWidgetSize::CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast' has a wrong offset!");
