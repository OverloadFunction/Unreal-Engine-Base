...
static_assert(offsetof(FObservedComponent, bIsSimulating) == 0x0000A0, "Member 'FObservedComponent::bIsSimulating' has a wrong offset!");
static_assert(offsetof(FObservedComponent, bPlaybackEnabled) == 0x0000A2, "Member 'FObservedComponent::bPlaybackEnabled' has a wrong offset!");
