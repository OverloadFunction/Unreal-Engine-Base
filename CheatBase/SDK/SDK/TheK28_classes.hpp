...
static_assert(sizeof(UAddon_K28Power_04) == 0x000300, "Wrong size on UAddon_K28Power_04");
...
static_assert(sizeof(UAddon_K28Power_15) == 0x000328, "Wrong size on UAddon_K28Power_15");
static_assert(offsetof(UAddon_K28Power_15, _survivorImposedEffectClasses) == 0x000310, "Member 'UAddon_K28Power_15::_survivorImposedEffectClasses' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_15, _statusEffectTime) == 0x000320, "Member 'UAddon_K28Power_15::_statusEffectTime' has a wrong offset!");
...
static_assert(sizeof(UAddon_K28Power_16) == 0x000310, "Wrong size on UAddon_K28Power_16");
...
static_assert(sizeof(UAddon_K28Power_17) == 0x000320, "Wrong size on UAddon_K28Power_17");
static_assert(offsetof(UAddon_K28Power_17, _survivorImposedEffectClass) == 0x000310, "Member 'UAddon_K28Power_17::_survivorImposedEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_17, _statusEffectDuration) == 0x000318, "Member 'UAddon_K28Power_17::_statusEffectDuration' has a wrong offset!");
...
static_assert(sizeof(UAddon_K28Power_18) == 0x000348, "Wrong size on UAddon_K28Power_18");
static_assert(offsetof(UAddon_K28Power_18, _survivorImposedEffectClass) == 0x000310, "Member 'UAddon_K28Power_18::_survivorImposedEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_18, _survivorStatusEffectTime) == 0x000318, "Member 'UAddon_K28Power_18::_survivorStatusEffectTime' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_18, _lockersToSlamRange) == 0x00031C, "Member 'UAddon_K28Power_18::_lockersToSlamRange' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_18, _montage) == 0x000320, "Member 'UAddon_K28Power_18::_montage' has a wrong offset!");
...
static_assert(sizeof(UAddon_K28Power_19) == 0x000330, "Wrong size on UAddon_K28Power_19");
static_assert(offsetof(UAddon_K28Power_19, _blockingRadius) == 0x000320, "Member 'UAddon_K28Power_19::_blockingRadius' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_19, _blockDuration) == 0x000324, "Member 'UAddon_K28Power_19::_blockDuration' has a wrong offset!");
...
static_assert(sizeof(UAddon_K28Power_20) == 0x000390, "Wrong size on UAddon_K28Power_20");
static_assert(offsetof(UAddon_K28Power_20, _survivorImposedEffectClass) == 0x000300, "Member 'UAddon_K28Power_20::_survivorImposedEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K28Power_20, _effectDuration) == 0x000308, "Member 'UAddon_K28Power_20::_effectDuration' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_Lockbar) == 0x000720, "Wrong size on UAISkill_FindInteractable_Lockbar");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, LockerTopHeightDiffFromActorLocation) == 0x000318, "Member 'UAISkill_FindInteractable_Lockbar::LockerTopHeightDiffFromActorLocation' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, LockbarMaxDistanceFromCamper) == 0x000320, "Member 'UAISkill_FindInteractable_Lockbar::LockbarMaxDistanceFromCamper' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, LockbarMaxDistanceFromCamperTolerance) == 0x000380, "Member 'UAISkill_FindInteractable_Lockbar::LockbarMaxDistanceFromCamperTolerance' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, MinLockbarWeight) == 0x0003E0, "Member 'UAISkill_FindInteractable_Lockbar::MinLockbarWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, MaxLockbarWeight) == 0x000440, "Member 'UAISkill_FindInteractable_Lockbar::MaxLockbarWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, HighLockbarWeightLastSeconds) == 0x0004A0, "Member 'UAISkill_FindInteractable_Lockbar::HighLockbarWeightLastSeconds' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, MinDistanceToReachMaxLockbarWeight) == 0x000500, "Member 'UAISkill_FindInteractable_Lockbar::MinDistanceToReachMaxLockbarWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, MaxDistanceToReachMinLockbarWeight) == 0x000560, "Member 'UAISkill_FindInteractable_Lockbar::MaxDistanceToReachMinLockbarWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, MaxDistanceToReachMinLockbarWeightIfNearGenerator) == 0x0005C0, "Member 'UAISkill_FindInteractable_Lockbar::MaxDistanceToReachMinLockbarWeightIfNearGenerator' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Lockbar, MaxHeightDifferenceFromGenerator) == 0x000620, "Member 'UAISkill_FindInteractable_Lockbar::MaxHeightDifferenceFromGenerator' has a wrong offset!");
...
static_assert(sizeof(UK28DayNightComponent) == 0x000638, "Wrong size on UK28DayNightComponent");
...
static_assert(offsetof(UK28DayNightComponent, _authority_numberInjuredSurvivors) == 0x000568, "Member 'UK28DayNightComponent::_authority_numberInjuredSurvivors' has a wrong offset!");
static_assert(offsetof(UK28DayNightComponent, _maxChargeAmount) == 0x00056C, "Member 'UK28DayNightComponent::_maxChargeAmount' has a wrong offset!");
static_assert(offsetof(UK28DayNightComponent, _currentChargeAmount) == 0x000570, "Member 'UK28DayNightComponent::_currentChargeAmount' has a wrong offset!");
static_assert(offsetof(UK28DayNightComponent, _nighttimeNearingActivationThresholdReached) == 0x0005A9, "Member 'UK28DayNightComponent::_nighttimeNearingActivationThresholdReached' has a wrong offset!");
static_assert(offsetof(UK28DayNightComponent, _hasReachedNightCycleNearEndThreshold) == 0x0005AA, "Member 'UK28DayNightComponent::_hasReachedNightCycleNearEndThreshold' has a wrong offset!");
static_assert(offsetof(UK28DayNightComponent, _killerIsAtNightfall) == 0x0005F0, "Member 'UK28DayNightComponent::_killerIsAtNightfall' has a wrong offset!");
...
static_assert(sizeof(UK28IsNightCycleState) == 0x000100, "Wrong size on UK28IsNightCycleState");
static_assert(offsetof(UK28IsNightCycleState, _nightCycleState) == 0x0000F0, "Member 'UK28IsNightCycleState::_nightCycleState' has a wrong offset!");
...
static_assert(sizeof(UK28PlayerComponent) == 0x0001C0, "Wrong size on UK28PlayerComponent");
...
static_assert(offsetof(UK28PlayerComponent, _nightEffectMinimumDistance) == 0x0000C8, "Member 'UK28PlayerComponent::_nightEffectMinimumDistance' has a wrong offset!");
static_assert(offsetof(UK28PlayerComponent, _nightEffectMaximumDistance) == 0x0000F0, "Member 'UK28PlayerComponent::_nightEffectMaximumDistance' has a wrong offset!");
static_assert(offsetof(UK28PlayerComponent, _stateTagsToDisableNightMode) == 0x000178, "Member 'UK28PlayerComponent::_stateTagsToDisableNightMode' has a wrong offset!");
...
static_assert(sizeof(UK28KillerComponent) == 0x0001F0, "Wrong size on UK28KillerComponent");
...
static_assert(sizeof(UK28KillerEnterLockerInteraction) == 0x0007D0, "Wrong size on UK28KillerEnterLockerInteraction");
static_assert(offsetof(UK28KillerEnterLockerInteraction, _hideKillerTimePercentage) == 0x000798, "Member 'UK28KillerEnterLockerInteraction::_hideKillerTimePercentage' has a wrong offset!");
...
static_assert(sizeof(UK28KillerExitLockerInteraction) == 0x000850, "Wrong size on UK28KillerExitLockerInteraction");
static_assert(offsetof(UK28KillerExitLockerInteraction, _cameraBehaviour) == 0x000798, "Member 'UK28KillerExitLockerInteraction::_cameraBehaviour' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerInteraction, _timeSearchLockerInteractionBlocked) == 0x0007A0, "Member 'UK28KillerExitLockerInteraction::_timeSearchLockerInteractionBlocked' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerInteraction, _minDotProductFadeOutThreshold) == 0x0007C8, "Member 'UK28KillerExitLockerInteraction::_minDotProductFadeOutThreshold' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerInteraction, _rotationMaxTime) == 0x0007CC, "Member 'UK28KillerExitLockerInteraction::_rotationMaxTime' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerInteraction, _fadeOutTime) == 0x0007D0, "Member 'UK28KillerExitLockerInteraction::_fadeOutTime' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerInteraction, _fovChangeTime) == 0x0007D4, "Member 'UK28KillerExitLockerInteraction::_fovChangeTime' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerInteraction, _fovChangeTeleportationCurve) == 0x0007D8, "Member 'UK28KillerExitLockerInteraction::_fovChangeTeleportationCurve' has a wrong offset!");
...
static_assert(sizeof(UK28KillerExitLockedLockerInteraction) == 0x0008C0, "Wrong size on UK28KillerExitLockedLockerInteraction");
static_assert(offsetof(UK28KillerExitLockedLockerInteraction, _lockbarBreakTimePercentage) == 0x000850, "Member 'UK28KillerExitLockedLockerInteraction::_lockbarBreakTimePercentage' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockedLockerInteraction, _minInteractionTime) == 0x000854, "Member 'UK28KillerExitLockedLockerInteraction::_minInteractionTime' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockedLockerInteraction, _exitInteractionTime) == 0x000858, "Member 'UK28KillerExitLockedLockerInteraction::_exitInteractionTime' has a wrong offset!");
...
static_assert(sizeof(UK28KillerExitLockerWithSurvivorInteraction) == 0x0008F0, "Wrong size on UK28KillerExitLockerWithSurvivorInteraction");
static_assert(offsetof(UK28KillerExitLockerWithSurvivorInteraction, _waitTimeBeforeSettingIntoCarryState) == 0x000850, "Member 'UK28KillerExitLockerWithSurvivorInteraction::_waitTimeBeforeSettingIntoCarryState' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerWithSurvivorInteraction, _montageFromTeleportation) == 0x000860, "Member 'UK28KillerExitLockerWithSurvivorInteraction::_montageFromTeleportation' has a wrong offset!");
static_assert(offsetof(UK28KillerExitLockerWithSurvivorInteraction, _montageFromAbduction) == 0x000880, "Member 'UK28KillerExitLockerWithSurvivorInteraction::_montageFromAbduction' has a wrong offset!");
...
static_assert(sizeof(UK28KillerInstinctEffect) == 0x000468, "Wrong size on UK28KillerInstinctEffect");
static_assert(offsetof(UK28KillerInstinctEffect, _secondsToLinger) == 0x000398, "Member 'UK28KillerInstinctEffect::_secondsToLinger' has a wrong offset!");
static_assert(offsetof(UK28KillerInstinctEffect, _maxDistanceToApplyRemnantTeleportKillerInstinct) == 0x000418, "Member 'UK28KillerInstinctEffect::_maxDistanceToApplyRemnantTeleportKillerInstinct' has a wrong offset!");
static_assert(offsetof(UK28KillerInstinctEffect, _lingeringEffectClass) == 0x000440, "Member 'UK28KillerInstinctEffect::_lingeringEffectClass' has a wrong offset!");
static_assert(offsetof(UK28KillerInstinctEffect, _lingeringEffect) == 0x000448, "Member 'UK28KillerInstinctEffect::_lingeringEffect' has a wrong offset!");
...
static_assert(sizeof(UK28KillerLockerComponent) == 0x000250, "Wrong size on UK28KillerLockerComponent");
...
static_assert(offsetof(UK28KillerLockerComponent, _extraArmsAnimationFollowerActorClass) == 0x000200, "Member 'UK28KillerLockerComponent::_extraArmsAnimationFollowerActorClass' has a wrong offset!");
static_assert(offsetof(UK28KillerLockerComponent, _extraArmsAnimationFollowerActor) == 0x000208, "Member 'UK28KillerLockerComponent::_extraArmsAnimationFollowerActor' has a wrong offset!");
static_assert(offsetof(UK28KillerLockerComponent, _timeBetweenAttemptTrigger) == 0x000218, "Member 'UK28KillerLockerComponent::_timeBetweenAttemptTrigger' has a wrong offset!");
...
static_assert(sizeof(UK28KillerTeleportationComponent) == 0x000340, "Wrong size on UK28KillerTeleportationComponent");
static_assert(offsetof(UK28KillerTeleportationComponent, _teleportationSpeed_DayCycle) == 0x0000D0, "Member 'UK28KillerTeleportationComponent::_teleportationSpeed_DayCycle' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _teleportationSpeed_NightCycle) == 0x000150, "Member 'UK28KillerTeleportationComponent::_teleportationSpeed_NightCycle' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _teleportationTimeForSurvivorGrab) == 0x000178, "Member 'UK28KillerTeleportationComponent::_teleportationTimeForSurvivorGrab' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _survivorPanicInLockerAnimationMontageDescriptor) == 0x0001A0, "Member 'UK28KillerTeleportationComponent::_survivorPanicInLockerAnimationMontageDescriptor' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _isTeleporting) == 0x0001D0, "Member 'UK28KillerTeleportationComponent::_isTeleporting' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _defaultTeleportationCurve) == 0x000220, "Member 'UK28KillerTeleportationComponent::_defaultTeleportationCurve' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _grabTeleportationCurve) == 0x000228, "Member 'UK28KillerTeleportationComponent::_grabTeleportationCurve' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _generatorOutlineUpdateStrategies) == 0x000288, "Member 'UK28KillerTeleportationComponent::_generatorOutlineUpdateStrategies' has a wrong offset!");
static_assert(offsetof(UK28KillerTeleportationComponent, _actorsHiddenDuringTeleport) == 0x000308, "Member 'UK28KillerTeleportationComponent::_actorsHiddenDuringTeleport' has a wrong offset!");
...
static_assert(sizeof(UK28LockerComponent) == 0x000340, "Wrong size on UK28LockerComponent");
...
static_assert(offsetof(UK28LockerComponent, _aiWarningSoundTimeInterval) == 0x0000E0, "Member 'UK28LockerComponent::_aiWarningSoundTimeInterval' has a wrong offset!");
static_assert(offsetof(UK28LockerComponent, _aiWarningSoundRange) == 0x0000E4, "Member 'UK28LockerComponent::_aiWarningSoundRange' has a wrong offset!");
...
static_assert(offsetof(UK28LockerComponent, _abductionCameraOffset) == 0x00031C, "Member 'UK28LockerComponent::_abductionCameraOffset' has a wrong offset!");
static_assert(offsetof(UK28LockerComponent, _killer) == 0x000338, "Member 'UK28LockerComponent::_killer' has a wrong offset!");
...
static_assert(sizeof(UK28LockerEntitySpikesUpdateStrategy) == 0x0000F8, "Wrong size on UK28LockerEntitySpikesUpdateStrategy");
static_assert(offsetof(UK28LockerEntitySpikesUpdateStrategy, _outlineColor) == 0x0000E0, "Member 'UK28LockerEntitySpikesUpdateStrategy::_outlineColor' has a wrong offset!");
...
static_assert(sizeof(UK28LockerTeleportSwapInteraction) == 0x000790, "Wrong size on UK28LockerTeleportSwapInteraction");
...
static_assert(sizeof(UK28LockLockbarInteraction) == 0x0007A0, "Wrong size on UK28LockLockbarInteraction");
static_assert(offsetof(UK28LockLockbarInteraction, _survivorAlignementTolerance) == 0x000798, "Member 'UK28LockLockbarInteraction::_survivorAlignementTolerance' has a wrong offset!");
...
static_assert(sizeof(UK28P01) == 0x000490, "Wrong size on UK28P01");
static_assert(offsetof(UK28P01, _perkActivationDuration) == 0x000460, "Member 'UK28P01::_perkActivationDuration' has a wrong offset!");
static_assert(offsetof(UK28P01, _effectClass) == 0x000470, "Member 'UK28P01::_effectClass' has a wrong offset!");
static_assert(offsetof(UK28P01, _injuryTimerDuration) == 0x000478, "Member 'UK28P01::_injuryTimerDuration' has a wrong offset!");
static_assert(offsetof(UK28P01, _injuryTimer) == 0x000480, "Member 'UK28P01::_injuryTimer' has a wrong offset!");
...
static_assert(sizeof(UK28P01Effect) == 0x0003A0, "Wrong size on UK28P01Effect");
static_assert(offsetof(UK28P01Effect, _playerOwner) == 0x000398, "Member 'UK28P01Effect::_playerOwner' has a wrong offset!");
...
static_assert(sizeof(UK28P02) == 0x000478, "Wrong size on UK28P02");
static_assert(offsetof(UK28P02, PerkActivationTime) == 0x000460, "Member 'UK28P02::PerkActivationTime' has a wrong offset!");
static_assert(offsetof(UK28P02, LockerDetectionRadius) == 0x000464, "Member 'UK28P02::LockerDetectionRadius' has a wrong offset!");
static_assert(offsetof(UK28P02, _timedRevealToKillerEffectClass) == 0x000470, "Member 'UK28P02::_timedRevealToKillerEffectClass' has a wrong offset!");
...
static_assert(sizeof(AK28Power) == 0x0008F0, "Wrong size on AK28Power");
static_assert(offsetof(AK28Power, _interactor) == 0x000568, "Member 'AK28Power::_interactor' has a wrong offset!");
static_assert(offsetof(AK28Power, _powerChargeComponent) == 0x000570, "Member 'AK28Power::_powerChargeComponent' has a wrong offset!");
static_assert(offsetof(AK28Power, _k28PowerChargePresentationPowerFadeComponent) == 0x000578, "Member 'AK28Power::_k28PowerChargePresentationPowerFadeComponent' has a wrong offset!");
static_assert(offsetof(AK28Power, _k28PowerPresentationItemProgressComponent) == 0x000580, "Member 'AK28Power::_k28PowerPresentationItemProgressComponent' has a wrong offset!");
static_assert(offsetof(AK28Power, _dayNightComponentClass) == 0x000588, "Member 'AK28Power::_dayNightComponentClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _teleportationStrategyComponentClass) == 0x000590, "Member 'AK28Power::_teleportationStrategyComponentClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _killerTeleportationComponentClass) == 0x000598, "Member 'AK28Power::_killerTeleportationComponentClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _killerPlayerViewComponentClass) == 0x0005A0, "Member 'AK28Power::_killerPlayerViewComponentClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _killerLockerComponentClass) == 0x0005A8, "Member 'AK28Power::_killerLockerComponentClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _secondaryCameraClass) == 0x0005B0, "Member 'AK28Power::_secondaryCameraClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _k28RemnantClass) == 0x0005B8, "Member 'AK28Power::_k28RemnantClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _moriArmsAnimationFollowerActorClass) == 0x0005C0, "Member 'AK28Power::_moriArmsAnimationFollowerActorClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _secondaryCamera) == 0x0005C8, "Member 'AK28Power::_secondaryCamera' has a wrong offset!");
static_assert(offsetof(AK28Power, _killerLockerComponent) == 0x0005D0, "Member 'AK28Power::_killerLockerComponent' has a wrong offset!");
static_assert(offsetof(AK28Power, _k28Remnant) == 0x0005D8, "Member 'AK28Power::_k28Remnant' has a wrong offset!");
static_assert(offsetof(AK28Power, _killerStatusEffects) == 0x0005E0, "Member 'AK28Power::_killerStatusEffects' has a wrong offset!");
static_assert(offsetof(AK28Power, _survivorStatusEffects) == 0x0005F0, "Member 'AK28Power::_survivorStatusEffects' has a wrong offset!");
static_assert(offsetof(AK28Power, _survivorAbductionCameraBehaviourClass) == 0x000600, "Member 'AK28Power::_survivorAbductionCameraBehaviourClass' has a wrong offset!");
static_assert(offsetof(AK28Power, _dayNightComponent) == 0x000608, "Member 'AK28Power::_dayNightComponent' has a wrong offset!");
static_assert(offsetof(AK28Power, _teleportationStrategyComponent) == 0x000610, "Member 'AK28Power::_teleportationStrategyComponent' has a wrong offset!");
static_assert(offsetof(AK28Power, _tokensWhenPowerIsFullyCharged) == 0x000618, "Member 'AK28Power::_tokensWhenPowerIsFullyCharged' has a wrong offset!");
static_assert(offsetof(AK28Power, _secondsRequiredToChargePowerStartOfMatch) == 0x000698, "Member 'AK28Power::_secondsRequiredToChargePowerStartOfMatch' has a wrong offset!");
static_assert(offsetof(AK28Power, _secondsRequiredToChargePowerDayTime) == 0x000718, "Member 'AK28Power::_secondsRequiredToChargePowerDayTime' has a wrong offset!");
static_assert(offsetof(AK28Power, _secondsRequiredToChargePowerNightTime) == 0x000798, "Member 'AK28Power::_secondsRequiredToChargePowerNightTime' has a wrong offset!");
static_assert(offsetof(AK28Power, _maxTrackedTimeSinceLockerOrRemnantExit) == 0x000818, "Member 'AK28Power::_maxTrackedTimeSinceLockerOrRemnantExit' has a wrong offset!");
static_assert(offsetof(AK28Power, _teleportTokens) == 0x000840, "Member 'AK28Power::_teleportTokens' has a wrong offset!");
static_assert(offsetof(AK28Power, _survivorInteractionsPreventingTagModifications) == 0x000848, "Member 'AK28Power::_survivorInteractionsPreventingTagModifications' has a wrong offset!");
static_assert(offsetof(AK28Power, _isTunableInit) == 0x0008C0, "Member 'AK28Power::_isTunableInit' has a wrong offset!");
...
static_assert(sizeof(UK28PowerPresentationItemProgressComponent) == 0x0000C8, "Wrong size on UK28PowerPresentationItemProgressComponent");
static_assert(offsetof(UK28PowerPresentationItemProgressComponent, _k28Power) == 0x0000C0, "Member 'UK28PowerPresentationItemProgressComponent::_k28Power' has a wrong offset!");
...
static_assert(sizeof(UK28RemnantOutlineUpdateStrategy) == 0x0000F8, "Wrong size on UK28RemnantOutlineUpdateStrategy");
static_assert(offsetof(UK28RemnantOutlineUpdateStrategy, _availableForTeleportSelectionColor) == 0x0000E0, "Member 'UK28RemnantOutlineUpdateStrategy::_availableForTeleportSelectionColor' has a wrong offset!");
...
static_assert(sizeof(UK28SurvivorAbductionCameraBehaviourComponent) == 0x0000E0, "Wrong size on UK28SurvivorAbductionCameraBehaviourComponent");
...
static_assert(sizeof(UK28SurvivorComponent) == 0x000248, "Wrong size on UK28SurvivorComponent");
static_assert(offsetof(UK28SurvivorComponent, _killerBlackMaterialDarknessEffect) == 0x0001C8, "Member 'UK28SurvivorComponent::_killerBlackMaterialDarknessEffect' has a wrong offset!");
...
static_assert(sizeof(AK28SurvivorCosmeticHelperActor) == 0x000390, "Wrong size on AK28SurvivorCosmeticHelperActor");
static_assert(offsetof(AK28SurvivorCosmeticHelperActor, _stateTagsToDisableNightMode) == 0x000370, "Member 'AK28SurvivorCosmeticHelperActor::_stateTagsToDisableNightMode' has a wrong offset!");
...
static_assert(sizeof(UK28SurvivorLockerAbductionInteraction) == 0x000820, "Wrong size on UK28SurvivorLockerAbductionInteraction");
static_assert(offsetof(UK28SurvivorLockerAbductionInteraction, _survivorPanicInLockerAnimationMontageDescriptor) == 0x000798, "Member 'UK28SurvivorLockerAbductionInteraction::_survivorPanicInLockerAnimationMontageDescriptor' has a wrong offset!");
static_assert(offsetof(UK28SurvivorLockerAbductionInteraction, _overriddenInteractionInstance) == 0x0007B8, "Member 'UK28SurvivorLockerAbductionInteraction::_overriddenInteractionInstance' has a wrong offset!");
static_assert(offsetof(UK28SurvivorLockerAbductionInteraction, _overridingTags) == 0x0007C0, "Member 'UK28SurvivorLockerAbductionInteraction::_overridingTags' has a wrong offset!");
static_assert(offsetof(UK28SurvivorLockerAbductionInteraction, _fadeOutTime) == 0x0007D0, "Member 'UK28SurvivorLockerAbductionInteraction::_fadeOutTime' has a wrong offset!");
static_assert(offsetof(UK28SurvivorLockerAbductionInteraction, _minDotProductFadeOutThreshold) == 0x0007D4, "Member 'UK28SurvivorLockerAbductionInteraction::_minDotProductFadeOutThreshold' has a wrong offset!");
static_assert(offsetof(UK28SurvivorLockerAbductionInteraction, _rotationMaxTime) == 0x0007D8, "Member 'UK28SurvivorLockerAbductionInteraction::_rotationMaxTime' has a wrong offset!");
...
static_assert(sizeof(UK28TeleportationStrategyComponent) == 0x000180, "Wrong size on UK28TeleportationStrategyComponent");
