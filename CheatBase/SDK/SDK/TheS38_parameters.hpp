...
static_assert(offsetof(S38P02_Authority_OnIsApplicableChanged, IsApplicable_0) == 0x000008, "Member 'S38P02_Authority_OnIsApplicableChanged::IsApplicable_0' has a wrong offset!");
...
static_assert(alignof(S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged) == 0x000001, "Wrong alignment on S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged");
static_assert(sizeof(S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged) == 0x000002, "Wrong size on S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged");
static_assert(offsetof(S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged, oldHealthState) == 0x000000, "Member 'S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged::oldHealthState' has a wrong offset!");
static_assert(offsetof(S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged, newHealthState) == 0x000001, "Member 'S38P03OnGroundStatusEffect_Authority_OnHealthStateChanged::newHealthState' has a wrong offset!");
...
static_assert(alignof(S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked) == 0x000008, "Wrong alignment on S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked");
static_assert(sizeof(S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked) == 0x000040, "Wrong size on S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked");
static_assert(offsetof(S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked, gameEventType) == 0x000000, "Member 'S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked::gameEventType' has a wrong offset!");
static_assert(offsetof(S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked, GameEventData) == 0x000010, "Member 'S38P03OnGroundStatusEffect_Authority_OnSurvivorHooked::GameEventData' has a wrong offset!");
