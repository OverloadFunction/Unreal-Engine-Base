...
static_assert(alignof(FNewRiftPopupAnalytics) == 0x000008, "Wrong alignment on FNewRiftPopupAnalytics");
static_assert(sizeof(FNewRiftPopupAnalytics) == 0x0000D0, "Wrong size on FNewRiftPopupAnalytics");
static_assert(offsetof(FNewRiftPopupAnalytics, buttonId) == 0x0000B8, "Member 'FNewRiftPopupAnalytics::buttonId' has a wrong offset!");
static_assert(offsetof(FNewRiftPopupAnalytics, VideoProgress) == 0x0000C8, "Member 'FNewRiftPopupAnalytics::VideoProgress' has a wrong offset!");
static_assert(offsetof(FNewRiftPopupAnalytics, WasVideoWatchUntilEnd) == 0x0000CC, "Member 'FNewRiftPopupAnalytics::WasVideoWatchUntilEnd' has a wrong offset!");
...
static_assert(alignof(FBootStepAnalytics) == 0x000008, "Wrong alignment on FBootStepAnalytics");
static_assert(sizeof(FBootStepAnalytics) == 0x000110, "Wrong size on FBootStepAnalytics");
static_assert(offsetof(FBootStepAnalytics, BootGuid) == 0x0000B8, "Member 'FBootStepAnalytics::BootGuid' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, StepName) == 0x0000C8, "Member 'FBootStepAnalytics::StepName' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, StepOrder) == 0x0000D8, "Member 'FBootStepAnalytics::StepOrder' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, StepStartTime) == 0x0000E0, "Member 'FBootStepAnalytics::StepStartTime' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, StepElapsedTime) == 0x0000F0, "Member 'FBootStepAnalytics::StepElapsedTime' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, TotalElapsedTime) == 0x0000F4, "Member 'FBootStepAnalytics::TotalElapsedTime' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, Result) == 0x0000F8, "Member 'FBootStepAnalytics::Result' has a wrong offset!");
static_assert(offsetof(FBootStepAnalytics, ResultReason) == 0x000100, "Member 'FBootStepAnalytics::ResultReason' has a wrong offset!");
...
static_assert(alignof(FQuestTrackedData) == 0x000008, "Wrong alignment on FQuestTrackedData");
static_assert(sizeof(FQuestTrackedData) == 0x000020, "Wrong size on FQuestTrackedData");
static_assert(offsetof(FQuestTrackedData, QuestId) == 0x000000, "Member 'FQuestTrackedData::QuestId' has a wrong offset!");
static_assert(offsetof(FQuestTrackedData, Action) == 0x000010, "Member 'FQuestTrackedData::Action' has a wrong offset!");
...
static_assert(alignof(FQuestNotificationData) == 0x000008, "Wrong alignment on FQuestNotificationData");
static_assert(sizeof(FQuestNotificationData) == 0x000020, "Wrong size on FQuestNotificationData");
static_assert(offsetof(FQuestNotificationData, SetType) == 0x000000, "Member 'FQuestNotificationData::SetType' has a wrong offset!");
static_assert(offsetof(FQuestNotificationData, Action) == 0x000010, "Member 'FQuestNotificationData::Action' has a wrong offset!");
...
static_assert(alignof(FQuestTrackingAnalytics) == 0x000008, "Wrong alignment on FQuestTrackingAnalytics");
static_assert(sizeof(FQuestTrackingAnalytics) == 0x0000D8, "Wrong size on FQuestTrackingAnalytics");
static_assert(offsetof(FQuestTrackingAnalytics, QuestTrackingUpdateTs) == 0x0000B8, "Member 'FQuestTrackingAnalytics::QuestTrackingUpdateTs' has a wrong offset!");
static_assert(offsetof(FQuestTrackingAnalytics, Quests) == 0x0000C8, "Member 'FQuestTrackingAnalytics::Quests' has a wrong offset!");
...
static_assert(sizeof(FPostGameAnalyticsBase) == 0x000198, "Wrong size on FPostGameAnalyticsBase");
...
static_assert(offsetof(FPostGameAnalyticsBase, SpecialEventPoints) == 0x0000F0, "Member 'FPostGameAnalyticsBase::SpecialEventPoints' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, SpecialEventPointsBonus) == 0x0000F4, "Member 'FPostGameAnalyticsBase::SpecialEventPointsBonus' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, MiscPoints) == 0x0000F8, "Member 'FPostGameAnalyticsBase::MiscPoints' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, MatchIncentive) == 0x0000FC, "Member 'FPostGameAnalyticsBase::MatchIncentive' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, GoNextSystemBonus) == 0x000100, "Member 'FPostGameAnalyticsBase::GoNextSystemBonus' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, GoNextSystemMultiplier) == 0x000104, "Member 'FPostGameAnalyticsBase::GoNextSystemMultiplier' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, LteIncentive) == 0x000108, "Member 'FPostGameAnalyticsBase::LteIncentive' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, MatchmakingIncentivePercentage) == 0x00010C, "Member 'FPostGameAnalyticsBase::MatchmakingIncentivePercentage' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, BaseIncentivePercentage) == 0x000110, "Member 'FPostGameAnalyticsBase::BaseIncentivePercentage' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, HiddenBaseIncentivePercentage) == 0x000114, "Member 'FPostGameAnalyticsBase::HiddenBaseIncentivePercentage' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, MatchmakingIncentiveRatio) == 0x000118, "Member 'FPostGameAnalyticsBase::MatchmakingIncentiveRatio' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, GameDuration) == 0x00011C, "Member 'FPostGameAnalyticsBase::GameDuration' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, CharacterName) == 0x000120, "Member 'FPostGameAnalyticsBase::CharacterName' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, Rank) == 0x000130, "Member 'FPostGameAnalyticsBase::Rank' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, PipsGainedOrLost) == 0x000134, "Member 'FPostGameAnalyticsBase::PipsGainedOrLost' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, MatchEndReason) == 0x000138, "Member 'FPostGameAnalyticsBase::MatchEndReason' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, UsedSurrenderOption) == 0x000148, "Member 'FPostGameAnalyticsBase::UsedSurrenderOption' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, IsTutorialBotMatch) == 0x000149, "Member 'FPostGameAnalyticsBase::IsTutorialBotMatch' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, OnboardingModeId) == 0x000150, "Member 'FPostGameAnalyticsBase::OnboardingModeId' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, OnboardingEnabled) == 0x000160, "Member 'FPostGameAnalyticsBase::OnboardingEnabled' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, OnboardingABTestingEnabled) == 0x000164, "Member 'FPostGameAnalyticsBase::OnboardingABTestingEnabled' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, OnboardingNumberActiveModes) == 0x000168, "Member 'FPostGameAnalyticsBase::OnboardingNumberActiveModes' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, OnboardingNewAssignedMode) == 0x00016C, "Member 'FPostGameAnalyticsBase::OnboardingNewAssignedMode' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, ExactPing) == 0x000170, "Member 'FPostGameAnalyticsBase::ExactPing' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, ServerSessionId) == 0x000178, "Member 'FPostGameAnalyticsBase::ServerSessionId' has a wrong offset!");
static_assert(offsetof(FPostGameAnalyticsBase, ServerRegion) == 0x000188, "Member 'FPostGameAnalyticsBase::ServerRegion' has a wrong offset!");
...
static_assert(sizeof(FPostGame_KillerAnalytics) == 0x000228, "Wrong size on FPostGame_KillerAnalytics");
static_assert(offsetof(FPostGame_KillerAnalytics, Brutality) == 0x000198, "Member 'FPostGame_KillerAnalytics::Brutality' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, Deviousness) == 0x00019C, "Member 'FPostGame_KillerAnalytics::Deviousness' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, Hunter) == 0x0001A0, "Member 'FPostGame_KillerAnalytics::Hunter' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, Sacrifice) == 0x0001A4, "Member 'FPostGame_KillerAnalytics::Sacrifice' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, BrutalityBonus) == 0x0001A8, "Member 'FPostGame_KillerAnalytics::BrutalityBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, DeviousnessBonus) == 0x0001AC, "Member 'FPostGame_KillerAnalytics::DeviousnessBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, HunterBonus) == 0x0001B0, "Member 'FPostGame_KillerAnalytics::HunterBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, SacrificeBonus) == 0x0001B4, "Member 'FPostGame_KillerAnalytics::SacrificeBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, EscapeesCount) == 0x0001B8, "Member 'FPostGame_KillerAnalytics::EscapeesCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, SacrificedCount) == 0x0001BC, "Member 'FPostGame_KillerAnalytics::SacrificedCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, KilledCount) == 0x0001C0, "Member 'FPostGame_KillerAnalytics::KilledCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, DisconnectCount) == 0x0001C4, "Member 'FPostGame_KillerAnalytics::DisconnectCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, BotCount) == 0x0001C8, "Member 'FPostGame_KillerAnalytics::BotCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, TimeOpenGate) == 0x0001CC, "Member 'FPostGame_KillerAnalytics::TimeOpenGate' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, SurvivorSpawningPosition) == 0x0001D0, "Member 'FPostGame_KillerAnalytics::SurvivorSpawningPosition' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorsDone) == 0x0001E0, "Member 'FPostGame_KillerAnalytics::GeneratorsDone' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, EGS_starter) == 0x0001E8, "Member 'FPostGame_KillerAnalytics::EGS_starter' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, EGS_time) == 0x0001F8, "Member 'FPostGame_KillerAnalytics::EGS_time' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, EGS_duration) == 0x0001FC, "Member 'FPostGame_KillerAnalytics::EGS_duration' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, EGS_sacrifice) == 0x000200, "Member 'FPostGame_KillerAnalytics::EGS_sacrifice' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, EGS_reachEnd) == 0x000204, "Member 'FPostGame_KillerAnalytics::EGS_reachEnd' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, UsedController) == 0x000205, "Member 'FPostGame_KillerAnalytics::UsedController' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, UsedKeyboard) == 0x000206, "Member 'FPostGame_KillerAnalytics::UsedKeyboard' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorRepairTimestamp1) == 0x000208, "Member 'FPostGame_KillerAnalytics::GeneratorRepairTimestamp1' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorRepairTimestamp2) == 0x00020C, "Member 'FPostGame_KillerAnalytics::GeneratorRepairTimestamp2' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorRepairTimestamp3) == 0x000210, "Member 'FPostGame_KillerAnalytics::GeneratorRepairTimestamp3' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorRepairTimestamp4) == 0x000214, "Member 'FPostGame_KillerAnalytics::GeneratorRepairTimestamp4' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorRepairTimestamp5) == 0x000218, "Member 'FPostGame_KillerAnalytics::GeneratorRepairTimestamp5' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorsMaxRegressionCount) == 0x00021C, "Member 'FPostGame_KillerAnalytics::GeneratorsMaxRegressionCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, GeneratorKicksCount) == 0x000220, "Member 'FPostGame_KillerAnalytics::GeneratorKicksCount' has a wrong offset!");
static_assert(offsetof(FPostGame_KillerAnalytics, UsedHapticsVibration) == 0x000224, "Member 'FPostGame_KillerAnalytics::UsedHapticsVibration' has a wrong offset!");
...
static_assert(alignof(FQuestNotificationAnalytics) == 0x000008, "Wrong alignment on FQuestNotificationAnalytics");
static_assert(sizeof(FQuestNotificationAnalytics) == 0x0000D8, "Wrong size on FQuestNotificationAnalytics");
static_assert(offsetof(FQuestNotificationAnalytics, QuestNotificationsUpdateTs) == 0x0000B8, "Member 'FQuestNotificationAnalytics::QuestNotificationsUpdateTs' has a wrong offset!");
static_assert(offsetof(FQuestNotificationAnalytics, NotificationModes) == 0x0000C8, "Member 'FQuestNotificationAnalytics::NotificationModes' has a wrong offset!");
...
static_assert(sizeof(FHookAnalytics) == 0x000188, "Wrong size on FHookAnalytics");
...
static_assert(offsetof(FHookAnalytics, HookStageOnHookEnter) == 0x000140, "Member 'FHookAnalytics::HookStageOnHookEnter' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, HookStageOnHookExit) == 0x000144, "Member 'FHookAnalytics::HookStageOnHookExit' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, SecondStageSkillChecksSucceeded) == 0x000148, "Member 'FHookAnalytics::SecondStageSkillChecksSucceeded' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, SecondStageSkillChecksFailed) == 0x00014C, "Member 'FHookAnalytics::SecondStageSkillChecksFailed' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, AntiCampMeterLevelOnUnhook) == 0x000150, "Member 'FHookAnalytics::AntiCampMeterLevelOnUnhook' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, JumpedOffHookWithAntiCampValue) == 0x000154, "Member 'FHookAnalytics::JumpedOffHookWithAntiCampValue' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, NumberOfRescuers) == 0x000158, "Member 'FHookAnalytics::NumberOfRescuers' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, TimeForFirstRescuer) == 0x00015C, "Member 'FHookAnalytics::TimeForFirstRescuer' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, MatchID) == 0x000160, "Member 'FHookAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, GameMode) == 0x000170, "Member 'FHookAnalytics::GameMode' has a wrong offset!");
static_assert(offsetof(FHookAnalytics, ReverseBearTrapOn) == 0x000180, "Member 'FHookAnalytics::ReverseBearTrapOn' has a wrong offset!");
...
static_assert(alignof(FCustomizationAuditAnalytics) == 0x000008, "Wrong alignment on FCustomizationAuditAnalytics");
static_assert(sizeof(FCustomizationAuditAnalytics) == 0x0000D0, "Wrong size on FCustomizationAuditAnalytics");
static_assert(offsetof(FCustomizationAuditAnalytics, HasPassedAudit) == 0x0000B8, "Member 'FCustomizationAuditAnalytics::HasPassedAudit' has a wrong offset!");
static_assert(offsetof(FCustomizationAuditAnalytics, MissingIds) == 0x0000C0, "Member 'FCustomizationAuditAnalytics::MissingIds' has a wrong offset!");
...
static_assert(sizeof(FDisconnectionAnalytics) == 0x000168, "Wrong size on FDisconnectionAnalytics");
...
static_assert(offsetof(FDisconnectionAnalytics, KrakenMatchId) == 0x000130, "Member 'FDisconnectionAnalytics::KrakenMatchId' has a wrong offset!");
static_assert(offsetof(FDisconnectionAnalytics, GameMode) == 0x000140, "Member 'FDisconnectionAnalytics::GameMode' has a wrong offset!");
static_assert(offsetof(FDisconnectionAnalytics, ServerSessionId) == 0x000148, "Member 'FDisconnectionAnalytics::ServerSessionId' has a wrong offset!");
static_assert(offsetof(FDisconnectionAnalytics, ServerRegion) == 0x000158, "Member 'FDisconnectionAnalytics::ServerRegion' has a wrong offset!");
...
static_assert(sizeof(FEndpointLatencyAnalytics) == 0x0000D8, "Wrong size on FEndpointLatencyAnalytics");
...
static_assert(offsetof(FEndpointLatencyAnalytics, Country) == 0x0000C8, "Member 'FEndpointLatencyAnalytics::Country' has a wrong offset!");
...
static_assert(alignof(FSingleEndpointLatencyAnalytics) == 0x000008, "Wrong alignment on FSingleEndpointLatencyAnalytics");
static_assert(sizeof(FSingleEndpointLatencyAnalytics) == 0x0000E0, "Wrong size on FSingleEndpointLatencyAnalytics");
static_assert(offsetof(FSingleEndpointLatencyAnalytics, Endpoint) == 0x0000B8, "Member 'FSingleEndpointLatencyAnalytics::Endpoint' has a wrong offset!");
static_assert(offsetof(FSingleEndpointLatencyAnalytics, Country) == 0x0000D0, "Member 'FSingleEndpointLatencyAnalytics::Country' has a wrong offset!");
...
static_assert(sizeof(FWalesCypherAnalytics) == 0x0000F0, "Wrong size on FWalesCypherAnalytics");
...
static_assert(offsetof(FWalesCypherAnalytics, HttpResultCode) == 0x0000E0, "Member 'FWalesCypherAnalytics::HttpResultCode' has a wrong offset!");
static_assert(offsetof(FWalesCypherAnalytics, TIMEOUT) == 0x0000E4, "Member 'FWalesCypherAnalytics::TIMEOUT' has a wrong offset!");
static_assert(offsetof(FWalesCypherAnalytics, CharmGranted) == 0x0000E5, "Member 'FWalesCypherAnalytics::CharmGranted' has a wrong offset!");
static_assert(offsetof(FWalesCypherAnalytics, CharmAlreadyOwned) == 0x0000E6, "Member 'FWalesCypherAnalytics::CharmAlreadyOwned' has a wrong offset!");
static_assert(offsetof(FWalesCypherAnalytics, ValidCharacterSelcted) == 0x0000E8, "Member 'FWalesCypherAnalytics::ValidCharacterSelcted' has a wrong offset!");
...
public:
	...
	int32                                         Delta;                                             // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumberOfExposers;                                  // 0x00DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TimeSinceStart;                                    // 0x00E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PreviousStageDuration;                             // 0x00E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AdditionalInfo;                                    // 0x00E8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AffectedMirrorsId;                                 // 0x00F8(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSurvivorExposerChangedAnalytics) == 0x000008, "Wrong alignment on FSurvivorExposerChangedAnalytics");
static_assert(sizeof(FSurvivorExposerChangedAnalytics) == 0x000108, "Wrong size on FSurvivorExposerChangedAnalytics");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, MatchID) == 0x0000B8, "Member 'FSurvivorExposerChangedAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, Reason) == 0x0000C8, "Member 'FSurvivorExposerChangedAnalytics::Reason' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, Delta) == 0x0000D8, "Member 'FSurvivorExposerChangedAnalytics::Delta' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, NumberOfExposers) == 0x0000DC, "Member 'FSurvivorExposerChangedAnalytics::NumberOfExposers' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, TimeSinceStart) == 0x0000E0, "Member 'FSurvivorExposerChangedAnalytics::TimeSinceStart' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, PreviousStageDuration) == 0x0000E4, "Member 'FSurvivorExposerChangedAnalytics::PreviousStageDuration' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, AdditionalInfo) == 0x0000E8, "Member 'FSurvivorExposerChangedAnalytics::AdditionalInfo' has a wrong offset!");
static_assert(offsetof(FSurvivorExposerChangedAnalytics, AffectedMirrorsId) == 0x0000F8, "Member 'FSurvivorExposerChangedAnalytics::AffectedMirrorsId' has a wrong offset!");
...
static_assert(alignof(FStepCompleteTime) == 0x000008, "Wrong alignment on FStepCompleteTime");
static_assert(sizeof(FStepCompleteTime) == 0x000018, "Wrong size on FStepCompleteTime");
static_assert(offsetof(FStepCompleteTime, StepName) == 0x000000, "Member 'FStepCompleteTime::StepName' has a wrong offset!");
static_assert(offsetof(FStepCompleteTime, StepElapsedTime) == 0x000010, "Member 'FStepCompleteTime::StepElapsedTime' has a wrong offset!");
static_assert(offsetof(FStepCompleteTime, StepIndex) == 0x000014, "Member 'FStepCompleteTime::StepIndex' has a wrong offset!");
...
static_assert(sizeof(FGameInitAnalytics) == 0x000160, "Wrong size on FGameInitAnalytics");
static_assert(offsetof(FGameInitAnalytics, InitGuid) == 0x0000B8, "Member 'FGameInitAnalytics::InitGuid' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, BootGuid) == 0x0000C8, "Member 'FGameInitAnalytics::BootGuid' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, StepName) == 0x0000D8, "Member 'FGameInitAnalytics::StepName' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, ParentBootStepName) == 0x0000E8, "Member 'FGameInitAnalytics::ParentBootStepName' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, StepIndex) == 0x0000F8, "Member 'FGameInitAnalytics::StepIndex' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, Success) == 0x0000FC, "Member 'FGameInitAnalytics::Success' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, CompleteStepState) == 0x000100, "Member 'FGameInitAnalytics::CompleteStepState' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, PreviouslyCompletedSteps) == 0x000110, "Member 'FGameInitAnalytics::PreviouslyCompletedSteps' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, StepStartTime) == 0x000120, "Member 'FGameInitAnalytics::StepStartTime' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, StepElapsedTime) == 0x000130, "Member 'FGameInitAnalytics::StepElapsedTime' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, TotalElapsedTime) == 0x000134, "Member 'FGameInitAnalytics::TotalElapsedTime' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, FailureCount) == 0x000138, "Member 'FGameInitAnalytics::FailureCount' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, AdditionalInfo) == 0x000140, "Member 'FGameInitAnalytics::AdditionalInfo' has a wrong offset!");
static_assert(offsetof(FGameInitAnalytics, Country) == 0x000150, "Member 'FGameInitAnalytics::Country' has a wrong offset!");
...
static_assert(alignof(FInboxAnalytics) == 0x000008, "Wrong alignment on FInboxAnalytics");
static_assert(sizeof(FInboxAnalytics) == 0x0000F8, "Wrong size on FInboxAnalytics");
static_assert(offsetof(FInboxAnalytics, NewsMessageId) == 0x0000B8, "Member 'FInboxAnalytics::NewsMessageId' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, Action) == 0x0000C4, "Member 'FInboxAnalytics::Action' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, TimeSpentReadingSeconds) == 0x0000C8, "Member 'FInboxAnalytics::TimeSpentReadingSeconds' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, WasPreviouslyRead) == 0x0000CC, "Member 'FInboxAnalytics::WasPreviouslyRead' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, RewardName) == 0x0000D0, "Member 'FInboxAnalytics::RewardName' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, RewardAmount) == 0x0000E0, "Member 'FInboxAnalytics::RewardAmount' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, LinkType) == 0x0000E4, "Member 'FInboxAnalytics::LinkType' has a wrong offset!");
static_assert(offsetof(FInboxAnalytics, LinkDestination) == 0x0000E8, "Member 'FInboxAnalytics::LinkDestination' has a wrong offset!");
...
static_assert(alignof(FInboxLoadedAnalytics) == 0x000008, "Wrong alignment on FInboxLoadedAnalytics");
static_assert(sizeof(FInboxLoadedAnalytics) == 0x0000C0, "Wrong size on FInboxLoadedAnalytics");
static_assert(offsetof(FInboxLoadedAnalytics, Type) == 0x0000B8, "Member 'FInboxLoadedAnalytics::Type' has a wrong offset!");
static_assert(offsetof(FInboxLoadedAnalytics, NumberLoaded) == 0x0000BC, "Member 'FInboxLoadedAnalytics::NumberLoaded' has a wrong offset!");
...
static_assert(alignof(FInboxErrorAnalytics) == 0x000008, "Wrong alignment on FInboxErrorAnalytics");
static_assert(sizeof(FInboxErrorAnalytics) == 0x0000D0, "Wrong size on FInboxErrorAnalytics");
static_assert(offsetof(FInboxErrorAnalytics, Type) == 0x0000B8, "Member 'FInboxErrorAnalytics::Type' has a wrong offset!");
static_assert(offsetof(FInboxErrorAnalytics, Error) == 0x0000BC, "Member 'FInboxErrorAnalytics::Error' has a wrong offset!");
static_assert(offsetof(FInboxErrorAnalytics, NewsMessageId) == 0x0000C0, "Member 'FInboxErrorAnalytics::NewsMessageId' has a wrong offset!");
...
static_assert(alignof(FLightingAnalytics) == 0x000008, "Wrong alignment on FLightingAnalytics");
static_assert(sizeof(FLightingAnalytics) == 0x0000E0, "Wrong size on FLightingAnalytics");
static_assert(offsetof(FLightingAnalytics, MatchID) == 0x0000B8, "Member 'FLightingAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FLightingAnalytics, SettingType) == 0x0000C8, "Member 'FLightingAnalytics::SettingType' has a wrong offset!");
static_assert(offsetof(FLightingAnalytics, SettingValue) == 0x0000D8, "Member 'FLightingAnalytics::SettingValue' has a wrong offset!");
...
static_assert(sizeof(FMapCoordAnalytics) == 0x0000F0, "Wrong size on FMapCoordAnalytics");
static_assert(offsetof(FMapCoordAnalytics, MatchID) == 0x0000B8, "Member 'FMapCoordAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FMapCoordAnalytics, MapName) == 0x0000C8, "Member 'FMapCoordAnalytics::MapName' has a wrong offset!");
static_assert(offsetof(FMapCoordAnalytics, MapSeed) == 0x0000D8, "Member 'FMapCoordAnalytics::MapSeed' has a wrong offset!");
static_assert(offsetof(FMapCoordAnalytics, MapItem) == 0x0000E0, "Member 'FMapCoordAnalytics::MapItem' has a wrong offset!");
...
static_assert(alignof(FMatchStartPlayerInfos) == 0x000008, "Wrong alignment on FMatchStartPlayerInfos");
static_assert(sizeof(FMatchStartPlayerInfos) == 0x000088, "Wrong size on FMatchStartPlayerInfos");
static_assert(offsetof(FMatchStartPlayerInfos, KrakenId) == 0x000000, "Member 'FMatchStartPlayerInfos::KrakenId' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, PlayerName) == 0x000010, "Member 'FMatchStartPlayerInfos::PlayerName' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, CharacterName) == 0x000020, "Member 'FMatchStartPlayerInfos::CharacterName' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, Offering) == 0x000030, "Member 'FMatchStartPlayerInfos::Offering' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, Item) == 0x000040, "Member 'FMatchStartPlayerInfos::Item' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, addons) == 0x000050, "Member 'FMatchStartPlayerInfos::addons' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, Perks) == 0x000060, "Member 'FMatchStartPlayerInfos::Perks' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, CustomizationItems) == 0x000070, "Member 'FMatchStartPlayerInfos::CustomizationItems' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, IsBot) == 0x000080, "Member 'FMatchStartPlayerInfos::IsBot' has a wrong offset!");
static_assert(offsetof(FMatchStartPlayerInfos, IsReplacementBot) == 0x000081, "Member 'FMatchStartPlayerInfos::IsReplacementBot' has a wrong offset!");
...
static_assert(alignof(FMatchStartAnalytics) == 0x000008, "Wrong alignment on FMatchStartAnalytics");
static_assert(sizeof(FMatchStartAnalytics) == 0x000100, "Wrong size on FMatchStartAnalytics");
static_assert(offsetof(FMatchStartAnalytics, MatchID) == 0x0000B8, "Member 'FMatchStartAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FMatchStartAnalytics, KrakenMatchId) == 0x0000C8, "Member 'FMatchStartAnalytics::KrakenMatchId' has a wrong offset!");
static_assert(offsetof(FMatchStartAnalytics, MapName) == 0x0000D8, "Member 'FMatchStartAnalytics::MapName' has a wrong offset!");
static_assert(offsetof(FMatchStartAnalytics, MapSeed) == 0x0000E8, "Member 'FMatchStartAnalytics::MapSeed' has a wrong offset!");
static_assert(offsetof(FMatchStartAnalytics, GameMode) == 0x0000EC, "Member 'FMatchStartAnalytics::GameMode' has a wrong offset!");
static_assert(offsetof(FMatchStartAnalytics, PlayersInfos) == 0x0000F0, "Member 'FMatchStartAnalytics::PlayersInfos' has a wrong offset!");
...
static_assert(sizeof(FMatchInfoAnalytics) == 0x000218, "Wrong size on FMatchInfoAnalytics");
...
static_assert(offsetof(FMatchInfoAnalytics, CharacterOwnership) == 0x0000E8, "Member 'FMatchInfoAnalytics::CharacterOwnership' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, Rank) == 0x0000F8, "Member 'FMatchInfoAnalytics::Rank' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, Level) == 0x0000FC, "Member 'FMatchInfoAnalytics::Level' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, Prestige) == 0x000100, "Member 'FMatchInfoAnalytics::Prestige' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, Pips) == 0x000104, "Member 'FMatchInfoAnalytics::Pips' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, PipsTotal) == 0x000108, "Member 'FMatchInfoAnalytics::PipsTotal' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, MapSeed) == 0x00010C, "Member 'FMatchInfoAnalytics::MapSeed' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, MapName) == 0x000110, "Member 'FMatchInfoAnalytics::MapName' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, PartyHostMirrorsId) == 0x000120, "Member 'FMatchInfoAnalytics::PartyHostMirrorsId' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, LobbyId) == 0x000130, "Member 'FMatchInfoAnalytics::LobbyId' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, MatchID) == 0x000140, "Member 'FMatchInfoAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, KrakenMatchId) == 0x000150, "Member 'FMatchInfoAnalytics::KrakenMatchId' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, PlayerName) == 0x000160, "Member 'FMatchInfoAnalytics::PlayerName' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, SelectedCountry) == 0x000170, "Member 'FMatchInfoAnalytics::SelectedCountry' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, FirstTimePlaying) == 0x000180, "Member 'FMatchInfoAnalytics::FirstTimePlaying' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, CumulativeMatches) == 0x000184, "Member 'FMatchInfoAnalytics::CumulativeMatches' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, CumulativeMatchesAsSurvivor) == 0x000188, "Member 'FMatchInfoAnalytics::CumulativeMatchesAsSurvivor' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, CumulativeMatchesAsKiller) == 0x00018C, "Member 'FMatchInfoAnalytics::CumulativeMatchesAsKiller' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, LastMatchTimestamp) == 0x000190, "Member 'FMatchInfoAnalytics::LastMatchTimestamp' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, ExactPing) == 0x0001A0, "Member 'FMatchInfoAnalytics::ExactPing' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, hasAnActiveArchiveQuest) == 0x0001A4, "Member 'FMatchInfoAnalytics::hasAnActiveArchiveQuest' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, IsUsingKeyboard) == 0x0001A5, "Member 'FMatchInfoAnalytics::IsUsingKeyboard' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, ControllerType) == 0x0001A8, "Member 'FMatchInfoAnalytics::ControllerType' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, InvertY) == 0x0001B8, "Member 'FMatchInfoAnalytics::InvertY' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, ColorBlindMode) == 0x0001C0, "Member 'FMatchInfoAnalytics::ColorBlindMode' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, ColorblindIntensity) == 0x0001D0, "Member 'FMatchInfoAnalytics::ColorblindIntensity' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, TerrorRadiusVisualSupport) == 0x0001D4, "Member 'FMatchInfoAnalytics::TerrorRadiusVisualSupport' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, IsTutorialBotMatch) == 0x0001D5, "Member 'FMatchInfoAnalytics::IsTutorialBotMatch' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, OnboardingModeId) == 0x0001D8, "Member 'FMatchInfoAnalytics::OnboardingModeId' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, OnboardingEnabled) == 0x0001E8, "Member 'FMatchInfoAnalytics::OnboardingEnabled' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, OnboardingABTestingEnabled) == 0x0001EC, "Member 'FMatchInfoAnalytics::OnboardingABTestingEnabled' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, OnboardingNumberActiveModes) == 0x0001F0, "Member 'FMatchInfoAnalytics::OnboardingNumberActiveModes' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, OnboardingNewAssignedMode) == 0x0001F4, "Member 'FMatchInfoAnalytics::OnboardingNewAssignedMode' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, ServerSessionId) == 0x0001F8, "Member 'FMatchInfoAnalytics::ServerSessionId' has a wrong offset!");
static_assert(offsetof(FMatchInfoAnalytics, ServerRegion) == 0x000208, "Member 'FMatchInfoAnalytics::ServerRegion' has a wrong offset!");
...
static_assert(sizeof(FPerformanceAnalytics) == 0x000420, "Wrong size on FPerformanceAnalytics");
...
static_assert(offsetof(FPerformanceAnalytics, XeSSMode) == 0x00028C, "Member 'FPerformanceAnalytics::XeSSMode' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, SharpnessValue) == 0x000290, "Member 'FPerformanceAnalytics::SharpnessValue' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, ShadowQuality) == 0x000294, "Member 'FPerformanceAnalytics::ShadowQuality' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, TextureQuality) == 0x000298, "Member 'FPerformanceAnalytics::TextureQuality' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, EffectsQuality) == 0x00029C, "Member 'FPerformanceAnalytics::EffectsQuality' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, FoliageQuality) == 0x0002A0, "Member 'FPerformanceAnalytics::FoliageQuality' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Scenario) == 0x0002A8, "Member 'FPerformanceAnalytics::Scenario' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Theme) == 0x0002B8, "Member 'FPerformanceAnalytics::Theme' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MapName) == 0x0002C8, "Member 'FPerformanceAnalytics::MapName' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, TileListCount) == 0x0002D8, "Member 'FPerformanceAnalytics::TileListCount' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Seed) == 0x0002DC, "Member 'FPerformanceAnalytics::Seed' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, CharacterName) == 0x0002E0, "Member 'FPerformanceAnalytics::CharacterName' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Cpu) == 0x0002F0, "Member 'FPerformanceAnalytics::Cpu' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, GpuAdapter) == 0x000300, "Member 'FPerformanceAnalytics::GpuAdapter' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MatchID) == 0x000310, "Member 'FPerformanceAnalytics::MatchID' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, RHIName) == 0x000320, "Member 'FPerformanceAnalytics::RHIName' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, IsSample) == 0x000330, "Member 'FPerformanceAnalytics::IsSample' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, GameFlowStep) == 0x000338, "Member 'FPerformanceAnalytics::GameFlowStep' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, KrakenMatchId) == 0x000348, "Member 'FPerformanceAnalytics::KrakenMatchId' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Characters) == 0x000358, "Member 'FPerformanceAnalytics::Characters' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Perks) == 0x000368, "Member 'FPerformanceAnalytics::Perks' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, CustomizationItems) == 0x000378, "Member 'FPerformanceAnalytics::CustomizationItems' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, gameType) == 0x000388, "Member 'FPerformanceAnalytics::gameType' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, FleetType) == 0x000398, "Member 'FPerformanceAnalytics::FleetType' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, InstanceType) == 0x0003A8, "Member 'FPerformanceAnalytics::InstanceType' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, AverageNumberOfConcurrentGameProcess) == 0x0003B8, "Member 'FPerformanceAnalytics::AverageNumberOfConcurrentGameProcess' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MinNumberOfConcurrentGameProcess) == 0x0003BC, "Member 'FPerformanceAnalytics::MinNumberOfConcurrentGameProcess' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MaxNumberOfConcurrentGameProcess) == 0x0003C0, "Member 'FPerformanceAnalytics::MaxNumberOfConcurrentGameProcess' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, AverageNumberOfConcurrentGameProcessInMatch) == 0x0003C4, "Member 'FPerformanceAnalytics::AverageNumberOfConcurrentGameProcessInMatch' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MinNumberOfConcurrentGameProcessInMatch) == 0x0003C8, "Member 'FPerformanceAnalytics::MinNumberOfConcurrentGameProcessInMatch' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MaxNumberOfConcurrentGameProcessInMatch) == 0x0003CC, "Member 'FPerformanceAnalytics::MaxNumberOfConcurrentGameProcessInMatch' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, ConcurrentMaps) == 0x0003D0, "Member 'FPerformanceAnalytics::ConcurrentMaps' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, Country) == 0x0003E0, "Member 'FPerformanceAnalytics::Country' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, MaxOutlineVisibleCount) == 0x0003F0, "Member 'FPerformanceAnalytics::MaxOutlineVisibleCount' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, OppositeOutlinePercent) == 0x0003F4, "Member 'FPerformanceAnalytics::OppositeOutlinePercent' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, ServerRegion) == 0x0003F8, "Member 'FPerformanceAnalytics::ServerRegion' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, ServerSessionId) == 0x000408, "Member 'FPerformanceAnalytics::ServerSessionId' has a wrong offset!");
static_assert(offsetof(FPerformanceAnalytics, BotCount) == 0x000418, "Member 'FPerformanceAnalytics::BotCount' has a wrong offset!");
...
static_assert(sizeof(FPostGame_SurvivorAnalytics) == 0x0001D8, "Wrong size on FPostGame_SurvivorAnalytics");
static_assert(offsetof(FPostGame_SurvivorAnalytics, Objectives) == 0x000198, "Member 'FPostGame_SurvivorAnalytics::Objectives' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, Survival) == 0x00019C, "Member 'FPostGame_SurvivorAnalytics::Survival' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, Altruism) == 0x0001A0, "Member 'FPostGame_SurvivorAnalytics::Altruism' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, Boldness) == 0x0001A4, "Member 'FPostGame_SurvivorAnalytics::Boldness' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, ObjectivesBonus) == 0x0001A8, "Member 'FPostGame_SurvivorAnalytics::ObjectivesBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, SurvivalBonus) == 0x0001AC, "Member 'FPostGame_SurvivorAnalytics::SurvivalBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, AltruismBonus) == 0x0001B0, "Member 'FPostGame_SurvivorAnalytics::AltruismBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, BoldnessBonus) == 0x0001B4, "Member 'FPostGame_SurvivorAnalytics::BoldnessBonus' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, Outcome) == 0x0001B8, "Member 'FPostGame_SurvivorAnalytics::Outcome' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, damageState) == 0x0001C8, "Member 'FPostGame_SurvivorAnalytics::damageState' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, HookedCount) == 0x0001CC, "Member 'FPostGame_SurvivorAnalytics::HookedCount' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, RepairCanceledBeforeRegressionStoppedCount) == 0x0001D0, "Member 'FPostGame_SurvivorAnalytics::RepairCanceledBeforeRegressionStoppedCount' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, UsedController) == 0x0001D4, "Member 'FPostGame_SurvivorAnalytics::UsedController' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, UsedKeyboard) == 0x0001D5, "Member 'FPostGame_SurvivorAnalytics::UsedKeyboard' has a wrong offset!");
static_assert(offsetof(FPostGame_SurvivorAnalytics, UsedHapticsVibration) == 0x0001D6, "Member 'FPostGame_SurvivorAnalytics::UsedHapticsVibration' has a wrong offset!");
...
static_assert(sizeof(FProceduralGenerationAnalytics) == 0x0001C8, "Wrong size on FProceduralGenerationAnalytics");
...
static_assert(offsetof(FProceduralGenerationAnalytics, NavmeshGenerationTime) == 0x0001C4, "Member 'FProceduralGenerationAnalytics::NavmeshGenerationTime' has a wrong offset!");
...
static_assert(offsetof(FRPCCountAnalytics, IsGameThreadOnly) == 0x000138, "Member 'FRPCCountAnalytics::IsGameThreadOnly' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, minStackDepth) == 0x00013C, "Member 'FRPCCountAnalytics::minStackDepth' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, AllNamedCounts) == 0x000140, "Member 'FRPCCountAnalytics::AllNamedCounts' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, TotalCount) == 0x000150, "Member 'FRPCCountAnalytics::TotalCount' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, UnlistedNames) == 0x000158, "Member 'FRPCCountAnalytics::UnlistedNames' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, UnlistedCount) == 0x000168, "Member 'FRPCCountAnalytics::UnlistedCount' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_CallConsoleCmdOnServer_Count) == 0x000170, "Member 'FRPCCountAnalytics::Server_CallConsoleCmdOnServer_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Client_CallConsoleCmdOnClient_Count) == 0x000174, "Member 'FRPCCountAnalytics::Client_CallConsoleCmdOnClient_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerAcknowledgePossession_Count) == 0x000178, "Member 'FRPCCountAnalytics::ServerAcknowledgePossession_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerCheckClientPossession_Count) == 0x00017C, "Member 'FRPCCountAnalytics::ServerCheckClientPossession_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerCheckClientPossessionReliable_Count) == 0x000180, "Member 'FRPCCountAnalytics::ServerCheckClientPossessionReliable_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerMovePacked_Count) == 0x000184, "Member 'FRPCCountAnalytics::ServerMovePacked_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerMoveOut_Count) == 0x000188, "Member 'FRPCCountAnalytics::ServerMoveOut_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerNotifyLoadedWorld_Count) == 0x00018C, "Member 'FRPCCountAnalytics::ServerNotifyLoadedWorld_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerSetSpectatorLocation_Count) == 0x000190, "Member 'FRPCCountAnalytics::ServerSetSpectatorLocation_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerShortTimeout_Count) == 0x000194, "Member 'FRPCCountAnalytics::ServerShortTimeout_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerUpdateCamera_Count) == 0x000198, "Member 'FRPCCountAnalytics::ServerUpdateCamera_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerUpdateLevelVisibility_Count) == 0x00019C, "Member 'FRPCCountAnalytics::ServerUpdateLevelVisibility_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerUpdateMultipleLevelsVisibility_Count) == 0x0001A0, "Member 'FRPCCountAnalytics::ServerUpdateMultipleLevelsVisibility_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, ServerVerifyViewTarget_Count) == 0x0001A4, "Member 'FRPCCountAnalytics::ServerVerifyViewTarget_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_ActivatePerk_Count) == 0x0001A8, "Member 'FRPCCountAnalytics::Server_ActivatePerk_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_ActivateSkillCheck_Count) == 0x0001AC, "Member 'FRPCCountAnalytics::Server_ActivateSkillCheck_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_Broadcast_ConfirmChargedCompleted_Count) == 0x0001B0, "Member 'FRPCCountAnalytics::Server_Broadcast_ConfirmChargedCompleted_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_Broadcast_StoreInteraction_Count) == 0x0001B4, "Member 'FRPCCountAnalytics::Server_Broadcast_StoreInteraction_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_ClearTargets_Count) == 0x0001B8, "Member 'FRPCCountAnalytics::Server_ClearTargets_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_ClientPassedFence_Count) == 0x0001BC, "Member 'FRPCCountAnalytics::Server_ClientPassedFence_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_DeactivateSkillCheck_Count) == 0x0001C0, "Member 'FRPCCountAnalytics::Server_DeactivateSkillCheck_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_EACMessageFromClient_Count) == 0x0001C4, "Member 'FRPCCountAnalytics::Server_EACMessageFromClient_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_HitTarget_Count) == 0x0001C8, "Member 'FRPCCountAnalytics::Server_HitTarget_Count' has a wrong offset!");
...
static_assert(offsetof(FRPCCountAnalytics, Server_MovementSetStateStack_Count) == 0x0001D4, "Member 'FRPCCountAnalytics::Server_MovementSetStateStack_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_NotifyStunHasBeenProcessed_Count) == 0x0001D8, "Member 'FRPCCountAnalytics::Server_NotifyStunHasBeenProcessed_Count' has a wrong offset!");
...
static_assert(offsetof(FRPCCountAnalytics, Server_PlayerReady_Count) == 0x0001E8, "Member 'FRPCCountAnalytics::Server_PlayerReady_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_ReceivePlayerProfile_Count) == 0x0001EC, "Member 'FRPCCountAnalytics::Server_ReceivePlayerProfile_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_RenderingFeaturesCompleted_Count) == 0x0001F0, "Member 'FRPCCountAnalytics::Server_RenderingFeaturesCompleted_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_ReplicateControlRotation_Count) == 0x0001F4, "Member 'FRPCCountAnalytics::Server_ReplicateControlRotation_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_RequestEndGame_Count) == 0x0001F8, "Member 'FRPCCountAnalytics::Server_RequestEndGame_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_RequestServerTime_Count) == 0x0001FC, "Member 'FRPCCountAnalytics::Server_RequestServerTime_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_RequestStateChange_Count) == 0x000200, "Member 'FRPCCountAnalytics::Server_RequestStateChange_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SendAttackInput_Count) == 0x000204, "Member 'FRPCCountAnalytics::Server_SendAttackInput_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SendInteractionInput_Count) == 0x000208, "Member 'FRPCCountAnalytics::Server_SendInteractionInput_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SendFastInteractionInput_Count) == 0x00020C, "Member 'FRPCCountAnalytics::Server_SendFastInteractionInput_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SendSecondaryActionPressed_Count) == 0x000210, "Member 'FRPCCountAnalytics::Server_SendSecondaryActionPressed_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetCharacterData_Count) == 0x000214, "Member 'FRPCCountAnalytics::Server_SetCharacterData_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetConsecutiveMatchStreak_Count) == 0x000218, "Member 'FRPCCountAnalytics::Server_SetConsecutiveMatchStreak_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetCustomizationMeshes_Count) == 0x00021C, "Member 'FRPCCountAnalytics::Server_SetCustomizationMeshes_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetEquipedPerks_Count) == 0x000220, "Member 'FRPCCountAnalytics::Server_SetEquipedPerks_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetEquipment_Count) == 0x000224, "Member 'FRPCCountAnalytics::Server_SetEquipment_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetInteractionToSwapTo_Count) == 0x000228, "Member 'FRPCCountAnalytics::Server_SetInteractionToSwapTo_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetIntroCompleted_Count) == 0x00022C, "Member 'FRPCCountAnalytics::Server_SetIntroCompleted_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetIsReadyToPlay_Count) == 0x000230, "Member 'FRPCCountAnalytics::Server_SetIsReadyToPlay_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetMaxAcceleration_Count) == 0x000234, "Member 'FRPCCountAnalytics::Server_SetMaxAcceleration_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetPlayerLoadout_Count) == 0x000238, "Member 'FRPCCountAnalytics::Server_SetPlayerLoadout_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetPlayerReady_Count) == 0x00023C, "Member 'FRPCCountAnalytics::Server_SetPlayerReady_Count' has a wrong offset!");
...
static_assert(offsetof(FRPCCountAnalytics, Server_SetMaxSpeedMultiplierScalar_Count) == 0x000250, "Member 'FRPCCountAnalytics::Server_SetMaxSpeedMultiplierScalar_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SendMessage_Count) == 0x000254, "Member 'FRPCCountAnalytics::Server_SendMessage_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetRunInput_Count) == 0x000258, "Member 'FRPCCountAnalytics::Server_SetRunInput_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetStateStack_Count) == 0x00025C, "Member 'FRPCCountAnalytics::Server_SetStateStack_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_StoreAttack_Count) == 0x000260, "Member 'FRPCCountAnalytics::Server_StoreAttack_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_TryDetectPlayer_Count) == 0x000264, "Member 'FRPCCountAnalytics::Server_TryDetectPlayer_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_UpdateDiscernedCharacters_Count) == 0x000268, "Member 'FRPCCountAnalytics::Server_UpdateDiscernedCharacters_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_UpdateReplicatedPips_Count) == 0x00026C, "Member 'FRPCCountAnalytics::Server_UpdateReplicatedPips_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_UpdateScreenAspectRatio_Count) == 0x000270, "Member 'FRPCCountAnalytics::Server_UpdateScreenAspectRatio_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SendClientAuthentication_Count) == 0x000274, "Member 'FRPCCountAnalytics::Server_SendClientAuthentication_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetEquipmentAddons_Count) == 0x000278, "Member 'FRPCCountAnalytics::Server_SetEquipmentAddons_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_NotifyOnRep_Count) == 0x00027C, "Member 'FRPCCountAnalytics::Server_NotifyOnRep_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_MovementTimeSync_Count) == 0x000280, "Member 'FRPCCountAnalytics::Server_MovementTimeSync_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetMapSpecificComponentReady_Count) == 0x000284, "Member 'FRPCCountAnalytics::Server_SetMapSpecificComponentReady_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_InitiateSecretRewardProcess_Count) == 0x000288, "Member 'FRPCCountAnalytics::Server_InitiateSecretRewardProcess_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_SetMutatorComponentReady_Count) == 0x00028C, "Member 'FRPCCountAnalytics::Server_SetMutatorComponentReady_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_NotifyHasMoved_Count) == 0x000290, "Member 'FRPCCountAnalytics::Server_NotifyHasMoved_Count' has a wrong offset!");
static_assert(offsetof(FRPCCountAnalytics, Server_LeaveGame_Count) == 0x000294, "Member 'FRPCCountAnalytics::Server_LeaveGame_Count' has a wrong offset!");
...
static_assert(alignof(FSupportACreatorCodeEntryAnalytics) == 0x000008, "Wrong alignment on FSupportACreatorCodeEntryAnalytics");
static_assert(sizeof(FSupportACreatorCodeEntryAnalytics) == 0x0000E0, "Wrong size on FSupportACreatorCodeEntryAnalytics");
static_assert(offsetof(FSupportACreatorCodeEntryAnalytics, IsValid) == 0x0000B8, "Member 'FSupportACreatorCodeEntryAnalytics::IsValid' has a wrong offset!");
static_assert(offsetof(FSupportACreatorCodeEntryAnalytics, ActiveUntil) == 0x0000C0, "Member 'FSupportACreatorCodeEntryAnalytics::ActiveUntil' has a wrong offset!");
static_assert(offsetof(FSupportACreatorCodeEntryAnalytics, Code) == 0x0000D0, "Member 'FSupportACreatorCodeEntryAnalytics::Code' has a wrong offset!");
