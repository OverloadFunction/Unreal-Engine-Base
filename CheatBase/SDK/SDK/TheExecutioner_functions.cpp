...
void ATormentAttackTrailController::OnTrailPointRemovedCosmetic(int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// (Event, Public, BlueprintEvent)
// Parameters:
// const class USplineComponent*           splinemesh                                             (ConstParm, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Parameters:
// const class AGenerator*                 oldHighlightedGenerator                                (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
