...
static_assert(alignof(FrenzyEffect_Authority_OnFrenzyTierIncreased) == 0x000004, "Wrong alignment on FrenzyEffect_Authority_OnFrenzyTierIncreased");
static_assert(sizeof(FrenzyEffect_Authority_OnFrenzyTierIncreased) == 0x000004, "Wrong size on FrenzyEffect_Authority_OnFrenzyTierIncreased");
static_assert(offsetof(FrenzyEffect_Authority_OnFrenzyTierIncreased, tier) == 0x000000, "Member 'FrenzyEffect_Authority_OnFrenzyTierIncreased::tier' has a wrong offset!");
