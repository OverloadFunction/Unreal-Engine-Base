...
static_assert(sizeof(FRigVMGraphFunctionArgument) == 0x0000D0, "Wrong size on FRigVMGraphFunctionArgument");
...
static_assert(offsetof(FRigVMGraphFunctionArgument, bIsArray) == 0x000060, "Member 'FRigVMGraphFunctionArgument::bIsArray' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, Direction) == 0x000061, "Member 'FRigVMGraphFunctionArgument::Direction' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, defaultValue) == 0x000068, "Member 'FRigVMGraphFunctionArgument::defaultValue' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, bIsConst) == 0x000078, "Member 'FRigVMGraphFunctionArgument::bIsConst' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionArgument, PathToTooltip) == 0x000080, "Member 'FRigVMGraphFunctionArgument::PathToTooltip' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunctionCompilationPropertyDescription) == 0x000068, "Wrong size on FRigVMFunctionCompilationPropertyDescription");
...
static_assert(offsetof(FRigVMFunctionCompilationPropertyDescription, defaultValue) == 0x000058, "Member 'FRigVMFunctionCompilationPropertyDescription::defaultValue' has a wrong offset!");
...
static_assert(sizeof(FRigVMGraphFunctionData) == 0x000300, "Wrong size on FRigVMGraphFunctionData");
...
static_assert(offsetof(FRigVMGraphFunctionData, SerializedCollapsedNode) == 0x0002F0, "Member 'FRigVMGraphFunctionData::SerializedCollapsedNode' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugLine) == 0x0001D0, "Wrong size on FRigVMFunction_DebugLine");
static_assert(offsetof(FRigVMFunction_DebugLine, A) == 0x000110, "Member 'FRigVMFunction_DebugLine::A' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, B) == 0x000128, "Member 'FRigVMFunction_DebugLine::B' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, Color) == 0x000140, "Member 'FRigVMFunction_DebugLine::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, Thickness) == 0x000150, "Member 'FRigVMFunction_DebugLine::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, space) == 0x000154, "Member 'FRigVMFunction_DebugLine::space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, WorldOffset) == 0x000160, "Member 'FRigVMFunction_DebugLine::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLine, bEnabled) == 0x0001C0, "Member 'FRigVMFunction_DebugLine::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugLineStrip) == 0x0001B0, "Wrong size on FRigVMFunction_DebugLineStrip");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Points) == 0x000110, "Member 'FRigVMFunction_DebugLineStrip::Points' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Color) == 0x000120, "Member 'FRigVMFunction_DebugLineStrip::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, Thickness) == 0x000130, "Member 'FRigVMFunction_DebugLineStrip::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, space) == 0x000134, "Member 'FRigVMFunction_DebugLineStrip::space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, WorldOffset) == 0x000140, "Member 'FRigVMFunction_DebugLineStrip::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugLineStrip, bEnabled) == 0x0001A0, "Member 'FRigVMFunction_DebugLineStrip::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformMutable) == 0x000210, "Wrong size on FRigVMFunction_DebugTransformMutable");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Transform) == 0x000110, "Member 'FRigVMFunction_DebugTransformMutable::Transform' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Mode) == 0x000170, "Member 'FRigVMFunction_DebugTransformMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Color) == 0x000174, "Member 'FRigVMFunction_DebugTransformMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Thickness) == 0x000184, "Member 'FRigVMFunction_DebugTransformMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, Scale) == 0x000188, "Member 'FRigVMFunction_DebugTransformMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, space) == 0x00018C, "Member 'FRigVMFunction_DebugTransformMutable::space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, WorldOffset) == 0x0001A0, "Member 'FRigVMFunction_DebugTransformMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformMutable, bEnabled) == 0x000200, "Member 'FRigVMFunction_DebugTransformMutable::bEnabled' has a wrong offset!");
...
static_assert(sizeof(FRigVMFunction_DebugTransformArrayMutable) == 0x0001D0, "Wrong size on FRigVMFunction_DebugTransformArrayMutable");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Transforms) == 0x000110, "Member 'FRigVMFunction_DebugTransformArrayMutable::Transforms' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Mode) == 0x000120, "Member 'FRigVMFunction_DebugTransformArrayMutable::Mode' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Color) == 0x000124, "Member 'FRigVMFunction_DebugTransformArrayMutable::Color' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Thickness) == 0x000134, "Member 'FRigVMFunction_DebugTransformArrayMutable::Thickness' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, Scale) == 0x000138, "Member 'FRigVMFunction_DebugTransformArrayMutable::Scale' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, space) == 0x00013C, "Member 'FRigVMFunction_DebugTransformArrayMutable::space' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, WorldOffset) == 0x000150, "Member 'FRigVMFunction_DebugTransformArrayMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, bEnabled) == 0x0001B0, "Member 'FRigVMFunction_DebugTransformArrayMutable::bEnabled' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugTransformArrayMutable, WorkData) == 0x0001B8, "Member 'FRigVMFunction_DebugTransformArrayMutable::WorkData' has a wrong offset!");
