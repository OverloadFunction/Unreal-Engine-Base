...
static_assert(sizeof(FMovieSceneObjectPathChannelKeyValue) == 0x000040, "Wrong size on FMovieSceneObjectPathChannelKeyValue");
...
static_assert(offsetof(FMovieSceneObjectPathChannelKeyValue, HardPtr) == 0x000038, "Member 'FMovieSceneObjectPathChannelKeyValue::HardPtr' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneObjectPathChannel) == 0x000140, "Wrong size on FMovieSceneObjectPathChannel");
...
static_assert(offsetof(FMovieSceneObjectPathChannel, KeyHandles) == 0x0000B8, "Member 'FMovieSceneObjectPathChannel::KeyHandles' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneBindingOverrideData) == 0x000058, "Wrong size on FMovieSceneBindingOverrideData");
...
static_assert(offsetof(FMovieSceneBindingOverrideData, bOverridesDefault) == 0x000050, "Member 'FMovieSceneBindingOverrideData::bOverridesDefault' has a wrong offset!");
