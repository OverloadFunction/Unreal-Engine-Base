...
static_assert(sizeof(UIDataManager_GetChallengeTrackerSkinData) == 0x000058, "Wrong size on UIDataManager_GetChallengeTrackerSkinData");
...
static_assert(alignof(UIDataManager_GetAlertRewardEventSkinData) == 0x000008, "Wrong alignment on UIDataManager_GetAlertRewardEventSkinData");
static_assert(sizeof(UIDataManager_GetAlertRewardEventSkinData) == 0x000030, "Wrong size on UIDataManager_GetAlertRewardEventSkinData");
static_assert(offsetof(UIDataManager_GetAlertRewardEventSkinData, EventThemeLabel) == 0x000000, "Member 'UIDataManager_GetAlertRewardEventSkinData::EventThemeLabel' has a wrong offset!");
static_assert(offsetof(UIDataManager_GetAlertRewardEventSkinData, ReturnValue) == 0x000010, "Member 'UIDataManager_GetAlertRewardEventSkinData::ReturnValue' has a wrong offset!");
...
static_assert(alignof(UIDataManager_GetInboxSkinUIData) == 0x000008, "Wrong alignment on UIDataManager_GetInboxSkinUIData");
static_assert(sizeof(UIDataManager_GetInboxSkinUIData) == 0x000048, "Wrong size on UIDataManager_GetInboxSkinUIData");
static_assert(offsetof(UIDataManager_GetInboxSkinUIData, inboxSkinLabel) == 0x000000, "Member 'UIDataManager_GetInboxSkinUIData::inboxSkinLabel' has a wrong offset!");
static_assert(offsetof(UIDataManager_GetInboxSkinUIData, ReturnValue) == 0x000010, "Member 'UIDataManager_GetInboxSkinUIData::ReturnValue' has a wrong offset!");
...
static_assert(alignof(UIDataManager_GetInputPromptControlModeData) == 0x000008, "Wrong alignment on UIDataManager_GetInputPromptControlModeData");
static_assert(sizeof(UIDataManager_GetInputPromptControlModeData) == 0x000058, "Wrong size on UIDataManager_GetInputPromptControlModeData");
static_assert(offsetof(UIDataManager_GetInputPromptControlModeData, controlMode) == 0x000000, "Member 'UIDataManager_GetInputPromptControlModeData::controlMode' has a wrong offset!");
static_assert(offsetof(UIDataManager_GetInputPromptControlModeData, ReturnValue) == 0x000008, "Member 'UIDataManager_GetInputPromptControlModeData::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(UIDataManager_GetLoadoutPartRarityMaterial) == 0x000040, "Wrong size on UIDataManager_GetLoadoutPartRarityMaterial");
...
static_assert(offsetof(UIDataManager_GetLoadoutPartRarityMaterial, slotIndex) == 0x000001, "Member 'UIDataManager_GetLoadoutPartRarityMaterial::slotIndex' has a wrong offset!");
...
static_assert(sizeof(UIDataManager_GetLoadoutPartStatusEffectMaterial) == 0x000040, "Wrong size on UIDataManager_GetLoadoutPartStatusEffectMaterial");
...
static_assert(offsetof(UIDataManager_GetLoadoutPartStatusEffectMaterial, slotIndex) == 0x000001, "Member 'UIDataManager_GetLoadoutPartStatusEffectMaterial::slotIndex' has a wrong offset!");
...
static_assert(alignof(UIDataManager_GetRarityTextColor) == 0x000004, "Wrong alignment on UIDataManager_GetRarityTextColor");
static_assert(sizeof(UIDataManager_GetRarityTextColor) == 0x000014, "Wrong size on UIDataManager_GetRarityTextColor");
static_assert(offsetof(UIDataManager_GetRarityTextColor, Rarity) == 0x000000, "Member 'UIDataManager_GetRarityTextColor::Rarity' has a wrong offset!");
static_assert(offsetof(UIDataManager_GetRarityTextColor, ReturnValue) == 0x000004, "Member 'UIDataManager_GetRarityTextColor::ReturnValue' has a wrong offset!");
