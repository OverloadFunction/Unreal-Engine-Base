...
static_assert(alignof(K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged) == 0x000001, "Wrong alignment on K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged");
static_assert(sizeof(K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged) == 0x000002, "Wrong size on K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged");
static_assert(offsetof(K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged, oldDamageState) == 0x000000, "Member 'K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged::oldDamageState' has a wrong offset!");
static_assert(offsetof(K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged, newDamageState) == 0x000001, "Member 'K32P01SurvivorStatusEffect_Authority_OnSurvivorDamageStateChanged::newDamageState' has a wrong offset!");
...
static_assert(alignof(K32Power_OnEmpAddedToPool) == 0x000008, "Wrong alignment on K32Power_OnEmpAddedToPool");
static_assert(sizeof(K32Power_OnEmpAddedToPool) == 0x000008, "Wrong size on K32Power_OnEmpAddedToPool");
static_assert(offsetof(K32Power_OnEmpAddedToPool, Actor) == 0x000000, "Member 'K32Power_OnEmpAddedToPool::Actor' has a wrong offset!");
...
static_assert(alignof(K32Power_OnPodAddedToPool) == 0x000008, "Wrong alignment on K32Power_OnPodAddedToPool");
static_assert(sizeof(K32Power_OnPodAddedToPool) == 0x000008, "Wrong size on K32Power_OnPodAddedToPool");
static_assert(offsetof(K32Power_OnPodAddedToPool, Actor) == 0x000000, "Member 'K32Power_OnPodAddedToPool::Actor' has a wrong offset!");
