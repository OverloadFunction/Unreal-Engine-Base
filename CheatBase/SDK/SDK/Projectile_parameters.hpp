...
static_assert(alignof(BaseProjectileLauncher_GetLaunchGravityScale) == 0x000004, "Wrong alignment on BaseProjectileLauncher_GetLaunchGravityScale");
static_assert(sizeof(BaseProjectileLauncher_GetLaunchGravityScale) == 0x000004, "Wrong size on BaseProjectileLauncher_GetLaunchGravityScale");
static_assert(offsetof(BaseProjectileLauncher_GetLaunchGravityScale, ReturnValue) == 0x000000, "Member 'BaseProjectileLauncher_GetLaunchGravityScale::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BaseProjectile_IsValidSlashableDetection) == 0x000008, "Wrong alignment on BaseProjectile_IsValidSlashableDetection");
static_assert(sizeof(BaseProjectile_IsValidSlashableDetection) == 0x000050, "Wrong size on BaseProjectile_IsValidSlashableDetection");
static_assert(offsetof(BaseProjectile_IsValidSlashableDetection, ImpactInfo) == 0x000000, "Member 'BaseProjectile_IsValidSlashableDetection::ImpactInfo' has a wrong offset!");
static_assert(offsetof(BaseProjectile_IsValidSlashableDetection, ReturnValue) == 0x000048, "Member 'BaseProjectile_IsValidSlashableDetection::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BaseProjectileReplicationComponent_Multicast_OnLaunch) == 0x000048, "Wrong size on BaseProjectileReplicationComponent_Multicast_OnLaunch");
...
static_assert(offsetof(BaseProjectileReplicationComponent_Multicast_OnLaunch, wasPredicted) == 0x000040, "Member 'BaseProjectileReplicationComponent_Multicast_OnLaunch::wasPredicted' has a wrong offset!");
...
static_assert(sizeof(BaseProjectileReplicationComponent_Multicast_OnLaunchWithImpact) == 0x000090, "Wrong size on BaseProjectileReplicationComponent_Multicast_OnLaunchWithImpact");
...
static_assert(offsetof(BaseProjectileReplicationComponent_Multicast_OnLaunchWithImpact, wasPredicted) == 0x000088, "Member 'BaseProjectileReplicationComponent_Multicast_OnLaunchWithImpact::wasPredicted' has a wrong offset!");
...
static_assert(alignof(BaseProjectileReplicationComponent_Mutlicast_DetectSlashable) == 0x000008, "Wrong alignment on BaseProjectileReplicationComponent_Mutlicast_DetectSlashable");
static_assert(sizeof(BaseProjectileReplicationComponent_Mutlicast_DetectSlashable) == 0x000050, "Wrong size on BaseProjectileReplicationComponent_Mutlicast_DetectSlashable");
static_assert(offsetof(BaseProjectileReplicationComponent_Mutlicast_DetectSlashable, Projectile) == 0x000000, "Member 'BaseProjectileReplicationComponent_Mutlicast_DetectSlashable::Projectile' has a wrong offset!");
static_assert(offsetof(BaseProjectileReplicationComponent_Mutlicast_DetectSlashable, ImpactInfo) == 0x000008, "Member 'BaseProjectileReplicationComponent_Mutlicast_DetectSlashable::ImpactInfo' has a wrong offset!");
...
static_assert(sizeof(BaseProjectileReplicationComponent_Server_TryDetectPlayer) == 0x0000A8, "Wrong size on BaseProjectileReplicationComponent_Server_TryDetectPlayer");
...
static_assert(offsetof(BaseProjectileReplicationComponent_Server_TryDetectPlayer, launchTime) == 0x000084, "Member 'BaseProjectileReplicationComponent_Server_TryDetectPlayer::launchTime' has a wrong offset!");
static_assert(offsetof(BaseProjectileReplicationComponent_Server_TryDetectPlayer, clientTime) == 0x000088, "Member 'BaseProjectileReplicationComponent_Server_TryDetectPlayer::clientTime' has a wrong offset!");
static_assert(offsetof(BaseProjectileReplicationComponent_Server_TryDetectPlayer, projectileCurrentLocationOnClient) == 0x000090, "Member 'BaseProjectileReplicationComponent_Server_TryDetectPlayer::projectileCurrentLocationOnClient' has a wrong offset!");
