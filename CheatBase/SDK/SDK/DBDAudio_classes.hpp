...
static_assert(sizeof(UAmbienceBoxComponent) == 0x0005E0, "Wrong size on UAmbienceBoxComponent");
...
static_assert(sizeof(UAudioCustomMeshComponent) == 0x000690, "Wrong size on UAudioCustomMeshComponent");
...
static_assert(alignof(UDBDAudioSettings) == 0x000008, "Wrong alignment on UDBDAudioSettings");
static_assert(sizeof(UDBDAudioSettings) == 0x000070, "Wrong size on UDBDAudioSettings");
static_assert(offsetof(UDBDAudioSettings, DefaultLanguage) == 0x000048, "Member 'UDBDAudioSettings::DefaultLanguage' has a wrong offset!");
static_assert(offsetof(UDBDAudioSettings, Languages) == 0x000050, "Member 'UDBDAudioSettings::Languages' has a wrong offset!");
static_assert(offsetof(UDBDAudioSettings, StateGroups) == 0x000060, "Member 'UDBDAudioSettings::StateGroups' has a wrong offset!");
