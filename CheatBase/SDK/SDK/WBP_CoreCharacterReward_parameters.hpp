...
static_assert(sizeof(WBP_CoreCharacterReward_C_ExecuteUbergraph_WBP_CoreCharacterReward) == 0x000150, "Wrong size on WBP_CoreCharacterReward_C_ExecuteUbergraph_WBP_CoreCharacterReward");
...
static_assert(sizeof(WBP_CoreCharacterReward_C_SetCharacterRewardData) == 0x000148, "Wrong size on WBP_CoreCharacterReward_C_SetCharacterRewardData");
...
static_assert(offsetof(WBP_CoreCharacterReward_C_SetKillSwitchOverlay, IsEnabled_0) == 0x000000, "Member 'WBP_CoreCharacterReward_C_SetKillSwitchOverlay::IsEnabled_0' has a wrong offset!");
