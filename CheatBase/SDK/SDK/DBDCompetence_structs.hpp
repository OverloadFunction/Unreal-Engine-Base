...
static_assert(sizeof(FDataDrivenStatusEffectInfo) == 0x0000B0, "Wrong size on FDataDrivenStatusEffectInfo");
...
static_assert(offsetof(FDataDrivenStatusEffectInfo, CanEffectBeImposedIfAlreadyExists) == 0x0000A0, "Member 'FDataDrivenStatusEffectInfo::CanEffectBeImposedIfAlreadyExists' has a wrong offset!");
static_assert(offsetof(FDataDrivenStatusEffectInfo, StatusEffect) == 0x0000A8, "Member 'FDataDrivenStatusEffectInfo::StatusEffect' has a wrong offset!");
