...
static_assert(offsetof(AControlRigShapeActor, ShapeName) == 0x0002C8, "Member 'AControlRigShapeActor::ShapeName' has a wrong offset!");
...
static_assert(offsetof(UTransformableControlHandle, ControlName) == 0x000098, "Member 'UTransformableControlHandle::ControlName' has a wrong offset!");
...
static_assert(sizeof(UControlRigComponent) == 0x000700, "Wrong size on UControlRigComponent");
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x0005A0, "Member 'UControlRigComponent::ControlRigClass' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreInitializeDelegate) == 0x0005A8, "Member 'UControlRigComponent::OnPreInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostInitializeDelegate) == 0x0005B8, "Member 'UControlRigComponent::OnPostInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreConstructionDelegate) == 0x0005C8, "Member 'UControlRigComponent::OnPreConstructionDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostConstructionDelegate) == 0x0005D8, "Member 'UControlRigComponent::OnPostConstructionDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreForwardsSolveDelegate) == 0x0005E8, "Member 'UControlRigComponent::OnPreForwardsSolveDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostForwardsSolveDelegate) == 0x0005F8, "Member 'UControlRigComponent::OnPostForwardsSolveDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, UserDefinedElements) == 0x000608, "Member 'UControlRigComponent::UserDefinedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x000618, "Member 'UControlRigComponent::MappedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bEnableLazyEvaluation) == 0x000628, "Member 'UControlRigComponent::bEnableLazyEvaluation' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationPositionThreshold) == 0x00062C, "Member 'UControlRigComponent::LazyEvaluationPositionThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationRotationThreshold) == 0x000630, "Member 'UControlRigComponent::LazyEvaluationRotationThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, LazyEvaluationScaleThreshold) == 0x000634, "Member 'UControlRigComponent::LazyEvaluationScaleThreshold' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetTransformBeforeTick) == 0x000638, "Member 'UControlRigComponent::bResetTransformBeforeTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeConstruction) == 0x000639, "Member 'UControlRigComponent::bResetInitialsBeforeConstruction' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateRigOnTick) == 0x00063A, "Member 'UControlRigComponent::bUpdateRigOnTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateInEditor) == 0x00063B, "Member 'UControlRigComponent::bUpdateInEditor' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bDrawBones) == 0x00063C, "Member 'UControlRigComponent::bDrawBones' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bShowDebugDrawing) == 0x00063D, "Member 'UControlRigComponent::bShowDebugDrawing' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x000640, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
...
static_assert(sizeof(UControlRigBlueprintGeneratedClass) == 0x0003B0, "Wrong size on UControlRigBlueprintGeneratedClass");
...
static_assert(sizeof(UControlRigShapeLibrary) == 0x000190, "Wrong size on UControlRigShapeLibrary");
...
static_assert(offsetof(UControlRigShapeLibrary, XRayMaterial) == 0x000128, "Member 'UControlRigShapeLibrary::XRayMaterial' has a wrong offset!");
static_assert(offsetof(UControlRigShapeLibrary, MaterialColorParameter) == 0x000160, "Member 'UControlRigShapeLibrary::MaterialColorParameter' has a wrong offset!");
static_assert(offsetof(UControlRigShapeLibrary, Shapes) == 0x000170, "Member 'UControlRigShapeLibrary::Shapes' has a wrong offset!");
...
static_assert(sizeof(UControlRigLayerInstance) == 0x000360, "Wrong size on UControlRigLayerInstance");
...
static_assert(sizeof(UControlRigSequence) == 0x0002A0, "Wrong size on UControlRigSequence");
...
static_assert(offsetof(UControlRigSequence, LastExportedFrameRate) == 0x000298, "Member 'UControlRigSequence::LastExportedFrameRate' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneControlRigParameterTrack) == 0x000110, "Wrong size on UMovieSceneControlRigParameterTrack");
