...
static_assert(sizeof(UAddon_TheBlight_18) == 0x000308, "Wrong size on UAddon_TheBlight_18");
static_assert(offsetof(UAddon_TheBlight_18, _blightUndetectableEffect) == 0x000300, "Member 'UAddon_TheBlight_18::_blightUndetectableEffect' has a wrong offset!");
...
static_assert(sizeof(UAddon_TheBlight_19) == 0x000310, "Wrong size on UAddon_TheBlight_19");
static_assert(offsetof(UAddon_TheBlight_19, _timedRevealToKillerEffectClass) == 0x000300, "Member 'UAddon_TheBlight_19::_timedRevealToKillerEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_TheBlight_19, _survivorInRangeDistance) == 0x000308, "Member 'UAddon_TheBlight_19::_survivorInRangeDistance' has a wrong offset!");
static_assert(offsetof(UAddon_TheBlight_19, _survivorRevealTime) == 0x00030C, "Member 'UAddon_TheBlight_19::_survivorRevealTime' has a wrong offset!");
...
static_assert(sizeof(UAddon_TheBlight_BaseConsecutiveDashModifier) == 0x000318, "Wrong size on UAddon_TheBlight_BaseConsecutiveDashModifier");
static_assert(offsetof(UAddon_TheBlight_BaseConsecutiveDashModifier, _modifierTag) == 0x000300, "Member 'UAddon_TheBlight_BaseConsecutiveDashModifier::_modifierTag' has a wrong offset!");
static_assert(offsetof(UAddon_TheBlight_BaseConsecutiveDashModifier, _increasePerDash) == 0x00030C, "Member 'UAddon_TheBlight_BaseConsecutiveDashModifier::_increasePerDash' has a wrong offset!");
static_assert(offsetof(UAddon_TheBlight_BaseConsecutiveDashModifier, _defaultModifierValue) == 0x000310, "Member 'UAddon_TheBlight_BaseConsecutiveDashModifier::_defaultModifierValue' has a wrong offset!");
...
static_assert(sizeof(UAddon_TheBlight_BaseForceMaxToken) == 0x000308, "Wrong size on UAddon_TheBlight_BaseForceMaxToken");
static_assert(offsetof(UAddon_TheBlight_BaseForceMaxToken, _overridenMaxDashToken) == 0x000300, "Member 'UAddon_TheBlight_BaseForceMaxToken::_overridenMaxDashToken' has a wrong offset!");
...
static_assert(sizeof(UAddon_TheBlight_SoulChemical) == 0x000308, "Wrong size on UAddon_TheBlight_SoulChemical");
static_assert(offsetof(UAddon_TheBlight_SoulChemical, _firstDashSpeedIncrease) == 0x000300, "Member 'UAddon_TheBlight_SoulChemical::_firstDashSpeedIncrease' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_BlightDash) == 0x0006E8, "Wrong size on UAISkill_Interaction_BlightDash");
static_assert(offsetof(UAISkill_Interaction_BlightDash, FirstDashCheckInterval) == 0x0002A0, "Member 'UAISkill_Interaction_BlightDash::FirstDashCheckInterval' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, ChainDashCheckInterval) == 0x0002A4, "Member 'UAISkill_Interaction_BlightDash::ChainDashCheckInterval' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MinimumFirstDashDistance) == 0x0002A8, "Member 'UAISkill_Interaction_BlightDash::MinimumFirstDashDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MinimumTraversalDistance) == 0x000308, "Member 'UAISkill_Interaction_BlightDash::MinimumTraversalDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MinimumEdgeDistance) == 0x000368, "Member 'UAISkill_Interaction_BlightDash::MinimumEdgeDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MaxDistancePerDash) == 0x0003C8, "Member 'UAISkill_Interaction_BlightDash::MaxDistancePerDash' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MaxDistanceFirstDashSearchRadius) == 0x000428, "Member 'UAISkill_Interaction_BlightDash::MaxDistanceFirstDashSearchRadius' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MaxDistanceChainDashSearchRadius) == 0x000488, "Member 'UAISkill_Interaction_BlightDash::MaxDistanceChainDashSearchRadius' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, ChaseLoopSearchDistance) == 0x0004E8, "Member 'UAISkill_Interaction_BlightDash::ChaseLoopSearchDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, ChaseLoopSearchRadius) == 0x000548, "Member 'UAISkill_Interaction_BlightDash::ChaseLoopSearchRadius' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, ChaseSearchRadius) == 0x0005A8, "Member 'UAISkill_Interaction_BlightDash::ChaseSearchRadius' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, SearchVerticalHeight) == 0x000608, "Member 'UAISkill_Interaction_BlightDash::SearchVerticalHeight' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, MaxCollisionAngle) == 0x00060C, "Member 'UAISkill_Interaction_BlightDash::MaxCollisionAngle' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, SafeCollisionAngle) == 0x000610, "Member 'UAISkill_Interaction_BlightDash::SafeCollisionAngle' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, DashDistanceToAngleCoefficient) == 0x000670, "Member 'UAISkill_Interaction_BlightDash::DashDistanceToAngleCoefficient' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, DashDistanceToAnglePower) == 0x000674, "Member 'UAISkill_Interaction_BlightDash::DashDistanceToAnglePower' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, CurveSegmentIntervalDistance) == 0x000678, "Member 'UAISkill_Interaction_BlightDash::CurveSegmentIntervalDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, DashStartAdjustDistance) == 0x00067C, "Member 'UAISkill_Interaction_BlightDash::DashStartAdjustDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, NavRaycastHitTargetDistanceMargin) == 0x000680, "Member 'UAISkill_Interaction_BlightDash::NavRaycastHitTargetDistanceMargin' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, PalletDetectionForwardDistance) == 0x000684, "Member 'UAISkill_Interaction_BlightDash::PalletDetectionForwardDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_BlightDash, PalletDetectionRadius) == 0x000688, "Member 'UAISkill_Interaction_BlightDash::PalletDetectionRadius' has a wrong offset!");
...
static_assert(sizeof(UBlightDashAttack) == 0x000440, "Wrong size on UBlightDashAttack");
...
static_assert(sizeof(ABlightPower) == 0x0006B0, "Wrong size on ABlightPower");
static_assert(offsetof(ABlightPower, _blightPowerCharge) == 0x000558, "Member 'ABlightPower::_blightPowerCharge' has a wrong offset!");
static_assert(offsetof(ABlightPower, _blightPowerToggle) == 0x000560, "Member 'ABlightPower::_blightPowerToggle' has a wrong offset!");
static_assert(offsetof(ABlightPower, _blightPowerActivateChargeable) == 0x000568, "Member 'ABlightPower::_blightPowerActivateChargeable' has a wrong offset!");
static_assert(offsetof(ABlightPower, _blightPowerStateComponent) == 0x000570, "Member 'ABlightPower::_blightPowerStateComponent' has a wrong offset!");
static_assert(offsetof(ABlightPower, _blightPowerActivateMaxCharge) == 0x000578, "Member 'ABlightPower::_blightPowerActivateMaxCharge' has a wrong offset!");
static_assert(offsetof(ABlightPower, _blightPowerMaxCharge) == 0x0005A0, "Member 'ABlightPower::_blightPowerMaxCharge' has a wrong offset!");
static_assert(offsetof(ABlightPower, _blightPowerRechargeRate) == 0x000620, "Member 'ABlightPower::_blightPowerRechargeRate' has a wrong offset!");
static_assert(offsetof(ABlightPower, _inPowerEffect) == 0x000648, "Member 'ABlightPower::_inPowerEffect' has a wrong offset!");
static_assert(offsetof(ABlightPower, _outOfPowerEffect) == 0x000650, "Member 'ABlightPower::_outOfPowerEffect' has a wrong offset!");
...
static_assert(sizeof(UBlightPowerChargePresentationPowerFadeComponent) == 0x0000C8, "Wrong size on UBlightPowerChargePresentationPowerFadeComponent");
...
static_assert(sizeof(UBlightPowerPresentationComponent) == 0x0000D0, "Wrong size on UBlightPowerPresentationComponent");
...
static_assert(sizeof(UBlightPowerStateComponent) == 0x0003E8, "Wrong size on UBlightPowerStateComponent");
static_assert(offsetof(UBlightPowerStateComponent, OnPowerCollided) == 0x0000D8, "Member 'UBlightPowerStateComponent::OnPowerCollided' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _blightPowerStateClasses) == 0x0000E8, "Member 'UBlightPowerStateComponent::_blightPowerStateClasses' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _canDashCheckCollisionRadius) == 0x0000F8, "Member 'UBlightPowerStateComponent::_canDashCheckCollisionRadius' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _canDashCheckCollisionHeight) == 0x000120, "Member 'UBlightPowerStateComponent::_canDashCheckCollisionHeight' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _canDashCheckCollisionRange) == 0x000148, "Member 'UBlightPowerStateComponent::_canDashCheckCollisionRange' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _killerTagsForWallHitQuery) == 0x000170, "Member 'UBlightPowerStateComponent::_killerTagsForWallHitQuery' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _canWallGrabPlayerTags) == 0x0001B8, "Member 'UBlightPowerStateComponent::_canWallGrabPlayerTags' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _blightLethalDashDodgeRadius) == 0x0001D8, "Member 'UBlightPowerStateComponent::_blightLethalDashDodgeRadius' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _powerInteractionDefinition) == 0x000200, "Member 'UBlightPowerStateComponent::_powerInteractionDefinition' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _stateTimer) == 0x000238, "Member 'UBlightPowerStateComponent::_stateTimer' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _blightPowerStates) == 0x000240, "Member 'UBlightPowerStateComponent::_blightPowerStates' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _currentBlightPowerState) == 0x000250, "Member 'UBlightPowerStateComponent::_currentBlightPowerState' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _dashTokens) == 0x000258, "Member 'UBlightPowerStateComponent::_dashTokens' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _maximumDashTokens) == 0x000260, "Member 'UBlightPowerStateComponent::_maximumDashTokens' has a wrong offset!");
static_assert(offsetof(UBlightPowerStateComponent, _tokenChargeRate) == 0x0002E0, "Member 'UBlightPowerStateComponent::_tokenChargeRate' has a wrong offset!");
...
static_assert(sizeof(UDragonsGrip) == 0x0004C8, "Wrong size on UDragonsGrip");
static_assert(offsetof(UDragonsGrip, _kickedGenerator) == 0x000460, "Member 'UDragonsGrip::_kickedGenerator' has a wrong offset!");
static_assert(offsetof(UDragonsGrip, _exposedStatusEffect) == 0x000468, "Member 'UDragonsGrip::_exposedStatusEffect' has a wrong offset!");
static_assert(offsetof(UDragonsGrip, _activationDuration) == 0x000470, "Member 'UDragonsGrip::_activationDuration' has a wrong offset!");
static_assert(offsetof(UDragonsGrip, _cooldownDuration) == 0x00047C, "Member 'UDragonsGrip::_cooldownDuration' has a wrong offset!");
static_assert(offsetof(UDragonsGrip, _exposedEffectDuration) == 0x000488, "Member 'UDragonsGrip::_exposedEffectDuration' has a wrong offset!");
static_assert(offsetof(UDragonsGrip, _onlyExposeFirstSurvivor) == 0x000494, "Member 'UDragonsGrip::_onlyExposeFirstSurvivor' has a wrong offset!");
static_assert(offsetof(UDragonsGrip, _loudNoiseRange) == 0x0004A0, "Member 'UDragonsGrip::_loudNoiseRange' has a wrong offset!");
...
static_assert(sizeof(UHexBloodFavor) == 0x0004F8, "Wrong size on UHexBloodFavor");
static_assert(offsetof(UHexBloodFavor, _palletInRange) == 0x0004E0, "Member 'UHexBloodFavor::_palletInRange' has a wrong offset!");
static_assert(offsetof(UHexBloodFavor, _palletPulldownBlockTime) == 0x0004EC, "Member 'UHexBloodFavor::_palletPulldownBlockTime' has a wrong offset!");
...
static_assert(sizeof(UHexUndying) == 0x000550, "Wrong size on UHexUndying");
static_assert(offsetof(UHexUndying, _revealSurvivorEffectClass) == 0x000530, "Member 'UHexUndying::_revealSurvivorEffectClass' has a wrong offset!");
static_assert(offsetof(UHexUndying, _revealAuraDistanceFromTotem) == 0x000540, "Member 'UHexUndying::_revealAuraDistanceFromTotem' has a wrong offset!");
...
static_assert(sizeof(UWallGrabInteractionDefinition) == 0x0007B0, "Wrong size on UWallGrabInteractionDefinition");
static_assert(offsetof(UWallGrabInteractionDefinition, _blightPowerStateComponent) == 0x000768, "Member 'UWallGrabInteractionDefinition::_blightPowerStateComponent' has a wrong offset!");
static_assert(offsetof(UWallGrabInteractionDefinition, _wallDashAccelerationMultiplier) == 0x000770, "Member 'UWallGrabInteractionDefinition::_wallDashAccelerationMultiplier' has a wrong offset!");
static_assert(offsetof(UWallGrabInteractionDefinition, _blightPowerCollisionIndicator) == 0x000798, "Member 'UWallGrabInteractionDefinition::_blightPowerCollisionIndicator' has a wrong offset!");
static_assert(offsetof(UWallGrabInteractionDefinition, _collisionIndicatorActorClass) == 0x0007A0, "Member 'UWallGrabInteractionDefinition::_collisionIndicatorActorClass' has a wrong offset!");
