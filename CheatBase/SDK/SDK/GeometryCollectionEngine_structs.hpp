...
static_assert(sizeof(FGeometryCollectionAutoInstanceMesh) == 0x000038, "Wrong size on FGeometryCollectionAutoInstanceMesh");
...
static_assert(offsetof(FGeometryCollectionAutoInstanceMesh, Materials) == 0x000028, "Member 'FGeometryCollectionAutoInstanceMesh::Materials' has a wrong offset!");
