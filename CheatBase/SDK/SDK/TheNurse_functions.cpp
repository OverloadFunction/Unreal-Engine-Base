...
void UBlinkPlayerComponent::Server_NotifyBlinkCharge(float charge)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BlinkPlayerComponent", "Server_NotifyBlinkCharge");

	Params::BlinkPlayerComponent_Server_NotifyBlinkCharge Parms{};
