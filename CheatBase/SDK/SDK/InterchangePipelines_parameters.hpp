...
static_assert(sizeof(InterchangePipelineMeshesUtilities_GetAllSkinnedMeshInstance) == 0x000018, "Wrong size on InterchangePipelineMeshesUtilities_GetAllSkinnedMeshInstance");
...
static_assert(offsetof(InterchangePipelineMeshesUtilities_GetAllSkinnedMeshInstance, bConvertStaticMeshToSkeletalMesh) == 0x000010, "Member 'InterchangePipelineMeshesUtilities_GetAllSkinnedMeshInstance::bConvertStaticMeshToSkeletalMesh' has a wrong offset!");
...
static_assert(sizeof(InterchangePipelineMeshesUtilities_GetAllStaticMeshGeometry) == 0x000018, "Wrong size on InterchangePipelineMeshesUtilities_GetAllStaticMeshGeometry");
...
static_assert(offsetof(InterchangePipelineMeshesUtilities_GetAllStaticMeshGeometry, bConvertSkeletalMeshToStaticMesh) == 0x000010, "Member 'InterchangePipelineMeshesUtilities_GetAllStaticMeshGeometry::bConvertSkeletalMeshToStaticMesh' has a wrong offset!");
...
static_assert(sizeof(InterchangePipelineMeshesUtilities_GetAllStaticMeshInstance) == 0x000018, "Wrong size on InterchangePipelineMeshesUtilities_GetAllStaticMeshInstance");
...
static_assert(offsetof(InterchangePipelineMeshesUtilities_GetAllStaticMeshInstance, bConvertSkeletalMeshToStaticMesh) == 0x000010, "Member 'InterchangePipelineMeshesUtilities_GetAllStaticMeshInstance::bConvertSkeletalMeshToStaticMesh' has a wrong offset!");
