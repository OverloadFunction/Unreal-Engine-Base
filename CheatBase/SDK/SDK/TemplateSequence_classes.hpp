...
static_assert(sizeof(UTemplateSequence) == 0x000100, "Wrong size on UTemplateSequence");
...
static_assert(offsetof(UTemplateSequence, BoundActorComponents) == 0x0000B0, "Member 'UTemplateSequence::BoundActorComponents' has a wrong offset!");
...
static_assert(sizeof(UCameraAnimationSequence) == 0x000100, "Wrong size on UCameraAnimationSequence");
