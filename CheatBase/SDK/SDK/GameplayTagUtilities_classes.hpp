...
static_assert(sizeof(UGameplayTagContainerComponent) == 0x000220, "Wrong size on UGameplayTagContainerComponent");
static_assert(offsetof(UGameplayTagContainerComponent, _tagToQueries) == 0x000180, "Member 'UGameplayTagContainerComponent::_tagToQueries' has a wrong offset!");
static_assert(offsetof(UGameplayTagContainerComponent, _ownerToQueries) == 0x0001D0, "Member 'UGameplayTagContainerComponent::_ownerToQueries' has a wrong offset!");
