...
static_assert(sizeof(FRigUnit_PBIK) == 0x000270, "Wrong size on FRigUnit_PBIK");
static_assert(offsetof(FRigUnit_PBIK, Root) == 0x000140, "Member 'FRigUnit_PBIK::Root' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Effectors) == 0x000150, "Member 'FRigUnit_PBIK::Effectors' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, EffectorSolverIndices) == 0x000160, "Member 'FRigUnit_PBIK::EffectorSolverIndices' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, BoneSettings) == 0x000170, "Member 'FRigUnit_PBIK::BoneSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, ExcludedBones) == 0x000180, "Member 'FRigUnit_PBIK::ExcludedBones' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Settings) == 0x000190, "Member 'FRigUnit_PBIK::Settings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, debug) == 0x0001CC, "Member 'FRigUnit_PBIK::debug' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, BoneSettingToSolverBoneIndex) == 0x0001D8, "Member 'FRigUnit_PBIK::BoneSettingToSolverBoneIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, SolverBoneToElementIndex) == 0x0001E8, "Member 'FRigUnit_PBIK::SolverBoneToElementIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Solver) == 0x0001F8, "Member 'FRigUnit_PBIK::Solver' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, bNeedsInit) == 0x000260, "Member 'FRigUnit_PBIK::bNeedsInit' has a wrong offset!");
