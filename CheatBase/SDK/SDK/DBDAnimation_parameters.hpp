...
static_assert(alignof(BaseMenuAnimInstance_RotateMenuPlayerTowardsCamera) == 0x000008, "Wrong alignment on BaseMenuAnimInstance_RotateMenuPlayerTowardsCamera");
static_assert(sizeof(BaseMenuAnimInstance_RotateMenuPlayerTowardsCamera) == 0x000018, "Wrong size on BaseMenuAnimInstance_RotateMenuPlayerTowardsCamera");
static_assert(offsetof(BaseMenuAnimInstance_RotateMenuPlayerTowardsCamera, cameraLookAtOffset) == 0x000000, "Member 'BaseMenuAnimInstance_RotateMenuPlayerTowardsCamera::cameraLookAtOffset' has a wrong offset!");
