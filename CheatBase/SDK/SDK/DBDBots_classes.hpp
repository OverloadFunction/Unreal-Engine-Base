...
static_assert(sizeof(UAISkill_Find) == 0x000300, "Wrong size on UAISkill_Find");
...
static_assert(offsetof(UAISkill_Find, RejectCooldownContextName) == 0x000164, "Member 'UAISkill_Find::RejectCooldownContextName' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, AbandonIfInChase) == 0x000170, "Member 'UAISkill_Find::AbandonIfInChase' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, RejectIfInPressureZone) == 0x000171, "Member 'UAISkill_Find::RejectIfInPressureZone' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, RejectIfNotFocusedBySelf) == 0x000172, "Member 'UAISkill_Find::RejectIfNotFocusedBySelf' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, RejectIfInteractableFocusedByOther) == 0x000173, "Member 'UAISkill_Find::RejectIfInteractableFocusedByOther' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, UsesActorLocation) == 0x000174, "Member 'UAISkill_Find::UsesActorLocation' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, ActorLocationOffset) == 0x000178, "Member 'UAISkill_Find::ActorLocationOffset' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, GoalBasicWeight) == 0x000190, "Member 'UAISkill_Find::GoalBasicWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, GoalWeightMaxDistance) == 0x0001F0, "Member 'UAISkill_Find::GoalWeightMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, GoalWeightAtMinDistance) == 0x000250, "Member 'UAISkill_Find::GoalWeightAtMinDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, SearchHeightAmplifier) == 0x0002B0, "Member 'UAISkill_Find::SearchHeightAmplifier' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, SearchHeightAmplifierActivationHeight) == 0x0002B4, "Member 'UAISkill_Find::SearchHeightAmplifierActivationHeight' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, IsUnsafeAction) == 0x0002B8, "Member 'UAISkill_Find::IsUnsafeAction' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, UnsafeInteractionID) == 0x0002C0, "Member 'UAISkill_Find::UnsafeInteractionID' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, UnsafeActionUsesItemAddons) == 0x0002D0, "Member 'UAISkill_Find::UnsafeActionUsesItemAddons' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, UnsafeActionIsSelfInteraction) == 0x0002D1, "Member 'UAISkill_Find::UnsafeActionIsSelfInteraction' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, UnsafeActionRange) == 0x0002D4, "Member 'UAISkill_Find::UnsafeActionRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Find, _currentWishedObjects) == 0x0002D8, "Member 'UAISkill_Find::_currentWishedObjects' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable) == 0x000318, "Wrong size on UAISkill_FindInteractable");
static_assert(offsetof(UAISkill_FindInteractable, RequiredInteractionId) == 0x000300, "Member 'UAISkill_FindInteractable::RequiredInteractionId' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable, RequiredInteractionInputType) == 0x000310, "Member 'UAISkill_FindInteractable::RequiredInteractionInputType' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindCollectable) == 0x000388, "Wrong size on UAISkill_FindCollectable");
static_assert(offsetof(UAISkill_FindCollectable, CollectUnderItemRatio) == 0x000318, "Member 'UAISkill_FindCollectable::CollectUnderItemRatio' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable, CollectOverItemChargeRatio) == 0x00031C, "Member 'UAISkill_FindCollectable::CollectOverItemChargeRatio' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable, GoalItemCountBonusWeight) == 0x000320, "Member 'UAISkill_FindCollectable::GoalItemCountBonusWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable, ItemMustHaveNormalPickupFlow) == 0x000380, "Member 'UAISkill_FindCollectable::ItemMustHaveNormalPickupFlow' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindCollectable_Searchable) == 0x0003A0, "Wrong size on UAISkill_FindCollectable_Searchable");
static_assert(offsetof(UAISkill_FindCollectable_Searchable, SearchIntervalAfterOpenSearchable) == 0x000388, "Member 'UAISkill_FindCollectable_Searchable::SearchIntervalAfterOpenSearchable' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Searchable, OpenSearchableRelevancyDuration) == 0x00038C, "Member 'UAISkill_FindCollectable_Searchable::OpenSearchableRelevancyDuration' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Searchable, _relevantSearchable) == 0x000398, "Member 'UAISkill_FindCollectable_Searchable::_relevantSearchable' has a wrong offset!");
...
static_assert(alignof(UBTService_LookAway) == 0x000008, "Wrong alignment on UBTService_LookAway");
static_assert(sizeof(UBTService_LookAway) == 0x000100, "Wrong size on UBTService_LookAway");
static_assert(offsetof(UBTService_LookAway, BBTargetInteractable) == 0x000078, "Member 'UBTService_LookAway::BBTargetInteractable' has a wrong offset!");
static_assert(offsetof(UBTService_LookAway, BBDisableService) == 0x0000A8, "Member 'UBTService_LookAway::BBDisableService' has a wrong offset!");
static_assert(offsetof(UBTService_LookAway, FocusPriority) == 0x0000D8, "Member 'UBTService_LookAway::FocusPriority' has a wrong offset!");
static_assert(offsetof(UBTService_LookAway, MaxInteractableRange) == 0x0000DC, "Member 'UBTService_LookAway::MaxInteractableRange' has a wrong offset!");
static_assert(offsetof(UBTService_LookAway, MaxRangeForSurvivors) == 0x0000E0, "Member 'UBTService_LookAway::MaxRangeForSurvivors' has a wrong offset!");
static_assert(offsetof(UBTService_LookAway, UpdateRelevantInteractablesInterval) == 0x0000E4, "Member 'UBTService_LookAway::UpdateRelevantInteractablesInterval' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindCollectable_Camper) == 0x000518, "Wrong size on UAISkill_FindCollectable_Camper");
static_assert(offsetof(UAISkill_FindCollectable_Camper, CollectUnderItemWeight) == 0x000388, "Member 'UAISkill_FindCollectable_Camper::CollectUnderItemWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Camper, CollectOverWeightRatioDifference) == 0x00038C, "Member 'UAISkill_FindCollectable_Camper::CollectOverWeightRatioDifference' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Camper, WantToKeepEmptyItemPenalty) == 0x000390, "Member 'UAISkill_FindCollectable_Camper::WantToKeepEmptyItemPenalty' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Camper, CloseItemDistThreshold) == 0x0003F0, "Member 'UAISkill_FindCollectable_Camper::CloseItemDistThreshold' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Camper, CloseItemWeightMultiplier) == 0x000450, "Member 'UAISkill_FindCollectable_Camper::CloseItemWeightMultiplier' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Camper, ItemGoalWeightMultiplier) == 0x0004B0, "Member 'UAISkill_FindCollectable_Camper::ItemGoalWeightMultiplier' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_Camper, EmptyItemChargeThreshold) == 0x000510, "Member 'UAISkill_FindCollectable_Camper::EmptyItemChargeThreshold' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_KillerPower) == 0x0002A0, "Wrong size on UAISkill_Interaction_KillerPower");
static_assert(offsetof(UAISkill_Interaction_KillerPower, BBInvestigateLocation) == 0x000280, "Member 'UAISkill_Interaction_KillerPower::BBInvestigateLocation' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_KillerPower, BBPatrolLocation) == 0x00028C, "Member 'UAISkill_Interaction_KillerPower::BBPatrolLocation' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_KillerPower, EvadeActorMaxDistance) == 0x000298, "Member 'UAISkill_Interaction_KillerPower::EvadeActorMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_KillerPower, EvadeLoopPathMaxDistance) == 0x00029C, "Member 'UAISkill_Interaction_KillerPower::EvadeLoopPathMaxDistance' has a wrong offset!");
...
static_assert(sizeof(UDBDAIPerceptionComponent) == 0x000550, "Wrong size on UDBDAIPerceptionComponent");
static_assert(offsetof(UDBDAIPerceptionComponent, RangedAttackTypes) == 0x0001C8, "Member 'UDBDAIPerceptionComponent::RangedAttackTypes' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, RangedKillerAbilities) == 0x0001D8, "Member 'UDBDAIPerceptionComponent::RangedKillerAbilities' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, FastVaultKillerAbilities) == 0x0001E8, "Member 'UDBDAIPerceptionComponent::FastVaultKillerAbilities' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, AntiPalletKillerAbilities) == 0x0001F8, "Member 'UDBDAIPerceptionComponent::AntiPalletKillerAbilities' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, HostileStimulusRelevancyMaxTimeToReach) == 0x000208, "Member 'UDBDAIPerceptionComponent::HostileStimulusRelevancyMaxTimeToReach' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, HostileStimulusRelevancySpeedBonus) == 0x00020C, "Member 'UDBDAIPerceptionComponent::HostileStimulusRelevancySpeedBonus' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, FleeFromStimuliActorMaxDistance) == 0x000210, "Member 'UDBDAIPerceptionComponent::FleeFromStimuliActorMaxDistance' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, FleeFromStimuliEscapePointMaxDistance) == 0x000214, "Member 'UDBDAIPerceptionComponent::FleeFromStimuliEscapePointMaxDistance' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, UseSimulatedCameraLocationForStimulusReceiverLocation) == 0x000218, "Member 'UDBDAIPerceptionComponent::UseSimulatedCameraLocationForStimulusReceiverLocation' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, CameraOffset) == 0x00021C, "Member 'UDBDAIPerceptionComponent::CameraOffset' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, StimulusHalfFOV) == 0x000220, "Member 'UDBDAIPerceptionComponent::StimulusHalfFOV' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, OutOfChaseFullPeripheralVisionRange) == 0x000224, "Member 'UDBDAIPerceptionComponent::OutOfChaseFullPeripheralVisionRange' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, InChaseFullPeripheralVisionRange) == 0x000228, "Member 'UDBDAIPerceptionComponent::InChaseFullPeripheralVisionRange' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, _objOverridingSenses) == 0x000230, "Member 'UDBDAIPerceptionComponent::_objOverridingSenses' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, _originalSenseConfigs) == 0x000280, "Member 'UDBDAIPerceptionComponent::_originalSenseConfigs' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, _detectedHostileStimuli) == 0x000290, "Member 'UDBDAIPerceptionComponent::_detectedHostileStimuli' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, _bestDetectedHostileStimulus) == 0x0002A0, "Member 'UDBDAIPerceptionComponent::_bestDetectedHostileStimulus' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, _lastBestDetectedHostileStimulusInMemory) == 0x000388, "Member 'UDBDAIPerceptionComponent::_lastBestDetectedHostileStimulusInMemory' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, _activePhaseWalkingNoiseMaxRange) == 0x0004E0, "Member 'UDBDAIPerceptionComponent::_activePhaseWalkingNoiseMaxRange' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, ThreatDividerForNonControlledActor) == 0x000540, "Member 'UDBDAIPerceptionComponent::ThreatDividerForNonControlledActor' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, HighThreatDistanceForNonControlledActor) == 0x000544, "Member 'UDBDAIPerceptionComponent::HighThreatDistanceForNonControlledActor' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, CurrentThreatDivider) == 0x000548, "Member 'UDBDAIPerceptionComponent::CurrentThreatDivider' has a wrong offset!");
static_assert(offsetof(UDBDAIPerceptionComponent, TerrorDistanceMultiplierForNonControlledActor) == 0x00054C, "Member 'UDBDAIPerceptionComponent::TerrorDistanceMultiplierForNonControlledActor' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_SolveCondemned) == 0x000580, "Wrong size on UAISkill_FindInteractable_SolveCondemned");
static_assert(offsetof(UAISkill_FindInteractable_SolveCondemned, NearCondemnedWeight) == 0x000318, "Member 'UAISkill_FindInteractable_SolveCondemned::NearCondemnedWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveCondemned, HighCondemnedThreshold) == 0x000378, "Member 'UAISkill_FindInteractable_SolveCondemned::HighCondemnedThreshold' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveCondemned, MaxLockedCondemnThreshold) == 0x0003D8, "Member 'UAISkill_FindInteractable_SolveCondemned::MaxLockedCondemnThreshold' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveCondemned, SolveCondemnedBasicWeight) == 0x000438, "Member 'UAISkill_FindInteractable_SolveCondemned::SolveCondemnedBasicWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveCondemned, CondemnedLevelProportionalWeight) == 0x000498, "Member 'UAISkill_FindInteractable_SolveCondemned::CondemnedLevelProportionalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveCondemned, SpecialGeneratorRemainPercent) == 0x0004F8, "Member 'UAISkill_FindInteractable_SolveCondemned::SpecialGeneratorRemainPercent' has a wrong offset!");
...
static_assert(alignof(UAISkill_FindInteractable_Shortcut) == 0x000008, "Wrong alignment on UAISkill_FindInteractable_Shortcut");
static_assert(sizeof(UAISkill_FindInteractable_Shortcut) == 0x000358, "Wrong size on UAISkill_FindInteractable_Shortcut");
static_assert(offsetof(UAISkill_FindInteractable_Shortcut, BaseInteractionTime) == 0x000318, "Member 'UAISkill_FindInteractable_Shortcut::BaseInteractionTime' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Shortcut, PerMeterInteractionTime) == 0x00031C, "Member 'UAISkill_FindInteractable_Shortcut::PerMeterInteractionTime' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Shortcut, MinValidSavedTime) == 0x000320, "Member 'UAISkill_FindInteractable_Shortcut::MinValidSavedTime' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Shortcut, MinimumDistance) == 0x000324, "Member 'UAISkill_FindInteractable_Shortcut::MinimumDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Shortcut, BBShortcutInteractable) == 0x000328, "Member 'UAISkill_FindInteractable_Shortcut::BBShortcutInteractable' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_Drone) == 0x000408, "Wrong size on UAISkill_FindInteractable_Drone");
static_assert(offsetof(UAISkill_FindInteractable_Drone, BaseActiveWeight) == 0x000318, "Member 'UAISkill_FindInteractable_Drone::BaseActiveWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Drone, BaseScoutingWeight) == 0x000378, "Member 'UAISkill_FindInteractable_Drone::BaseScoutingWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Drone, ValidGoalObjectClasses) == 0x0003D8, "Member 'UAISkill_FindInteractable_Drone::ValidGoalObjectClasses' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Drone, DroneRadiusMargin) == 0x0003E8, "Member 'UAISkill_FindInteractable_Drone::DroneRadiusMargin' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Drone, DroneScoutingAutoDiscoverRange) == 0x0003EC, "Member 'UAISkill_FindInteractable_Drone::DroneScoutingAutoDiscoverRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Drone, DroneStealthAutoDiscoverRange) == 0x0003F0, "Member 'UAISkill_FindInteractable_Drone::DroneStealthAutoDiscoverRange' has a wrong offset!");
...
static_assert(sizeof(ADBDAIBTController) == 0x000A98, "Wrong size on ADBDAIBTController");
static_assert(offsetof(ADBDAIBTController, BehaviorTree) == 0x000878, "Member 'ADBDAIBTController::BehaviorTree' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, BaseSkills) == 0x000880, "Member 'ADBDAIBTController::BaseSkills' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, RoleSkills) == 0x000890, "Member 'ADBDAIBTController::RoleSkills' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, CharacterClassSkills) == 0x0008A0, "Member 'ADBDAIBTController::CharacterClassSkills' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, PerkSkills) == 0x0008B0, "Member 'ADBDAIBTController::PerkSkills' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, EventSkills) == 0x0008C0, "Member 'ADBDAIBTController::EventSkills' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, ListenToAttackEvents) == 0x0008D0, "Member 'ADBDAIBTController::ListenToAttackEvents' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _dbdPerception) == 0x0008D8, "Member 'ADBDAIBTController::_dbdPerception' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _dbdBlackboard) == 0x0008E0, "Member 'ADBDAIBTController::_dbdBlackboard' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _dbdPathFollowing) == 0x0008E8, "Member 'ADBDAIBTController::_dbdPathFollowing' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _dbdBehaviorTree) == 0x0008F0, "Member 'ADBDAIBTController::_dbdBehaviorTree' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _navMeshExplorer) == 0x0008F8, "Member 'ADBDAIBTController::_navMeshExplorer' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _aiState) == 0x000900, "Member 'ADBDAIBTController::_aiState' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _aiGoal) == 0x000908, "Member 'ADBDAIBTController::_aiGoal' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _aiPassiveCamera) == 0x000910, "Member 'ADBDAIBTController::_aiPassiveCamera' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _enemyTracker) == 0x000918, "Member 'ADBDAIBTController::_enemyTracker' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _obstacleAnalysis) == 0x000920, "Member 'ADBDAIBTController::_obstacleAnalysis' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _setDynamicSubtrees) == 0x000930, "Member 'ADBDAIBTController::_setDynamicSubtrees' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _areAISkillsInitialized) == 0x000980, "Member 'ADBDAIBTController::_areAISkillsInitialized' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _aiSkills) == 0x000988, "Member 'ADBDAIBTController::_aiSkills' has a wrong offset!");
static_assert(offsetof(ADBDAIBTController, _pausingAISkills) == 0x000998, "Member 'ADBDAIBTController::_pausingAISkills' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_TeleportInteractable) == 0x0003F0, "Wrong size on UAISkill_FindInteractable_TeleportInteractable");
static_assert(offsetof(UAISkill_FindInteractable_TeleportInteractable, GoalValidDistance) == 0x000318, "Member 'UAISkill_FindInteractable_TeleportInteractable::GoalValidDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_TeleportInteractable, TeleportFixedWeight) == 0x000378, "Member 'UAISkill_FindInteractable_TeleportInteractable::TeleportFixedWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_TeleportInteractable, CacheActorsInterval) == 0x0003D8, "Member 'UAISkill_FindInteractable_TeleportInteractable::CacheActorsInterval' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractable) == 0x000320, "Wrong size on UBTService_FindInteractable");
...
static_assert(offsetof(UBTService_FindInteractable, RejectIfAllyWithinRange) == 0x00011C, "Member 'UBTService_FindInteractable::RejectIfAllyWithinRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, IgnoreFocusFilterInEndgameCollapse) == 0x000120, "Member 'UBTService_FindInteractable::IgnoreFocusFilterInEndgameCollapse' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, ReverseKnownFilter) == 0x000121, "Member 'UBTService_FindInteractable::ReverseKnownFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, RejectIfNotInSight) == 0x000122, "Member 'UBTService_FindInteractable::RejectIfNotInSight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, IgnoreSightFilterIfDiscovered) == 0x000123, "Member 'UBTService_FindInteractable::IgnoreSightFilterIfDiscovered' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, IgnoreSightFilterIfInRange) == 0x000124, "Member 'UBTService_FindInteractable::IgnoreSightFilterIfInRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, RejectAboveRange) == 0x000128, "Member 'UBTService_FindInteractable::RejectAboveRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, IgnoreRangeFilterIfDiscovered) == 0x00012C, "Member 'UBTService_FindInteractable::IgnoreRangeFilterIfDiscovered' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, IgnoreRangeFilterIfInSight) == 0x00012D, "Member 'UBTService_FindInteractable::IgnoreRangeFilterIfInSight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, BBInteractableLocation) == 0x000130, "Member 'UBTService_FindInteractable::BBInteractableLocation' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, BBInteractableObj) == 0x000160, "Member 'UBTService_FindInteractable::BBInteractableObj' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, BBOwnerObj) == 0x000190, "Member 'UBTService_FindInteractable::BBOwnerObj' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, GoalBasicWeight) == 0x0001C0, "Member 'UBTService_FindInteractable::GoalBasicWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, GoalWeightMaxDistance) == 0x000220, "Member 'UBTService_FindInteractable::GoalWeightMaxDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, GoalWeightAtMinDistance) == 0x000280, "Member 'UBTService_FindInteractable::GoalWeightAtMinDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, WeightSkillContext) == 0x0002E0, "Member 'UBTService_FindInteractable::WeightSkillContext' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, ProjectGoalLocationToNavigationExtent) == 0x0002F0, "Member 'UBTService_FindInteractable::ProjectGoalLocationToNavigationExtent' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, _goalInteractable) == 0x000308, "Member 'UBTService_FindInteractable::_goalInteractable' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable, _aiOwner) == 0x000310, "Member 'UBTService_FindInteractable::_aiOwner' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractable_Totem) == 0x000348, "Wrong size on UBTService_FindInteractable_Totem");
...
static_assert(alignof(IAIEvadeLoopModifierInterface) == 0x000001, "Wrong alignment on IAIEvadeLoopModifierInterface");
static_assert(sizeof(IAIEvadeLoopModifierInterface) == 0x000001, "Wrong size on IAIEvadeLoopModifierInterface");
...
static_assert(sizeof(UAISkill_Strafe) == 0x0002F8, "Wrong size on UAISkill_Strafe");
...
static_assert(offsetof(UAISkill_Strafe, StrafeBackwardRange) == 0x000120, "Member 'UAISkill_Strafe::StrafeBackwardRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, StrafeFowardRange) == 0x000124, "Member 'UAISkill_Strafe::StrafeFowardRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, DodgeDirectionSweepTestStartMultiplier) == 0x000128, "Member 'UAISkill_Strafe::DodgeDirectionSweepTestStartMultiplier' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, DodgeDirectionSweepTestEndMultiplier) == 0x00012C, "Member 'UAISkill_Strafe::DodgeDirectionSweepTestEndMultiplier' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, DynamicDodgeDirectionAngleInterval) == 0x000130, "Member 'UAISkill_Strafe::DynamicDodgeDirectionAngleInterval' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, IgnoreUnderNavLinkStartRange) == 0x000134, "Member 'UAISkill_Strafe::IgnoreUnderNavLinkStartRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, PauseStrafeOnAnimation) == 0x000138, "Member 'UAISkill_Strafe::PauseStrafeOnAnimation' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, StrafeHoldInterval) == 0x000140, "Member 'UAISkill_Strafe::StrafeHoldInterval' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, StrafeHoldDeviation) == 0x0001A0, "Member 'UAISkill_Strafe::StrafeHoldDeviation' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, StrafePauseInterval) == 0x000200, "Member 'UAISkill_Strafe::StrafePauseInterval' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, StrafePauseDeviation) == 0x000260, "Member 'UAISkill_Strafe::StrafePauseDeviation' has a wrong offset!");
static_assert(offsetof(UAISkill_Strafe, BBUnsafeActionID) == 0x0002C0, "Member 'UAISkill_Strafe::BBUnsafeActionID' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindCollectable_Hatchet) == 0x000388, "Wrong size on UAISkill_FindCollectable_Hatchet");
...
static_assert(sizeof(UAISkill_FindCollectable_Trap) == 0x000388, "Wrong size on UAISkill_FindCollectable_Trap");
...
static_assert(sizeof(UAISkill_FindInteractable_CloseTelevisionNearGenerator) == 0x000558, "Wrong size on UAISkill_FindInteractable_CloseTelevisionNearGenerator");
static_assert(offsetof(UAISkill_FindInteractable_CloseTelevisionNearGenerator, MaximumCondemnedPercentToCloseTelevision) == 0x000318, "Member 'UAISkill_FindInteractable_CloseTelevisionNearGenerator::MaximumCondemnedPercentToCloseTelevision' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CloseTelevisionNearGenerator, DistanceBetweenGeneratorAndTelevisionThreshold) == 0x000378, "Member 'UAISkill_FindInteractable_CloseTelevisionNearGenerator::DistanceBetweenGeneratorAndTelevisionThreshold' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CloseTelevisionNearGenerator, BaseValue) == 0x0003D8, "Member 'UAISkill_FindInteractable_CloseTelevisionNearGenerator::BaseValue' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CloseTelevisionNearGenerator, CloseTelevisionDistanceLinearWeight) == 0x000438, "Member 'UAISkill_FindInteractable_CloseTelevisionNearGenerator::CloseTelevisionDistanceLinearWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CloseTelevisionNearGenerator, CloseTelevisionMaximumDistanceFromCamper) == 0x000498, "Member 'UAISkill_FindInteractable_CloseTelevisionNearGenerator::CloseTelevisionMaximumDistanceFromCamper' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CloseTelevisionNearGenerator, MaxHeightDifferenceToCloseTelevisions) == 0x0004F8, "Member 'UAISkill_FindInteractable_CloseTelevisionNearGenerator::MaxHeightDifferenceToCloseTelevisions' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_Invitation) == 0x000318, "Wrong size on UAISkill_FindInteractable_Invitation");
...
static_assert(sizeof(UAISkill_FindInteractable_K32ItemBox) == 0x000380, "Wrong size on UAISkill_FindInteractable_K32ItemBox");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, BBK32EmpTargetActor) == 0x000318, "Member 'UAISkill_FindInteractable_K32ItemBox::BBK32EmpTargetActor' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, BBOriginalFocusedActor) == 0x000324, "Member 'UAISkill_FindInteractable_K32ItemBox::BBOriginalFocusedActor' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, GoalClassesToGiveAdditionalWeight) == 0x000330, "Member 'UAISkill_FindInteractable_K32ItemBox::GoalClassesToGiveAdditionalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, EmpTargetNearGoalWeight) == 0x000340, "Member 'UAISkill_FindInteractable_K32ItemBox::EmpTargetNearGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, NearEmpBoxGoalWeight) == 0x000344, "Member 'UAISkill_FindInteractable_K32ItemBox::NearEmpBoxGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, NearEmpBoxDistance) == 0x000348, "Member 'UAISkill_FindInteractable_K32ItemBox::NearEmpBoxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, K32EmpMaxCount) == 0x00034C, "Member 'UAISkill_FindInteractable_K32ItemBox::K32EmpMaxCount' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K32ItemBox, K32ItemBoxChargeWeightRatio) == 0x000350, "Member 'UAISkill_FindInteractable_K32ItemBox::K32ItemBoxChargeWeightRatio' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_K33ControlStation) == 0x000498, "Wrong size on UAISkill_FindInteractable_K33ControlStation");
static_assert(offsetof(UAISkill_FindInteractable_K33ControlStation, GeneratorMaxRange) == 0x000318, "Member 'UAISkill_FindInteractable_K33ControlStation::GeneratorMaxRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K33ControlStation, TurretProximityPenaltyMaxRange) == 0x000378, "Member 'UAISkill_FindInteractable_K33ControlStation::TurretProximityPenaltyMaxRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K33ControlStation, TurretsRemainingWeightBonus) == 0x0003D8, "Member 'UAISkill_FindInteractable_K33ControlStation::TurretsRemainingWeightBonus' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K33ControlStation, TurretProximityWeightPenalty) == 0x000438, "Member 'UAISkill_FindInteractable_K33ControlStation::TurretProximityWeightPenalty' has a wrong offset!");
...
static_assert(offsetof(ANavLinkProxy_Base, StartedOnEndPointDistance) == 0x000308, "Member 'ANavLinkProxy_Base::StartedOnEndPointDistance' has a wrong offset!");
static_assert(offsetof(ANavLinkProxy_Base, DisableSmartLinkPointInverting) == 0x00030C, "Member 'ANavLinkProxy_Base::DisableSmartLinkPointInverting' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_K33Turret) == 0x000438, "Wrong size on UAISkill_FindInteractable_K33Turret");
static_assert(offsetof(UAISkill_FindInteractable_K33Turret, RedeployGeneratorMaxRange) == 0x000318, "Member 'UAISkill_FindInteractable_K33Turret::RedeployGeneratorMaxRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K33Turret, UndeployGeneratorMaxRange) == 0x000378, "Member 'UAISkill_FindInteractable_K33Turret::UndeployGeneratorMaxRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K33Turret, UndeployCharacterMaxRange) == 0x0003D8, "Member 'UAISkill_FindInteractable_K33Turret::UndeployCharacterMaxRange' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_K35Husk) == 0x0003D8, "Wrong size on UAISkill_FindInteractable_K35Husk");
static_assert(offsetof(UAISkill_FindInteractable_K35Husk, KillerToHuskWeightPenaltyAtMinDistance) == 0x000318, "Member 'UAISkill_FindInteractable_K35Husk::KillerToHuskWeightPenaltyAtMinDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_K35Husk, KillerToHuskWeightMaxDistance) == 0x000378, "Member 'UAISkill_FindInteractable_K35Husk::KillerToHuskWeightMaxDistance' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_Reassurance) == 0x000680, "Wrong size on UAISkill_FindInteractable_Reassurance");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, ReassuranceStatusEffect) == 0x000318, "Member 'UAISkill_FindInteractable_Reassurance::ReassuranceStatusEffect' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, AllyDangerStateGoalWeight) == 0x000320, "Member 'UAISkill_FindInteractable_Reassurance::AllyDangerStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, MaxHookTimeGoalWeight) == 0x000380, "Member 'UAISkill_FindInteractable_Reassurance::MaxHookTimeGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, HumanAllyHookedGoalWeight) == 0x0003E0, "Member 'UAISkill_FindInteractable_Reassurance::HumanAllyHookedGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, IdealKillerDistanceFromHook) == 0x000440, "Member 'UAISkill_FindInteractable_Reassurance::IdealKillerDistanceFromHook' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, MaxKillerProximityWeight) == 0x0004A0, "Member 'UAISkill_FindInteractable_Reassurance::MaxKillerProximityWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, BotDangerStateGoalWeight) == 0x000500, "Member 'UAISkill_FindInteractable_Reassurance::BotDangerStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, IncapacitatedAlliesGoalWeight) == 0x000560, "Member 'UAISkill_FindInteractable_Reassurance::IncapacitatedAlliesGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, BotInjuredStateGoalWeight) == 0x0005C0, "Member 'UAISkill_FindInteractable_Reassurance::BotInjuredStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Reassurance, _hookedAndNotReassuredSurvivors) == 0x000620, "Member 'UAISkill_FindInteractable_Reassurance::_hookedAndNotReassuredSurvivors' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_SeanceSpot) == 0x000A68, "Wrong size on UAISkill_FindInteractable_SeanceSpot");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, LowerExposedValueKillers) == 0x000318, "Member 'UAISkill_FindInteractable_SeanceSpot::LowerExposedValueKillers' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, DirectTeleportKillers) == 0x000328, "Member 'UAISkill_FindInteractable_SeanceSpot::DirectTeleportKillers' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, TeleportInteractables) == 0x000338, "Member 'UAISkill_FindInteractable_SeanceSpot::TeleportInteractables' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, NoMitherPerk) == 0x000348, "Member 'UAISkill_FindInteractable_SeanceSpot::NoMitherPerk' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, PerHookWeight) == 0x000358, "Member 'UAISkill_FindInteractable_SeanceSpot::PerHookWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, LowerExposedValueWeight) == 0x0003B8, "Member 'UAISkill_FindInteractable_SeanceSpot::LowerExposedValueWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, TeleportKillerWeightPenalty) == 0x000418, "Member 'UAISkill_FindInteractable_SeanceSpot::TeleportKillerWeightPenalty' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, KillerDistanceMaxWeight) == 0x000478, "Member 'UAISkill_FindInteractable_SeanceSpot::KillerDistanceMaxWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, KillerMaxDistance) == 0x0004D8, "Member 'UAISkill_FindInteractable_SeanceSpot::KillerMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, KillerInChaseWeight) == 0x000538, "Member 'UAISkill_FindInteractable_SeanceSpot::KillerInChaseWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, KillerMovingAwayWeight) == 0x000598, "Member 'UAISkill_FindInteractable_SeanceSpot::KillerMovingAwayWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, KillerMovingAwayMaxAngle) == 0x0005F8, "Member 'UAISkill_FindInteractable_SeanceSpot::KillerMovingAwayMaxAngle' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, LastSeenWeightPenalty) == 0x000658, "Member 'UAISkill_FindInteractable_SeanceSpot::LastSeenWeightPenalty' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, LastSeenMaxTime) == 0x0006B8, "Member 'UAISkill_FindInteractable_SeanceSpot::LastSeenMaxTime' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, LastVisitedWeightPenalty) == 0x000718, "Member 'UAISkill_FindInteractable_SeanceSpot::LastVisitedWeightPenalty' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, LastVisitedMaxTime) == 0x000778, "Member 'UAISkill_FindInteractable_SeanceSpot::LastVisitedMaxTime' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, JoinBaseWeight) == 0x0007D8, "Member 'UAISkill_FindInteractable_SeanceSpot::JoinBaseWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, JoinWithPerkWeight) == 0x000838, "Member 'UAISkill_FindInteractable_SeanceSpot::JoinWithPerkWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, SeanceOriginatorWeight) == 0x000898, "Member 'UAISkill_FindInteractable_SeanceSpot::SeanceOriginatorWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, RemainingGeneratorWeightBonus) == 0x0008F8, "Member 'UAISkill_FindInteractable_SeanceSpot::RemainingGeneratorWeightBonus' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, CrowSpawnerWeightBonus) == 0x000958, "Member 'UAISkill_FindInteractable_SeanceSpot::CrowSpawnerWeightBonus' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, CrowSpawnerMaxWeightBonus) == 0x0009B8, "Member 'UAISkill_FindInteractable_SeanceSpot::CrowSpawnerMaxWeightBonus' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SeanceSpot, CrowSpawnerBaselineAmount) == 0x000A18, "Member 'UAISkill_FindInteractable_SeanceSpot::CrowSpawnerBaselineAmount' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_SolveRBT) == 0x0003D8, "Wrong size on UAISkill_FindInteractable_SolveRBT");
static_assert(offsetof(UAISkill_FindInteractable_SolveRBT, UrgencyGoalWeight) == 0x000318, "Member 'UAISkill_FindInteractable_SolveRBT::UrgencyGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveRBT, PriorityGoalWeight) == 0x000378, "Member 'UAISkill_FindInteractable_SolveRBT::PriorityGoalWeight' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_SolveSickness) == 0x000438, "Wrong size on UAISkill_FindInteractable_SolveSickness");
static_assert(offsetof(UAISkill_FindInteractable_SolveSickness, BaseGoalWeight) == 0x000318, "Member 'UAISkill_FindInteractable_SolveSickness::BaseGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveSickness, UrgencyGoalWeight) == 0x000378, "Member 'UAISkill_FindInteractable_SolveSickness::UrgencyGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_SolveSickness, InteractingGoalPenaltyWeight) == 0x0003D8, "Member 'UAISkill_FindInteractable_SolveSickness::InteractingGoalPenaltyWeight' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_StatusEffect) == 0x000328, "Wrong size on UAISkill_FindInteractable_StatusEffect");
static_assert(offsetof(UAISkill_FindInteractable_StatusEffect, RequiredPerkFlag) == 0x000318, "Member 'UAISkill_FindInteractable_StatusEffect::RequiredPerkFlag' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_StatusEffect, InvertCondition) == 0x000324, "Member 'UAISkill_FindInteractable_StatusEffect::InvertCondition' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_StatusEffect_Plague) == 0x000328, "Wrong size on UAISkill_FindInteractable_StatusEffect_Plague");
...
static_assert(sizeof(UAISkill_FindInteractable_Waker) == 0x000448, "Wrong size on UAISkill_FindInteractable_Waker");
static_assert(offsetof(UAISkill_FindInteractable_Waker, FixedGoalWeight) == 0x000318, "Member 'UAISkill_FindInteractable_Waker::FixedGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Waker, FixedGoalWeightMaxRange) == 0x000378, "Member 'UAISkill_FindInteractable_Waker::FixedGoalWeightMaxRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Waker, BonusAttentionGoalWeight) == 0x0003D8, "Member 'UAISkill_FindInteractable_Waker::BonusAttentionGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_Waker, WakerTargetBBKey) == 0x000438, "Member 'UAISkill_FindInteractable_Waker::WakerTargetBBKey' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Find_StrengthInShadows) == 0x000420, "Wrong size on UAISkill_Find_StrengthInShadows");
static_assert(offsetof(UAISkill_Find_StrengthInShadows, KillerDistanceMaxWeightPenalty) == 0x000300, "Member 'UAISkill_Find_StrengthInShadows::KillerDistanceMaxWeightPenalty' has a wrong offset!");
static_assert(offsetof(UAISkill_Find_StrengthInShadows, KillerMaxDistance) == 0x000360, "Member 'UAISkill_Find_StrengthInShadows::KillerMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Find_StrengthInShadows, BasementVerticalOffset) == 0x0003C0, "Member 'UAISkill_Find_StrengthInShadows::BasementVerticalOffset' has a wrong offset!");
...
static_assert(sizeof(UAISkill_InteractionTarget_LungeAttack) == 0x000370, "Wrong size on UAISkill_InteractionTarget_LungeAttack");
...
static_assert(offsetof(UAISkill_InteractionTarget_LungeAttack, AttackTypes) == 0x000350, "Member 'UAISkill_InteractionTarget_LungeAttack::AttackTypes' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionTarget_LungeAttack, ExceptionStateTags) == 0x000360, "Member 'UAISkill_InteractionTarget_LungeAttack::ExceptionStateTags' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindGoalObject) == 0x000438, "Wrong size on UBTService_FindGoalObject");
...
static_assert(offsetof(UBTService_FindGoalObject, WeightSkillContext) == 0x000310, "Member 'UBTService_FindGoalObject::WeightSkillContext' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, IsUnsafeAction) == 0x00031C, "Member 'UBTService_FindGoalObject::IsUnsafeAction' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, BBUnsafeActionID) == 0x000320, "Member 'UBTService_FindGoalObject::BBUnsafeActionID' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, BBUnsafeActionUsesItemAddons) == 0x000350, "Member 'UBTService_FindGoalObject::BBUnsafeActionUsesItemAddons' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, BBUnsafeActionIsSelfInteraction) == 0x000380, "Member 'UBTService_FindGoalObject::BBUnsafeActionIsSelfInteraction' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, BBUnsafeActionRange) == 0x0003B0, "Member 'UBTService_FindGoalObject::BBUnsafeActionRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, UnsafeInteractionID) == 0x0003E0, "Member 'UBTService_FindGoalObject::UnsafeInteractionID' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, UnsafeActionUsesItemAddons) == 0x0003F0, "Member 'UBTService_FindGoalObject::UnsafeActionUsesItemAddons' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, UnsafeActionIsSelfInteraction) == 0x0003F1, "Member 'UBTService_FindGoalObject::UnsafeActionIsSelfInteraction' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, UnsafeActionRange) == 0x0003F4, "Member 'UBTService_FindGoalObject::UnsafeActionRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, ProjectGoalLocationToNavigationExtent) == 0x0003F8, "Member 'UBTService_FindGoalObject::ProjectGoalLocationToNavigationExtent' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, CanInterruptDuringSkillCheck) == 0x000410, "Member 'UBTService_FindGoalObject::CanInterruptDuringSkillCheck' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, _aiOwner) == 0x000418, "Member 'UBTService_FindGoalObject::_aiOwner' has a wrong offset!");
static_assert(offsetof(UBTService_FindGoalObject, shouldHideBBKeysInEditor) == 0x000430, "Member 'UBTService_FindGoalObject::shouldHideBBKeysInEditor' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindActor) == 0x000450, "Wrong size on UBTService_FindActor");
static_assert(offsetof(UBTService_FindActor, ActorLocationOffset) == 0x000438, "Member 'UBTService_FindActor::ActorLocationOffset' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindActor_WishList) == 0x000468, "Wrong size on UBTService_FindActor_WishList");
static_assert(offsetof(UBTService_FindActor_WishList, WishListTag) == 0x000450, "Member 'UBTService_FindActor_WishList::WishListTag' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor) == 0x000660, "Wrong size on UBTService_FindInteractor");
static_assert(offsetof(UBTService_FindInteractor, RegisterAsDiscoveredWhenFound) == 0x000438, "Member 'UBTService_FindInteractor::RegisterAsDiscoveredWhenFound' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, BBOnlyFromActor) == 0x000440, "Member 'UBTService_FindInteractor::BBOnlyFromActor' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, OnlyWithInteractorIDs) == 0x000470, "Member 'UBTService_FindInteractor::OnlyWithInteractorIDs' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfTerrorIsCloserThanSelfMargin) == 0x000480, "Member 'UBTService_FindInteractor::RejectIfTerrorIsCloserThanSelfMargin' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfInTerrorRadius) == 0x000484, "Member 'UBTService_FindInteractor::RejectIfInTerrorRadius' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfInPressureZone) == 0x000488, "Member 'UBTService_FindInteractor::RejectIfInPressureZone' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, UseLastKnownPositionForTerrorRejects) == 0x000489, "Member 'UBTService_FindInteractor::UseLastKnownPositionForTerrorRejects' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfWasInCooldownAndFocusedOnAnotherObject) == 0x00048A, "Member 'UBTService_FindInteractor::RejectIfWasInCooldownAndFocusedOnAnotherObject' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectCooldownContextName) == 0x00048C, "Member 'UBTService_FindInteractor::RejectCooldownContextName' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, IgnoreMindFocusCooldown) == 0x000498, "Member 'UBTService_FindInteractor::IgnoreMindFocusCooldown' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfAnySiblingInteractorHasCooldown) == 0x000499, "Member 'UBTService_FindInteractor::RejectIfAnySiblingInteractorHasCooldown' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, AbandonIfInChase) == 0x00049A, "Member 'UBTService_FindInteractor::AbandonIfInChase' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfFocusedByOther) == 0x00049B, "Member 'UBTService_FindInteractor::RejectIfFocusedByOther' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfFocusedByOtherMargin) == 0x00049C, "Member 'UBTService_FindInteractor::RejectIfFocusedByOtherMargin' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfInteractableFocusedByOther) == 0x0004A0, "Member 'UBTService_FindInteractor::RejectIfInteractableFocusedByOther' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfAllyWithinRange) == 0x0004A4, "Member 'UBTService_FindInteractor::RejectIfAllyWithinRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfNotFocusedBySelf) == 0x0004A8, "Member 'UBTService_FindInteractor::RejectIfNotFocusedBySelf' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, IgnoreFocusFilterInEndgameCollapse) == 0x0004A9, "Member 'UBTService_FindInteractor::IgnoreFocusFilterInEndgameCollapse' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectIfNotInSight) == 0x0004AA, "Member 'UBTService_FindInteractor::RejectIfNotInSight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, IgnoreSightFilterIfDiscovered) == 0x0004AB, "Member 'UBTService_FindInteractor::IgnoreSightFilterIfDiscovered' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, IgnoreSightFilterIfInRange) == 0x0004AC, "Member 'UBTService_FindInteractor::IgnoreSightFilterIfInRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, RejectAboveRange) == 0x0004B0, "Member 'UBTService_FindInteractor::RejectAboveRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, IgnoreRangeFilterIfDiscovered) == 0x0004B4, "Member 'UBTService_FindInteractor::IgnoreRangeFilterIfDiscovered' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, IgnoreRangeFilterIfInSight) == 0x0004B5, "Member 'UBTService_FindInteractor::IgnoreRangeFilterIfInSight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, BBInteractLocation) == 0x0004B8, "Member 'UBTService_FindInteractor::BBInteractLocation' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, BBInteractorObj) == 0x0004E8, "Member 'UBTService_FindInteractor::BBInteractorObj' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, UsesActorLocation) == 0x000518, "Member 'UBTService_FindInteractor::UsesActorLocation' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, CantInterruptGoalInteractionUnderRemainingTime) == 0x000520, "Member 'UBTService_FindInteractor::CantInterruptGoalInteractionUnderRemainingTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, GoalWeightBonusWhileInteracting) == 0x000580, "Member 'UBTService_FindInteractor::GoalWeightBonusWhileInteracting' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, InteractionSpeedStatusEffectID) == 0x0005E0, "Member 'UBTService_FindInteractor::InteractionSpeedStatusEffectID' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, GoalWeightInteractionSpeedVariance) == 0x0005F0, "Member 'UBTService_FindInteractor::GoalWeightInteractionSpeedVariance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor, _goalInteractor) == 0x000650, "Member 'UBTService_FindInteractor::_goalInteractor' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Generator) == 0x000800, "Wrong size on UBTService_FindInteractor_Generator");
static_assert(offsetof(UBTService_FindInteractor_Generator, StatusFilter) == 0x000660, "Member 'UBTService_FindInteractor_Generator::StatusFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Generator, MinRepairRatioFilter) == 0x000668, "Member 'UBTService_FindInteractor_Generator::MinRepairRatioFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Generator, UsePerceptionToGetRepairRatio) == 0x0006C8, "Member 'UBTService_FindInteractor_Generator::UsePerceptionToGetRepairRatio' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Generator, MaxRepairGoalWeight) == 0x0006D0, "Member 'UBTService_FindInteractor_Generator::MaxRepairGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Generator, InfectedStateGoalWeight) == 0x000730, "Member 'UBTService_FindInteractor_Generator::InfectedStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Generator, HexRuinGoalWeight) == 0x000790, "Member 'UBTService_FindInteractor_Generator::HexRuinGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Generator, HexRuinPerkId) == 0x0007F0, "Member 'UBTService_FindInteractor_Generator::HexRuinPerkId' has a wrong offset!");
...
static_assert(sizeof(UDBDAIEnemyTrackerComponent) == 0x0001C8, "Wrong size on UDBDAIEnemyTrackerComponent");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, EnemyTracker) == 0x0000B8, "Member 'UDBDAIEnemyTrackerComponent::EnemyTracker' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, EnemyTargetPrediction) == 0x0000C0, "Member 'UDBDAIEnemyTrackerComponent::EnemyTargetPrediction' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, DataUpdateInterval) == 0x0000C8, "Member 'UDBDAIEnemyTrackerComponent::DataUpdateInterval' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, TargetPredictionUpdateInterval) == 0x0000CC, "Member 'UDBDAIEnemyTrackerComponent::TargetPredictionUpdateInterval' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, IndirectUpdateDelay) == 0x0000D0, "Member 'UDBDAIEnemyTrackerComponent::IndirectUpdateDelay' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, PotentialTargetedLocationRange) == 0x0000D8, "Member 'UDBDAIEnemyTrackerComponent::PotentialTargetedLocationRange' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, BaseKnownInfoExpirationTime) == 0x000138, "Member 'UDBDAIEnemyTrackerComponent::BaseKnownInfoExpirationTime' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, DistanceInfoExpirationTime) == 0x00013C, "Member 'UDBDAIEnemyTrackerComponent::DistanceInfoExpirationTime' has a wrong offset!");
static_assert(offsetof(UDBDAIEnemyTrackerComponent, _trackedEnemiesData) == 0x000168, "Member 'UDBDAIEnemyTrackerComponent::_trackedEnemiesData' has a wrong offset!");
...
static_assert(sizeof(UAISkill_InteractionUseItem_Flashlight) == 0x0003B0, "Wrong size on UAISkill_InteractionUseItem_Flashlight");
...
static_assert(offsetof(UAISkill_InteractionUseItem_Flashlight, ValidKillerInteractionIDs) == 0x000360, "Member 'UAISkill_InteractionUseItem_Flashlight::ValidKillerInteractionIDs' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionUseItem_Flashlight, _targetActor) == 0x000370, "Member 'UAISkill_InteractionUseItem_Flashlight::_targetActor' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Trap) == 0x0007A0, "Wrong size on UBTService_FindInteractor_Trap");
static_assert(offsetof(UBTService_FindInteractor_Trap, HelpDestroyDemoPortal) == 0x000660, "Member 'UBTService_FindInteractor_Trap::HelpDestroyDemoPortal' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Trap, SeeStandardTrapRoll) == 0x0006C0, "Member 'UBTService_FindInteractor_Trap::SeeStandardTrapRoll' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Trap, TrapGroundLocationOffset) == 0x000788, "Member 'UBTService_FindInteractor_Trap::TrapGroundLocationOffset' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Trap, InteractableOnlyWithInteractionId) == 0x000790, "Member 'UBTService_FindInteractor_Trap::InteractableOnlyWithInteractionId' has a wrong offset!");
...
static_assert(alignof(UAISkill_InteractionUseItem_SmokeBomb) == 0x000008, "Wrong alignment on UAISkill_InteractionUseItem_SmokeBomb");
static_assert(sizeof(UAISkill_InteractionUseItem_SmokeBomb) == 0x0002B8, "Wrong size on UAISkill_InteractionUseItem_SmokeBomb");
static_assert(offsetof(UAISkill_InteractionUseItem_SmokeBomb, MinDistance) == 0x000290, "Member 'UAISkill_InteractionUseItem_SmokeBomb::MinDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionUseItem_SmokeBomb, MeleeMaxDistance) == 0x000294, "Member 'UAISkill_InteractionUseItem_SmokeBomb::MeleeMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionUseItem_SmokeBomb, RangedMaxDistance) == 0x000298, "Member 'UAISkill_InteractionUseItem_SmokeBomb::RangedMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionUseItem_SmokeBomb, SmokeBombRerollTime) == 0x00029C, "Member 'UAISkill_InteractionUseItem_SmokeBomb::SmokeBombRerollTime' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionUseItem_SmokeBomb, IgnoreSpecialAttacks) == 0x0002A0, "Member 'UAISkill_InteractionUseItem_SmokeBomb::IgnoreSpecialAttacks' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Camper) == 0x0009F0, "Wrong size on UBTService_FindInteractor_Camper");
static_assert(offsetof(UBTService_FindInteractor_Camper, StatusFilter) == 0x000660, "Member 'UBTService_FindInteractor_Camper::StatusFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, IgnoreWhenTargetStatusEffects) == 0x000668, "Member 'UBTService_FindInteractor_Camper::IgnoreWhenTargetStatusEffects' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, RequiredAttentionMovementFrequency) == 0x000678, "Member 'UBTService_FindInteractor_Camper::RequiredAttentionMovementFrequency' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AttentionMovementFrequencyLerp) == 0x00067C, "Member 'UBTService_FindInteractor_Camper::AttentionMovementFrequencyLerp' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AttentionValidTime) == 0x000680, "Member 'UBTService_FindInteractor_Camper::AttentionValidTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AttentionExtensionTime) == 0x000684, "Member 'UBTService_FindInteractor_Camper::AttentionExtensionTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AttentionValidDistance) == 0x000688, "Member 'UBTService_FindInteractor_Camper::AttentionValidDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AttentionCooldownReduction) == 0x00068C, "Member 'UBTService_FindInteractor_Camper::AttentionCooldownReduction' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AnnoyanceFollowIncreasePercent) == 0x000690, "Member 'UBTService_FindInteractor_Camper::AnnoyanceFollowIncreasePercent' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AnnoyanceFollowDistance) == 0x000694, "Member 'UBTService_FindInteractor_Camper::AnnoyanceFollowDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AnnoyanceBaseDecayPercent) == 0x000698, "Member 'UBTService_FindInteractor_Camper::AnnoyanceBaseDecayPercent' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AnnoyanceDecayInAttentionPercent) == 0x00069C, "Member 'UBTService_FindInteractor_Camper::AnnoyanceDecayInAttentionPercent' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, MinimumCooldownAnnoyanceValue) == 0x0006A0, "Member 'UBTService_FindInteractor_Camper::MinimumCooldownAnnoyanceValue' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AvoidAttentionTime) == 0x0006A4, "Member 'UBTService_FindInteractor_Camper::AvoidAttentionTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AllyDangerStateGoalWeight) == 0x0006A8, "Member 'UBTService_FindInteractor_Camper::AllyDangerStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, IncapacitatedAlliesGoalWeight) == 0x000708, "Member 'UBTService_FindInteractor_Camper::IncapacitatedAlliesGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, CrawlingRecoveryProgressGoalWeight) == 0x000768, "Member 'UBTService_FindInteractor_Camper::CrawlingRecoveryProgressGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, CrawlingDeathTimerGoalWeight) == 0x0007C8, "Member 'UBTService_FindInteractor_Camper::CrawlingDeathTimerGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, IdealKillerDistanceFromCrawling) == 0x000828, "Member 'UBTService_FindInteractor_Camper::IdealKillerDistanceFromCrawling' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, MaxKillerProximityWeight) == 0x000888, "Member 'UBTService_FindInteractor_Camper::MaxKillerProximityWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Camper, AttentionWeight) == 0x0008E8, "Member 'UBTService_FindInteractor_Camper::AttentionWeight' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_Blink) == 0x000400, "Wrong size on UAISkill_Interaction_Blink");
static_assert(offsetof(UAISkill_Interaction_Blink, MinimumPatrolBlinkRange) == 0x0002A0, "Member 'UAISkill_Interaction_Blink::MinimumPatrolBlinkRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, MaximumChaseSingleBlinkRange) == 0x0002A4, "Member 'UAISkill_Interaction_Blink::MaximumChaseSingleBlinkRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, MinimumBlinkRange) == 0x0002A8, "Member 'UAISkill_Interaction_Blink::MinimumBlinkRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, MaximumConsecutiveBlinkRange) == 0x0002AC, "Member 'UAISkill_Interaction_Blink::MaximumConsecutiveBlinkRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, PostBlinkMaxChargeTime) == 0x0002B0, "Member 'UAISkill_Interaction_Blink::PostBlinkMaxChargeTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, VerticalDistanceMultiplier) == 0x0002B4, "Member 'UAISkill_Interaction_Blink::VerticalDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, MaxBlinkTargetVerticalDistance) == 0x0002B8, "Member 'UAISkill_Interaction_Blink::MaxBlinkTargetVerticalDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, MaxBlinkDistanceInaccuracy) == 0x0002C0, "Member 'UAISkill_Interaction_Blink::MaxBlinkDistanceInaccuracy' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, BlinkDistanceInaccuracyMaxDistance) == 0x000320, "Member 'UAISkill_Interaction_Blink::BlinkDistanceInaccuracyMaxDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, BlinkVerticalOffset) == 0x000380, "Member 'UAISkill_Interaction_Blink::BlinkVerticalOffset' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, BBBlinkDestination) == 0x000384, "Member 'UAISkill_Interaction_Blink::BBBlinkDestination' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Blink, _nurseBot) == 0x0003C8, "Member 'UAISkill_Interaction_Blink::_nurseBot' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Searchable) == 0x0006E0, "Wrong size on UBTService_FindInteractor_Searchable");
static_assert(offsetof(UBTService_FindInteractor_Searchable, WantToKeepEmptyItemPenalty) == 0x000660, "Member 'UBTService_FindInteractor_Searchable::WantToKeepEmptyItemPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Searchable, GoalPerkWeight) == 0x0006C0, "Member 'UBTService_FindInteractor_Searchable::GoalPerkWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Searchable, CanSearchWhileHoldingItemConditions) == 0x0006D0, "Member 'UBTService_FindInteractor_Searchable::CanSearchWhileHoldingItemConditions' has a wrong offset!");
...
static_assert(sizeof(UBTTask_ExtMoveTo) == 0x000268, "Wrong size on UBTTask_ExtMoveTo");
...
static_assert(offsetof(UBTTask_ExtMoveTo, StrafeVerticalOffset) == 0x000110, "Member 'UBTTask_ExtMoveTo::StrafeVerticalOffset' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, ToGoalMovementMode) == 0x000114, "Member 'UBTTask_ExtMoveTo::ToGoalMovementMode' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, NearGoalMovementMode) == 0x000115, "Member 'UBTTask_ExtMoveTo::NearGoalMovementMode' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, DefaultNavLinkMovementMode) == 0x000116, "Member 'UBTTask_ExtMoveTo::DefaultNavLinkMovementMode' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, NearGoalModeUnderDistance) == 0x000118, "Member 'UBTTask_ExtMoveTo::NearGoalModeUnderDistance' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, NormalMoveUnderNavLinkDistance) == 0x00011C, "Member 'UBTTask_ExtMoveTo::NormalMoveUnderNavLinkDistance' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, BBIgnoreGroupAvoidance) == 0x000120, "Member 'UBTTask_ExtMoveTo::BBIgnoreGroupAvoidance' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, BlockedCheckInterval) == 0x000150, "Member 'UBTTask_ExtMoveTo::BlockedCheckInterval' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, BlockedContinueTimes) == 0x000154, "Member 'UBTTask_ExtMoveTo::BlockedContinueTimes' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, BlockedSpeedPercent) == 0x000158, "Member 'UBTTask_ExtMoveTo::BlockedSpeedPercent' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, MaxTriesToRepathAroundBlocker) == 0x00015C, "Member 'UBTTask_ExtMoveTo::MaxTriesToRepathAroundBlocker' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, MovementModesNearActors) == 0x000160, "Member 'UBTTask_ExtMoveTo::MovementModesNearActors' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, RepathInterval) == 0x000170, "Member 'UBTTask_ExtMoveTo::RepathInterval' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, UseAccelerationForPaths) == 0x000174, "Member 'UBTTask_ExtMoveTo::UseAccelerationForPaths' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, PathReachedPointRadius) == 0x000178, "Member 'UBTTask_ExtMoveTo::PathReachedPointRadius' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, NearPathFilterRadius) == 0x00017C, "Member 'UBTTask_ExtMoveTo::NearPathFilterRadius' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, UseContextualAcceptableRadius) == 0x000180, "Member 'UBTTask_ExtMoveTo::UseContextualAcceptableRadius' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, RequiresPreciseMovement) == 0x00018C, "Member 'UBTTask_ExtMoveTo::RequiresPreciseMovement' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, NeverFinish) == 0x00018D, "Member 'UBTTask_ExtMoveTo::NeverFinish' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, FindRelevantDangerInterval) == 0x000190, "Member 'UBTTask_ExtMoveTo::FindRelevantDangerInterval' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, UpdateTraverseStatesInterval) == 0x000194, "Member 'UBTTask_ExtMoveTo::UpdateTraverseStatesInterval' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, FailTaskOnUndodgeableDangerObject) == 0x000198, "Member 'UBTTask_ExtMoveTo::FailTaskOnUndodgeableDangerObject' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, IgnoreDangerObjects) == 0x000199, "Member 'UBTTask_ExtMoveTo::IgnoreDangerObjects' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, MinimumDangerTraversePriority) == 0x00019A, "Member 'UBTTask_ExtMoveTo::MinimumDangerTraversePriority' has a wrong offset!");
static_assert(offsetof(UBTTask_ExtMoveTo, _seenActorsMap) == 0x0001C0, "Member 'UBTTask_ExtMoveTo::_seenActorsMap' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_CleanBreak) == 0x000008, "Wrong alignment on UAISkill_Interaction_CleanBreak");
static_assert(sizeof(UAISkill_Interaction_CleanBreak) == 0x000288, "Wrong size on UAISkill_Interaction_CleanBreak");
static_assert(offsetof(UAISkill_Interaction_CleanBreak, MaxHealthPercentToUse) == 0x000280, "Member 'UAISkill_Interaction_CleanBreak::MaxHealthPercentToUse' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_Cloak) == 0x0002B8, "Wrong size on UAISkill_Interaction_Cloak");
static_assert(offsetof(UAISkill_Interaction_Cloak, StartUncloakDistance) == 0x0002A0, "Member 'UAISkill_Interaction_Cloak::StartUncloakDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Cloak, StopUncloakDistance) == 0x0002A4, "Member 'UAISkill_Interaction_Cloak::StopUncloakDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Cloak, StartUncloakForPickupDistance) == 0x0002A8, "Member 'UAISkill_Interaction_Cloak::StartUncloakForPickupDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Cloak, BBDyingSurvivorLocation) == 0x0002AC, "Member 'UAISkill_Interaction_Cloak::BBDyingSurvivorLocation' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_DismissAttachedObject) == 0x000008, "Wrong alignment on UAISkill_Interaction_DismissAttachedObject");
static_assert(sizeof(UAISkill_Interaction_DismissAttachedObject) == 0x000290, "Wrong size on UAISkill_Interaction_DismissAttachedObject");
static_assert(offsetof(UAISkill_Interaction_DismissAttachedObject, BBShouldFallPallet) == 0x000280, "Member 'UAISkill_Interaction_DismissAttachedObject::BBShouldFallPallet' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_DismissAttachedObject, StopAtPalletDistance) == 0x00028C, "Member 'UAISkill_Interaction_DismissAttachedObject::StopAtPalletDistance' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_Heal) == 0x000008, "Wrong alignment on UAISkill_Interaction_Heal");
static_assert(sizeof(UAISkill_Interaction_Heal) == 0x0002B0, "Wrong size on UAISkill_Interaction_Heal");
static_assert(offsetof(UAISkill_Interaction_Heal, SemanticTags) == 0x000280, "Member 'UAISkill_Interaction_Heal::SemanticTags' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Heal, UseItemAddon) == 0x0002A0, "Member 'UAISkill_Interaction_Heal::UseItemAddon' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_Heal, WakerTargetBBKey) == 0x0002A4, "Member 'UAISkill_Interaction_Heal::WakerTargetBBKey' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_InLocker) == 0x0002E0, "Wrong size on UAISkill_Interaction_InLocker");
...
static_assert(offsetof(UAISkill_Interaction_InLocker, BBInLockerSkillsContext) == 0x0002BC, "Member 'UAISkill_Interaction_InLocker::BBInLockerSkillsContext' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_InLocker, InitialRunningTime) == 0x0002C8, "Member 'UAISkill_Interaction_InLocker::InitialRunningTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_InLocker, StartRefreshingTime) == 0x0002CC, "Member 'UAISkill_Interaction_InLocker::StartRefreshingTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_InLocker, RefreshTimeMargin) == 0x0002D0, "Member 'UAISkill_Interaction_InLocker::RefreshTimeMargin' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_InLocker, RefreshTimeAmount) == 0x0002D4, "Member 'UAISkill_Interaction_InLocker::RefreshTimeAmount' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_InLocker_BuiltToLast) == 0x0002E0, "Wrong size on UAISkill_Interaction_InLocker_BuiltToLast");
...
static_assert(sizeof(UAISkill_Interaction_InLocker_Flashbang) == 0x0002E0, "Wrong size on UAISkill_Interaction_InLocker_Flashbang");
...
static_assert(sizeof(UAISkill_Interaction_InLocker_HeadOn) == 0x000340, "Wrong size on UAISkill_Interaction_InLocker_HeadOn");
static_assert(offsetof(UAISkill_Interaction_InLocker_HeadOn, MaxKillerNearbyDistance) == 0x0002E0, "Member 'UAISkill_Interaction_InLocker_HeadOn::MaxKillerNearbyDistance' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_InLocker_InnerHealing) == 0x0002E0, "Wrong size on UAISkill_Interaction_InLocker_InnerHealing");
...
static_assert(sizeof(UBTService_Patrol_Discovery) == 0x0001A8, "Wrong size on UBTService_Patrol_Discovery");
...
static_assert(offsetof(UBTService_Patrol_Discovery, BlockedPositionLerp) == 0x000174, "Member 'UBTService_Patrol_Discovery::BlockedPositionLerp' has a wrong offset!");
static_assert(offsetof(UBTService_Patrol_Discovery, BlockedPositionMaxDistance) == 0x000178, "Member 'UBTService_Patrol_Discovery::BlockedPositionMaxDistance' has a wrong offset!");
static_assert(offsetof(UBTService_Patrol_Discovery, BlockedPositionMinTime) == 0x00017C, "Member 'UBTService_Patrol_Discovery::BlockedPositionMinTime' has a wrong offset!");
static_assert(offsetof(UBTService_Patrol_Discovery, ForcedAwayPatrolPointDistance) == 0x000180, "Member 'UBTService_Patrol_Discovery::ForcedAwayPatrolPointDistance' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_ShoulderTheBurden) == 0x000008, "Wrong alignment on UAISkill_Interaction_ShoulderTheBurden");
static_assert(sizeof(UAISkill_Interaction_ShoulderTheBurden) == 0x000288, "Wrong size on UAISkill_Interaction_ShoulderTheBurden");
static_assert(offsetof(UAISkill_Interaction_ShoulderTheBurden, RequiredHookStageDifference) == 0x000280, "Member 'UAISkill_Interaction_ShoulderTheBurden::RequiredHookStageDifference' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_MeatHook) == 0x000AC0, "Wrong size on UBTService_FindInteractor_MeatHook");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, StatusFilter) == 0x000660, "Member 'UBTService_FindInteractor_MeatHook::StatusFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, KeepInteractionValidForTime) == 0x000664, "Member 'UBTService_FindInteractor_MeatHook::KeepInteractionValidForTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, AllyDangerStateGoalWeight) == 0x000668, "Member 'UBTService_FindInteractor_MeatHook::AllyDangerStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, BotDangerStateGoalWeight) == 0x0006C8, "Member 'UBTService_FindInteractor_MeatHook::BotDangerStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, BotInjuredStateGoalWeight) == 0x000728, "Member 'UBTService_FindInteractor_MeatHook::BotInjuredStateGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, HumanAllyHookedGoalWeight) == 0x000788, "Member 'UBTService_FindInteractor_MeatHook::HumanAllyHookedGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, MaxHookTimeGoalWeight) == 0x0007E8, "Member 'UBTService_FindInteractor_MeatHook::MaxHookTimeGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, IncapacitatedAlliesGoalWeight) == 0x000848, "Member 'UBTService_FindInteractor_MeatHook::IncapacitatedAlliesGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, IdealKillerDistanceFromHook) == 0x0008A8, "Member 'UBTService_FindInteractor_MeatHook::IdealKillerDistanceFromHook' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, MaxKillerProximityWeight) == 0x000908, "Member 'UBTService_FindInteractor_MeatHook::MaxKillerProximityWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, SabotageKillerDistanceToHookScore) == 0x000968, "Member 'UBTService_FindInteractor_MeatHook::SabotageKillerDistanceToHookScore' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, SabotageKillerSpeedToHookScore) == 0x0009C8, "Member 'UBTService_FindInteractor_MeatHook::SabotageKillerSpeedToHookScore' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, SabotageHookValidTargetTime) == 0x000A28, "Member 'UBTService_FindInteractor_MeatHook::SabotageHookValidTargetTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, KillerTargetUpdateInterval) == 0x000A88, "Member 'UBTService_FindInteractor_MeatHook::KillerTargetUpdateInterval' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, UnsafeSabotageHealthyMarginTime) == 0x000A8C, "Member 'UBTService_FindInteractor_MeatHook::UnsafeSabotageHealthyMarginTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, UnsafeSabotageInjuredMarginTime) == 0x000A90, "Member 'UBTService_FindInteractor_MeatHook::UnsafeSabotageInjuredMarginTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, NoToolboxInteractionID) == 0x000A98, "Member 'UBTService_FindInteractor_MeatHook::NoToolboxInteractionID' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_MeatHook, UnsafeCommitDistance) == 0x000AA8, "Member 'UBTService_FindInteractor_MeatHook::UnsafeCommitDistance' has a wrong offset!");
...
static_assert(alignof(UAISkill_RespectPallet) == 0x000008, "Wrong alignment on UAISkill_RespectPallet");
static_assert(sizeof(UAISkill_RespectPallet) == 0x0001A8, "Wrong size on UAISkill_RespectPallet");
static_assert(offsetof(UAISkill_RespectPallet, ValidPalletRange) == 0x000118, "Member 'UAISkill_RespectPallet::ValidPalletRange' has a wrong offset!");
static_assert(offsetof(UAISkill_RespectPallet, SafeRangeFromPallet) == 0x00011C, "Member 'UAISkill_RespectPallet::SafeRangeFromPallet' has a wrong offset!");
static_assert(offsetof(UAISkill_RespectPallet, CommitUnderRangeFromPallet) == 0x000120, "Member 'UAISkill_RespectPallet::CommitUnderRangeFromPallet' has a wrong offset!");
static_assert(offsetof(UAISkill_RespectPallet, MaxSurvivorRange) == 0x000124, "Member 'UAISkill_RespectPallet::MaxSurvivorRange' has a wrong offset!");
static_assert(offsetof(UAISkill_RespectPallet, BBRespectPalletChanceOverride) == 0x000128, "Member 'UAISkill_RespectPallet::BBRespectPalletChanceOverride' has a wrong offset!");
static_assert(offsetof(UAISkill_RespectPallet, RespectRerollTime) == 0x000134, "Member 'UAISkill_RespectPallet::RespectRerollTime' has a wrong offset!");
static_assert(offsetof(UAISkill_RespectPallet, RespectPalletChance) == 0x000138, "Member 'UAISkill_RespectPallet::RespectPalletChance' has a wrong offset!");
...
static_assert(alignof(UAISkill_Reveal) == 0x000008, "Wrong alignment on UAISkill_Reveal");
static_assert(sizeof(UAISkill_Reveal) == 0x000138, "Wrong size on UAISkill_Reveal");
static_assert(offsetof(UAISkill_Reveal, KillerStateTags) == 0x000118, "Member 'UAISkill_Reveal::KillerStateTags' has a wrong offset!");
static_assert(offsetof(UAISkill_Reveal, SurvivorStateTags) == 0x000128, "Member 'UAISkill_Reveal::SurvivorStateTags' has a wrong offset!");
...
static_assert(alignof(UAISkill_Stealth) == 0x000008, "Wrong alignment on UAISkill_Stealth");
static_assert(sizeof(UAISkill_Stealth) == 0x000120, "Wrong size on UAISkill_Stealth");
static_assert(offsetof(UAISkill_Stealth, StealthUnderTerrorSize) == 0x000118, "Member 'UAISkill_Stealth::StealthUnderTerrorSize' has a wrong offset!");
...
static_assert(sizeof(UAISkill_StrafeChained) == 0x0002F8, "Wrong size on UAISkill_StrafeChained");
...
static_assert(sizeof(UAISkill_StrafeDodge) == 0x0003C0, "Wrong size on UAISkill_StrafeDodge");
static_assert(offsetof(UAISkill_StrafeDodge, StartRoll) == 0x0002F8, "Member 'UAISkill_StrafeDodge::StartRoll' has a wrong offset!");
...
static_assert(alignof(UBTService_EnablePostPathMovement) == 0x000008, "Wrong alignment on UBTService_EnablePostPathMovement");
static_assert(sizeof(UBTService_EnablePostPathMovement) == 0x000078, "Wrong size on UBTService_EnablePostPathMovement");
...
static_assert(sizeof(UBTService_FindFootsteps) == 0x0004C0, "Wrong size on UBTService_FindFootsteps");
static_assert(offsetof(UBTService_FindFootsteps, InChaseMultiplier) == 0x000438, "Member 'UBTService_FindFootsteps::InChaseMultiplier' has a wrong offset!");
static_assert(offsetof(UBTService_FindFootsteps, FootstepSeenMinWeight) == 0x00043C, "Member 'UBTService_FindFootsteps::FootstepSeenMinWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindFootsteps, AcceptableRadius) == 0x000440, "Member 'UBTService_FindFootsteps::AcceptableRadius' has a wrong offset!");
static_assert(offsetof(UBTService_FindFootsteps, ActiveTimeWeightPenalty) == 0x000448, "Member 'UBTService_FindFootsteps::ActiveTimeWeightPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindFootsteps, NavMeshProjectionBoxExtent) == 0x0004A8, "Member 'UBTService_FindFootsteps::NavMeshProjectionBoxExtent' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractable_EnemySurvivor) == 0x0009F8, "Wrong size on UBTService_FindInteractable_EnemySurvivor");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, PurposeFilter) == 0x000320, "Member 'UBTService_FindInteractable_EnemySurvivor::PurposeFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, LastSeenMaximumTime) == 0x000328, "Member 'UBTService_FindInteractable_EnemySurvivor::LastSeenMaximumTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, EstimatedLocationMaxRange) == 0x000388, "Member 'UBTService_FindInteractable_EnemySurvivor::EstimatedLocationMaxRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, EstimatedLocationKnownRange) == 0x0003E8, "Member 'UBTService_FindInteractable_EnemySurvivor::EstimatedLocationKnownRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, ClosestNavMeshLocationRange) == 0x000448, "Member 'UBTService_FindInteractable_EnemySurvivor::ClosestNavMeshLocationRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, ReachedLastSeenLocationDistance) == 0x000460, "Member 'UBTService_FindInteractable_EnemySurvivor::ReachedLastSeenLocationDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, MaxDistanceToLoopInteractable) == 0x000464, "Member 'UBTService_FindInteractable_EnemySurvivor::MaxDistanceToLoopInteractable' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, MaxDistanceToLoopPath) == 0x000468, "Member 'UBTService_FindInteractable_EnemySurvivor::MaxDistanceToLoopPath' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, VaultInteractionIDs) == 0x000470, "Member 'UBTService_FindInteractable_EnemySurvivor::VaultInteractionIDs' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, IgnoreVaultUnderRange) == 0x000480, "Member 'UBTService_FindInteractable_EnemySurvivor::IgnoreVaultUnderRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, CrawlingRecoveryProgressGoalWeight) == 0x000488, "Member 'UBTService_FindInteractable_EnemySurvivor::CrawlingRecoveryProgressGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BestTargetWeight) == 0x0004E8, "Member 'UBTService_FindInteractable_EnemySurvivor::BestTargetWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, MeleeRangeWeight) == 0x000548, "Member 'UBTService_FindInteractable_EnemySurvivor::MeleeRangeWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, MeleeRangeDistance) == 0x0005A8, "Member 'UBTService_FindInteractable_EnemySurvivor::MeleeRangeDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, CurrentTargetWeight) == 0x000608, "Member 'UBTService_FindInteractable_EnemySurvivor::CurrentTargetWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, LastSurvivorWeight) == 0x000668, "Member 'UBTService_FindInteractable_EnemySurvivor::LastSurvivorWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, ForcedSurvivorWeight) == 0x0006C8, "Member 'UBTService_FindInteractable_EnemySurvivor::ForcedSurvivorWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, ActiveTimeWeightPenalty) == 0x000728, "Member 'UBTService_FindInteractable_EnemySurvivor::ActiveTimeWeightPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, LoopSafetyRatingWeightPenalty) == 0x000788, "Member 'UBTService_FindInteractable_EnemySurvivor::LoopSafetyRatingWeightPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, EnduranceWeightPenalty) == 0x0007E8, "Member 'UBTService_FindInteractable_EnemySurvivor::EnduranceWeightPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, AverageHookDifferenceWeightPenalty) == 0x000848, "Member 'UBTService_FindInteractable_EnemySurvivor::AverageHookDifferenceWeightPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBStimulusActor) == 0x0008A8, "Member 'UBTService_FindInteractable_EnemySurvivor::BBStimulusActor' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBStimulusNavLocation) == 0x0008D8, "Member 'UBTService_FindInteractable_EnemySurvivor::BBStimulusNavLocation' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBIsStimulusInSight) == 0x000908, "Member 'UBTService_FindInteractable_EnemySurvivor::BBIsStimulusInSight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBWasInSight) == 0x000938, "Member 'UBTService_FindInteractable_EnemySurvivor::BBWasInSight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBPredictedLocation) == 0x000968, "Member 'UBTService_FindInteractable_EnemySurvivor::BBPredictedLocation' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBWasBlind) == 0x000998, "Member 'UBTService_FindInteractable_EnemySurvivor::BBWasBlind' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractable_EnemySurvivor, BBCanKillStimulus) == 0x0009C8, "Member 'UBTService_FindInteractable_EnemySurvivor::BBCanKillStimulus' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Exit) == 0x000768, "Wrong size on UBTService_FindInteractor_Exit");
static_assert(offsetof(UBTService_FindInteractor_Exit, Filter) == 0x000660, "Member 'UBTService_FindInteractor_Exit::Filter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, OpenCondition) == 0x000661, "Member 'UBTService_FindInteractor_Exit::OpenCondition' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, BBFinalExitLocation) == 0x000668, "Member 'UBTService_FindInteractor_Exit::BBFinalExitLocation' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, ClosedDoorOffset) == 0x000698, "Member 'UBTService_FindInteractor_Exit::ClosedDoorOffset' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, OpenDoorOffset) == 0x00069C, "Member 'UBTService_FindInteractor_Exit::OpenDoorOffset' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, PrioritizePlayerRange) == 0x0006A0, "Member 'UBTService_FindInteractor_Exit::PrioritizePlayerRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, AbortOnBlockedExitSwitch) == 0x0006A4, "Member 'UBTService_FindInteractor_Exit::AbortOnBlockedExitSwitch' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, OpenedExitGoalWeight) == 0x0006A8, "Member 'UBTService_FindInteractor_Exit::OpenedExitGoalWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Exit, HatchBonusGoalWeight) == 0x000708, "Member 'UBTService_FindInteractor_Exit::HatchBonusGoalWeight' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Locker) == 0x000688, "Wrong size on UBTService_FindInteractor_Locker");
static_assert(offsetof(UBTService_FindInteractor_Locker, StatusFilter) == 0x000660, "Member 'UBTService_FindInteractor_Locker::StatusFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Locker, LockerNeedsToBeOpenable) == 0x000661, "Member 'UBTService_FindInteractor_Locker::LockerNeedsToBeOpenable' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Locker, PerksToRunInLocker) == 0x000668, "Member 'UBTService_FindInteractor_Locker::PerksToRunInLocker' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Pallet) == 0x000AE8, "Wrong size on UBTService_FindInteractor_Pallet");
static_assert(offsetof(UBTService_FindInteractor_Pallet, IntentionFilter) == 0x000660, "Member 'UBTService_FindInteractor_Pallet::IntentionFilter' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, InteractableLocationOffset) == 0x000668, "Member 'UBTService_FindInteractor_Pallet::InteractableLocationOffset' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, RestorePalletGameplayTags) == 0x000680, "Member 'UBTService_FindInteractor_Pallet::RestorePalletGameplayTags' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, BrokenGeneratorGoalMaxDistance) == 0x000690, "Member 'UBTService_FindInteractor_Pallet::BrokenGeneratorGoalMaxDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, BrokenGeneratorGoalMaxDistanceWeight) == 0x0006F0, "Member 'UBTService_FindInteractor_Pallet::BrokenGeneratorGoalMaxDistanceWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, MaxSafetyRatingWeight) == 0x000750, "Member 'UBTService_FindInteractor_Pallet::MaxSafetyRatingWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, SpawnInSurvivorLOSPenalty) == 0x0007B0, "Member 'UBTService_FindInteractor_Pallet::SpawnInSurvivorLOSPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, SpawnNearSurvivorMinDistanceSquared) == 0x000810, "Member 'UBTService_FindInteractor_Pallet::SpawnNearSurvivorMinDistanceSquared' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, SpawnNearSurvivorPenalty) == 0x000870, "Member 'UBTService_FindInteractor_Pallet::SpawnNearSurvivorPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, PlacedNearGamePalletMinDistanceSquared) == 0x0008D0, "Member 'UBTService_FindInteractor_Pallet::PlacedNearGamePalletMinDistanceSquared' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, PlacedNearGamePalletPenalty) == 0x000930, "Member 'UBTService_FindInteractor_Pallet::PlacedNearGamePalletPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, ConvincingFactorTolerance) == 0x000990, "Member 'UBTService_FindInteractor_Pallet::ConvincingFactorTolerance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, SkipSafetyCheck) == 0x0009F0, "Member 'UBTService_FindInteractor_Pallet::SkipSafetyCheck' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, BBPickSideRelativelyFrom) == 0x0009F8, "Member 'UBTService_FindInteractor_Pallet::BBPickSideRelativelyFrom' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, AcceptablePalletDropExtent) == 0x000A28, "Member 'UBTService_FindInteractor_Pallet::AcceptablePalletDropExtent' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, BBEvadePointCrossingDest) == 0x000A40, "Member 'UBTService_FindInteractor_Pallet::BBEvadePointCrossingDest' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, ExtraHealthySurvivorActionTime) == 0x000A70, "Member 'UBTService_FindInteractor_Pallet::ExtraHealthySurvivorActionTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, ExtraInjuredSurvivorActionTime) == 0x000A74, "Member 'UBTService_FindInteractor_Pallet::ExtraInjuredSurvivorActionTime' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, PalletInteractorLocationOffset) == 0x000A78, "Member 'UBTService_FindInteractor_Pallet::PalletInteractorLocationOffset' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, AcceptableEvadePointCrossingDestDist) == 0x000A7C, "Member 'UBTService_FindInteractor_Pallet::AcceptableEvadePointCrossingDestDist' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Pallet, ChaseTargetMaxDistance) == 0x000A80, "Member 'UBTService_FindInteractor_Pallet::ChaseTargetMaxDistance' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_SearchLocker) == 0x0009E0, "Wrong size on UBTService_FindInteractor_SearchLocker");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, BBLockerInteractable) == 0x000660, "Member 'UBTService_FindInteractor_SearchLocker::BBLockerInteractable' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, SlowEnterAudibleDistance) == 0x000690, "Member 'UBTService_FindInteractor_SearchLocker::SlowEnterAudibleDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, RushedEnterAudibleDistance) == 0x0006F0, "Member 'UBTService_FindInteractor_SearchLocker::RushedEnterAudibleDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, MaxNoisePrecisionRange) == 0x000750, "Member 'UBTService_FindInteractor_SearchLocker::MaxNoisePrecisionRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, InjuredAudibleRange) == 0x0007B0, "Member 'UBTService_FindInteractor_SearchLocker::InjuredAudibleRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, ConvincedWeight) == 0x000810, "Member 'UBTService_FindInteractor_SearchLocker::ConvincedWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, PotentialLockerWeight) == 0x000870, "Member 'UBTService_FindInteractor_SearchLocker::PotentialLockerWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, RandomToDistanceWeightRatio) == 0x0008D0, "Member 'UBTService_FindInteractor_SearchLocker::RandomToDistanceWeightRatio' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, LineOfSightOffsets) == 0x000930, "Member 'UBTService_FindInteractor_SearchLocker::LineOfSightOffsets' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_SearchLocker, _potentialLockers) == 0x000990, "Member 'UBTService_FindInteractor_SearchLocker::_potentialLockers' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Self) == 0x000808, "Wrong size on UBTService_FindInteractor_Self");
static_assert(offsetof(UBTService_FindInteractor_Self, BBInputType) == 0x000660, "Member 'UBTService_FindInteractor_Self::BBInputType' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Self, BBIsSkillSelfInteraction) == 0x000690, "Member 'UBTService_FindInteractor_Self::BBIsSkillSelfInteraction' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Self, SelfHelpInteractions) == 0x0006C0, "Member 'UBTService_FindInteractor_Self::SelfHelpInteractions' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Self, SelfInteractionContext) == 0x0006D0, "Member 'UBTService_FindInteractor_Self::SelfInteractionContext' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Self, SurvivorProximityRange) == 0x0006DC, "Member 'UBTService_FindInteractor_Self::SurvivorProximityRange' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Self, SurvivorProximityWeightPenalty) == 0x0006E0, "Member 'UBTService_FindInteractor_Self::SurvivorProximityWeightPenalty' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Self, SelfHealIsEnabledFromWakeupBonusWeight) == 0x000740, "Member 'UBTService_FindInteractor_Self::SelfHealIsEnabledFromWakeupBonusWeight' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_Totem) == 0x000760, "Wrong size on UBTService_FindInteractor_Totem");
static_assert(offsetof(UBTService_FindInteractor_Totem, InactiveGoalWeightMaxDistance) == 0x000660, "Member 'UBTService_FindInteractor_Totem::InactiveGoalWeightMaxDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Totem, InactiveGoalWeightAtMinDistance) == 0x0006C0, "Member 'UBTService_FindInteractor_Totem::InactiveGoalWeightAtMinDistance' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Totem, GoalPerkWeight) == 0x000720, "Member 'UBTService_FindInteractor_Totem::GoalPerkWeight' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Totem, CleansePerks) == 0x000730, "Member 'UBTService_FindInteractor_Totem::CleansePerks' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Totem, SearchUsingBoundPerks) == 0x000740, "Member 'UBTService_FindInteractor_Totem::SearchUsingBoundPerks' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Totem, BoundPerkIds) == 0x000748, "Member 'UBTService_FindInteractor_Totem::BoundPerkIds' has a wrong offset!");
static_assert(offsetof(UBTService_FindInteractor_Totem, OnlyWhenInjured) == 0x000758, "Member 'UBTService_FindInteractor_Totem::OnlyWhenInjured' has a wrong offset!");
...
static_assert(sizeof(UBTService_FindInteractor_WishList) == 0x000678, "Wrong size on UBTService_FindInteractor_WishList");
static_assert(offsetof(UBTService_FindInteractor_WishList, WishListTag) == 0x000660, "Member 'UBTService_FindInteractor_WishList::WishListTag' has a wrong offset!");
...
static_assert(sizeof(UBTService_SetCameraFocus) == 0x0000B0, "Wrong size on UBTService_SetCameraFocus");
...
static_assert(offsetof(UBTService_SetCameraFocus, FocusPriority) == 0x0000A8, "Member 'UBTService_SetCameraFocus::FocusPriority' has a wrong offset!");
...
static_assert(sizeof(UBTTask_FleeMoveTo) == 0x000280, "Wrong size on UBTTask_FleeMoveTo");
static_assert(offsetof(UBTTask_FleeMoveTo, InScrambleMovementMinDistance) == 0x000268, "Member 'UBTTask_FleeMoveTo::InScrambleMovementMinDistance' has a wrong offset!");
static_assert(offsetof(UBTTask_FleeMoveTo, OutScrambleMovementMinDistance) == 0x00026C, "Member 'UBTTask_FleeMoveTo::OutScrambleMovementMinDistance' has a wrong offset!");
static_assert(offsetof(UBTTask_FleeMoveTo, InScrambleMovementInterval) == 0x000270, "Member 'UBTTask_FleeMoveTo::InScrambleMovementInterval' has a wrong offset!");
static_assert(offsetof(UBTTask_FleeMoveTo, LoopScrambleMovementInterval) == 0x000274, "Member 'UBTTask_FleeMoveTo::LoopScrambleMovementInterval' has a wrong offset!");
static_assert(offsetof(UBTTask_FleeMoveTo, LoopScrambleMovementRandomDeviation) == 0x000278, "Member 'UBTTask_FleeMoveTo::LoopScrambleMovementRandomDeviation' has a wrong offset!");
static_assert(offsetof(UBTTask_FleeMoveTo, CrouchWithinLastEvadeLoopPointRadius) == 0x00027C, "Member 'UBTTask_FleeMoveTo::CrouchWithinLastEvadeLoopPointRadius' has a wrong offset!");
...
static_assert(sizeof(UBTTask_StealthMoveTo) == 0x000268, "Wrong size on UBTTask_StealthMoveTo");
...
static_assert(sizeof(UDBDAIPassiveCameraComponent) == 0x000230, "Wrong size on UDBDAIPassiveCameraComponent");
static_assert(offsetof(UDBDAIPassiveCameraComponent, RotateCameraOnStationaryWaitTime) == 0x0000B8, "Member 'UDBDAIPassiveCameraComponent::RotateCameraOnStationaryWaitTime' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, RotateCameraOnStationaryDegreePerSecond) == 0x0000BC, "Member 'UDBDAIPassiveCameraComponent::RotateCameraOnStationaryDegreePerSecond' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, CameraRotationFullRotationDelay) == 0x0000C0, "Member 'UDBDAIPassiveCameraComponent::CameraRotationFullRotationDelay' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, CameraRotationBetweenTargetDelay) == 0x000120, "Member 'UDBDAIPassiveCameraComponent::CameraRotationBetweenTargetDelay' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, CameraRotationMinimumInteractionTime) == 0x000180, "Member 'UDBDAIPassiveCameraComponent::CameraRotationMinimumInteractionTime' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, CameraRotationTotalRaycasts) == 0x0001E0, "Member 'UDBDAIPassiveCameraComponent::CameraRotationTotalRaycasts' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, ForwardViewHalfAngle) == 0x0001E4, "Member 'UDBDAIPassiveCameraComponent::ForwardViewHalfAngle' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, FocusPointCandidateRemoveOppositeHalfAngle) == 0x0001E8, "Member 'UDBDAIPassiveCameraComponent::FocusPointCandidateRemoveOppositeHalfAngle' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, FocusPointCandidateForceKeepDistance) == 0x0001EC, "Member 'UDBDAIPassiveCameraComponent::FocusPointCandidateForceKeepDistance' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, FocusPointCandidateMinDistance) == 0x0001F0, "Member 'UDBDAIPassiveCameraComponent::FocusPointCandidateMinDistance' has a wrong offset!");
static_assert(offsetof(UDBDAIPassiveCameraComponent, InvalidKillerLocationRangeRatio) == 0x0001F4, "Member 'UDBDAIPassiveCameraComponent::InvalidKillerLocationRangeRatio' has a wrong offset!");
...
static_assert(sizeof(UDBDAIStateComponent) == 0x000480, "Wrong size on UDBDAIStateComponent");
...
static_assert(offsetof(UDBDAIStateComponent, NotMovingCheckInterval) == 0x00023C, "Member 'UDBDAIStateComponent::NotMovingCheckInterval' has a wrong offset!");
static_assert(offsetof(UDBDAIStateComponent, NotMovingSpeedPercent) == 0x000240, "Member 'UDBDAIStateComponent::NotMovingSpeedPercent' has a wrong offset!");
static_assert(offsetof(UDBDAIStateComponent, NotMovingContinuousTimes) == 0x000244, "Member 'UDBDAIStateComponent::NotMovingContinuousTimes' has a wrong offset!");
static_assert(offsetof(UDBDAIStateComponent, PrimaryChaseTargetDirectionDistanceMultiplier) == 0x000248, "Member 'UDBDAIStateComponent::PrimaryChaseTargetDirectionDistanceMultiplier' has a wrong offset!");
static_assert(offsetof(UDBDAIStateComponent, SpecialAttackReactionTimeMultiplier) == 0x000250, "Member 'UDBDAIStateComponent::SpecialAttackReactionTimeMultiplier' has a wrong offset!");
static_assert(offsetof(UDBDAIStateComponent, BlindPowerStateTags) == 0x0002B0, "Member 'UDBDAIStateComponent::BlindPowerStateTags' has a wrong offset!");
...
static_assert(sizeof(UDBDBehaviorTreeComponent) == 0x000310, "Wrong size on UDBDBehaviorTreeComponent");
static_assert(offsetof(UDBDBehaviorTreeComponent, _lastRelevantNodeMemories) == 0x0002B0, "Member 'UDBDBehaviorTreeComponent::_lastRelevantNodeMemories' has a wrong offset!");
static_assert(offsetof(UDBDBehaviorTreeComponent, _createdObjects) == 0x000300, "Member 'UDBDBehaviorTreeComponent::_createdObjects' has a wrong offset!");
...
static_assert(sizeof(UDBDBlackboardComponent) == 0x0004C0, "Wrong size on UDBDBlackboardComponent");
static_assert(offsetof(UDBDBlackboardComponent, _mindFocusEntries) == 0x0001C8, "Member 'UDBDBlackboardComponent::_mindFocusEntries' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _globalMindFocusCooldowns) == 0x000218, "Member 'UDBDBlackboardComponent::_globalMindFocusCooldowns' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _pinLocations) == 0x000268, "Member 'UDBDBlackboardComponent::_pinLocations' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _pinObjects) == 0x0002B8, "Member 'UDBDBlackboardComponent::_pinObjects' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _lostMindFocusEntries) == 0x000308, "Member 'UDBDBlackboardComponent::_lostMindFocusEntries' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _objectWishListMap) == 0x000358, "Member 'UDBDBlackboardComponent::_objectWishListMap' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _discoveredObjects) == 0x0003A8, "Member 'UDBDBlackboardComponent::_discoveredObjects' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _intentionValidators) == 0x0003F8, "Member 'UDBDBlackboardComponent::_intentionValidators' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _convincingDreamPallets) == 0x000448, "Member 'UDBDBlackboardComponent::_convincingDreamPallets' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _dropItemLocks) == 0x000498, "Member 'UDBDBlackboardComponent::_dropItemLocks' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _forcedChaseTarget) == 0x0004A8, "Member 'UDBDBlackboardComponent::_forcedChaseTarget' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _forcedChaseTargetOwner) == 0x0004B0, "Member 'UDBDBlackboardComponent::_forcedChaseTargetOwner' has a wrong offset!");
static_assert(offsetof(UDBDBlackboardComponent, _hasNewForcedChaseTarget) == 0x0004B8, "Member 'UDBDBlackboardComponent::_hasNewForcedChaseTarget' has a wrong offset!");
...
static_assert(sizeof(UDBDNavLinkCustomComponent) == 0x000290, "Wrong size on UDBDNavLinkCustomComponent");
static_assert(offsetof(UDBDNavLinkCustomComponent, UseRelativeLinkEndPoint) == 0x0001E8, "Member 'UDBDNavLinkCustomComponent::UseRelativeLinkEndPoint' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, BaseLinkRelativeStart) == 0x0001F0, "Member 'UDBDNavLinkCustomComponent::BaseLinkRelativeStart' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, BaseLinkRelativeEnd) == 0x000208, "Member 'UDBDNavLinkCustomComponent::BaseLinkRelativeEnd' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, BaseLinkWorldEnd) == 0x000220, "Member 'UDBDNavLinkCustomComponent::BaseLinkWorldEnd' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, BaseLinkDirection) == 0x000238, "Member 'UDBDNavLinkCustomComponent::BaseLinkDirection' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, AutoSnapSmartLinkPointsUpHeight) == 0x00023C, "Member 'UDBDNavLinkCustomComponent::AutoSnapSmartLinkPointsUpHeight' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, AutoSnapSmartLinkPointsDownHeight) == 0x000240, "Member 'UDBDNavLinkCustomComponent::AutoSnapSmartLinkPointsDownHeight' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, AutoSnapCollisionChannel) == 0x000244, "Member 'UDBDNavLinkCustomComponent::AutoSnapCollisionChannel' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, AutoSmartLinkDirectionMaxHeight) == 0x000248, "Member 'UDBDNavLinkCustomComponent::AutoSmartLinkDirectionMaxHeight' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, DisableSmartLinkOnPathObstruction) == 0x00024C, "Member 'UDBDNavLinkCustomComponent::DisableSmartLinkOnPathObstruction' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, PathObstructionTestDistance) == 0x000250, "Member 'UDBDNavLinkCustomComponent::PathObstructionTestDistance' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, PathObstructionTestShapeRadius) == 0x000254, "Member 'UDBDNavLinkCustomComponent::PathObstructionTestShapeRadius' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, PathObstructionTestHeightOffset) == 0x000258, "Member 'UDBDNavLinkCustomComponent::PathObstructionTestHeightOffset' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, PathObstructionCollisionChannel) == 0x00025C, "Member 'UDBDNavLinkCustomComponent::PathObstructionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, DisableOtherSmartLinkInProximityOnEnable) == 0x00025D, "Member 'UDBDNavLinkCustomComponent::DisableOtherSmartLinkInProximityOnEnable' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, EnableOtherSmartLinkInProximityOnDisable) == 0x00025E, "Member 'UDBDNavLinkCustomComponent::EnableOtherSmartLinkInProximityOnDisable' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, OtherSmartLinkInProximitySearchDistance) == 0x000260, "Member 'UDBDNavLinkCustomComponent::OtherSmartLinkInProximitySearchDistance' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, ShowDebugInfo) == 0x000264, "Member 'UDBDNavLinkCustomComponent::ShowDebugInfo' has a wrong offset!");
static_assert(offsetof(UDBDNavLinkCustomComponent, _navLinkProxyInProximity) == 0x000280, "Member 'UDBDNavLinkCustomComponent::_navLinkProxyInProximity' has a wrong offset!");
...
static_assert(sizeof(UDBDNavMeshExplorerComponent) == 0x0001A0, "Wrong size on UDBDNavMeshExplorerComponent");
...
static_assert(offsetof(UDBDNavMeshExplorerComponent, FullyAutoExploredAtGameTime) == 0x000120, "Member 'UDBDNavMeshExplorerComponent::FullyAutoExploredAtGameTime' has a wrong offset!");
static_assert(offsetof(UDBDNavMeshExplorerComponent, _pathFollowingComponent) == 0x000128, "Member 'UDBDNavMeshExplorerComponent::_pathFollowingComponent' has a wrong offset!");
...
static_assert(sizeof(UDBDNavObstacleAnalysisComponent) == 0x000150, "Wrong size on UDBDNavObstacleAnalysisComponent");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, IsSupported) == 0x0000B8, "Member 'UDBDNavObstacleAnalysisComponent::IsSupported' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, CloseLoopRadius) == 0x0000BC, "Member 'UDBDNavObstacleAnalysisComponent::CloseLoopRadius' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, InitialMergeObstacleRadius) == 0x0000C0, "Member 'UDBDNavObstacleAnalysisComponent::InitialMergeObstacleRadius' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, MaxMergeObstacleRadius) == 0x0000C4, "Member 'UDBDNavObstacleAnalysisComponent::MaxMergeObstacleRadius' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, MergeObstacleRadiusMultiplierPerStep) == 0x0000C8, "Member 'UDBDNavObstacleAnalysisComponent::MergeObstacleRadiusMultiplierPerStep' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, ObstacleMatrixCellSize) == 0x0000CC, "Member 'UDBDNavObstacleAnalysisComponent::ObstacleMatrixCellSize' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, _edgeVertices) == 0x0000D0, "Member 'UDBDNavObstacleAnalysisComponent::_edgeVertices' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, _incompleteNavObstacles) == 0x0000E8, "Member 'UDBDNavObstacleAnalysisComponent::_incompleteNavObstacles' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, _navObstacles) == 0x0000F8, "Member 'UDBDNavObstacleAnalysisComponent::_navObstacles' has a wrong offset!");
static_assert(offsetof(UDBDNavObstacleAnalysisComponent, _navObstacleMatrix) == 0x000108, "Member 'UDBDNavObstacleAnalysisComponent::_navObstacleMatrix' has a wrong offset!");
...
static_assert(sizeof(UDBDPathFollowingComponent) == 0x000590, "Wrong size on UDBDPathFollowingComponent");
static_assert(offsetof(UDBDPathFollowingComponent, UnblockPathDeviationRadius) == 0x0002F0, "Member 'UDBDPathFollowingComponent::UnblockPathDeviationRadius' has a wrong offset!");
static_assert(offsetof(UDBDPathFollowingComponent, UnblockPathTimeLimit) == 0x0002F4, "Member 'UDBDPathFollowingComponent::UnblockPathTimeLimit' has a wrong offset!");
static_assert(offsetof(UDBDPathFollowingComponent, UnblockPathReachDistance) == 0x0002F8, "Member 'UDBDPathFollowingComponent::UnblockPathReachDistance' has a wrong offset!");
static_assert(offsetof(UDBDPathFollowingComponent, KeepMovingAfterPathEndTime) == 0x0002FC, "Member 'UDBDPathFollowingComponent::KeepMovingAfterPathEndTime' has a wrong offset!");
static_assert(offsetof(UDBDPathFollowingComponent, LookAheadDistance) == 0x000300, "Member 'UDBDPathFollowingComponent::LookAheadDistance' has a wrong offset!");
static_assert(offsetof(UDBDPathFollowingComponent, _onNavLinkProxies) == 0x000468, "Member 'UDBDPathFollowingComponent::_onNavLinkProxies' has a wrong offset!");
static_assert(offsetof(UDBDPathFollowingComponent, _preciseMovementRequesters) == 0x0004B8, "Member 'UDBDPathFollowingComponent::_preciseMovementRequesters' has a wrong offset!");
...
static_assert(sizeof(UNavigationQueryFilter_Slasher) == 0x000130, "Wrong size on UNavigationQueryFilter_Slasher");
...
static_assert(offsetof(UNavigationQueryFilter_Slasher, SpecialInteractionsTimeCost) == 0x0000C0, "Member 'UNavigationQueryFilter_Slasher::SpecialInteractionsTimeCost' has a wrong offset!");
static_assert(offsetof(UNavigationQueryFilter_Slasher, MapCenterAngleRegularMultiplier) == 0x000110, "Member 'UNavigationQueryFilter_Slasher::MapCenterAngleRegularMultiplier' has a wrong offset!");
static_assert(offsetof(UNavigationQueryFilter_Slasher, MapCenterAngleStealthMultiplier) == 0x000114, "Member 'UNavigationQueryFilter_Slasher::MapCenterAngleStealthMultiplier' has a wrong offset!");
...
static_assert(offsetof(UPathBuilder, RequiresPreciseMovement) == 0x000044, "Member 'UPathBuilder::RequiresPreciseMovement' has a wrong offset!");
