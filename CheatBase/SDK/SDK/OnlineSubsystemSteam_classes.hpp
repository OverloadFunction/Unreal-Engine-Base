...
{
public:
	bool                                          bIsPassthrough;                                    // 0x1E68(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E69[0x7];                                     // 0x1E69(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001E70, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001E68, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
