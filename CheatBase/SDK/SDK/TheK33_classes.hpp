...
static_assert(sizeof(UK33TurretAttackableComponent) == 0x0000B8, "Wrong size on UK33TurretAttackableComponent");
...
static_assert(sizeof(UIsInRangeOfK33ControlStation) == 0x000108, "Wrong size on UIsInRangeOfK33ControlStation");
...
static_assert(sizeof(UK33TunnelProceduralGenerationComponent) == 0x000188, "Wrong size on UK33TunnelProceduralGenerationComponent");
static_assert(offsetof(UK33TunnelProceduralGenerationComponent, _blocksSpawnData) == 0x0000B8, "Member 'UK33TunnelProceduralGenerationComponent::_blocksSpawnData' has a wrong offset!");
static_assert(offsetof(UK33TunnelProceduralGenerationComponent, _tunnelBlockAssetsReferences) == 0x0000D0, "Member 'UK33TunnelProceduralGenerationComponent::_tunnelBlockAssetsReferences' has a wrong offset!");
static_assert(offsetof(UK33TunnelProceduralGenerationComponent, _tunnelBlockAssetClasses) == 0x000120, "Member 'UK33TunnelProceduralGenerationComponent::_tunnelBlockAssetClasses' has a wrong offset!");
static_assert(offsetof(UK33TunnelProceduralGenerationComponent, _tunnelBlocks) == 0x000170, "Member 'UK33TunnelProceduralGenerationComponent::_tunnelBlocks' has a wrong offset!");
static_assert(offsetof(UK33TunnelProceduralGenerationComponent, _blockSize) == 0x000180, "Member 'UK33TunnelProceduralGenerationComponent::_blockSize' has a wrong offset!");
static_assert(offsetof(UK33TunnelProceduralGenerationComponent, _basementHeightOffset) == 0x000184, "Member 'UK33TunnelProceduralGenerationComponent::_basementHeightOffset' has a wrong offset!");
...
static_assert(sizeof(UK33CheatComponent) == 0x0000B8, "Wrong size on UK33CheatComponent");
...
static_assert(sizeof(UK33ControlStationAttackableComponent) == 0x0000B8, "Wrong size on UK33ControlStationAttackableComponent");
...
static_assert(sizeof(UK33ControlStationTunnelEntranceOutlineUpdateStrategy) == 0x000180, "Wrong size on UK33ControlStationTunnelEntranceOutlineUpdateStrategy");
static_assert(offsetof(UK33ControlStationTunnelEntranceOutlineUpdateStrategy, _controlStationIsFlaggedForTarget) == 0x000160, "Member 'UK33ControlStationTunnelEntranceOutlineUpdateStrategy::_controlStationIsFlaggedForTarget' has a wrong offset!");
static_assert(offsetof(UK33ControlStationTunnelEntranceOutlineUpdateStrategy, _controlStationIsSelected) == 0x000170, "Member 'UK33ControlStationTunnelEntranceOutlineUpdateStrategy::_controlStationIsSelected' has a wrong offset!");
...
static_assert(sizeof(UK33ControlStationTurretSpawnerOutlineUpdateStrategy) == 0x000128, "Wrong size on UK33ControlStationTurretSpawnerOutlineUpdateStrategy");
static_assert(offsetof(UK33ControlStationTurretSpawnerOutlineUpdateStrategy, _maxDistanceToRevealToSurvivor) == 0x000100, "Member 'UK33ControlStationTurretSpawnerOutlineUpdateStrategy::_maxDistanceToRevealToSurvivor' has a wrong offset!");
...
static_assert(sizeof(AK33TunnelPulse) == 0x000350, "Wrong size on AK33TunnelPulse");
static_assert(offsetof(AK33TunnelPulse, _lastPulseForwardOffset) == 0x0002C0, "Member 'AK33TunnelPulse::_lastPulseForwardOffset' has a wrong offset!");
static_assert(offsetof(AK33TunnelPulse, _lastPulseUpOffset) == 0x0002C4, "Member 'AK33TunnelPulse::_lastPulseUpOffset' has a wrong offset!");
static_assert(offsetof(AK33TunnelPulse, _sideOffsetCurveMultiplier) == 0x0002C8, "Member 'AK33TunnelPulse::_sideOffsetCurveMultiplier' has a wrong offset!");
static_assert(offsetof(AK33TunnelPulse, _firstTunnelBlockSideOffsetCurveMultiplier) == 0x0002D0, "Member 'AK33TunnelPulse::_firstTunnelBlockSideOffsetCurveMultiplier' has a wrong offset!");
static_assert(offsetof(AK33TunnelPulse, _lastTunnelBlockSideOffsetCurveMultiplier) == 0x0002D8, "Member 'AK33TunnelPulse::_lastTunnelBlockSideOffsetCurveMultiplier' has a wrong offset!");
static_assert(offsetof(AK33TunnelPulse, _sideOffsetSize) == 0x0002E0, "Member 'AK33TunnelPulse::_sideOffsetSize' has a wrong offset!");
...
static_assert(sizeof(UK33ExitTunnelInteraction) == 0x000980, "Wrong size on UK33ExitTunnelInteraction");
static_assert(offsetof(UK33ExitTunnelInteraction, _firstAnimationTime) == 0x000768, "Member 'UK33ExitTunnelInteraction::_firstAnimationTime' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _secondAnimationTime) == 0x000790, "Member 'UK33ExitTunnelInteraction::_secondAnimationTime' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _killerInstinctTriggerDistance) == 0x0007B8, "Member 'UK33ExitTunnelInteraction::_killerInstinctTriggerDistance' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _killerInstinctLingerTime) == 0x0007E0, "Member 'UK33ExitTunnelInteraction::_killerInstinctLingerTime' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _exitTunnelPenaltyRange) == 0x000860, "Member 'UK33ExitTunnelInteraction::_exitTunnelPenaltyRange' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _exitTunnelPenaltyPercentage) == 0x000888, "Member 'UK33ExitTunnelInteraction::_exitTunnelPenaltyPercentage' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _killerInstinctStatusEffectClass) == 0x0008B0, "Member 'UK33ExitTunnelInteraction::_killerInstinctStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _exitTunnelAnimationTime) == 0x0008B8, "Member 'UK33ExitTunnelInteraction::_exitTunnelAnimationTime' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _toggleMeshVisibilityAnimationPercentageTime) == 0x0008BC, "Member 'UK33ExitTunnelInteraction::_toggleMeshVisibilityAnimationPercentageTime' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _cameraOffset) == 0x0008C0, "Member 'UK33ExitTunnelInteraction::_cameraOffset' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _cameraRotationSpeed) == 0x0008D8, "Member 'UK33ExitTunnelInteraction::_cameraRotationSpeed' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _fadeOutDuration) == 0x0008DC, "Member 'UK33ExitTunnelInteraction::_fadeOutDuration' has a wrong offset!");
static_assert(offsetof(UK33ExitTunnelInteraction, _useExitTimePenalty) == 0x000973, "Member 'UK33ExitTunnelInteraction::_useExitTimePenalty' has a wrong offset!");
...
static_assert(sizeof(UK33FallOutOfWorldPositionFinderComponent) == 0x0000C0, "Wrong size on UK33FallOutOfWorldPositionFinderComponent");
...
static_assert(sizeof(AK33FeetVFX) == 0x000350, "Wrong size on AK33FeetVFX");
static_assert(offsetof(AK33FeetVFX, _currentFootType) == 0x0002C0, "Member 'AK33FeetVFX::_currentFootType' has a wrong offset!");
static_assert(offsetof(AK33FeetVFX, _footstepEffectDuration) == 0x0002C4, "Member 'AK33FeetVFX::_footstepEffectDuration' has a wrong offset!");
static_assert(offsetof(AK33FeetVFX, OnAcquiredChanged) == 0x0002C8, "Member 'AK33FeetVFX::OnAcquiredChanged' has a wrong offset!");
...
static_assert(alignof(IK33FXInterface) == 0x000001, "Wrong alignment on IK33FXInterface");
static_assert(sizeof(IK33FXInterface) == 0x000001, "Wrong size on IK33FXInterface");
...
static_assert(sizeof(UK33KillerControlStationSelectorComponent) == 0x000308, "Wrong size on UK33KillerControlStationSelectorComponent");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _thresholdDeltaSquaredDistanceForBestTargetRecalculation) == 0x0000D0, "Member 'UK33KillerControlStationSelectorComponent::_thresholdDeltaSquaredDistanceForBestTargetRecalculation' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _minDeltaDotProductForBestTargetRecalculation) == 0x0000D4, "Member 'UK33KillerControlStationSelectorComponent::_minDeltaDotProductForBestTargetRecalculation' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _minDotProductForEligibleControlStationTarget) == 0x0000D8, "Member 'UK33KillerControlStationSelectorComponent::_minDotProductForEligibleControlStationTarget' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _minDistanceForEligibleControlStationTargetOutsideTunnel) == 0x0000DC, "Member 'UK33KillerControlStationSelectorComponent::_minDistanceForEligibleControlStationTargetOutsideTunnel' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _actorIndicatorClass) == 0x0000E8, "Member 'UK33KillerControlStationSelectorComponent::_actorIndicatorClass' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _tunnelNavigationComponentClass) == 0x000120, "Member 'UK33KillerControlStationSelectorComponent::_tunnelNavigationComponentClass' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _indicatorInstance) == 0x000158, "Member 'UK33KillerControlStationSelectorComponent::_indicatorInstance' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _tunnelNavigationComponentInstance) == 0x000160, "Member 'UK33KillerControlStationSelectorComponent::_tunnelNavigationComponentInstance' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _replicated_selectedControlStation) == 0x000180, "Member 'UK33KillerControlStationSelectorComponent::_replicated_selectedControlStation' has a wrong offset!");
static_assert(offsetof(UK33KillerControlStationSelectorComponent, _aimDirectionProvider) == 0x000188, "Member 'UK33KillerControlStationSelectorComponent::_aimDirectionProvider' has a wrong offset!");
...
static_assert(sizeof(UK33KillerStunnedByTurretStatusEffect) == 0x0003C8, "Wrong size on UK33KillerStunnedByTurretStatusEffect");
static_assert(offsetof(UK33KillerStunnedByTurretStatusEffect, _movementSpeedCurve) == 0x000398, "Member 'UK33KillerStunnedByTurretStatusEffect::_movementSpeedCurve' has a wrong offset!");
static_assert(offsetof(UK33KillerStunnedByTurretStatusEffect, _movementSpeedDuration) == 0x0003A0, "Member 'UK33KillerStunnedByTurretStatusEffect::_movementSpeedDuration' has a wrong offset!");
...
static_assert(sizeof(UK33KillerTunnelStateComponent) == 0x000378, "Wrong size on UK33KillerTunnelStateComponent");
static_assert(offsetof(UK33KillerTunnelStateComponent, _isInTunnel) == 0x0000C0, "Member 'UK33KillerTunnelStateComponent::_isInTunnel' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _movementInputConstraintStrategyClass) == 0x000110, "Member 'UK33KillerTunnelStateComponent::_movementInputConstraintStrategyClass' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _movementInputConstraintStrategy) == 0x000118, "Member 'UK33KillerTunnelStateComponent::_movementInputConstraintStrategy' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _inTunnelUntouchedClasses) == 0x000120, "Member 'UK33KillerTunnelStateComponent::_inTunnelUntouchedClasses' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _controlStationTunnelConnectionClass) == 0x000180, "Member 'UK33KillerTunnelStateComponent::_controlStationTunnelConnectionClass' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _controlStationTunnelConnectionInstance) == 0x0001B8, "Member 'UK33KillerTunnelStateComponent::_controlStationTunnelConnectionInstance' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _accelerationMultiplier) == 0x0001C0, "Member 'UK33KillerTunnelStateComponent::_accelerationMultiplier' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _heightOffsetForDistanceChecks) == 0x0001E8, "Member 'UK33KillerTunnelStateComponent::_heightOffsetForDistanceChecks' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _defaultOcclusionRefreshInterval) == 0x000210, "Member 'UK33KillerTunnelStateComponent::_defaultOcclusionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _minAnimPitchInTunnel) == 0x000214, "Member 'UK33KillerTunnelStateComponent::_minAnimPitchInTunnel' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _worldElementsVisibility) == 0x00023A, "Member 'UK33KillerTunnelStateComponent::_worldElementsVisibility' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _tunnelElementsVisibility) == 0x00023B, "Member 'UK33KillerTunnelStateComponent::_tunnelElementsVisibility' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _killerCollisionBlockType) == 0x00023C, "Member 'UK33KillerTunnelStateComponent::_killerCollisionBlockType' has a wrong offset!");
static_assert(offsetof(UK33KillerTunnelStateComponent, _tunnelAmbiance) == 0x000240, "Member 'UK33KillerTunnelStateComponent::_tunnelAmbiance' has a wrong offset!");
...
static_assert(sizeof(UK33P01) == 0x000490, "Wrong size on UK33P01");
static_assert(offsetof(UK33P01, _perkCooldownTime) == 0x000460, "Member 'UK33P01::_perkCooldownTime' has a wrong offset!");
static_assert(offsetof(UK33P01, _screamRevealRangeFromLocker) == 0x00046C, "Member 'UK33P01::_screamRevealRangeFromLocker' has a wrong offset!");
static_assert(offsetof(UK33P01, _blindedStatusEffect) == 0x000470, "Member 'UK33P01::_blindedStatusEffect' has a wrong offset!");
static_assert(offsetof(UK33P01, _blindedEffectDuration) == 0x000478, "Member 'UK33P01::_blindedEffectDuration' has a wrong offset!");
...
static_assert(sizeof(UK33P02) == 0x000480, "Wrong size on UK33P02");
static_assert(offsetof(UK33P02, _hasteStatusEffect) == 0x000460, "Member 'UK33P02::_hasteStatusEffect' has a wrong offset!");
static_assert(offsetof(UK33P02, _hasteDuration) == 0x000468, "Member 'UK33P02::_hasteDuration' has a wrong offset!");
static_assert(offsetof(UK33P02, _hasteAmount) == 0x000474, "Member 'UK33P02::_hasteAmount' has a wrong offset!");
static_assert(offsetof(UK33P02, _hasteEffect) == 0x000478, "Member 'UK33P02::_hasteEffect' has a wrong offset!");
...
static_assert(sizeof(UK33P03) == 0x000488, "Wrong size on UK33P03");
static_assert(offsetof(UK33P03, _perkAuraRevealDuration) == 0x000460, "Member 'UK33P03::_perkAuraRevealDuration' has a wrong offset!");
static_assert(offsetof(UK33P03, _obliviousDuration) == 0x00046C, "Member 'UK33P03::_obliviousDuration' has a wrong offset!");
static_assert(offsetof(UK33P03, _revealedStatusEffect) == 0x000478, "Member 'UK33P03::_revealedStatusEffect' has a wrong offset!");
static_assert(offsetof(UK33P03, _obliviousStatusEffect) == 0x000480, "Member 'UK33P03::_obliviousStatusEffect' has a wrong offset!");
...
static_assert(sizeof(AK33Power) == 0x0006D8, "Wrong size on AK33Power");
static_assert(offsetof(AK33Power, _tailAttackChargeableComponent) == 0x000570, "Member 'AK33Power::_tailAttackChargeableComponent' has a wrong offset!");
static_assert(offsetof(AK33Power, _interactor) == 0x000578, "Member 'AK33Power::_interactor' has a wrong offset!");
static_assert(offsetof(AK33Power, _interactionVolume) == 0x000580, "Member 'AK33Power::_interactionVolume' has a wrong offset!");
static_assert(offsetof(AK33Power, _tailAttackChargeTime) == 0x000588, "Member 'AK33Power::_tailAttackChargeTime' has a wrong offset!");
static_assert(offsetof(AK33Power, _powerChargePresentationItemProgress) == 0x000608, "Member 'AK33Power::_powerChargePresentationItemProgress' has a wrong offset!");
static_assert(offsetof(AK33Power, _k33PowerCharge) == 0x000610, "Member 'AK33Power::_k33PowerCharge' has a wrong offset!");
static_assert(offsetof(AK33Power, _feetActorPool) == 0x000618, "Member 'AK33Power::_feetActorPool' has a wrong offset!");
static_assert(offsetof(AK33Power, _killerStatusEffects) == 0x000620, "Member 'AK33Power::_killerStatusEffects' has a wrong offset!");
static_assert(offsetof(AK33Power, _survivorStatusEffects) == 0x000630, "Member 'AK33Power::_survivorStatusEffects' has a wrong offset!");
static_assert(offsetof(AK33Power, _killerTunnelComponentClass) == 0x000640, "Member 'AK33Power::_killerTunnelComponentClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _quadrupedComponentClass) == 0x000648, "Member 'AK33Power::_quadrupedComponentClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _controlStationSelectorComponentClass) == 0x000650, "Member 'AK33Power::_controlStationSelectorComponentClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _survivorDetectionComponentClass) == 0x000658, "Member 'AK33Power::_survivorDetectionComponentClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _turretDamageComponentClass) == 0x000660, "Member 'AK33Power::_turretDamageComponentClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _turretPlacerComponentClass) == 0x000668, "Member 'AK33Power::_turretPlacerComponentClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _k33HuskClass) == 0x000670, "Member 'AK33Power::_k33HuskClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _turretPlacers) == 0x000678, "Member 'AK33Power::_turretPlacers' has a wrong offset!");
static_assert(offsetof(AK33Power, _feetPoolSize) == 0x000688, "Member 'AK33Power::_feetPoolSize' has a wrong offset!");
static_assert(offsetof(AK33Power, _feetActorClass) == 0x000690, "Member 'AK33Power::_feetActorClass' has a wrong offset!");
static_assert(offsetof(AK33Power, _k33Husk) == 0x000698, "Member 'AK33Power::_k33Husk' has a wrong offset!");
static_assert(offsetof(AK33Power, _turretPoolInitializer) == 0x0006C0, "Member 'AK33Power::_turretPoolInitializer' has a wrong offset!");
static_assert(offsetof(AK33Power, _turretPool) == 0x0006C8, "Member 'AK33Power::_turretPool' has a wrong offset!");
...
static_assert(sizeof(UK33PowerAddon20StatusEffect) == 0x0003C0, "Wrong size on UK33PowerAddon20StatusEffect");
static_assert(offsetof(UK33PowerAddon20StatusEffect, _effectDuration) == 0x000398, "Member 'UK33PowerAddon20StatusEffect::_effectDuration' has a wrong offset!");
...
static_assert(sizeof(UK33SurvivorTurretDestructionComponent) == 0x0000C8, "Wrong size on UK33SurvivorTurretDestructionComponent");
...
static_assert(sizeof(UK33PowerChargePresentationItemProgressComponent) == 0x0000F0, "Wrong size on UK33PowerChargePresentationItemProgressComponent");
...
static_assert(alignof(IK33SelectedControlStationOutlineFollower) == 0x000001, "Wrong alignment on IK33SelectedControlStationOutlineFollower");
static_assert(sizeof(IK33SelectedControlStationOutlineFollower) == 0x000001, "Wrong size on IK33SelectedControlStationOutlineFollower");
...
static_assert(sizeof(UK33Power_Addon_14) == 0x000328, "Wrong size on UK33Power_Addon_14");
static_assert(offsetof(UK33Power_Addon_14, _blindnessStatusEffect) == 0x000310, "Member 'UK33Power_Addon_14::_blindnessStatusEffect' has a wrong offset!");
static_assert(offsetof(UK33Power_Addon_14, _blindnessDuration) == 0x000318, "Member 'UK33Power_Addon_14::_blindnessDuration' has a wrong offset!");
static_assert(offsetof(UK33Power_Addon_14, _survivorRangeDistanceFromTurretToTriggerEffect) == 0x00031C, "Member 'UK33Power_Addon_14::_survivorRangeDistanceFromTurretToTriggerEffect' has a wrong offset!");
...
static_assert(sizeof(UK33Power_Addon_15) == 0x000358, "Wrong size on UK33Power_Addon_15");
static_assert(offsetof(UK33Power_Addon_15, _turretRange) == 0x000350, "Member 'UK33Power_Addon_15::_turretRange' has a wrong offset!");
...
static_assert(sizeof(UK33Power_Addon_16) == 0x000350, "Wrong size on UK33Power_Addon_16");
static_assert(offsetof(UK33Power_Addon_16, _activationLifetime) == 0x000310, "Member 'UK33Power_Addon_16::_activationLifetime' has a wrong offset!");
static_assert(offsetof(UK33Power_Addon_16, _screamRevealDuration) == 0x000314, "Member 'UK33Power_Addon_16::_screamRevealDuration' has a wrong offset!");
static_assert(offsetof(UK33Power_Addon_16, _survivorRangeDistanceFromKillerToTriggerEffect) == 0x000318, "Member 'UK33Power_Addon_16::_survivorRangeDistanceFromKillerToTriggerEffect' has a wrong offset!");
...
static_assert(sizeof(UK33SurvivorDetectedFromTunnelStatusEffect) == 0x000450, "Wrong size on UK33SurvivorDetectedFromTunnelStatusEffect");
static_assert(offsetof(UK33SurvivorDetectedFromTunnelStatusEffect, _timeBetweenFootsteps) == 0x000398, "Member 'UK33SurvivorDetectedFromTunnelStatusEffect::_timeBetweenFootsteps' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectedFromTunnelStatusEffect, _offscreenIndicatorType) == 0x0003C0, "Member 'UK33SurvivorDetectedFromTunnelStatusEffect::_offscreenIndicatorType' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectedFromTunnelStatusEffect, _offscreenIndicatorMinVisibleDistance) == 0x0003C8, "Member 'UK33SurvivorDetectedFromTunnelStatusEffect::_offscreenIndicatorMinVisibleDistance' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectedFromTunnelStatusEffect, _offscreenIndicatorLifetime) == 0x0003F0, "Member 'UK33SurvivorDetectedFromTunnelStatusEffect::_offscreenIndicatorLifetime' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectedFromTunnelStatusEffect, _indicatorLerpMultiplierSpeed) == 0x00042C, "Member 'UK33SurvivorDetectedFromTunnelStatusEffect::_indicatorLerpMultiplierSpeed' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectedFromTunnelStatusEffect, _aboveKillerHeadRange) == 0x000430, "Member 'UK33SurvivorDetectedFromTunnelStatusEffect::_aboveKillerHeadRange' has a wrong offset!");
...
static_assert(sizeof(UK33QuadrupedComponent) == 0x000118, "Wrong size on UK33QuadrupedComponent");
static_assert(offsetof(UK33QuadrupedComponent, _isInQuadrupedMode) == 0x0000C0, "Member 'UK33QuadrupedComponent::_isInQuadrupedMode' has a wrong offset!");
...
static_assert(sizeof(UK33SelectControlStationInteraction) == 0x000770, "Wrong size on UK33SelectControlStationInteraction");
...
static_assert(sizeof(UK33SelectedControlStationLinkedActorOutlineUpdateStrategy) == 0x000150, "Wrong size on UK33SelectedControlStationLinkedActorOutlineUpdateStrategy");
static_assert(offsetof(UK33SelectedControlStationLinkedActorOutlineUpdateStrategy, _revealedColorForSelectedLinkedControlStation) == 0x000100, "Member 'UK33SelectedControlStationLinkedActorOutlineUpdateStrategy::_revealedColorForSelectedLinkedControlStation' has a wrong offset!");
static_assert(offsetof(UK33SelectedControlStationLinkedActorOutlineUpdateStrategy, _revealedColorForTargetedLinkedControlStation) == 0x000110, "Member 'UK33SelectedControlStationLinkedActorOutlineUpdateStrategy::_revealedColorForTargetedLinkedControlStation' has a wrong offset!");
static_assert(offsetof(UK33SelectedControlStationLinkedActorOutlineUpdateStrategy, _exitProximityDistance) == 0x000120, "Member 'UK33SelectedControlStationLinkedActorOutlineUpdateStrategy::_exitProximityDistance' has a wrong offset!");
...
static_assert(sizeof(UK33SpawnTurretInteraction) == 0x000770, "Wrong size on UK33SpawnTurretInteraction");
...
static_assert(sizeof(UK33SpecialModeComponent) == 0x0002A0, "Wrong size on UK33SpecialModeComponent");
static_assert(offsetof(UK33SpecialModeComponent, _isInSpecialMode) == 0x0000C8, "Member 'UK33SpecialModeComponent::_isInSpecialMode' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _specialModeMaxCharge) == 0x000110, "Member 'UK33SpecialModeComponent::_specialModeMaxCharge' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _specialModeMaximumChargePercentOnPickUp) == 0x000138, "Member 'UK33SpecialModeComponent::_specialModeMaximumChargePercentOnPickUp' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _specialModeMovingInTunnelChargeRate) == 0x000160, "Member 'UK33SpecialModeComponent::_specialModeMovingInTunnelChargeRate' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _specialModeDechargeRatePerAttackingTurrets) == 0x000188, "Member 'UK33SpecialModeComponent::_specialModeDechargeRatePerAttackingTurrets' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _terrorRadiusSizeInSpecialMode) == 0x0001B0, "Member 'UK33SpecialModeComponent::_terrorRadiusSizeInSpecialMode' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _specialModeNormalChargeRate) == 0x0001D8, "Member 'UK33SpecialModeComponent::_specialModeNormalChargeRate' has a wrong offset!");
static_assert(offsetof(UK33SpecialModeComponent, _chargeState) == 0x000238, "Member 'UK33SpecialModeComponent::_chargeState' has a wrong offset!");
...
static_assert(sizeof(AK33SurvivorCosmeticHelperActor) == 0x0003E8, "Wrong size on AK33SurvivorCosmeticHelperActor");
...
static_assert(sizeof(UK33SurvivorDetectionComponent) == 0x000258, "Wrong size on UK33SurvivorDetectionComponent");
static_assert(offsetof(UK33SurvivorDetectionComponent, _detectionDistance) == 0x0000B8, "Member 'UK33SurvivorDetectionComponent::_detectionDistance' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectionComponent, _survivorStatusEffect) == 0x000138, "Member 'UK33SurvivorDetectionComponent::_survivorStatusEffect' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectionComponent, _survivorsInRange) == 0x000198, "Member 'UK33SurvivorDetectionComponent::_survivorsInRange' has a wrong offset!");
static_assert(offsetof(UK33SurvivorDetectionComponent, _bufferTimeBeforeActivatingSurvivorDetection) == 0x0001A8, "Member 'UK33SurvivorDetectionComponent::_bufferTimeBeforeActivatingSurvivorDetection' has a wrong offset!");
...
static_assert(sizeof(UK33TailAttack) == 0x000570, "Wrong size on UK33TailAttack");
static_assert(offsetof(UK33TailAttack, _useGamepadEmulationForYaw) == 0x000438, "Member 'UK33TailAttack::_useGamepadEmulationForYaw' has a wrong offset!");
static_assert(offsetof(UK33TailAttack, _yawPitchSpeedSmoothingTime) == 0x000460, "Member 'UK33TailAttack::_yawPitchSpeedSmoothingTime' has a wrong offset!");
static_assert(offsetof(UK33TailAttack, _yawSpeedResetSmoothingTime) == 0x000488, "Member 'UK33TailAttack::_yawSpeedResetSmoothingTime' has a wrong offset!");
static_assert(offsetof(UK33TailAttack, _yawScale) == 0x0004B0, "Member 'UK33TailAttack::_yawScale' has a wrong offset!");
static_assert(offsetof(UK33TailAttack, _pitchScale) == 0x0004D8, "Member 'UK33TailAttack::_pitchScale' has a wrong offset!");
static_assert(offsetof(UK33TailAttack, _yawPitchDelayTime) == 0x000500, "Member 'UK33TailAttack::_yawPitchDelayTime' has a wrong offset!");
...
static_assert(sizeof(UK33TunnelBlockCosmeticActorSpawner) == 0x000440, "Wrong size on UK33TunnelBlockCosmeticActorSpawner");
static_assert(offsetof(UK33TunnelBlockCosmeticActorSpawner, _cosmeticBlockSpawnInfo) == 0x0003B8, "Member 'UK33TunnelBlockCosmeticActorSpawner::_cosmeticBlockSpawnInfo' has a wrong offset!");
static_assert(offsetof(UK33TunnelBlockCosmeticActorSpawner, _selectedTunnelBlockCosmeticClass) == 0x000400, "Member 'UK33TunnelBlockCosmeticActorSpawner::_selectedTunnelBlockCosmeticClass' has a wrong offset!");
static_assert(offsetof(UK33TunnelBlockCosmeticActorSpawner, _editorVariationIndex) == 0x000438, "Member 'UK33TunnelBlockCosmeticActorSpawner::_editorVariationIndex' has a wrong offset!");
...
static_assert(sizeof(UK33TunnelMovementInputAccelerationConstraintStrategyComponent) == 0x0000C8, "Wrong size on UK33TunnelMovementInputAccelerationConstraintStrategyComponent");
static_assert(offsetof(UK33TunnelMovementInputAccelerationConstraintStrategyComponent, _forcedDirectionalInputs) == 0x0000B8, "Member 'UK33TunnelMovementInputAccelerationConstraintStrategyComponent::_forcedDirectionalInputs' has a wrong offset!");
...
static_assert(sizeof(UK33TunnelNavigationComponent) == 0x0001C0, "Wrong size on UK33TunnelNavigationComponent");
static_assert(offsetof(UK33TunnelNavigationComponent, _dotProductDeltaValueForPathRecalculation) == 0x0000B8, "Member 'UK33TunnelNavigationComponent::_dotProductDeltaValueForPathRecalculation' has a wrong offset!");
static_assert(offsetof(UK33TunnelNavigationComponent, _minDistanceDeltaForPathRecalculation) == 0x0000BC, "Member 'UK33TunnelNavigationComponent::_minDistanceDeltaForPathRecalculation' has a wrong offset!");
static_assert(offsetof(UK33TunnelNavigationComponent, _tunnelPulsationComponentClass) == 0x0000C0, "Member 'UK33TunnelNavigationComponent::_tunnelPulsationComponentClass' has a wrong offset!");
static_assert(offsetof(UK33TunnelNavigationComponent, _tunnelPulsationComponent) == 0x0000C8, "Member 'UK33TunnelNavigationComponent::_tunnelPulsationComponent' has a wrong offset!");
static_assert(offsetof(UK33TunnelNavigationComponent, _aimDirectionProvider) == 0x0000D0, "Member 'UK33TunnelNavigationComponent::_aimDirectionProvider' has a wrong offset!");
...
static_assert(sizeof(UK33TunnelPulsationComponent) == 0x000130, "Wrong size on UK33TunnelPulsationComponent");
static_assert(offsetof(UK33TunnelPulsationComponent, _initialPulsePoolSize) == 0x0000B8, "Member 'UK33TunnelPulsationComponent::_initialPulsePoolSize' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _tunnelPulseActorClass) == 0x0000C0, "Member 'UK33TunnelPulsationComponent::_tunnelPulseActorClass' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _pulseSpeed) == 0x0000C8, "Member 'UK33TunnelPulsationComponent::_pulseSpeed' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _timeBetweenPulseWaves) == 0x0000CC, "Member 'UK33TunnelPulsationComponent::_timeBetweenPulseWaves' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _numberOfPulsesPerWaves) == 0x0000D0, "Member 'UK33TunnelPulsationComponent::_numberOfPulsesPerWaves' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _timeBetweenPulsesInWave) == 0x0000D4, "Member 'UK33TunnelPulsationComponent::_timeBetweenPulsesInWave' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _minDistanceToTriggerNextPulseWave) == 0x0000D8, "Member 'UK33TunnelPulsationComponent::_minDistanceToTriggerNextPulseWave' has a wrong offset!");
static_assert(offsetof(UK33TunnelPulsationComponent, _pool) == 0x0000E0, "Member 'UK33TunnelPulsationComponent::_pool' has a wrong offset!");
...
static_assert(sizeof(AK33Turret) == 0x000658, "Wrong size on AK33Turret");
static_assert(offsetof(AK33Turret, _rootComponent) == 0x000558, "Member 'AK33Turret::_rootComponent' has a wrong offset!");
static_assert(offsetof(AK33Turret, _interactableZone) == 0x000560, "Member 'AK33Turret::_interactableZone' has a wrong offset!");
static_assert(offsetof(AK33Turret, _turretInteractor) == 0x000568, "Member 'AK33Turret::_turretInteractor' has a wrong offset!");
static_assert(offsetof(AK33Turret, _dropInteraction) == 0x000570, "Member 'AK33Turret::_dropInteraction' has a wrong offset!");
static_assert(offsetof(AK33Turret, _collectInteraction) == 0x000578, "Member 'AK33Turret::_collectInteraction' has a wrong offset!");
static_assert(offsetof(AK33Turret, _outlineComponent) == 0x000580, "Member 'AK33Turret::_outlineComponent' has a wrong offset!");
static_assert(offsetof(AK33Turret, _materialHelper) == 0x000588, "Member 'AK33Turret::_materialHelper' has a wrong offset!");
static_assert(offsetof(AK33Turret, _turretOutlineUpdateStrategy) == 0x000590, "Member 'AK33Turret::_turretOutlineUpdateStrategy' has a wrong offset!");
static_assert(offsetof(AK33Turret, _turretRepairChargeable) == 0x000598, "Member 'AK33Turret::_turretRepairChargeable' has a wrong offset!");
static_assert(offsetof(AK33Turret, _montagePlayer) == 0x0005A0, "Member 'AK33Turret::_montagePlayer' has a wrong offset!");
static_assert(offsetof(AK33Turret, _montageFollower) == 0x0005A8, "Member 'AK33Turret::_montageFollower' has a wrong offset!");
static_assert(offsetof(AK33Turret, _turretCollision) == 0x0005B0, "Member 'AK33Turret::_turretCollision' has a wrong offset!");
static_assert(offsetof(AK33Turret, _tailAttackCollision) == 0x0005B8, "Member 'AK33Turret::_tailAttackCollision' has a wrong offset!");
static_assert(offsetof(AK33Turret, _dangerPredictionComponent) == 0x0005C0, "Member 'AK33Turret::_dangerPredictionComponent' has a wrong offset!");
static_assert(offsetof(AK33Turret, _navModifierComponent) == 0x0005C8, "Member 'AK33Turret::_navModifierComponent' has a wrong offset!");
static_assert(offsetof(AK33Turret, _laserRoot) == 0x0005D0, "Member 'AK33Turret::_laserRoot' has a wrong offset!");
static_assert(offsetof(AK33Turret, _poolableActorComponent) == 0x0005D8, "Member 'AK33Turret::_poolableActorComponent' has a wrong offset!");
static_assert(offsetof(AK33Turret, _turretStateController) == 0x0005E0, "Member 'AK33Turret::_turretStateController' has a wrong offset!");
static_assert(offsetof(AK33Turret, _detectionSocketName) == 0x0005E8, "Member 'AK33Turret::_detectionSocketName' has a wrong offset!");
...
static_assert(sizeof(UK33TurretAudioVolumeAdjuster) == 0x000158, "Wrong size on UK33TurretAudioVolumeAdjuster");
static_assert(offsetof(UK33TurretAudioVolumeAdjuster, _distanceToTrackTurrets) == 0x00014C, "Member 'UK33TurretAudioVolumeAdjuster::_distanceToTrackTurrets' has a wrong offset!");
...
static_assert(sizeof(UK33TurretCollisionsHandler) == 0x0000D8, "Wrong size on UK33TurretCollisionsHandler");
...
static_assert(sizeof(UK33TurretDamageComponent) == 0x0002D0, "Wrong size on UK33TurretDamageComponent");
static_assert(offsetof(UK33TurretDamageComponent, _currentDamageAmount) == 0x0000E8, "Member 'UK33TurretDamageComponent::_currentDamageAmount' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _isAttackedByTurret) == 0x0000F0, "Member 'UK33TurretDamageComponent::_isAttackedByTurret' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _stunnedAfterFullyDamagedEffect) == 0x000180, "Member 'UK33TurretDamageComponent::_stunnedAfterFullyDamagedEffect' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _stunnedAfterFullyDamagedDuration) == 0x000188, "Member 'UK33TurretDamageComponent::_stunnedAfterFullyDamagedDuration' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _maxDamageAmount) == 0x0001B0, "Member 'UK33TurretDamageComponent::_maxDamageAmount' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _damageReductionRate) == 0x000230, "Member 'UK33TurretDamageComponent::_damageReductionRate' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _damageRatePerTurretCurveFloat) == 0x000258, "Member 'UK33TurretDamageComponent::_damageRatePerTurretCurveFloat' has a wrong offset!");
static_assert(offsetof(UK33TurretDamageComponent, _damageReductionDelayDuration) == 0x000260, "Member 'UK33TurretDamageComponent::_damageReductionDelayDuration' has a wrong offset!");
...
static_assert(sizeof(UK33TurretDangerPredictionComponent) == 0x000158, "Wrong size on UK33TurretDangerPredictionComponent");
static_assert(offsetof(UK33TurretDangerPredictionComponent, MinimumLureDistanceFromKiller) == 0x000120, "Member 'UK33TurretDangerPredictionComponent::MinimumLureDistanceFromKiller' has a wrong offset!");
static_assert(offsetof(UK33TurretDangerPredictionComponent, IdealDistanceBehindTurret) == 0x000124, "Member 'UK33TurretDangerPredictionComponent::IdealDistanceBehindTurret' has a wrong offset!");
static_assert(offsetof(UK33TurretDangerPredictionComponent, MaxPenaltyAtAngle) == 0x000128, "Member 'UK33TurretDangerPredictionComponent::MaxPenaltyAtAngle' has a wrong offset!");
...
static_assert(sizeof(UK33TurretDestructionComponent) == 0x0001A8, "Wrong size on UK33TurretDestructionComponent");
static_assert(offsetof(UK33TurretDestructionComponent, _autoDestroyTime) == 0x0000B8, "Member 'UK33TurretDestructionComponent::_autoDestroyTime' has a wrong offset!");
static_assert(offsetof(UK33TurretDestructionComponent, _autoDestroyPauseSurvivorRange) == 0x0000E0, "Member 'UK33TurretDestructionComponent::_autoDestroyPauseSurvivorRange' has a wrong offset!");
...
static_assert(sizeof(UK33TurretKillerAttackComponent) == 0x0002F0, "Wrong size on UK33TurretKillerAttackComponent");
static_assert(offsetof(UK33TurretKillerAttackComponent, _isAttacking) == 0x0000D0, "Member 'UK33TurretKillerAttackComponent::_isAttacking' has a wrong offset!");
static_assert(offsetof(UK33TurretKillerAttackComponent, _bipedRaycastProperties) == 0x0001B0, "Member 'UK33TurretKillerAttackComponent::_bipedRaycastProperties' has a wrong offset!");
static_assert(offsetof(UK33TurretKillerAttackComponent, _quadrupedRaycastProperties) == 0x0001C0, "Member 'UK33TurretKillerAttackComponent::_quadrupedRaycastProperties' has a wrong offset!");
static_assert(offsetof(UK33TurretKillerAttackComponent, _killerDetectionRadius) == 0x0001D0, "Member 'UK33TurretKillerAttackComponent::_killerDetectionRadius' has a wrong offset!");
static_assert(offsetof(UK33TurretKillerAttackComponent, _killerDetectionHeightRange) == 0x000250, "Member 'UK33TurretKillerAttackComponent::_killerDetectionHeightRange' has a wrong offset!");
static_assert(offsetof(UK33TurretKillerAttackComponent, _sphereTraceRadius) == 0x000258, "Member 'UK33TurretKillerAttackComponent::_sphereTraceRadius' has a wrong offset!");
static_assert(offsetof(UK33TurretKillerAttackComponent, _stateTagsPreventingKillerDetection) == 0x000260, "Member 'UK33TurretKillerAttackComponent::_stateTagsPreventingKillerDetection' has a wrong offset!");
...
static_assert(sizeof(UK33TurretLaserComponent) == 0x0000D8, "Wrong size on UK33TurretLaserComponent");
...
static_assert(sizeof(UK33TurretMalfunctionComponent) == 0x0001C0, "Wrong size on UK33TurretMalfunctionComponent");
static_assert(offsetof(UK33TurretMalfunctionComponent, _malfunctionDuration) == 0x000118, "Member 'UK33TurretMalfunctionComponent::_malfunctionDuration' has a wrong offset!");
...
static_assert(sizeof(UK33TurretMotionTrackerComponent) == 0x000118, "Wrong size on UK33TurretMotionTrackerComponent");
static_assert(offsetof(UK33TurretMotionTrackerComponent, _secondsBetweenBipSoundPerKillerDistanceCurve) == 0x0000C0, "Member 'UK33TurretMotionTrackerComponent::_secondsBetweenBipSoundPerKillerDistanceCurve' has a wrong offset!");
static_assert(offsetof(UK33TurretMotionTrackerComponent, _motionTrackerMaxDetectionRange) == 0x0000F0, "Member 'UK33TurretMotionTrackerComponent::_motionTrackerMaxDetectionRange' has a wrong offset!");
...
static_assert(sizeof(UK33TurretOutlineUpdateStrategy) == 0x000198, "Wrong size on UK33TurretOutlineUpdateStrategy");
static_assert(offsetof(UK33TurretOutlineUpdateStrategy, _outlineColor) == 0x000174, "Member 'UK33TurretOutlineUpdateStrategy::_outlineColor' has a wrong offset!");
...
static_assert(sizeof(UK33TurretOverheatComponent) == 0x000160, "Wrong size on UK33TurretOverheatComponent");
static_assert(offsetof(UK33TurretOverheatComponent, _currentHeatAmount) == 0x0000B8, "Member 'UK33TurretOverheatComponent::_currentHeatAmount' has a wrong offset!");
static_assert(offsetof(UK33TurretOverheatComponent, _turretHeatAccumulationRate) == 0x0000C0, "Member 'UK33TurretOverheatComponent::_turretHeatAccumulationRate' has a wrong offset!");
static_assert(offsetof(UK33TurretOverheatComponent, _turretHeatDissipationRate) == 0x0000E8, "Member 'UK33TurretOverheatComponent::_turretHeatDissipationRate' has a wrong offset!");
...
static_assert(sizeof(UK33TurretPlacementValidationStrategy) == 0x000148, "Wrong size on UK33TurretPlacementValidationStrategy");
static_assert(offsetof(UK33TurretPlacementValidationStrategy, _navmeshProjectionBoxExtent) == 0x000110, "Member 'UK33TurretPlacementValidationStrategy::_navmeshProjectionBoxExtent' has a wrong offset!");
static_assert(offsetof(UK33TurretPlacementValidationStrategy, _navmeshProjectionBoxExtentForSnapping) == 0x000128, "Member 'UK33TurretPlacementValidationStrategy::_navmeshProjectionBoxExtentForSnapping' has a wrong offset!");
...
static_assert(sizeof(UK33TurretPlacer) == 0x0003E0, "Wrong size on UK33TurretPlacer");
static_assert(offsetof(UK33TurretPlacer, _turretVisualPlacementStaticMeshComponentClass) == 0x000378, "Member 'UK33TurretPlacer::_turretVisualPlacementStaticMeshComponentClass' has a wrong offset!");
static_assert(offsetof(UK33TurretPlacer, _replicatedIsPlacementValid) == 0x000380, "Member 'UK33TurretPlacer::_replicatedIsPlacementValid' has a wrong offset!");
static_assert(offsetof(UK33TurretPlacer, _replicatedPlacementLocation) == 0x000388, "Member 'UK33TurretPlacer::_replicatedPlacementLocation' has a wrong offset!");
static_assert(offsetof(UK33TurretPlacer, _turretStaticMesh) == 0x0003C0, "Member 'UK33TurretPlacer::_turretStaticMesh' has a wrong offset!");
static_assert(offsetof(UK33TurretPlacer, _otherTurretsDropOffLocations) == 0x0003C8, "Member 'UK33TurretPlacer::_otherTurretsDropOffLocations' has a wrong offset!");
static_assert(offsetof(UK33TurretPlacer, _turretMeshLerpSpeed) == 0x0003D8, "Member 'UK33TurretPlacer::_turretMeshLerpSpeed' has a wrong offset!");
