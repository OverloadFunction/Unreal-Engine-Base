...
static_assert(sizeof(WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup) == 0x000068, "Wrong size on WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup");
...
static_assert(offsetof(WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup, K2Node_Event_limitReached) == 0x000038, "Member 'WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup::K2Node_Event_limitReached' has a wrong offset!");
static_assert(offsetof(WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup, K2Node_MakeStruct_SlateColor_1) == 0x00003C, "Member 'WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup::K2Node_MakeStruct_SlateColor_1' has a wrong offset!");
static_assert(offsetof(WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup, K2Node_Select_Default) == 0x000050, "Member 'WBP_CoreGenericTextInputPopup_C_ExecuteUbergraph_WBP_CoreGenericTextInputPopup::K2Node_Select_Default' has a wrong offset!");
