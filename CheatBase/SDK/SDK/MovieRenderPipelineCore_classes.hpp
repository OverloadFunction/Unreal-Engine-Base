...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x0002A8, "Wrong size on UMovieRenderDebugWidget");
...
static_assert(sizeof(UMoviePipelineConfigBase) == 0x000090, "Wrong size on UMoviePipelineConfigBase");
...
static_assert(sizeof(UMoviePipelinePrimaryConfig) == 0x0000F8, "Wrong size on UMoviePipelinePrimaryConfig");
static_assert(offsetof(UMoviePipelinePrimaryConfig, PerShotConfigMapping) == 0x000090, "Member 'UMoviePipelinePrimaryConfig::PerShotConfigMapping' has a wrong offset!");
static_assert(offsetof(UMoviePipelinePrimaryConfig, OutputSetting) == 0x0000E0, "Member 'UMoviePipelinePrimaryConfig::OutputSetting' has a wrong offset!");
static_assert(offsetof(UMoviePipelinePrimaryConfig, TransientSettings) == 0x0000E8, "Member 'UMoviePipelinePrimaryConfig::TransientSettings' has a wrong offset!");
...
static_assert(sizeof(UMoviePipelineExecutorShot) == 0x000168, "Wrong size on UMoviePipelineExecutorShot");
...
static_assert(sizeof(UMoviePipelineExecutorJob) == 0x000130, "Wrong size on UMoviePipelineExecutorJob");
...
static_assert(sizeof(UMoviePipelineQueue) == 0x000080, "Wrong size on UMoviePipelineQueue");
...
static_assert(sizeof(UMoviePipelineShotConfig) == 0x000090, "Wrong size on UMoviePipelineShotConfig");
