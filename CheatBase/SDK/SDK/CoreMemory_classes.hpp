...
static_assert(sizeof(UCoreMemoryAtEndTrialCountQEEvaluator) == 0x0000C8, "Wrong size on UCoreMemoryAtEndTrialCountQEEvaluator");
...
static_assert(sizeof(UCoreMemoryController) == 0x000120, "Wrong size on UCoreMemoryController");
...
static_assert(offsetof(UCoreMemoryController, _archiveSpecialBehaviourId) == 0x0000D8, "Member 'UCoreMemoryController::_archiveSpecialBehaviourId' has a wrong offset!");
static_assert(offsetof(UCoreMemoryController, _coreMemoryPortalClass) == 0x0000E8, "Member 'UCoreMemoryController::_coreMemoryPortalClass' has a wrong offset!");
static_assert(offsetof(UCoreMemoryController, _coreMemoryPortal) == 0x0000F0, "Member 'UCoreMemoryController::_coreMemoryPortal' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryFragmentComponent) == 0x000198, "Wrong size on UCoreMemoryFragmentComponent");
static_assert(offsetof(UCoreMemoryFragmentComponent, _owningPlayer) == 0x000118, "Member 'UCoreMemoryFragmentComponent::_owningPlayer' has a wrong offset!");
...
static_assert(offsetof(UCoreMemoryFragmentComponent, _wasTriggered) == 0x000129, "Member 'UCoreMemoryFragmentComponent::_wasTriggered' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentComponent, _killerPreventingTags) == 0x000130, "Member 'UCoreMemoryFragmentComponent::_killerPreventingTags' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentComponent, _camperPreventingTags) == 0x000150, "Member 'UCoreMemoryFragmentComponent::_camperPreventingTags' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentComponent, _isDespawned) == 0x000178, "Member 'UCoreMemoryFragmentComponent::_isDespawned' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentComponent, _wasCollected) == 0x000179, "Member 'UCoreMemoryFragmentComponent::_wasCollected' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryFragmentFXComponent) == 0x000140, "Wrong size on UCoreMemoryFragmentFXComponent");
...
static_assert(offsetof(UCoreMemoryFragmentFXComponent, Cosmetic_FragmentSpawned) == 0x0000C8, "Member 'UCoreMemoryFragmentFXComponent::Cosmetic_FragmentSpawned' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentFXComponent, Cosmetic_FragmentDespawn) == 0x0000D8, "Member 'UCoreMemoryFragmentFXComponent::Cosmetic_FragmentDespawn' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentFXComponent, Cosmetic_FragmentCollected) == 0x0000E8, "Member 'UCoreMemoryFragmentFXComponent::Cosmetic_FragmentCollected' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentFXComponent, _tendrilMeshRotationOffset) == 0x0000F8, "Member 'UCoreMemoryFragmentFXComponent::_tendrilMeshRotationOffset' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentFXComponent, _hoverHeight) == 0x000110, "Member 'UCoreMemoryFragmentFXComponent::_hoverHeight' has a wrong offset!");
static_assert(offsetof(UCoreMemoryFragmentFXComponent, Cosmetic_FragmentDespawnCountingDown) == 0x000130, "Member 'UCoreMemoryFragmentFXComponent::Cosmetic_FragmentDespawnCountingDown' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryFragmentNavAgentComponent) == 0x0000C0, "Wrong size on UCoreMemoryFragmentNavAgentComponent");
...
static_assert(sizeof(UCoreMemoryFragmentOutlineUpdateStrategy) == 0x000100, "Wrong size on UCoreMemoryFragmentOutlineUpdateStrategy");
...
static_assert(sizeof(UCoreMemoryFragmentNotCollectedOutlineUpdateStrategy) == 0x000100, "Wrong size on UCoreMemoryFragmentNotCollectedOutlineUpdateStrategy");
...
static_assert(sizeof(UCoreMemoryFragmentNotCollectedWithinRangeOutlineUpdateStrategy) == 0x000108, "Wrong size on UCoreMemoryFragmentNotCollectedWithinRangeOutlineUpdateStrategy");
static_assert(offsetof(UCoreMemoryFragmentNotCollectedWithinRangeOutlineUpdateStrategy, _auraDisplayedRange) == 0x000100, "Member 'UCoreMemoryFragmentNotCollectedWithinRangeOutlineUpdateStrategy::_auraDisplayedRange' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryFragmentNotTriggeredOutlineUpdateStrategy) == 0x000100, "Wrong size on UCoreMemoryFragmentNotTriggeredOutlineUpdateStrategy");
...
static_assert(sizeof(UCoreMemoryFragmentSimpleMovementComponent) == 0x000108, "Wrong size on UCoreMemoryFragmentSimpleMovementComponent");
...
static_assert(offsetof(UCoreMemoryFragmentSimpleMovementComponent, _speedCurve) == 0x0000F8, "Member 'UCoreMemoryFragmentSimpleMovementComponent::_speedCurve' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryFragmentToPositionMovementComponent) == 0x000128, "Wrong size on UCoreMemoryFragmentToPositionMovementComponent");
static_assert(offsetof(UCoreMemoryFragmentToPositionMovementComponent, _fragmentMoveSpeed) == 0x000100, "Member 'UCoreMemoryFragmentToPositionMovementComponent::_fragmentMoveSpeed' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryNavMovementComponent) == 0x000238, "Wrong size on UCoreMemoryNavMovementComponent");
static_assert(offsetof(UCoreMemoryNavMovementComponent, _moveRequest) == 0x000198, "Member 'UCoreMemoryNavMovementComponent::_moveRequest' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavMovementComponent, _navFilter) == 0x0001E8, "Member 'UCoreMemoryNavMovementComponent::_navFilter' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavMovementComponent, _movementAcceptanceRadius) == 0x0001F0, "Member 'UCoreMemoryNavMovementComponent::_movementAcceptanceRadius' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavMovementComponent, _fragmentMoveSpeed) == 0x0001F8, "Member 'UCoreMemoryNavMovementComponent::_fragmentMoveSpeed' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavMovementComponent, _navAgentComponent) == 0x000220, "Member 'UCoreMemoryNavMovementComponent::_navAgentComponent' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryNavToLocationMovementComponent) == 0x000240, "Wrong size on UCoreMemoryNavToLocationMovementComponent");
static_assert(offsetof(UCoreMemoryNavToLocationMovementComponent, _moveRequest) == 0x0001B0, "Member 'UCoreMemoryNavToLocationMovementComponent::_moveRequest' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavToLocationMovementComponent, _navFilter) == 0x000200, "Member 'UCoreMemoryNavToLocationMovementComponent::_navFilter' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavToLocationMovementComponent, _movementAcceptanceRadius) == 0x000208, "Member 'UCoreMemoryNavToLocationMovementComponent::_movementAcceptanceRadius' has a wrong offset!");
static_assert(offsetof(UCoreMemoryNavToLocationMovementComponent, _navAgentComponent) == 0x000210, "Member 'UCoreMemoryNavToLocationMovementComponent::_navAgentComponent' has a wrong offset!");
...
static_assert(sizeof(UCoreMemoryPortalFXComponent) == 0x000120, "Wrong size on UCoreMemoryPortalFXComponent");
...
static_assert(sizeof(UCoreMemoryPortalOutlineUpdateStrategy) == 0x000110, "Wrong size on UCoreMemoryPortalOutlineUpdateStrategy");
static_assert(offsetof(UCoreMemoryPortalOutlineUpdateStrategy, _outlineColor) == 0x000100, "Member 'UCoreMemoryPortalOutlineUpdateStrategy::_outlineColor' has a wrong offset!");
...
static_assert(alignof(UCoreMemoryRoleSpecificQuestProgressBehaviour) == 0x000008, "Wrong alignment on UCoreMemoryRoleSpecificQuestProgressBehaviour");
static_assert(sizeof(UCoreMemoryRoleSpecificQuestProgressBehaviour) == 0x000088, "Wrong size on UCoreMemoryRoleSpecificQuestProgressBehaviour");
static_assert(offsetof(UCoreMemoryRoleSpecificQuestProgressBehaviour, _roleSpecificTagsForSurvivor) == 0x000068, "Member 'UCoreMemoryRoleSpecificQuestProgressBehaviour::_roleSpecificTagsForSurvivor' has a wrong offset!");
static_assert(offsetof(UCoreMemoryRoleSpecificQuestProgressBehaviour, _roleSpecificTagsForKiller) == 0x000078, "Member 'UCoreMemoryRoleSpecificQuestProgressBehaviour::_roleSpecificTagsForKiller' has a wrong offset!");
...
static_assert(sizeof(UCoreMemorySpawnedStatusEffectTrackerComponent) == 0x0000D0, "Wrong size on UCoreMemorySpawnedStatusEffectTrackerComponent");
static_assert(offsetof(UCoreMemorySpawnedStatusEffectTrackerComponent, _authority_spawnedStatusEffects) == 0x0000B8, "Member 'UCoreMemorySpawnedStatusEffectTrackerComponent::_authority_spawnedStatusEffects' has a wrong offset!");
static_assert(offsetof(UCoreMemorySpawnedStatusEffectTrackerComponent, _authority_imposeStatusEffectBehaviour) == 0x0000C8, "Member 'UCoreMemorySpawnedStatusEffectTrackerComponent::_authority_imposeStatusEffectBehaviour' has a wrong offset!");
