...
static_assert(offsetof(ClosetStun_C_ExecuteUbergraph_ClosetStun, K2Node_DynamicCast_AsSurvivor) == 0x000090, "Member 'ClosetStun_C_ExecuteUbergraph_ClosetStun::K2Node_DynamicCast_AsSurvivor' has a wrong offset!");
