...
public:
	...
	TSoftObjectPtr<class UMaterialInterface>      Material;                                          // 0x0008(0x0038)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMoviePipelinePostProcessPass) == 0x000008, "Wrong alignment on FMoviePipelinePostProcessPass");
static_assert(sizeof(FMoviePipelinePostProcessPass) == 0x000040, "Wrong size on FMoviePipelinePostProcessPass");
