...
static_assert(sizeof(UUIDataManager) == 0x000388, "Wrong size on UUIDataManager");
...
static_assert(offsetof(UUIDataManager, TooltipEventSkinUIDataMap) == 0x0001C8, "Member 'UUIDataManager::TooltipEventSkinUIDataMap' has a wrong offset!");
static_assert(offsetof(UUIDataManager, AlertRewardEventSkinUIDataMap) == 0x000218, "Member 'UUIDataManager::AlertRewardEventSkinUIDataMap' has a wrong offset!");
static_assert(offsetof(UUIDataManager, ChallengeTrackerSkinUiDataMap) == 0x000268, "Member 'UUIDataManager::ChallengeTrackerSkinUiDataMap' has a wrong offset!");
static_assert(offsetof(UUIDataManager, InboxSkinUiDataMap) == 0x0002B8, "Member 'UUIDataManager::InboxSkinUiDataMap' has a wrong offset!");
...
static_assert(sizeof(UUIEventDispatcher) == 0x0004A0, "Wrong size on UUIEventDispatcher");
static_assert(offsetof(UUIEventDispatcher, OnDrawScaleformBlockingArea) == 0x000348, "Member 'UUIEventDispatcher::OnDrawScaleformBlockingArea' has a wrong offset!");
static_assert(offsetof(UUIEventDispatcher, OnRemoveScaleformBlockingArea) == 0x000358, "Member 'UUIEventDispatcher::OnRemoveScaleformBlockingArea' has a wrong offset!");
