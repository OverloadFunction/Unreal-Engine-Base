...
static_assert(offsetof(BP_Audio_Killer_AnimNotifies_Handler_C_HandleAnimNotify, K2Node_DynamicCast_AsKiller) == 0x000018, "Member 'BP_Audio_Killer_AnimNotifies_Handler_C_HandleAnimNotify::K2Node_DynamicCast_AsKiller' has a wrong offset!");
