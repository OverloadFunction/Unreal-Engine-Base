...
static_assert(sizeof(FDataStreamDefinition) == 0x000028, "Wrong size on FDataStreamDefinition");
...
static_assert(offsetof(FDataStreamDefinition, ClassName) == 0x00000C, "Member 'FDataStreamDefinition::ClassName' has a wrong offset!");
static_assert(offsetof(FDataStreamDefinition, Class) == 0x000018, "Member 'FDataStreamDefinition::Class' has a wrong offset!");
static_assert(offsetof(FDataStreamDefinition, DefaultSendStatus) == 0x000020, "Member 'FDataStreamDefinition::DefaultSendStatus' has a wrong offset!");
static_assert(offsetof(FDataStreamDefinition, bAutoCreate) == 0x000021, "Member 'FDataStreamDefinition::bAutoCreate' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicationBridgeFilterConfig) == 0x000018, "Wrong size on FObjectReplicationBridgeFilterConfig");
...
static_assert(offsetof(FObjectReplicationBridgeFilterConfig, DynamicFilterName) == 0x00000C, "Member 'FObjectReplicationBridgeFilterConfig::DynamicFilterName' has a wrong offset!");
...
static_assert(sizeof(FNetBlobHandlerDefinition) == 0x00000C, "Wrong size on FNetBlobHandlerDefinition");
...
static_assert(sizeof(FNetObjectFilterDefinition) == 0x000024, "Wrong size on FNetObjectFilterDefinition");
...
static_assert(offsetof(FNetObjectFilterDefinition, ClassName) == 0x00000C, "Member 'FNetObjectFilterDefinition::ClassName' has a wrong offset!");
static_assert(offsetof(FNetObjectFilterDefinition, ConfigClassName) == 0x000018, "Member 'FNetObjectFilterDefinition::ConfigClassName' has a wrong offset!");
...
static_assert(sizeof(FNetObjectPrioritizerDefinition) == 0x000038, "Wrong size on FNetObjectPrioritizerDefinition");
...
static_assert(offsetof(FNetObjectPrioritizerDefinition, ClassName) == 0x00000C, "Member 'FNetObjectPrioritizerDefinition::ClassName' has a wrong offset!");
static_assert(offsetof(FNetObjectPrioritizerDefinition, Class) == 0x000018, "Member 'FNetObjectPrioritizerDefinition::Class' has a wrong offset!");
static_assert(offsetof(FNetObjectPrioritizerDefinition, ConfigClassName) == 0x000020, "Member 'FNetObjectPrioritizerDefinition::ConfigClassName' has a wrong offset!");
static_assert(offsetof(FNetObjectPrioritizerDefinition, ConfigClass) == 0x000030, "Member 'FNetObjectPrioritizerDefinition::ConfigClass' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicationBridgePollConfig) == 0x000014, "Wrong size on FObjectReplicationBridgePollConfig");
...
static_assert(offsetof(FObjectReplicationBridgePollConfig, PollFramePeriod) == 0x00000C, "Member 'FObjectReplicationBridgePollConfig::PollFramePeriod' has a wrong offset!");
static_assert(offsetof(FObjectReplicationBridgePollConfig, bIncludeSubclasses) == 0x000010, "Member 'FObjectReplicationBridgePollConfig::bIncludeSubclasses' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicationBridgePrioritizerConfig) == 0x000018, "Wrong size on FObjectReplicationBridgePrioritizerConfig");
...
static_assert(offsetof(FObjectReplicationBridgePrioritizerConfig, PrioritizerName) == 0x00000C, "Member 'FObjectReplicationBridgePrioritizerConfig::PrioritizerName' has a wrong offset!");
...
static_assert(sizeof(FObjectReplicationBridgeDeltaCompressionConfig) == 0x000010, "Wrong size on FObjectReplicationBridgeDeltaCompressionConfig");
...
static_assert(offsetof(FObjectReplicationBridgeDeltaCompressionConfig, bEnableDeltaCompression) == 0x00000C, "Member 'FObjectReplicationBridgeDeltaCompressionConfig::bEnableDeltaCompression' has a wrong offset!");
...
static_assert(sizeof(FSupportsStructNetSerializerConfig) == 0x000010, "Wrong size on FSupportsStructNetSerializerConfig");
...
static_assert(offsetof(FSupportsStructNetSerializerConfig, bCanUseStructNetSerializer) == 0x00000C, "Member 'FSupportsStructNetSerializerConfig::bCanUseStructNetSerializer' has a wrong offset!");
