...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x000820, "Wrong size on UVoipListenerSynthComponent");
...
static_assert(offsetof(AOnlineBeaconHost, bAuthRequired) == 0x0002DC, "Member 'AOnlineBeaconHost::bAuthRequired' has a wrong offset!");
...
static_assert(sizeof(UIpConnection) == 0x001E68, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001E4C, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
static_assert(sizeof(UOnlineSessionClient) == 0x000218, "Wrong size on UOnlineSessionClient");
static_assert(offsetof(UOnlineSessionClient, bIsFromInvite) == 0x000210, "Member 'UOnlineSessionClient::bIsFromInvite' has a wrong offset!");
static_assert(offsetof(UOnlineSessionClient, bHandlingDisconnect) == 0x000211, "Member 'UOnlineSessionClient::bHandlingDisconnect' has a wrong offset!");
