...
static_assert(sizeof(UIKRigComponent) == 0x0000D0, "Wrong size on UIKRigComponent");
...
static_assert(offsetof(UIKRigDefinition, Skeleton) == 0x000070, "Member 'UIKRigDefinition::Skeleton' has a wrong offset!");
static_assert(offsetof(UIKRigDefinition, Goals) == 0x0000E0, "Member 'UIKRigDefinition::Goals' has a wrong offset!");
static_assert(offsetof(UIKRigDefinition, Solvers) == 0x0000F0, "Member 'UIKRigDefinition::Solvers' has a wrong offset!");
static_assert(offsetof(UIKRigDefinition, RetargetDefinition) == 0x000100, "Member 'UIKRigDefinition::RetargetDefinition' has a wrong offset!");
...
static_assert(sizeof(UIKRetargeter) == 0x000248, "Wrong size on UIKRetargeter");
static_assert(offsetof(UIKRetargeter, SourceIKRigAsset) == 0x000030, "Member 'UIKRetargeter::SourceIKRigAsset' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, TargetIKRigAsset) == 0x000068, "Member 'UIKRetargeter::TargetIKRigAsset' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, ChainMapping) == 0x0000A0, "Member 'UIKRetargeter::ChainMapping' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, ChainSettings) == 0x0000B0, "Member 'UIKRetargeter::ChainSettings' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, RootSettings) == 0x0000C0, "Member 'UIKRetargeter::RootSettings' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, GlobalSettings) == 0x0000C8, "Member 'UIKRetargeter::GlobalSettings' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, Profiles) == 0x0000D0, "Member 'UIKRetargeter::Profiles' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, CurrentProfile) == 0x000120, "Member 'UIKRetargeter::CurrentProfile' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, SourceRetargetPoses) == 0x000130, "Member 'UIKRetargeter::SourceRetargetPoses' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, TargetRetargetPoses) == 0x000180, "Member 'UIKRetargeter::TargetRetargetPoses' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, CurrentSourceRetargetPose) == 0x0001D0, "Member 'UIKRetargeter::CurrentSourceRetargetPose' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, CurrentTargetRetargetPose) == 0x0001DC, "Member 'UIKRetargeter::CurrentTargetRetargetPose' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, RetargetPoses) == 0x0001E8, "Member 'UIKRetargeter::RetargetPoses' has a wrong offset!");
static_assert(offsetof(UIKRetargeter, CurrentRetargetPose) == 0x000238, "Member 'UIKRetargeter::CurrentRetargetPose' has a wrong offset!");
