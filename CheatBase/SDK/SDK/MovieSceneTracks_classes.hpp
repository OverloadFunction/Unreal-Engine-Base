...
static_assert(sizeof(UMovieSceneAudioSection) == 0x000638, "Wrong size on UMovieSceneAudioSection");
...
static_assert(offsetof(UMovieSceneAudioSection, OnAudioFinished) == 0x000618, "Member 'UMovieSceneAudioSection::OnAudioFinished' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnAudioPlaybackPercent) == 0x000628, "Member 'UMovieSceneAudioSection::OnAudioPlaybackPercent' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, params) == 0x000100, "Member 'UMovieSceneSkeletalAnimationSection::params' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneObjectPropertyTrack) == 0x0000E8, "Wrong size on UMovieSceneObjectPropertyTrack");
static_assert(offsetof(UMovieSceneObjectPropertyTrack, PropertyClass) == 0x0000E0, "Member 'UMovieSceneObjectPropertyTrack::PropertyClass' has a wrong offset!");
