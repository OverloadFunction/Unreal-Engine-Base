...
static_assert(sizeof(RigHierarchy_FindControl_ForBlueprintOnly) == 0x000980, "Wrong size on RigHierarchy_FindControl_ForBlueprintOnly");
...
static_assert(sizeof(RigHierarchyController_AddAnimationChannel_ForBlueprint) == 0x0001F0, "Wrong size on RigHierarchyController_AddAnimationChannel_ForBlueprint");
...
static_assert(offsetof(RigHierarchyController_AddAnimationChannel_ForBlueprint, bSetupUndo) == 0x0001D8, "Member 'RigHierarchyController_AddAnimationChannel_ForBlueprint::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddAnimationChannel_ForBlueprint, bPrintPythonCommand) == 0x0001D9, "Member 'RigHierarchyController_AddAnimationChannel_ForBlueprint::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddAnimationChannel_ForBlueprint, ReturnValue) == 0x0001DC, "Member 'RigHierarchyController_AddAnimationChannel_ForBlueprint::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(RigHierarchyController_AddControl_ForBlueprint) == 0x000270, "Wrong size on RigHierarchyController_AddControl_ForBlueprint");
...
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, InValue) == 0x0001D8, "Member 'RigHierarchyController_AddControl_ForBlueprint::InValue' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, bSetupUndo) == 0x00025C, "Member 'RigHierarchyController_AddControl_ForBlueprint::bSetupUndo' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, bPrintPythonCommand) == 0x00025D, "Member 'RigHierarchyController_AddControl_ForBlueprint::bPrintPythonCommand' has a wrong offset!");
static_assert(offsetof(RigHierarchyController_AddControl_ForBlueprint, ReturnValue) == 0x000260, "Member 'RigHierarchyController_AddControl_ForBlueprint::ReturnValue' has a wrong offset!");
