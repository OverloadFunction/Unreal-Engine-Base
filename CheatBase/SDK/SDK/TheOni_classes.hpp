...
static_assert(sizeof(UAbsorbBloodOrbsInteraction) == 0x0007B0, "Wrong size on UAbsorbBloodOrbsInteraction");
...
static_assert(sizeof(UAISkill_FindOrb) == 0x000390, "Wrong size on UAISkill_FindOrb");
static_assert(offsetof(UAISkill_FindOrb, BloodOrbVisionRange) == 0x000300, "Member 'UAISkill_FindOrb::BloodOrbVisionRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindOrb, BloodOrbMaxDensityWeight) == 0x000308, "Member 'UAISkill_FindOrb::BloodOrbMaxDensityWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindOrb, BaseClusterRange) == 0x000368, "Member 'UAISkill_FindOrb::BaseClusterRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindOrb, PerOrbClusterRange) == 0x00036C, "Member 'UAISkill_FindOrb::PerOrbClusterRange' has a wrong offset!");
static_assert(offsetof(UAISkill_FindOrb, _bloodOrbClusters) == 0x000380, "Member 'UAISkill_FindOrb::_bloodOrbClusters' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_DemonMode) == 0x000008, "Wrong alignment on UAISkill_Interaction_DemonMode");
static_assert(sizeof(UAISkill_Interaction_DemonMode) == 0x000360, "Wrong size on UAISkill_Interaction_DemonMode");
static_assert(offsetof(UAISkill_Interaction_DemonMode, InChaseMinimumRange) == 0x0002A0, "Member 'UAISkill_Interaction_DemonMode::InChaseMinimumRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_DemonMode, TraversalMinimumRange) == 0x000300, "Member 'UAISkill_Interaction_DemonMode::TraversalMinimumRange' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_OniDash) == 0x000008, "Wrong alignment on UAISkill_Interaction_OniDash");
static_assert(sizeof(UAISkill_Interaction_OniDash) == 0x0003D8, "Wrong size on UAISkill_Interaction_OniDash");
static_assert(offsetof(UAISkill_Interaction_OniDash, MaxSideAngle) == 0x0002A0, "Member 'UAISkill_Interaction_OniDash::MaxSideAngle' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, StopTurnMargin) == 0x0002A4, "Member 'UAISkill_Interaction_OniDash::StopTurnMargin' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, MinStartDashDistance) == 0x0002A8, "Member 'UAISkill_Interaction_OniDash::MinStartDashDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, MinStartDashObstructedDistance) == 0x000308, "Member 'UAISkill_Interaction_OniDash::MinStartDashObstructedDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, DashFocusPointPathAheadDistance) == 0x000368, "Member 'UAISkill_Interaction_OniDash::DashFocusPointPathAheadDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, ChargingUntilPercent) == 0x0003C8, "Member 'UAISkill_Interaction_OniDash::ChargingUntilPercent' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, PalletDetectionForwardDistance) == 0x0003CC, "Member 'UAISkill_Interaction_OniDash::PalletDetectionForwardDistance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, PalletDetectionRadius) == 0x0003D0, "Member 'UAISkill_Interaction_OniDash::PalletDetectionRadius' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniDash, AttackInput) == 0x0003D4, "Member 'UAISkill_Interaction_OniDash::AttackInput' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_OniPounce) == 0x000008, "Wrong alignment on UAISkill_Interaction_OniPounce");
static_assert(sizeof(UAISkill_Interaction_OniPounce) == 0x0002C0, "Wrong size on UAISkill_Interaction_OniPounce");
static_assert(offsetof(UAISkill_Interaction_OniPounce, MaxHorizontalStartRange) == 0x0002A0, "Member 'UAISkill_Interaction_OniPounce::MaxHorizontalStartRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniPounce, MaxVerticalStartRange) == 0x0002A4, "Member 'UAISkill_Interaction_OniPounce::MaxVerticalStartRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniPounce, PalletHeightOffset) == 0x0002A8, "Member 'UAISkill_Interaction_OniPounce::PalletHeightOffset' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniPounce, MaxStartRangeWhenNavigationBlocked) == 0x0002AC, "Member 'UAISkill_Interaction_OniPounce::MaxStartRangeWhenNavigationBlocked' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniPounce, MinChargeTime) == 0x0002B0, "Member 'UAISkill_Interaction_OniPounce::MinChargeTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniPounce, AttackRange) == 0x0002B4, "Member 'UAISkill_Interaction_OniPounce::AttackRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OniPounce, FacingAngle) == 0x0002B8, "Member 'UAISkill_Interaction_OniPounce::FacingAngle' has a wrong offset!");
...
static_assert(sizeof(UAISkill_Interaction_OrbAbsorb) == 0x000288, "Wrong size on UAISkill_Interaction_OrbAbsorb");
static_assert(offsetof(UAISkill_Interaction_OrbAbsorb, OrbRelevantRange) == 0x000280, "Member 'UAISkill_Interaction_OrbAbsorb::OrbRelevantRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_OrbAbsorb, ChaseTargetRange) == 0x000284, "Member 'UAISkill_Interaction_OrbAbsorb::ChaseTargetRange' has a wrong offset!");
...
static_assert(sizeof(UBloodOrbAbsorberComponent) == 0x000120, "Wrong size on UBloodOrbAbsorberComponent");
...
static_assert(offsetof(UBloodOrbAbsorberComponent, _survivorBloodOrbDropperComponents) == 0x000110, "Member 'UBloodOrbAbsorberComponent::_survivorBloodOrbDropperComponents' has a wrong offset!");
...
static_assert(sizeof(UBloodOrbDropperComponent) == 0x000130, "Wrong size on UBloodOrbDropperComponent");
...
static_assert(sizeof(UBloodOrbOverlapRevealToKiller) == 0x0003C0, "Wrong size on UBloodOrbOverlapRevealToKiller");
...
static_assert(sizeof(UDemonModeComponent) == 0x000250, "Wrong size on UDemonModeComponent");
...
static_assert(offsetof(UDemonModeComponent, _demonModeState) == 0x000174, "Member 'UDemonModeComponent::_demonModeState' has a wrong offset!");
static_assert(offsetof(UDemonModeComponent, _normalModeCustomization) == 0x000220, "Member 'UDemonModeComponent::_normalModeCustomization' has a wrong offset!");
static_assert(offsetof(UDemonModeComponent, _demonModeCustomization) == 0x000230, "Member 'UDemonModeComponent::_demonModeCustomization' has a wrong offset!");
static_assert(offsetof(UDemonModeComponent, _demonModeVfx) == 0x000240, "Member 'UDemonModeComponent::_demonModeVfx' has a wrong offset!");
...
static_assert(sizeof(UDemonModeCooldownInteraction) == 0x000790, "Wrong size on UDemonModeCooldownInteraction");
...
static_assert(sizeof(UIsPlayerAbsorbingBloodOrbsCondition) == 0x000130, "Wrong size on UIsPlayerAbsorbingBloodOrbsCondition");
...
static_assert(sizeof(UOniAttackPicker) == 0x0000D0, "Wrong size on UOniAttackPicker");
...
static_assert(sizeof(UOniBasicAttack) == 0x000440, "Wrong size on UOniBasicAttack");
...
static_assert(sizeof(UOniDashInteraction) == 0x000920, "Wrong size on UOniDashInteraction");
...
static_assert(sizeof(UOniDemonBasicAttack) == 0x000430, "Wrong size on UOniDemonBasicAttack");
...
static_assert(sizeof(UOniDemonPowerAttack) == 0x000460, "Wrong size on UOniDemonPowerAttack");
...
static_assert(sizeof(UOniDemonDashAttack) == 0x000460, "Wrong size on UOniDemonDashAttack");
...
static_assert(offsetof(UOniPounceInteraction, _killer) == 0x0008E0, "Member 'UOniPounceInteraction::_killer' has a wrong offset!");
...
static_assert(sizeof(URenjirosBloodyGlove) == 0x0003B8, "Wrong size on URenjirosBloodyGlove");
static_assert(offsetof(URenjirosBloodyGlove, _revealTime) == 0x000308, "Member 'URenjirosBloodyGlove::_revealTime' has a wrong offset!");
static_assert(offsetof(URenjirosBloodyGlove, _bloodOrbRevealToKillerStatusEffectClass) == 0x000310, "Member 'URenjirosBloodyGlove::_bloodOrbRevealToKillerStatusEffectClass' has a wrong offset!");
static_assert(offsetof(URenjirosBloodyGlove, _revealEffectPerSurvivor) == 0x000318, "Member 'URenjirosBloodyGlove::_revealEffectPerSurvivor' has a wrong offset!");
