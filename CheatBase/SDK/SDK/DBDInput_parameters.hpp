...
static_assert(alignof(InteractiveWidgetInterface_HandleOnMouseDownEvent) == 0x000008, "Wrong alignment on InteractiveWidgetInterface_HandleOnMouseDownEvent");
static_assert(sizeof(InteractiveWidgetInterface_HandleOnMouseDownEvent) == 0x000080, "Wrong size on InteractiveWidgetInterface_HandleOnMouseDownEvent");
static_assert(offsetof(InteractiveWidgetInterface_HandleOnMouseDownEvent, InMouseEvent) == 0x000000, "Member 'InteractiveWidgetInterface_HandleOnMouseDownEvent::InMouseEvent' has a wrong offset!");
...
static_assert(alignof(InteractiveWidgetInterface_HandleOnMouseWheelEvent) == 0x000008, "Wrong alignment on InteractiveWidgetInterface_HandleOnMouseWheelEvent");
static_assert(sizeof(InteractiveWidgetInterface_HandleOnMouseWheelEvent) == 0x000080, "Wrong size on InteractiveWidgetInterface_HandleOnMouseWheelEvent");
static_assert(offsetof(InteractiveWidgetInterface_HandleOnMouseWheelEvent, InMouseEvent) == 0x000000, "Member 'InteractiveWidgetInterface_HandleOnMouseWheelEvent::InMouseEvent' has a wrong offset!");
