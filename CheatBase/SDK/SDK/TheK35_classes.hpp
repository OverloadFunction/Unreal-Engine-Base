...
static_assert(sizeof(UK35PowerWidgetPresentationComponent) == 0x0000D0, "Wrong size on UK35PowerWidgetPresentationComponent");
...
static_assert(sizeof(UK35AimProjectileWidgetComponent) == 0x0000E8, "Wrong size on UK35AimProjectileWidgetComponent");
...
static_assert(sizeof(AK35AreaBlast) == 0x0003F8, "Wrong size on AK35AreaBlast");
...
static_assert(offsetof(AK35AreaBlast, _killer) == 0x0003B8, "Member 'AK35AreaBlast::_killer' has a wrong offset!");
static_assert(offsetof(AK35AreaBlast, _affectedSurvivors) == 0x0003C0, "Member 'AK35AreaBlast::_affectedSurvivors' has a wrong offset!");
...
static_assert(sizeof(UK35CheatComponent) == 0x0000B8, "Wrong size on UK35CheatComponent");
...
static_assert(sizeof(AK35Decoy) == 0x000488, "Wrong size on AK35Decoy");
...
static_assert(offsetof(AK35Decoy, _overlappingPlayers) == 0x0003F8, "Member 'AK35Decoy::_overlappingPlayers' has a wrong offset!");
static_assert(offsetof(AK35Decoy, _objectState) == 0x000448, "Member 'AK35Decoy::_objectState' has a wrong offset!");
...
static_assert(sizeof(AK35KillerAreaBlastTravelProjectile) == 0x0006C8, "Wrong size on AK35KillerAreaBlastTravelProjectile");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _environmentCollision) == 0x0003D8, "Member 'AK35KillerAreaBlastTravelProjectile::_environmentCollision' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _playerCollision) == 0x0003E0, "Member 'AK35KillerAreaBlastTravelProjectile::_playerCollision' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _killerProjectileDodge) == 0x0003E8, "Member 'AK35KillerAreaBlastTravelProjectile::_killerProjectileDodge' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _projectileTimeoutTime) == 0x0003F0, "Member 'AK35KillerAreaBlastTravelProjectile::_projectileTimeoutTime' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _maxAllowedBounces) == 0x000418, "Member 'AK35KillerAreaBlastTravelProjectile::_maxAllowedBounces' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _bounciness) == 0x000498, "Member 'AK35KillerAreaBlastTravelProjectile::_bounciness' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _friction) == 0x000518, "Member 'AK35KillerAreaBlastTravelProjectile::_friction' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _hinderedOnPassThroughLifetime) == 0x000598, "Member 'AK35KillerAreaBlastTravelProjectile::_hinderedOnPassThroughLifetime' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _hinderedOnPassThroughStatusEffectClass) == 0x000618, "Member 'AK35KillerAreaBlastTravelProjectile::_hinderedOnPassThroughStatusEffectClass' has a wrong offset!");
static_assert(offsetof(AK35KillerAreaBlastTravelProjectile, _isProjectileActive) == 0x000620, "Member 'AK35KillerAreaBlastTravelProjectile::_isProjectileActive' has a wrong offset!");
...
static_assert(sizeof(UK35KillerAreaBlastTravelProjectileLauncher) == 0x000228, "Wrong size on UK35KillerAreaBlastTravelProjectileLauncher");
static_assert(offsetof(UK35KillerAreaBlastTravelProjectileLauncher, _launchSpeed) == 0x0001A8, "Member 'UK35KillerAreaBlastTravelProjectileLauncher::_launchSpeed' has a wrong offset!");
static_assert(offsetof(UK35KillerAreaBlastTravelProjectileLauncher, _spawnSocketName) == 0x0001D0, "Member 'UK35KillerAreaBlastTravelProjectileLauncher::_spawnSocketName' has a wrong offset!");
static_assert(offsetof(UK35KillerAreaBlastTravelProjectileLauncher, _pitchCurve) == 0x0001E0, "Member 'UK35KillerAreaBlastTravelProjectileLauncher::_pitchCurve' has a wrong offset!");
...
static_assert(sizeof(UK35KillerEffectTracker) == 0x000150, "Wrong size on UK35KillerEffectTracker");
static_assert(offsetof(UK35KillerEffectTracker, _removalTime) == 0x0000B8, "Member 'UK35KillerEffectTracker::_removalTime' has a wrong offset!");
static_assert(offsetof(UK35KillerEffectTracker, _effectExtensionTimeOnInjury) == 0x0000E0, "Member 'UK35KillerEffectTracker::_effectExtensionTimeOnInjury' has a wrong offset!");
static_assert(offsetof(UK35KillerEffectTracker, _killerEffectData) == 0x000108, "Member 'UK35KillerEffectTracker::_killerEffectData' has a wrong offset!");
...
static_assert(sizeof(UK35KillerRemoteDetonateAreaBlastInteractionDefinition) == 0x000780, "Wrong size on UK35KillerRemoteDetonateAreaBlastInteractionDefinition");
...
static_assert(sizeof(UK35KillerShootAreaBlastCooldownInteractionDefinition) == 0x000770, "Wrong size on UK35KillerShootAreaBlastCooldownInteractionDefinition");
...
static_assert(sizeof(AK35KillerTeleportPoint) == 0x000508, "Wrong size on AK35KillerTeleportPoint");
static_assert(offsetof(AK35KillerTeleportPoint, OnAcquiredChanged) == 0x000310, "Member 'AK35KillerTeleportPoint::OnAcquiredChanged' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _rotationSpeed) == 0x000338, "Member 'AK35KillerTeleportPoint::_rotationSpeed' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _minRotationDistance) == 0x00033C, "Member 'AK35KillerTeleportPoint::_minRotationDistance' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _dialogRange) == 0x000340, "Member 'AK35KillerTeleportPoint::_dialogRange' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _decoyTouchDistance) == 0x000344, "Member 'AK35KillerTeleportPoint::_decoyTouchDistance' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _killerTeleportLingerTime) == 0x000348, "Member 'AK35KillerTeleportPoint::_killerTeleportLingerTime' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _spawnTime) == 0x000350, "Member 'AK35KillerTeleportPoint::_spawnTime' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _killerTeleportPointInteractableClass) == 0x000378, "Member 'AK35KillerTeleportPoint::_killerTeleportPointInteractableClass' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _outlineComponent) == 0x000380, "Member 'AK35KillerTeleportPoint::_outlineComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _outlineStrategy) == 0x000388, "Member 'AK35KillerTeleportPoint::_outlineStrategy' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _targetOverlapComponent) == 0x000390, "Member 'AK35KillerTeleportPoint::_targetOverlapComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _playerOverlapComponent) == 0x000398, "Member 'AK35KillerTeleportPoint::_playerOverlapComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _primitivesRegistererComponent) == 0x0003A0, "Member 'AK35KillerTeleportPoint::_primitivesRegistererComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _clippableProviderComponent) == 0x0003A8, "Member 'AK35KillerTeleportPoint::_clippableProviderComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _headSphereComponent) == 0x0003B0, "Member 'AK35KillerTeleportPoint::_headSphereComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _bodyCapsuleComponent) == 0x0003B8, "Member 'AK35KillerTeleportPoint::_bodyCapsuleComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _visionCheckingPoints) == 0x0003C0, "Member 'AK35KillerTeleportPoint::_visionCheckingPoints' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _navModifierComponent) == 0x0003D0, "Member 'AK35KillerTeleportPoint::_navModifierComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _dangerPredictionComponent) == 0x0003D8, "Member 'AK35KillerTeleportPoint::_dangerPredictionComponent' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _killerTeleportPointState) == 0x0003E0, "Member 'AK35KillerTeleportPoint::_killerTeleportPointState' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _isAcquiredFromPool) == 0x0003E1, "Member 'AK35KillerTeleportPoint::_isAcquiredFromPool' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _killerTeleportPointInteractable) == 0x0003E8, "Member 'AK35KillerTeleportPoint::_killerTeleportPointInteractable' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _overlappingPlayers) == 0x000450, "Member 'AK35KillerTeleportPoint::_overlappingPlayers' has a wrong offset!");
static_assert(offsetof(AK35KillerTeleportPoint, _objectState) == 0x000500, "Member 'AK35KillerTeleportPoint::_objectState' has a wrong offset!");
...
static_assert(sizeof(UK35KillerTeleportPointDangerPredictionComponent) == 0x000120, "Wrong size on UK35KillerTeleportPointDangerPredictionComponent");
...
static_assert(offsetof(UK35KillerTeleportPointOutlineStrategy, _visibleAuraDistanceSurvivor) == 0x0000E0, "Member 'UK35KillerTeleportPointOutlineStrategy::_visibleAuraDistanceSurvivor' has a wrong offset!");
...
static_assert(sizeof(UK35KillerTeleportPointPlacementValidatorComponent) == 0x0000C0, "Wrong size on UK35KillerTeleportPointPlacementValidatorComponent");
static_assert(offsetof(UK35KillerTeleportPointPlacementValidatorComponent, _objectPlacementValidationStrategyWithRestrictions) == 0x0000B8, "Member 'UK35KillerTeleportPointPlacementValidatorComponent::_objectPlacementValidationStrategyWithRestrictions' has a wrong offset!");
...
static_assert(sizeof(UK35KillerTeleportPointPool) == 0x000310, "Wrong size on UK35KillerTeleportPointPool");
static_assert(offsetof(UK35KillerTeleportPointPool, _maxKillerTeleportPoints) == 0x000148, "Member 'UK35KillerTeleportPointPool::_maxKillerTeleportPoints' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointPool, _secondsCooldown) == 0x0001C8, "Member 'UK35KillerTeleportPointPool::_secondsCooldown' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointPool, _visibleAuraDistanceSurvivor) == 0x000248, "Member 'UK35KillerTeleportPointPool::_visibleAuraDistanceSurvivor' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointPool, _cooldownTimer) == 0x0002D0, "Member 'UK35KillerTeleportPointPool::_cooldownTimer' has a wrong offset!");
...
static_assert(sizeof(UK35KillerTeleportPointSpawningManager) == 0x000450, "Wrong size on UK35KillerTeleportPointSpawningManager");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _maximumChargeTime) == 0x0001E0, "Member 'UK35KillerTeleportPointSpawningManager::_maximumChargeTime' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _chargeTimerReductionMultiplierOnManuallyDestroyingKillerTeleportPoint) == 0x000260, "Member 'UK35KillerTeleportPointSpawningManager::_chargeTimerReductionMultiplierOnManuallyDestroyingKillerTeleportPoint' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _spawnTime) == 0x000288, "Member 'UK35KillerTeleportPointSpawningManager::_spawnTime' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _spawnTimeReductionOnSurvivorHookedWithKillerTeleportPointNearby) == 0x0002B0, "Member 'UK35KillerTeleportPointSpawningManager::_spawnTimeReductionOnSurvivorHookedWithKillerTeleportPointNearby' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _spawnTimeReductionOnInjuredSurvivorWithKillerEffect) == 0x0002D8, "Member 'UK35KillerTeleportPointSpawningManager::_spawnTimeReductionOnInjuredSurvivorWithKillerEffect' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _addon16SpawnTimeReductionOnWallOrPalletBreakPercentage) == 0x000300, "Member 'UK35KillerTeleportPointSpawningManager::_addon16SpawnTimeReductionOnWallOrPalletBreakPercentage' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _spawnTimeReductionOnAfflictedSurvivorWithKillerEffect) == 0x000328, "Member 'UK35KillerTeleportPointSpawningManager::_spawnTimeReductionOnAfflictedSurvivorWithKillerEffect' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportPointSpawningManager, _spawnTimeMultiplierBySurvivorsAffectedWithKillerEffectCurve) == 0x0003A8, "Member 'UK35KillerTeleportPointSpawningManager::_spawnTimeMultiplierBySurvivorsAffectedWithKillerEffectCurve' has a wrong offset!");
...
static_assert(sizeof(UK35KillerTeleportPointTargetingComponent) == 0x000128, "Wrong size on UK35KillerTeleportPointTargetingComponent");
static_assert(offsetof(UK35KillerTeleportPointTargetingComponent, _minimumTeleportDistance) == 0x0000B8, "Member 'UK35KillerTeleportPointTargetingComponent::_minimumTeleportDistance' has a wrong offset!");
...
static_assert(sizeof(UK35KillerTeleportToKillerTeleportPointInteractionDefinition) == 0x000900, "Wrong size on UK35KillerTeleportToKillerTeleportPointInteractionDefinition");
static_assert(offsetof(UK35KillerTeleportToKillerTeleportPointInteractionDefinition, _addon20SurvivorNearDecoyOrKillerTeleportRangeDistance) == 0x000770, "Member 'UK35KillerTeleportToKillerTeleportPointInteractionDefinition::_addon20SurvivorNearDecoyOrKillerTeleportRangeDistance' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportToKillerTeleportPointInteractionDefinition, _teleportDuration) == 0x000798, "Member 'UK35KillerTeleportToKillerTeleportPointInteractionDefinition::_teleportDuration' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportToKillerTeleportPointInteractionDefinition, _wakeUpTime) == 0x0007C0, "Member 'UK35KillerTeleportToKillerTeleportPointInteractionDefinition::_wakeUpTime' has a wrong offset!");
static_assert(offsetof(UK35KillerTeleportToKillerTeleportPointInteractionDefinition, _killerCollisionIgnoredLingerTime) == 0x000840, "Member 'UK35KillerTeleportToKillerTeleportPointInteractionDefinition::_killerCollisionIgnoredLingerTime' has a wrong offset!");
...
static_assert(sizeof(UK35NeckWormAnimInstance) == 0x000370, "Wrong size on UK35NeckWormAnimInstance");
...
static_assert(sizeof(UK35P01) == 0x000480, "Wrong size on UK35P01");
static_assert(offsetof(UK35P01, _activeTime) == 0x000460, "Member 'UK35P01::_activeTime' has a wrong offset!");
static_assert(offsetof(UK35P01, _timedHasteEffectClass) == 0x000470, "Member 'UK35P01::_timedHasteEffectClass' has a wrong offset!");
static_assert(offsetof(UK35P01, _hasteStatusEffectDuration) == 0x000478, "Member 'UK35P01::_hasteStatusEffectDuration' has a wrong offset!");
static_assert(offsetof(UK35P01, _hasteAmount) == 0x00047C, "Member 'UK35P01::_hasteAmount' has a wrong offset!");
...
static_assert(sizeof(UK35P02) == 0x0004A0, "Wrong size on UK35P02");
static_assert(offsetof(UK35P02, _generatorTerrorRadiusEmitter) == 0x000460, "Member 'UK35P02::_generatorTerrorRadiusEmitter' has a wrong offset!");
static_assert(offsetof(UK35P02, _undetectableStatusEffect) == 0x000468, "Member 'UK35P02::_undetectableStatusEffect' has a wrong offset!");
static_assert(offsetof(UK35P02, _activePerkDuration) == 0x000470, "Member 'UK35P02::_activePerkDuration' has a wrong offset!");
static_assert(offsetof(UK35P02, _cooldownDuration) == 0x00047C, "Member 'UK35P02::_cooldownDuration' has a wrong offset!");
static_assert(offsetof(UK35P02, _terrorRadiusSize) == 0x000488, "Member 'UK35P02::_terrorRadiusSize' has a wrong offset!");
static_assert(offsetof(UK35P02, _undetectableStatusEffectClass) == 0x000490, "Member 'UK35P02::_undetectableStatusEffectClass' has a wrong offset!");
...
static_assert(sizeof(UK35P03) == 0x000478, "Wrong size on UK35P03");
static_assert(offsetof(UK35P03, _maxTokens) == 0x000460, "Member 'UK35P03::_maxTokens' has a wrong offset!");
static_assert(offsetof(UK35P03, _tokenGain) == 0x00046C, "Member 'UK35P03::_tokenGain' has a wrong offset!");
static_assert(offsetof(UK35P03, _cooldownTime) == 0x000470, "Member 'UK35P03::_cooldownTime' has a wrong offset!");
...
static_assert(sizeof(AK35Power) == 0x000758, "Wrong size on AK35Power");
static_assert(offsetof(AK35Power, OnMoriBegin) == 0x000610, "Member 'AK35Power::OnMoriBegin' has a wrong offset!");
static_assert(offsetof(AK35Power, OnMoriEnd) == 0x000620, "Member 'AK35Power::OnMoriEnd' has a wrong offset!");
static_assert(offsetof(AK35Power, _areaBlastClass) == 0x000630, "Member 'AK35Power::_areaBlastClass' has a wrong offset!");
static_assert(offsetof(AK35Power, _decoyClass) == 0x000638, "Member 'AK35Power::_decoyClass' has a wrong offset!");
static_assert(offsetof(AK35Power, _teleportPointTargetingIndicatorClass) == 0x000640, "Member 'AK35Power::_teleportPointTargetingIndicatorClass' has a wrong offset!");
static_assert(offsetof(AK35Power, _extendedDestructionTimeWhenInfectedStatusEffect) == 0x000648, "Member 'AK35Power::_extendedDestructionTimeWhenInfectedStatusEffect' has a wrong offset!");
static_assert(offsetof(AK35Power, _interactionAttacherComponent) == 0x000650, "Member 'AK35Power::_interactionAttacherComponent' has a wrong offset!");
static_assert(offsetof(AK35Power, _cosmeticIdleTimerBuffer) == 0x000658, "Member 'AK35Power::_cosmeticIdleTimerBuffer' has a wrong offset!");
static_assert(offsetof(AK35Power, _minKillerCosmeticIdleTime) == 0x00065C, "Member 'AK35Power::_minKillerCosmeticIdleTime' has a wrong offset!");
static_assert(offsetof(AK35Power, _maxKillerCosmeticIdleTime) == 0x000660, "Member 'AK35Power::_maxKillerCosmeticIdleTime' has a wrong offset!");
static_assert(offsetof(AK35Power, _minKillerTeleportPointCosmeticIdleTime) == 0x000664, "Member 'AK35Power::_minKillerTeleportPointCosmeticIdleTime' has a wrong offset!");
static_assert(offsetof(AK35Power, _maxKillerTeleportPointCosmeticIdleTime) == 0x000668, "Member 'AK35Power::_maxKillerTeleportPointCosmeticIdleTime' has a wrong offset!");
static_assert(offsetof(AK35Power, _areaBlast) == 0x000670, "Member 'AK35Power::_areaBlast' has a wrong offset!");
static_assert(offsetof(AK35Power, _decoy) == 0x000678, "Member 'AK35Power::_decoy' has a wrong offset!");
static_assert(offsetof(AK35Power, _teleportPointTargetingIndicator) == 0x000680, "Member 'AK35Power::_teleportPointTargetingIndicator' has a wrong offset!");
static_assert(offsetof(AK35Power, _isKillerInMori) == 0x000688, "Member 'AK35Power::_isKillerInMori' has a wrong offset!");
...
static_assert(sizeof(UK35ShootProjectileWidgetComponent) == 0x0000E8, "Wrong size on UK35ShootProjectileWidgetComponent");
...
static_assert(sizeof(UK35SightManager) == 0x000168, "Wrong size on UK35SightManager");
...
static_assert(sizeof(UK35SpawnHuskWidgetComponent) == 0x0000D0, "Wrong size on UK35SpawnHuskWidgetComponent");
...
static_assert(sizeof(AK35SurvivorCosmeticHelperActor) == 0x000368, "Wrong size on AK35SurvivorCosmeticHelperActor");
...
static_assert(sizeof(UK35SurvivorDestroyKillerTeleportPointChargeableInteractionDefinition) == 0x0009C0, "Wrong size on UK35SurvivorDestroyKillerTeleportPointChargeableInteractionDefinition");
...
static_assert(sizeof(UK35SurvivorDestroyKillerTeleportPointFailureStunInteractionDefinition) == 0x000770, "Wrong size on UK35SurvivorDestroyKillerTeleportPointFailureStunInteractionDefinition");
...
static_assert(sizeof(UK35SurvivorKillerEffectUIComponent) == 0x0000D8, "Wrong size on UK35SurvivorKillerEffectUIComponent");
...
static_assert(sizeof(UK35TeleportToHuskWidgetComponent) == 0x0000E8, "Wrong size on UK35TeleportToHuskWidgetComponent");
...
static_assert(sizeof(UOwningPlayerInK35KillerTeleportPointRange) == 0x0001A0, "Wrong size on UOwningPlayerInK35KillerTeleportPointRange");
static_assert(offsetof(UOwningPlayerInK35KillerTeleportPointRange, _killerTeleportPointRange) == 0x000108, "Member 'UOwningPlayerInK35KillerTeleportPointRange::_killerTeleportPointRange' has a wrong offset!");
