...
static_assert(alignof(BPFL_UI_Common_C_SetScrollbarColor) == 0x000008, "Wrong alignment on BPFL_UI_Common_C_SetScrollbarColor");
static_assert(sizeof(BPFL_UI_Common_C_SetScrollbarColor) == 0x000038, "Wrong size on BPFL_UI_Common_C_SetScrollbarColor");
static_assert(offsetof(BPFL_UI_Common_C_SetScrollbarColor, TintColor) == 0x000000, "Member 'BPFL_UI_Common_C_SetScrollbarColor::TintColor' has a wrong offset!");
static_assert(offsetof(BPFL_UI_Common_C_SetScrollbarColor, ScrollBox) == 0x000010, "Member 'BPFL_UI_Common_C_SetScrollbarColor::ScrollBox' has a wrong offset!");
static_assert(offsetof(BPFL_UI_Common_C_SetScrollbarColor, __WorldContext) == 0x000018, "Member 'BPFL_UI_Common_C_SetScrollbarColor::__WorldContext' has a wrong offset!");
static_assert(offsetof(BPFL_UI_Common_C_SetScrollbarColor, K2Node_MakeStruct_SlateColor) == 0x000020, "Member 'BPFL_UI_Common_C_SetScrollbarColor::K2Node_MakeStruct_SlateColor' has a wrong offset!");
