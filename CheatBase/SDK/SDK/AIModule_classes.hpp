...
static_assert(sizeof(UPawnAction_Move) == 0x0000F8, "Wrong size on UPawnAction_Move");
...
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x000268, "Wrong size on UEnvQueryTest_Overlap");
...
static_assert(offsetof(UAISenseConfig_Sight, FullPeripheralVisionRange) == 0x000074, "Member 'UAISenseConfig_Sight::FullPeripheralVisionRange' has a wrong offset!");
...
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionForgotten) == 0x000178, "Member 'UAIPerceptionComponent::OnTargetPerceptionForgotten' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionUpdated) == 0x000188, "Member 'UAIPerceptionComponent::OnTargetPerceptionUpdated' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnTargetPerceptionInfoUpdated) == 0x000198, "Member 'UAIPerceptionComponent::OnTargetPerceptionInfoUpdated' has a wrong offset!");
...
static_assert(offsetof(UAISystem, DefaultSightCollisionChannel) == 0x000105, "Member 'UAISystem::DefaultSightCollisionChannel' has a wrong offset!");
...
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x000658, "Member 'AEQSTestingPawn::QueryTemplate' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x000660, "Member 'AEQSTestingPawn::QueryParams' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x000670, "Member 'AEQSTestingPawn::QueryConfig' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, TimeLimitPerStep) == 0x000680, "Member 'AEQSTestingPawn::TimeLimitPerStep' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, StepToDebugDraw) == 0x000684, "Member 'AEQSTestingPawn::StepToDebugDraw' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x000688, "Member 'AEQSTestingPawn::HighlightMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x000690, "Member 'AEQSTestingPawn::QueryingMode' has a wrong offset!");
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x000698, "Member 'AEQSTestingPawn::NavAgentProperties' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryTest_GameplayTags, bRejectIncompatibleItems) == 0x000280, "Member 'UEnvQueryTest_GameplayTags::bRejectIncompatibleItems' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, bUpdatedToUseQuery) == 0x000281, "Member 'UEnvQueryTest_GameplayTags::bUpdatedToUseQuery' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_GameplayTags, TagsToMatch) == 0x000282, "Member 'UEnvQueryTest_GameplayTags::TagsToMatch' has a wrong offset!");
...
static_assert(sizeof(UAISense_Sight) == 0x0001C0, "Wrong size on UAISense_Sight");
static_assert(offsetof(UAISense_Sight, MaxTracesPerTick) == 0x000168, "Member 'UAISense_Sight::MaxTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxAsyncTracesPerTick) == 0x00016C, "Member 'UAISense_Sight::MaxAsyncTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MinQueriesPerTimeSliceCheck) == 0x000170, "Member 'UAISense_Sight::MinQueriesPerTimeSliceCheck' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxTimeSlicePerTick) == 0x000178, "Member 'UAISense_Sight::MaxTimeSlicePerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, HighImportanceQueryDistanceThreshold) == 0x000180, "Member 'UAISense_Sight::HighImportanceQueryDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MaxQueryImportance) == 0x000188, "Member 'UAISense_Sight::MaxQueryImportance' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, SightLimitQueryImportance) == 0x00018C, "Member 'UAISense_Sight::SightLimitQueryImportance' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, PendingQueriesBudgetReductionRatio) == 0x000190, "Member 'UAISense_Sight::PendingQueriesBudgetReductionRatio' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, bUseAsynchronousTraceForDefaultSightQueries) == 0x000194, "Member 'UAISense_Sight::bUseAsynchronousTraceForDefaultSightQueries' has a wrong offset!");
