...
static_assert(sizeof(UCharacterSightComponent) == 0x0001A8, "Wrong size on UCharacterSightComponent");
...
static_assert(offsetof(UCharacterSightComponent, _aiCanBeSeenTestRightOffset) == 0x000120, "Member 'UCharacterSightComponent::_aiCanBeSeenTestRightOffset' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _aiCanBeSeenTestHighOffset) == 0x000124, "Member 'UCharacterSightComponent::_aiCanBeSeenTestHighOffset' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _aiCanBeSeenTestLowOffset) == 0x000128, "Member 'UCharacterSightComponent::_aiCanBeSeenTestLowOffset' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _aiCanBeSeenTestMaxRange) == 0x00012C, "Member 'UCharacterSightComponent::_aiCanBeSeenTestMaxRange' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _aiCanBeSeenTestProgressive) == 0x000130, "Member 'UCharacterSightComponent::_aiCanBeSeenTestProgressive' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _aiProgressiveTestMinimumRange) == 0x000134, "Member 'UCharacterSightComponent::_aiProgressiveTestMinimumRange' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _sightableCharacterClass) == 0x000138, "Member 'UCharacterSightComponent::_sightableCharacterClass' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _discernedCharacters) == 0x000140, "Member 'UCharacterSightComponent::_discernedCharacters' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _localDiscernibleCharacters) == 0x000150, "Member 'UCharacterSightComponent::_localDiscernibleCharacters' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _debugMode) == 0x000170, "Member 'UCharacterSightComponent::_debugMode' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _canSee) == 0x000171, "Member 'UCharacterSightComponent::_canSee' has a wrong offset!");
static_assert(offsetof(UCharacterSightComponent, _activationDefinition) == 0x000178, "Member 'UCharacterSightComponent::_activationDefinition' has a wrong offset!");
...
static_assert(sizeof(UBaseCharacterVelocityCalculationStrategy) == 0x0000B8, "Wrong size on UBaseCharacterVelocityCalculationStrategy");
...
static_assert(sizeof(UActorPoolComponent) == 0x0000F8, "Wrong size on UActorPoolComponent");
static_assert(offsetof(UActorPoolComponent, _actorClass) == 0x0000E8, "Member 'UActorPoolComponent::_actorClass' has a wrong offset!");
static_assert(offsetof(UActorPoolComponent, _size) == 0x0000F0, "Member 'UActorPoolComponent::_size' has a wrong offset!");
...
static_assert(sizeof(UCharacterSightableComponent) == 0x0001B0, "Wrong size on UCharacterSightableComponent");
...
static_assert(offsetof(UCharacterSightableComponent, _registeredSightComponents) == 0x0001A0, "Member 'UCharacterSightableComponent::_registeredSightComponents' has a wrong offset!");
...
static_assert(sizeof(UAuthoritativeActorPoolComponent) == 0x000118, "Wrong size on UAuthoritativeActorPoolComponent");
static_assert(offsetof(UAuthoritativeActorPoolComponent, _replicatedPool) == 0x0000F8, "Member 'UAuthoritativeActorPoolComponent::_replicatedPool' has a wrong offset!");
static_assert(offsetof(UAuthoritativeActorPoolComponent, _local_oldPool) == 0x000108, "Member 'UAuthoritativeActorPoolComponent::_local_oldPool' has a wrong offset!");
...
static_assert(sizeof(UStateController) == 0x000150, "Wrong size on UStateController");
static_assert(offsetof(UStateController, OnStateChangedBlueprintEvent) == 0x0000E8, "Member 'UStateController::OnStateChangedBlueprintEvent' has a wrong offset!");
static_assert(offsetof(UStateController, _stateClasses) == 0x0000F8, "Member 'UStateController::_stateClasses' has a wrong offset!");
static_assert(offsetof(UStateController, _defaultStateClass) == 0x000108, "Member 'UStateController::_defaultStateClass' has a wrong offset!");
static_assert(offsetof(UStateController, _states) == 0x000110, "Member 'UStateController::_states' has a wrong offset!");
static_assert(offsetof(UStateController, _local_currentState) == 0x000130, "Member 'UStateController::_local_currentState' has a wrong offset!");
static_assert(offsetof(UStateController, _authority_RepCurrentState) == 0x000138, "Member 'UStateController::_authority_RepCurrentState' has a wrong offset!");
...
static_assert(sizeof(UBasePoolableActorComponent) == 0x0000E8, "Wrong size on UBasePoolableActorComponent");
static_assert(offsetof(UBasePoolableActorComponent, OnAcquiredChanged) == 0x0000D8, "Member 'UBasePoolableActorComponent::OnAcquiredChanged' has a wrong offset!");
...
static_assert(sizeof(UMoveActorToComponent) == 0x000120, "Wrong size on UMoveActorToComponent");
...
static_assert(sizeof(UAuthoritativePoolableActorComponent) == 0x0000F0, "Wrong size on UAuthoritativePoolableActorComponent");
static_assert(offsetof(UAuthoritativePoolableActorComponent, _acquired) == 0x0000E8, "Member 'UAuthoritativePoolableActorComponent::_acquired' has a wrong offset!");
...
static_assert(sizeof(UActorPoolInitializer) == 0x0000F8, "Wrong size on UActorPoolInitializer");
static_assert(offsetof(UActorPoolInitializer, _poolSize) == 0x0000B8, "Member 'UActorPoolInitializer::_poolSize' has a wrong offset!");
...
static_assert(sizeof(UBoxOcclusionQueryComponent) == 0x000600, "Wrong size on UBoxOcclusionQueryComponent");
static_assert(offsetof(UBoxOcclusionQueryComponent, TimeUntilOccluded) == 0x0005E0, "Member 'UBoxOcclusionQueryComponent::TimeUntilOccluded' has a wrong offset!");
...
static_assert(alignof(IFallOutOfWorldPositionFinder) == 0x000001, "Wrong alignment on IFallOutOfWorldPositionFinder");
static_assert(sizeof(IFallOutOfWorldPositionFinder) == 0x000001, "Wrong size on IFallOutOfWorldPositionFinder");
...
static_assert(alignof(ISpecialAttackInstigator) == 0x000001, "Wrong alignment on ISpecialAttackInstigator");
static_assert(sizeof(ISpecialAttackInstigator) == 0x000001, "Wrong size on ISpecialAttackInstigator");
...
static_assert(sizeof(ULocalActorPoolComponent) == 0x000108, "Wrong size on ULocalActorPoolComponent");
static_assert(offsetof(ULocalActorPoolComponent, _pool) == 0x0000F8, "Member 'ULocalActorPoolComponent::_pool' has a wrong offset!");
...
static_assert(sizeof(UPoolableActorComponent) == 0x0000F0, "Wrong size on UPoolableActorComponent");
