...
static_assert(sizeof(NiagaraDataChannelLibrary_GetNiagaraDataChannel) == 0x000020, "Wrong size on NiagaraDataChannelLibrary_GetNiagaraDataChannel");
...
static_assert(offsetof(NiagaraDataChannelLibrary_GetNiagaraDataChannel, ReturnValue) == 0x000018, "Member 'NiagaraDataChannelLibrary_GetNiagaraDataChannel::ReturnValue' has a wrong offset!");
