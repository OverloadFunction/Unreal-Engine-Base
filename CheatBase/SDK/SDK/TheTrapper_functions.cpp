...
void ABearTrap::Authority_ImposeRevealAuraEffect(class ASurvivor* Survivor)
{
	static class UFunction* Func = nullptr;
...
// Function TheTrapper.BearTrap.OnGuidedStateChanged
// (Final, Native, Private)

void ABearTrap::OnGuidedStateChanged()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BearTrap", "OnGuidedStateChanged");
...
void ABearTrap::OnTrappedInjuredBleedoutKO(class ADBDPlayer* injuredBleedoutInstigator)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BearTrap", "OnTrappedInjuredBleedoutKO");

	Params::BearTrap_OnTrappedInjuredBleedoutKO Parms{};
...
float USetBearTrap::GetSetTrapHasteSpeed()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SetBearTrap", "GetSetTrapHasteSpeed");

	Params::SetBearTrap_GetSetTrapHasteSpeed Parms{};
