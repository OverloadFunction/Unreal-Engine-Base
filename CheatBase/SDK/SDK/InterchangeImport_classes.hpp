...
static_assert(alignof(IInterchangeStaticMeshPayloadInterface) == 0x000001, "Wrong alignment on IInterchangeStaticMeshPayloadInterface");
static_assert(sizeof(IInterchangeStaticMeshPayloadInterface) == 0x000001, "Wrong size on IInterchangeStaticMeshPayloadInterface");
...
static_assert(alignof(IInterchangeSkeletalMeshPayloadInterface) == 0x000001, "Wrong alignment on IInterchangeSkeletalMeshPayloadInterface");
static_assert(sizeof(IInterchangeSkeletalMeshPayloadInterface) == 0x000001, "Wrong size on IInterchangeSkeletalMeshPayloadInterface");
