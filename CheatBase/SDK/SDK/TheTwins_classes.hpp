...
static_assert(sizeof(UAddon_K22Power_10) == 0x000318, "Wrong size on UAddon_K22Power_10");
static_assert(offsetof(UAddon_K22Power_10, _hemorrhageStatusEffectClass) == 0x000310, "Member 'UAddon_K22Power_10::_hemorrhageStatusEffectClass' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_11) == 0x000320, "Wrong size on UAddon_K22Power_11");
static_assert(offsetof(UAddon_K22Power_11, _survivorRemoveTwinMaxChargeAdditiveEffect) == 0x000310, "Member 'UAddon_K22Power_11::_survivorRemoveTwinMaxChargeAdditiveEffect' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_11, _increaseRemoveTwinTime) == 0x000318, "Member 'UAddon_K22Power_11::_increaseRemoveTwinTime' has a wrong offset!");
...
static_assert(sizeof(UTwinJumpAudioMutedEffect) == 0x000398, "Wrong size on UTwinJumpAudioMutedEffect");
...
static_assert(sizeof(UBaseTwinInspectLocker) == 0x0007D0, "Wrong size on UBaseTwinInspectLocker");
static_assert(offsetof(UBaseTwinInspectLocker, _inspectInteractionTime) == 0x000798, "Member 'UBaseTwinInspectLocker::_inspectInteractionTime' has a wrong offset!");
...
static_assert(sizeof(UTwinInspectEmptyLocker) == 0x0007D0, "Wrong size on UTwinInspectEmptyLocker");
...
static_assert(sizeof(UAddon_K22Power_14) == 0x000320, "Wrong size on UAddon_K22Power_14");
static_assert(offsetof(UAddon_K22Power_14, _brokenStatusEffectClass) == 0x000310, "Member 'UAddon_K22Power_14::_brokenStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_14, _brokenDuration) == 0x000318, "Member 'UAddon_K22Power_14::_brokenDuration' has a wrong offset!");
...
static_assert(sizeof(UTwinInspectOccupiedLocker) == 0x0007D0, "Wrong size on UTwinInspectOccupiedLocker");
...
static_assert(sizeof(UAddon_K22Power_16) == 0x000310, "Wrong size on UAddon_K22Power_16");
...
static_assert(sizeof(UTwinJumpAttack) == 0x000580, "Wrong size on UTwinJumpAttack");
static_assert(offsetof(UTwinJumpAttack, _wasLastAttackSuccessful) == 0x000430, "Member 'UTwinJumpAttack::_wasLastAttackSuccessful' has a wrong offset!");
static_assert(offsetof(UTwinJumpAttack, _jumpVelocity) == 0x000438, "Member 'UTwinJumpAttack::_jumpVelocity' has a wrong offset!");
static_assert(offsetof(UTwinJumpAttack, _jumpAngleCurve) == 0x000460, "Member 'UTwinJumpAttack::_jumpAngleCurve' has a wrong offset!");
static_assert(offsetof(UTwinJumpAttack, _upDownObstructionAnglePrecision) == 0x0004B0, "Member 'UTwinJumpAttack::_upDownObstructionAnglePrecision' has a wrong offset!");
static_assert(offsetof(UTwinJumpAttack, _leftRightObstructionAnglePrecision) == 0x0004D8, "Member 'UTwinJumpAttack::_leftRightObstructionAnglePrecision' has a wrong offset!");
static_assert(offsetof(UTwinJumpAttack, _authorizedLandingHeight) == 0x000500, "Member 'UTwinJumpAttack::_authorizedLandingHeight' has a wrong offset!");
static_assert(offsetof(UTwinJumpAttack, _shouldTwinHaveJumpObjectType) == 0x000531, "Member 'UTwinJumpAttack::_shouldTwinHaveJumpObjectType' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_17) == 0x000348, "Wrong size on UAddon_K22Power_17");
static_assert(offsetof(UAddon_K22Power_17, _twinDormantObliviousEffectClass) == 0x000318, "Member 'UAddon_K22Power_17::_twinDormantObliviousEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_17, _lingerDuration) == 0x000320, "Member 'UAddon_K22Power_17::_lingerDuration' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_18) == 0x000320, "Wrong size on UAddon_K22Power_18");
static_assert(offsetof(UAddon_K22Power_18, _timedRevealToKillerStatusEffectClass) == 0x000310, "Member 'UAddon_K22Power_18::_timedRevealToKillerStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_18, _auraRevealedDuration) == 0x000318, "Member 'UAddon_K22Power_18::_auraRevealedDuration' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_19) == 0x000320, "Wrong size on UAddon_K22Power_19");
static_assert(offsetof(UAddon_K22Power_19, _undetectableDuration) == 0x000310, "Member 'UAddon_K22Power_19::_undetectableDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_19, _undetectableEffectClass) == 0x000318, "Member 'UAddon_K22Power_19::_undetectableEffectClass' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_20) == 0x000320, "Wrong size on UAddon_K22Power_20");
static_assert(offsetof(UAddon_K22Power_20, _exposedDuration) == 0x000310, "Member 'UAddon_K22Power_20::_exposedDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_20, _exposedEffect) == 0x000318, "Member 'UAddon_K22Power_20::_exposedEffect' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_8) == 0x000320, "Wrong size on UAddon_K22Power_8");
static_assert(offsetof(UAddon_K22Power_8, _survivorDestroyTwinMaxChargeAdditiveEffectClass) == 0x000310, "Member 'UAddon_K22Power_8::_survivorDestroyTwinMaxChargeAdditiveEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_8, _increaseDestroyTwinTime) == 0x000318, "Member 'UAddon_K22Power_8::_increaseDestroyTwinTime' has a wrong offset!");
...
static_assert(sizeof(UAddon_K22Power_9) == 0x000320, "Wrong size on UAddon_K22Power_9");
static_assert(offsetof(UAddon_K22Power_9, _blindnessStatusEffectClass) == 0x000310, "Member 'UAddon_K22Power_9::_blindnessStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K22Power_9, _blindnessDuration) == 0x000318, "Member 'UAddon_K22Power_9::_blindnessDuration' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindInteractable_CrushTwin) == 0x000470, "Wrong size on UAISkill_FindInteractable_CrushTwin");
static_assert(offsetof(UAISkill_FindInteractable_CrushTwin, _crushVictorGoalWeight) == 0x000328, "Member 'UAISkill_FindInteractable_CrushTwin::_crushVictorGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CrushTwin, _recoveringTimeEstimationErrorMin) == 0x000388, "Member 'UAISkill_FindInteractable_CrushTwin::_recoveringTimeEstimationErrorMin' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CrushTwin, _recoveringTimeEstimationErrorMax) == 0x0003E8, "Member 'UAISkill_FindInteractable_CrushTwin::_recoveringTimeEstimationErrorMax' has a wrong offset!");
static_assert(offsetof(UAISkill_FindInteractable_CrushTwin, _destroyTwinMaxCharge) == 0x000448, "Member 'UAISkill_FindInteractable_CrushTwin::_destroyTwinMaxCharge' has a wrong offset!");
...
static_assert(sizeof(UBrotherBlindFlashlightableLightingStrategy) == 0x0000B8, "Wrong size on UBrotherBlindFlashlightableLightingStrategy");
...
static_assert(sizeof(AConjoinedTwin) == 0x0017B0, "Wrong size on AConjoinedTwin");
static_assert(offsetof(AConjoinedTwin, _restrictedPossessionAreaTracker) == 0x0015B8, "Member 'AConjoinedTwin::_restrictedPossessionAreaTracker' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinOutlineUpdateStrategy) == 0x0015C0, "Member 'AConjoinedTwin::_twinOutlineUpdateStrategy' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinLullabyAudioComponent) == 0x0015C8, "Member 'AConjoinedTwin::_twinLullabyAudioComponent' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinBlindingFX) == 0x0015D0, "Member 'AConjoinedTwin::_twinBlindingFX' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, TwinNoiseRange) == 0x0015D8, "Member 'AConjoinedTwin::TwinNoiseRange' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _customizedAudio) == 0x0015E0, "Member 'AConjoinedTwin::_customizedAudio' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _attackerComponent) == 0x0015E8, "Member 'AConjoinedTwin::_attackerComponent' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _maxWalkSpeed) == 0x0015F0, "Member 'AConjoinedTwin::_maxWalkSpeed' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _hitValidator) == 0x001618, "Member 'AConjoinedTwin::_hitValidator' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _hitValidationConfigurator) == 0x001620, "Member 'AConjoinedTwin::_hitValidationConfigurator' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _gravityScale) == 0x001628, "Member 'AConjoinedTwin::_gravityScale' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _animationFollower) == 0x001650, "Member 'AConjoinedTwin::_animationFollower' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _revealDurationOnAttached) == 0x001678, "Member 'AConjoinedTwin::_revealDurationOnAttached' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _firstPersonViewComponent) == 0x0016A0, "Member 'AConjoinedTwin::_firstPersonViewComponent' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _eyesFlashlightable) == 0x0016A8, "Member 'AConjoinedTwin::_eyesFlashlightable' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _blindFlashlightTargetFXComponent) == 0x0016B0, "Member 'AConjoinedTwin::_blindFlashlightTargetFXComponent' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _rangedExplosiveEffectHandlerComponent) == 0x0016B8, "Member 'AConjoinedTwin::_rangedExplosiveEffectHandlerComponent' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _flashlightBlindEvasionScoreTimer) == 0x0016C8, "Member 'AConjoinedTwin::_flashlightBlindEvasionScoreTimer' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _flashlightEvasionScoreCooldown) == 0x0016F8, "Member 'AConjoinedTwin::_flashlightEvasionScoreCooldown' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _hideFootstepsEffect) == 0x001720, "Member 'AConjoinedTwin::_hideFootstepsEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinsBloodhoundEffect) == 0x001728, "Member 'AConjoinedTwin::_twinsBloodhoundEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinsRevealKillerAuraEffect) == 0x001730, "Member 'AConjoinedTwin::_twinsRevealKillerAuraEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinsDormantKillerInstinctEffect) == 0x001738, "Member 'AConjoinedTwin::_twinsDormantKillerInstinctEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinsRevealAuraOnAttachedToSurvivorEffect) == 0x001740, "Member 'AConjoinedTwin::_twinsRevealAuraOnAttachedToSurvivorEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinsRevealAuraOnRecallReadyEffect) == 0x001748, "Member 'AConjoinedTwin::_twinsRevealAuraOnRecallReadyEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _timeDeafenedOnTriggerEffect) == 0x001750, "Member 'AConjoinedTwin::_timeDeafenedOnTriggerEffect' has a wrong offset!");
static_assert(offsetof(AConjoinedTwin, _twinPossessNegationEffectComponent) == 0x001758, "Member 'AConjoinedTwin::_twinPossessNegationEffectComponent' has a wrong offset!");
...
static_assert(sizeof(UConjoinedTwinStateMachine) == 0x000140, "Wrong size on UConjoinedTwinStateMachine");
...
static_assert(sizeof(UCoupDeGrace) == 0x000480, "Wrong size on UCoupDeGrace");
static_assert(offsetof(UCoupDeGrace, _tokenGainOnRepair) == 0x000460, "Member 'UCoupDeGrace::_tokenGainOnRepair' has a wrong offset!");
static_assert(offsetof(UCoupDeGrace, _lungeAttackAddDurationMultiplier) == 0x000464, "Member 'UCoupDeGrace::_lungeAttackAddDurationMultiplier' has a wrong offset!");
static_assert(offsetof(UCoupDeGrace, _completedGenerators) == 0x000470, "Member 'UCoupDeGrace::_completedGenerators' has a wrong offset!");
...
static_assert(sizeof(UHoarder) == 0x0004B0, "Wrong size on UHoarder");
static_assert(offsetof(UHoarder, _chests) == 0x000468, "Member 'UHoarder::_chests' has a wrong offset!");
static_assert(offsetof(UHoarder, _camperInteractItemPickupRevealRange) == 0x000478, "Member 'UHoarder::_camperInteractItemPickupRevealRange' has a wrong offset!");
static_assert(offsetof(UHoarder, _extraChestsSpawned) == 0x000484, "Member 'UHoarder::_extraChestsSpawned' has a wrong offset!");
static_assert(offsetof(UHoarder, _bubbleIndicatorLifetime) == 0x000490, "Member 'UHoarder::_bubbleIndicatorLifetime' has a wrong offset!");
static_assert(offsetof(UHoarder, _showUniqueChestVisualPerState) == 0x00049C, "Member 'UHoarder::_showUniqueChestVisualPerState' has a wrong offset!");
...
static_assert(sizeof(UIsTwinRecallReady) == 0x0000F8, "Wrong size on UIsTwinRecallReady");
...
static_assert(sizeof(UK22AchievementTagTeam) == 0x0000C8, "Wrong size on UK22AchievementTagTeam");
...
static_assert(sizeof(AK22Power) == 0x000778, "Wrong size on AK22Power");
static_assert(offsetof(AK22Power, _releaseConjoinedTwinChargeable) == 0x000570, "Member 'AK22Power::_releaseConjoinedTwinChargeable' has a wrong offset!");
static_assert(offsetof(AK22Power, _possessConjoinedTwinChargeable) == 0x000578, "Member 'AK22Power::_possessConjoinedTwinChargeable' has a wrong offset!");
static_assert(offsetof(AK22Power, _killerDormantStealthStatusEffectClass) == 0x000580, "Member 'AK22Power::_killerDormantStealthStatusEffectClass' has a wrong offset!");
static_assert(offsetof(AK22Power, _conjoinedTwin) == 0x0005A0, "Member 'AK22Power::_conjoinedTwin' has a wrong offset!");
static_assert(offsetof(AK22Power, _conjoinedTwinParadise) == 0x0005A8, "Member 'AK22Power::_conjoinedTwinParadise' has a wrong offset!");
static_assert(offsetof(AK22Power, _powerCharge) == 0x0005B0, "Member 'AK22Power::_powerCharge' has a wrong offset!");
static_assert(offsetof(AK22Power, _powerChargePresentationItemProgress) == 0x0005B8, "Member 'AK22Power::_powerChargePresentationItemProgress' has a wrong offset!");
static_assert(offsetof(AK22Power, _powerFadeComponent) == 0x0005C0, "Member 'AK22Power::_powerFadeComponent' has a wrong offset!");
static_assert(offsetof(AK22Power, _powerMaxCharge) == 0x0005C8, "Member 'AK22Power::_powerMaxCharge' has a wrong offset!");
static_assert(offsetof(AK22Power, _conjoinedTwinClass) == 0x0005F0, "Member 'AK22Power::_conjoinedTwinClass' has a wrong offset!");
static_assert(offsetof(AK22Power, _defaultPowerRechargeTime) == 0x000608, "Member 'AK22Power::_defaultPowerRechargeTime' has a wrong offset!");
static_assert(offsetof(AK22Power, _powerRechargeTimeAfterTwinKicked) == 0x000630, "Member 'AK22Power::_powerRechargeTimeAfterTwinKicked' has a wrong offset!");
static_assert(offsetof(AK22Power, _timeBeforeAutoDestroy) == 0x000658, "Member 'AK22Power::_timeBeforeAutoDestroy' has a wrong offset!");
static_assert(offsetof(AK22Power, _timeBeforeRecallFromDormant) == 0x000680, "Member 'AK22Power::_timeBeforeRecallFromDormant' has a wrong offset!");
static_assert(offsetof(AK22Power, _timeBeforeRecallFromAttachedSurvivor) == 0x0006A8, "Member 'AK22Power::_timeBeforeRecallFromAttachedSurvivor' has a wrong offset!");
static_assert(offsetof(AK22Power, _timeBeforeRecallFromLocker) == 0x0006D0, "Member 'AK22Power::_timeBeforeRecallFromLocker' has a wrong offset!");
static_assert(offsetof(AK22Power, _recallReady) == 0x00073C, "Member 'AK22Power::_recallReady' has a wrong offset!");
...
static_assert(sizeof(UK22PowerChargePresentationItemProgressComponent) == 0x0000E0, "Wrong size on UK22PowerChargePresentationItemProgressComponent");
static_assert(offsetof(UK22PowerChargePresentationItemProgressComponent, _powerChargeComponent) == 0x0000C0, "Member 'UK22PowerChargePresentationItemProgressComponent::_powerChargeComponent' has a wrong offset!");
...
static_assert(sizeof(UK22PowerFadeComponent) == 0x0000D8, "Wrong size on UK22PowerFadeComponent");
static_assert(offsetof(UK22PowerFadeComponent, _powerChargeComponent) == 0x0000B8, "Member 'UK22PowerFadeComponent::_powerChargeComponent' has a wrong offset!");
...
static_assert(sizeof(UK22ScoreComponent) == 0x0000C8, "Wrong size on UK22ScoreComponent");
...
static_assert(sizeof(UPossessionComponent) == 0x000160, "Wrong size on UPossessionComponent");
static_assert(offsetof(UPossessionComponent, _startPossessed) == 0x000131, "Member 'UPossessionComponent::_startPossessed' has a wrong offset!");
static_assert(offsetof(UPossessionComponent, _emptyController) == 0x000138, "Member 'UPossessionComponent::_emptyController' has a wrong offset!");
...
static_assert(sizeof(UKillerPossessionComponent) == 0x0001C0, "Wrong size on UKillerPossessionComponent");
static_assert(offsetof(UKillerPossessionComponent, _shouldDeactivateCollisionsWithSurvivors) == 0x000160, "Member 'UKillerPossessionComponent::_shouldDeactivateCollisionsWithSurvivors' has a wrong offset!");
static_assert(offsetof(UKillerPossessionComponent, _timeBeforeCollisionsDeactivation) == 0x000198, "Member 'UKillerPossessionComponent::_timeBeforeCollisionsDeactivation' has a wrong offset!");
...
static_assert(sizeof(UKillerPossessNegationEffectComponent) == 0x0000F8, "Wrong size on UKillerPossessNegationEffectComponent");
...
static_assert(sizeof(UOppression) == 0x000478, "Wrong size on UOppression");
static_assert(offsetof(UOppression, _nbGeneratorsAffectedByPerk) == 0x000460, "Member 'UOppression::_nbGeneratorsAffectedByPerk' has a wrong offset!");
static_assert(offsetof(UOppression, _perkCooldown) == 0x00046C, "Member 'UOppression::_perkCooldown' has a wrong offset!");
...
static_assert(sizeof(URecallTwin) == 0x0007A0, "Wrong size on URecallTwin");
...
static_assert(sizeof(USisterBlindFlashlightableLightingStrategy) == 0x0000D8, "Wrong size on USisterBlindFlashlightableLightingStrategy");
...
static_assert(sizeof(UTwinAOELingeringStatusEffect) == 0x0004A8, "Wrong size on UTwinAOELingeringStatusEffect");
static_assert(offsetof(UTwinAOELingeringStatusEffect, _shriekingRange) == 0x000408, "Member 'UTwinAOELingeringStatusEffect::_shriekingRange' has a wrong offset!");
...
static_assert(sizeof(UTwinAttachmentComponent) == 0x000288, "Wrong size on UTwinAttachmentComponent");
static_assert(offsetof(UTwinAttachmentComponent, _attachedPlayer) == 0x0000F8, "Member 'UTwinAttachmentComponent::_attachedPlayer' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _gateBlockerEffectClass) == 0x000180, "Member 'UTwinAttachmentComponent::_gateBlockerEffectClass' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _graspBrokenEffectClass) == 0x000188, "Member 'UTwinAttachmentComponent::_graspBrokenEffectClass' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _graspIncapacitatedEffectClass) == 0x000190, "Member 'UTwinAttachmentComponent::_graspIncapacitatedEffectClass' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _graspObliviousEffectClass) == 0x000198, "Member 'UTwinAttachmentComponent::_graspObliviousEffectClass' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _graspKillerInstinctEffectClass) == 0x0001A0, "Member 'UTwinAttachmentComponent::_graspKillerInstinctEffectClass' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _gateBlockerStatusEffect) == 0x0001A8, "Member 'UTwinAttachmentComponent::_gateBlockerStatusEffect' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _hasBeenDetachedBySurvivorDamageChanged) == 0x0001C2, "Member 'UTwinAttachmentComponent::_hasBeenDetachedBySurvivorDamageChanged' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _cantEscapeByGateLingerDuration) == 0x0001C8, "Member 'UTwinAttachmentComponent::_cantEscapeByGateLingerDuration' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _escapeBlockerLingerTimers) == 0x0001F0, "Member 'UTwinAttachmentComponent::_escapeBlockerLingerTimers' has a wrong offset!");
static_assert(offsetof(UTwinAttachmentComponent, _notCancelableInteractionTags) == 0x000240, "Member 'UTwinAttachmentComponent::_notCancelableInteractionTags' has a wrong offset!");
...
static_assert(sizeof(UTwinBaseAddon) == 0x000310, "Wrong size on UTwinBaseAddon");
static_assert(offsetof(UTwinBaseAddon, _statusEffectClass) == 0x000300, "Member 'UTwinBaseAddon::_statusEffectClass' has a wrong offset!");
static_assert(offsetof(UTwinBaseAddon, _customParam) == 0x000308, "Member 'UTwinBaseAddon::_customParam' has a wrong offset!");
...
static_assert(sizeof(UTwinBaseKillerInstinctEffect) == 0x0004F8, "Wrong size on UTwinBaseKillerInstinctEffect");
static_assert(offsetof(UTwinBaseKillerInstinctEffect, _lullabyRange) == 0x000398, "Member 'UTwinBaseKillerInstinctEffect::_lullabyRange' has a wrong offset!");
static_assert(offsetof(UTwinBaseKillerInstinctEffect, _lingerDuration) == 0x000418, "Member 'UTwinBaseKillerInstinctEffect::_lingerDuration' has a wrong offset!");
...
static_assert(sizeof(UTwinCharacterMovementComponent) == 0x001450, "Wrong size on UTwinCharacterMovementComponent");
...
static_assert(sizeof(UTwinDestructionComponent) == 0x000200, "Wrong size on UTwinDestructionComponent");
static_assert(offsetof(UTwinDestructionComponent, _huskClass) == 0x000100, "Member 'UTwinDestructionComponent::_huskClass' has a wrong offset!");
static_assert(offsetof(UTwinDestructionComponent, _dyingTransform) == 0x000110, "Member 'UTwinDestructionComponent::_dyingTransform' has a wrong offset!");
static_assert(offsetof(UTwinDestructionComponent, _dyingFromSurvivorTranslation) == 0x0001F8, "Member 'UTwinDestructionComponent::_dyingFromSurvivorTranslation' has a wrong offset!");
...
static_assert(sizeof(UTwinFirstPersonViewComponent) == 0x000120, "Wrong size on UTwinFirstPersonViewComponent");
...
static_assert(sizeof(UTwinJumpTargetVisibleEffect) == 0x0003B0, "Wrong size on UTwinJumpTargetVisibleEffect");
static_assert(offsetof(UTwinJumpTargetVisibleEffect, _twinJumpTargetObject) == 0x000398, "Member 'UTwinJumpTargetVisibleEffect::_twinJumpTargetObject' has a wrong offset!");
static_assert(offsetof(UTwinJumpTargetVisibleEffect, _twinJumpTarget) == 0x0003A0, "Member 'UTwinJumpTargetVisibleEffect::_twinJumpTarget' has a wrong offset!");
static_assert(offsetof(UTwinJumpTargetVisibleEffect, _jumpTargetVisibility) == 0x0003A8, "Member 'UTwinJumpTargetVisibleEffect::_jumpTargetVisibility' has a wrong offset!");
...
static_assert(sizeof(UTwinLockerBlockerComponent) == 0x000130, "Wrong size on UTwinLockerBlockerComponent");
static_assert(offsetof(UTwinLockerBlockerComponent, _interactionClasses) == 0x0000D0, "Member 'UTwinLockerBlockerComponent::_interactionClasses' has a wrong offset!");
static_assert(offsetof(UTwinLockerBlockerComponent, _interactionsToDisableOnLockerClasses) == 0x0000F0, "Member 'UTwinLockerBlockerComponent::_interactionsToDisableOnLockerClasses' has a wrong offset!");
...
static_assert(sizeof(UTwinLullabyRangeAdditiveEffect) == 0x0004E8, "Wrong size on UTwinLullabyRangeAdditiveEffect");
static_assert(offsetof(UTwinLullabyRangeAdditiveEffect, _defaultTwinLullabyDormantRange) == 0x000398, "Member 'UTwinLullabyRangeAdditiveEffect::_defaultTwinLullabyDormantRange' has a wrong offset!");
static_assert(offsetof(UTwinLullabyRangeAdditiveEffect, _twinLullabyDormantRange) == 0x0003C0, "Member 'UTwinLullabyRangeAdditiveEffect::_twinLullabyDormantRange' has a wrong offset!");
static_assert(offsetof(UTwinLullabyRangeAdditiveEffect, _twinLullabyAttachedRange) == 0x000440, "Member 'UTwinLullabyRangeAdditiveEffect::_twinLullabyAttachedRange' has a wrong offset!");
...
static_assert(sizeof(UTwinOutlineUpdateStrategy) == 0x000150, "Wrong size on UTwinOutlineUpdateStrategy");
static_assert(offsetof(UTwinOutlineUpdateStrategy, _visibleColorForKiller) == 0x0000E0, "Member 'UTwinOutlineUpdateStrategy::_visibleColorForKiller' has a wrong offset!");
...
static_assert(sizeof(UTwinPlacerComponent) == 0x000350, "Wrong size on UTwinPlacerComponent");
...
static_assert(sizeof(UTwinPossessionComponent) == 0x000178, "Wrong size on UTwinPossessionComponent");
...
static_assert(sizeof(UTwinPossessNegationEffectComponent) == 0x0000F8, "Wrong size on UTwinPossessNegationEffectComponent");
...
static_assert(sizeof(UTwinPowerChargePresentationItemProgressComponent) == 0x0000C0, "Wrong size on UTwinPowerChargePresentationItemProgressComponent");
...
static_assert(sizeof(UTwinPowerFadeComponent) == 0x0000B8, "Wrong size on UTwinPowerFadeComponent");
...
static_assert(sizeof(UTwinRevealAuraOnAttachedToSurvivorStatusEffect) == 0x0003C8, "Wrong size on UTwinRevealAuraOnAttachedToSurvivorStatusEffect");
...
static_assert(sizeof(UTwinStateHelperComponent) == 0x000110, "Wrong size on UTwinStateHelperComponent");
...
static_assert(sizeof(UTwinStunnableComponent) == 0x0000E8, "Wrong size on UTwinStunnableComponent");
