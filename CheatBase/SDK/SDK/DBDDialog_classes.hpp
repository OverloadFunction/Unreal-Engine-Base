...
static_assert(sizeof(UDialogHandlerComponent) == 0x0001D0, "Wrong size on UDialogHandlerComponent");
...
static_assert(offsetof(UDialogHandlerComponent, _dialogDataAsset) == 0x0000D0, "Member 'UDialogHandlerComponent::_dialogDataAsset' has a wrong offset!");
static_assert(offsetof(UDialogHandlerComponent, _stopAudioGameplayEvents) == 0x0000D8, "Member 'UDialogHandlerComponent::_stopAudioGameplayEvents' has a wrong offset!");
static_assert(offsetof(UDialogHandlerComponent, _allowingDialogueStartStateTagQuery) == 0x0000E8, "Member 'UDialogHandlerComponent::_allowingDialogueStartStateTagQuery' has a wrong offset!");
static_assert(offsetof(UDialogHandlerComponent, _stopAudioClip) == 0x000130, "Member 'UDialogHandlerComponent::_stopAudioClip' has a wrong offset!");
static_assert(offsetof(UDialogHandlerComponent, _cachedDialogEvents) == 0x000170, "Member 'UDialogHandlerComponent::_cachedDialogEvents' has a wrong offset!");
static_assert(offsetof(UDialogHandlerComponent, _cachedStopAudioGameplayEvents) == 0x000180, "Member 'UDialogHandlerComponent::_cachedStopAudioGameplayEvents' has a wrong offset!");
