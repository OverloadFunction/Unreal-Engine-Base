...
static_assert(sizeof(FMovieSceneColorSectionTemplate) == 0x000488, "Wrong size on FMovieSceneColorSectionTemplate");
...
static_assert(offsetof(FMovieSceneColorSectionTemplate, BlendType) == 0x000480, "Member 'FMovieSceneColorSectionTemplate::BlendType' has a wrong offset!");
...
static_assert(sizeof(FMovieSceneObjectPropertyTemplate) == 0x000180, "Wrong size on FMovieSceneObjectPropertyTemplate");
...
static_assert(sizeof(FMovieSceneStringPropertySectionTemplate) == 0x000150, "Wrong size on FMovieSceneStringPropertySectionTemplate");
