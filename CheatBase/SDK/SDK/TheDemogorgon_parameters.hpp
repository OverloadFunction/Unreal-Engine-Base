...
static_assert(alignof(TeleportToDemogorgonPortalInteraction_OnKillerSet) == 0x000008, "Wrong alignment on TeleportToDemogorgonPortalInteraction_OnKillerSet");
static_assert(sizeof(TeleportToDemogorgonPortalInteraction_OnKillerSet) == 0x000008, "Wrong size on TeleportToDemogorgonPortalInteraction_OnKillerSet");
static_assert(offsetof(TeleportToDemogorgonPortalInteraction_OnKillerSet, Killer) == 0x000000, "Member 'TeleportToDemogorgonPortalInteraction_OnKillerSet::Killer' has a wrong offset!");
