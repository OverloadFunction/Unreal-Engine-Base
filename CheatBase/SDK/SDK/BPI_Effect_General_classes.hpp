...
static_assert(alignof(IBPI_Effect_General_C) == 0x000001, "Wrong alignment on IBPI_Effect_General_C");
static_assert(sizeof(IBPI_Effect_General_C) == 0x000001, "Wrong size on IBPI_Effect_General_C");
