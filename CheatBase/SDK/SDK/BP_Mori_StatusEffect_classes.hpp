...
static_assert(sizeof(UBP_Mori_StatusEffect_C) == 0x0003A0, "Wrong size on UBP_Mori_StatusEffect_C");
static_assert(offsetof(UBP_Mori_StatusEffect_C, UberGraphFrame) == 0x000398, "Member 'UBP_Mori_StatusEffect_C::UberGraphFrame' has a wrong offset!");
