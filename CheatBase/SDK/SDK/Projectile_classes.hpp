...
static_assert(sizeof(UDBDProjectileMovementComponent) == 0x0002F0, "Wrong size on UDBDProjectileMovementComponent");
static_assert(offsetof(UDBDProjectileMovementComponent, OnComponentToSweepCollisionBP) == 0x000270, "Member 'UDBDProjectileMovementComponent::OnComponentToSweepCollisionBP' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _componentsToSweep) == 0x000298, "Member 'UDBDProjectileMovementComponent::_componentsToSweep' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _previousPosition) == 0x0002A8, "Member 'UDBDProjectileMovementComponent::_previousPosition' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _cachedUpdatedComponent) == 0x0002C0, "Member 'UDBDProjectileMovementComponent::_cachedUpdatedComponent' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _initialLocation) == 0x0002C8, "Member 'UDBDProjectileMovementComponent::_initialLocation' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _distanceTravelled) == 0x0002E0, "Member 'UDBDProjectileMovementComponent::_distanceTravelled' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _hasMaximumDistance) == 0x0002E4, "Member 'UDBDProjectileMovementComponent::_hasMaximumDistance' has a wrong offset!");
static_assert(offsetof(UDBDProjectileMovementComponent, _maximumTravelDistance) == 0x0002E8, "Member 'UDBDProjectileMovementComponent::_maximumTravelDistance' has a wrong offset!");
...
static_assert(sizeof(UPhysicsBasedProjectileMovementComponent) == 0x0002F0, "Wrong size on UPhysicsBasedProjectileMovementComponent");
...
static_assert(sizeof(UBaseProjectileLauncher) == 0x0001A8, "Wrong size on UBaseProjectileLauncher");
static_assert(offsetof(UBaseProjectileLauncher, IsOutOfAmmoTag) == 0x0000B8, "Member 'UBaseProjectileLauncher::IsOutOfAmmoTag' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _requireLaunchImpactDetection) == 0x0000F8, "Member 'UBaseProjectileLauncher::_requireLaunchImpactDetection' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _hasInfiniteAmmunition) == 0x0000F9, "Member 'UBaseProjectileLauncher::_hasInfiniteAmmunition' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, ProjectileClass) == 0x000100, "Member 'UBaseProjectileLauncher::ProjectileClass' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _ammo) == 0x000108, "Member 'UBaseProjectileLauncher::_ammo' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _maxAmmo) == 0x00010C, "Member 'UBaseProjectileLauncher::_maxAmmo' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _canLaunchWhileOutOfAmmo) == 0x000110, "Member 'UBaseProjectileLauncher::_canLaunchWhileOutOfAmmo' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _debugProjectile) == 0x000140, "Member 'UBaseProjectileLauncher::_debugProjectile' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _projectileProvider) == 0x000190, "Member 'UBaseProjectileLauncher::_projectileProvider' has a wrong offset!");
static_assert(offsetof(UBaseProjectileLauncher, _projectileReplicationComponent) == 0x0001A0, "Member 'UBaseProjectileLauncher::_projectileReplicationComponent' has a wrong offset!");
...
static_assert(sizeof(ABaseProjectile) == 0x000350, "Wrong size on ABaseProjectile");
...
static_assert(sizeof(APhysicsBasedProjectile) == 0x000358, "Wrong size on APhysicsBasedProjectile");
static_assert(offsetof(APhysicsBasedProjectile, Movement) == 0x000350, "Member 'APhysicsBasedProjectile::Movement' has a wrong offset!");
...
static_assert(sizeof(UBaseProjectileReplicationComponent) == 0x0000C0, "Wrong size on UBaseProjectileReplicationComponent");
