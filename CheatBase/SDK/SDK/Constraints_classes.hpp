...
static_assert(sizeof(UTickableTranslationConstraint) == 0x0000C0, "Wrong size on UTickableTranslationConstraint");
static_assert(offsetof(UTickableTranslationConstraint, OffsetTranslation) == 0x0000A0, "Member 'UTickableTranslationConstraint::OffsetTranslation' has a wrong offset!");
static_assert(offsetof(UTickableTranslationConstraint, AxisFilter) == 0x0000B8, "Member 'UTickableTranslationConstraint::AxisFilter' has a wrong offset!");
...
static_assert(sizeof(UTickableScaleConstraint) == 0x0000C0, "Wrong size on UTickableScaleConstraint");
static_assert(offsetof(UTickableScaleConstraint, OffsetScale) == 0x0000A0, "Member 'UTickableScaleConstraint::OffsetScale' has a wrong offset!");
static_assert(offsetof(UTickableScaleConstraint, AxisFilter) == 0x0000B8, "Member 'UTickableScaleConstraint::AxisFilter' has a wrong offset!");
...
static_assert(sizeof(UTickableLookAtConstraint) == 0x0000B0, "Wrong size on UTickableLookAtConstraint");
