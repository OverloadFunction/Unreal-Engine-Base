...
static_assert(alignof(BaseGasCloudProjectile_GetKiller) == 0x000008, "Wrong alignment on BaseGasCloudProjectile_GetKiller");
static_assert(sizeof(BaseGasCloudProjectile_GetKiller) == 0x000008, "Wrong size on BaseGasCloudProjectile_GetKiller");
static_assert(offsetof(BaseGasCloudProjectile_GetKiller, ReturnValue) == 0x000000, "Member 'BaseGasCloudProjectile_GetKiller::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BombProjectile_OnComponentHit) == 0x000008, "Wrong alignment on BombProjectile_OnComponentHit");
static_assert(sizeof(BombProjectile_OnComponentHit) == 0x000120, "Wrong size on BombProjectile_OnComponentHit");
static_assert(offsetof(BombProjectile_OnComponentHit, HitComponent) == 0x000000, "Member 'BombProjectile_OnComponentHit::HitComponent' has a wrong offset!");
static_assert(offsetof(BombProjectile_OnComponentHit, OtherActor) == 0x000008, "Member 'BombProjectile_OnComponentHit::OtherActor' has a wrong offset!");
static_assert(offsetof(BombProjectile_OnComponentHit, OtherComponent) == 0x000010, "Member 'BombProjectile_OnComponentHit::OtherComponent' has a wrong offset!");
static_assert(offsetof(BombProjectile_OnComponentHit, NormalImpulse) == 0x000018, "Member 'BombProjectile_OnComponentHit::NormalImpulse' has a wrong offset!");
static_assert(offsetof(BombProjectile_OnComponentHit, HitResult) == 0x000030, "Member 'BombProjectile_OnComponentHit::HitResult' has a wrong offset!");
