...
static_assert(alignof(BeastOfPrey_GetUndetectableActivationDuration) == 0x000004, "Wrong alignment on BeastOfPrey_GetUndetectableActivationDuration");
static_assert(sizeof(BeastOfPrey_GetUndetectableActivationDuration) == 0x000004, "Wrong size on BeastOfPrey_GetUndetectableActivationDuration");
static_assert(offsetof(BeastOfPrey_GetUndetectableActivationDuration, ReturnValue) == 0x000000, "Member 'BeastOfPrey_GetUndetectableActivationDuration::ReturnValue' has a wrong offset!");
...
static_assert(alignof(HatchetProjectile_Cosmetic_OnCollisionDetected) == 0x000001, "Wrong alignment on HatchetProjectile_Cosmetic_OnCollisionDetected");
static_assert(sizeof(HatchetProjectile_Cosmetic_OnCollisionDetected) == 0x000001, "Wrong size on HatchetProjectile_Cosmetic_OnCollisionDetected");
static_assert(offsetof(HatchetProjectile_Cosmetic_OnCollisionDetected, SurfaceType) == 0x000000, "Member 'HatchetProjectile_Cosmetic_OnCollisionDetected::SurfaceType' has a wrong offset!");
...
static_assert(alignof(HatchetProjectile_IsHatchetStrengthEnhanced) == 0x000001, "Wrong alignment on HatchetProjectile_IsHatchetStrengthEnhanced");
static_assert(sizeof(HatchetProjectile_IsHatchetStrengthEnhanced) == 0x000001, "Wrong size on HatchetProjectile_IsHatchetStrengthEnhanced");
static_assert(offsetof(HatchetProjectile_IsHatchetStrengthEnhanced, ReturnValue) == 0x000000, "Member 'HatchetProjectile_IsHatchetStrengthEnhanced::ReturnValue' has a wrong offset!");
...
static_assert(alignof(HatchetProjectile_OnAcquiredChanged) == 0x000001, "Wrong alignment on HatchetProjectile_OnAcquiredChanged");
static_assert(sizeof(HatchetProjectile_OnAcquiredChanged) == 0x000001, "Wrong size on HatchetProjectile_OnAcquiredChanged");
static_assert(offsetof(HatchetProjectile_OnAcquiredChanged, IsAcquired) == 0x000000, "Member 'HatchetProjectile_OnAcquiredChanged::IsAcquired' has a wrong offset!");
...
static_assert(alignof(HatchetProjectile_OnActivationChanged) == 0x000001, "Wrong alignment on HatchetProjectile_OnActivationChanged");
static_assert(sizeof(HatchetProjectile_OnActivationChanged) == 0x000001, "Wrong size on HatchetProjectile_OnActivationChanged");
static_assert(offsetof(HatchetProjectile_OnActivationChanged, Enabled) == 0x000000, "Member 'HatchetProjectile_OnActivationChanged::Enabled' has a wrong offset!");
...
static_assert(alignof(HatchetProjectile_OnComponentHit) == 0x000008, "Wrong alignment on HatchetProjectile_OnComponentHit");
static_assert(sizeof(HatchetProjectile_OnComponentHit) == 0x000120, "Wrong size on HatchetProjectile_OnComponentHit");
static_assert(offsetof(HatchetProjectile_OnComponentHit, HitComponent) == 0x000000, "Member 'HatchetProjectile_OnComponentHit::HitComponent' has a wrong offset!");
static_assert(offsetof(HatchetProjectile_OnComponentHit, OtherActor) == 0x000008, "Member 'HatchetProjectile_OnComponentHit::OtherActor' has a wrong offset!");
static_assert(offsetof(HatchetProjectile_OnComponentHit, OtherComponent) == 0x000010, "Member 'HatchetProjectile_OnComponentHit::OtherComponent' has a wrong offset!");
static_assert(offsetof(HatchetProjectile_OnComponentHit, NormalImpulse) == 0x000018, "Member 'HatchetProjectile_OnComponentHit::NormalImpulse' has a wrong offset!");
static_assert(offsetof(HatchetProjectile_OnComponentHit, HitResult) == 0x000030, "Member 'HatchetProjectile_OnComponentHit::HitResult' has a wrong offset!");
