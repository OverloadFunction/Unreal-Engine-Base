...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// const struct FAmbianceManagerParams&    newAmbiance                                            (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGMAmbianceManager::ApplyAmbiance(const struct FAmbianceManagerParams& newAmbiance)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GMAmbianceManager", "ApplyAmbiance");

	Params::GMAmbianceManager_ApplyAmbiance Parms{};

	Parms.newAmbiance = std::move(newAmbiance);
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// const class UAmbianceManagerDataAsset*  assetToLoad                                            (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    overrideTransition                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   Duration                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UCurveFloat*                      Curve                                                  (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
