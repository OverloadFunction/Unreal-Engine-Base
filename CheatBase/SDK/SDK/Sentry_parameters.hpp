...
static_assert(offsetof(SentrySubsystem_CaptureEventWithScope, ReturnValue) == 0x000020, "Member 'SentrySubsystem_CaptureEventWithScope::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SentrySubsystem_CaptureMessageWithScope, Level) == 0x000024, "Member 'SentrySubsystem_CaptureMessageWithScope::Level' has a wrong offset!");
...
static_assert(sizeof(SentrySubsystem_ConfigureScope) == 0x000014, "Wrong size on SentrySubsystem_ConfigureScope");
...
static_assert(sizeof(SentrySubsystem_InitializeWithSettings) == 0x000014, "Wrong size on SentrySubsystem_InitializeWithSettings");
