...
// const TArray<struct FASValue>&          params                                                 (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// struct FASValue                         ReturnValue                                            (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct FASValue UGFxMoviePlayer::Invoke(const class FString& MovieClipName, const class FString& FunctionName, const TArray<struct FASValue>& params)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const class FString&                    MovieClipName                                          (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FTransform&                DisplayTransform                                       (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Native, Public, HasOutParams, HasDefaults, BlueprintCallable)
// Parameters:
// const struct FTransform&                ViewTransform                                          (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FASValue UGFxObject::Invoke(const class FString& FunctionName, const TArray<struct FASValue>& params)
{
	static class UFunction* Func = nullptr;
...
struct FASValue UScaleformBlueprintLibrary::Invoke(class UGFxMoviePlayer* MoviePlayer, const class FString& FunctionName, const TArray<struct FASValue>& params)
{
	static class UFunction* Func = nullptr;
