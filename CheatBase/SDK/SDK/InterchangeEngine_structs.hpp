...
static_assert(sizeof(FInterchangePipelineStack) == 0x000010, "Wrong size on FInterchangePipelineStack");
...
static_assert(sizeof(FInterchangeImportSettings) == 0x0000A0, "Wrong size on FInterchangeImportSettings");
...
static_assert(offsetof(FInterchangeImportSettings, bShowPipelineStacksConfigurationDialog) == 0x000098, "Member 'FInterchangeImportSettings::bShowPipelineStacksConfigurationDialog' has a wrong offset!");
...
static_assert(sizeof(FInterchangeContentImportSettings) == 0x000140, "Wrong size on FInterchangeContentImportSettings");
static_assert(offsetof(FInterchangeContentImportSettings, DefaultPipelineStackOverride) == 0x0000A0, "Member 'FInterchangeContentImportSettings::DefaultPipelineStackOverride' has a wrong offset!");
static_assert(offsetof(FInterchangeContentImportSettings, ShowPipelineStacksConfigurationDialogOverride) == 0x0000F0, "Member 'FInterchangeContentImportSettings::ShowPipelineStacksConfigurationDialogOverride' has a wrong offset!");
