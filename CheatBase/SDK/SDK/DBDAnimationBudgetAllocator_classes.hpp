...
static_assert(sizeof(UDBDSkeletalMeshComponentBudgeted) == 0x001140, "Wrong size on UDBDSkeletalMeshComponentBudgeted");
static_assert(offsetof(UDBDSkeletalMeshComponentBudgeted, _autoRegisterToAnimBudgeter) == 0x001121, "Member 'UDBDSkeletalMeshComponentBudgeted::_autoRegisterToAnimBudgeter' has a wrong offset!");
static_assert(offsetof(UDBDSkeletalMeshComponentBudgeted, _autoComputeSignificance) == 0x001122, "Member 'UDBDSkeletalMeshComponentBudgeted::_autoComputeSignificance' has a wrong offset!");
static_assert(offsetof(UDBDSkeletalMeshComponentBudgeted, _significanceStrategy) == 0x001128, "Member 'UDBDSkeletalMeshComponentBudgeted::_significanceStrategy' has a wrong offset!");
static_assert(offsetof(UDBDSkeletalMeshComponentBudgeted, _animBudgeterSignificanceStrategy) == 0x001130, "Member 'UDBDSkeletalMeshComponentBudgeted::_animBudgeterSignificanceStrategy' has a wrong offset!");
