...
static_assert(sizeof(FSimulationStageMetaData) == 0x0000B8, "Wrong size on FSimulationStageMetaData");
...
static_assert(offsetof(FSimulationStageMetaData, ElementCountXBinding) == 0x000018, "Member 'FSimulationStageMetaData::ElementCountXBinding' has a wrong offset!");
...
static_assert(offsetof(FSimulationStageMetaData, ElementCountZBinding) == 0x000030, "Member 'FSimulationStageMetaData::ElementCountZBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationSourceType) == 0x00003C, "Member 'FSimulationStageMetaData::IterationSourceType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationDataInterface) == 0x000040, "Member 'FSimulationStageMetaData::IterationDataInterface' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, IterationDirectBinding) == 0x00004C, "Member 'FSimulationStageMetaData::IterationDirectBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ExecuteBehavior) == 0x000058, "Member 'FSimulationStageMetaData::ExecuteBehavior' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateBinding) == 0x000060, "Member 'FSimulationStageMetaData::ParticleIterationStateBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateRange) == 0x000070, "Member 'FSimulationStageMetaData::ParticleIterationStateRange' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, OutputDestinations) == 0x000078, "Member 'FSimulationStageMetaData::OutputDestinations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, InputDataInterfaces) == 0x000088, "Member 'FSimulationStageMetaData::InputDataInterfaces' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterations) == 0x000098, "Member 'FSimulationStageMetaData::NumIterations' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, NumIterationsBinding) == 0x00009C, "Member 'FSimulationStageMetaData::NumIterationsBinding' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchType) == 0x0000A8, "Member 'FSimulationStageMetaData::GpuDispatchType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDirectDispatchElementType) == 0x0000A9, "Member 'FSimulationStageMetaData::GpuDirectDispatchElementType' has a wrong offset!");
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchNumThreads) == 0x0000AC, "Member 'FSimulationStageMetaData::GpuDispatchNumThreads' has a wrong offset!");
