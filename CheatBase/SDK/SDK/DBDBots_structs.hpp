...
static_assert(sizeof(FAIGetAttentionMovement) == 0x000018, "Wrong size on FAIGetAttentionMovement");
...
static_assert(sizeof(FAITrackedEnemyData) == 0x000188, "Wrong size on FAITrackedEnemyData");
