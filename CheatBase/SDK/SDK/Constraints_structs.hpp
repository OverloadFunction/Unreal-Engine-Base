...
static_assert(sizeof(FConstraintAndActiveChannel) == 0x000140, "Wrong size on FConstraintAndActiveChannel");
...
static_assert(offsetof(FConstraintAndActiveChannel, ActiveChannel) == 0x000038, "Member 'FConstraintAndActiveChannel::ActiveChannel' has a wrong offset!");
static_assert(offsetof(FConstraintAndActiveChannel, ConstraintCopyToSpawn) == 0x000138, "Member 'FConstraintAndActiveChannel::ConstraintCopyToSpawn' has a wrong offset!");
