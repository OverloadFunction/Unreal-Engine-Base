...
static_assert(alignof(UInterchangeAnimationAPI) == 0x000008, "Wrong alignment on UInterchangeAnimationAPI");
static_assert(sizeof(UInterchangeAnimationAPI) == 0x000030, "Wrong size on UInterchangeAnimationAPI");
...
static_assert(sizeof(UInterchangeSourceNode) == 0x0000C0, "Wrong size on UInterchangeSourceNode");
