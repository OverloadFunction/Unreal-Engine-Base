...
static_assert(sizeof(UBlastMine) == 0x000508, "Wrong size on UBlastMine");
static_assert(offsetof(UBlastMine, _blastMinePlacerClass) == 0x0004E8, "Member 'UBlastMine::_blastMinePlacerClass' has a wrong offset!");
static_assert(offsetof(UBlastMine, _blastMineFirecrackerClass) == 0x0004F0, "Member 'UBlastMine::_blastMineFirecrackerClass' has a wrong offset!");
static_assert(offsetof(UBlastMine, _blastMine) == 0x0004F8, "Member 'UBlastMine::_blastMine' has a wrong offset!");
...
static_assert(alignof(UBlastMineExplosiveActorEffect) == 0x000008, "Wrong alignment on UBlastMineExplosiveActorEffect");
static_assert(sizeof(UBlastMineExplosiveActorEffect) == 0x000038, "Wrong size on UBlastMineExplosiveActorEffect");
...
static_assert(sizeof(UBlastMineKickSensor) == 0x000110, "Wrong size on UBlastMineKickSensor");
...
static_assert(sizeof(UBlastMineVisibilityController) == 0x0001C8, "Wrong size on UBlastMineVisibilityController");
static_assert(offsetof(UBlastMineVisibilityController, _systems) == 0x000120, "Member 'UBlastMineVisibilityController::_systems' has a wrong offset!");
static_assert(offsetof(UBlastMineVisibilityController, _meshes) == 0x000170, "Member 'UBlastMineVisibilityController::_meshes' has a wrong offset!");
...
static_assert(sizeof(UCounterforce) == 0x000488, "Wrong size on UCounterforce");
static_assert(offsetof(UCounterforce, _totemAuraVisibleDuration) == 0x000464, "Member 'UCounterforce::_totemAuraVisibleDuration' has a wrong offset!");
static_assert(offsetof(UCounterforce, _startingTotemCleanseSpeedBonus) == 0x000470, "Member 'UCounterforce::_startingTotemCleanseSpeedBonus' has a wrong offset!");
static_assert(offsetof(UCounterforce, _stackableTotemCleanseSpeedBonus) == 0x00047C, "Member 'UCounterforce::_stackableTotemCleanseSpeedBonus' has a wrong offset!");
...
static_assert(sizeof(UResurgence) == 0x000470, "Wrong size on UResurgence");
static_assert(offsetof(UResurgence, _healRegainPercentage) == 0x000460, "Member 'UResurgence::_healRegainPercentage' has a wrong offset!");
