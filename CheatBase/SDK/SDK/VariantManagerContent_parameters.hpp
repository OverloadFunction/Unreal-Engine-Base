...
static_assert(sizeof(Variant_AddDependency) == 0x000080, "Wrong size on Variant_AddDependency");
...
static_assert(offsetof(Variant_AddDependency, ReturnValue) == 0x000078, "Member 'Variant_AddDependency::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(Variant_GetDependency) == 0x000080, "Wrong size on Variant_GetDependency");
...
static_assert(sizeof(Variant_SetDependency) == 0x000080, "Wrong size on Variant_SetDependency");
