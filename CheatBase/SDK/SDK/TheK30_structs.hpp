...
static_assert(sizeof(FFloatingCameraHandler) == 0x000108, "Wrong size on FFloatingCameraHandler");
...
static_assert(offsetof(FFloatingCameraHandler, _perchRadiusThreshold) == 0x0000F8, "Member 'FFloatingCameraHandler::_perchRadiusThreshold' has a wrong offset!");
