...
static_assert(alignof(DoctorSurvivorCosmeticHelperActor_Cosmetic_OnOwningSurvivorShocked) == 0x000001, "Wrong alignment on DoctorSurvivorCosmeticHelperActor_Cosmetic_OnOwningSurvivorShocked");
static_assert(sizeof(DoctorSurvivorCosmeticHelperActor_Cosmetic_OnOwningSurvivorShocked) == 0x000001, "Wrong size on DoctorSurvivorCosmeticHelperActor_Cosmetic_OnOwningSurvivorShocked");
static_assert(offsetof(DoctorSurvivorCosmeticHelperActor_Cosmetic_OnOwningSurvivorShocked, madnessLevelIncreased) == 0x000000, "Member 'DoctorSurvivorCosmeticHelperActor_Cosmetic_OnOwningSurvivorShocked::madnessLevelIncreased' has a wrong offset!");
...
static_assert(sizeof(CartersSpark_CancelSurvivorInteraction) == 0x000010, "Wrong size on CartersSpark_CancelSurvivorInteraction");
...
static_assert(offsetof(CartersSpark_CancelSurvivorInteraction, ReturnValue) == 0x000008, "Member 'CartersSpark_CancelSurvivorInteraction::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DisciplineEffect_Cosmetic_ActivateKillerRedStain, Activate_0) == 0x000000, "Member 'DisciplineEffect_Cosmetic_ActivateKillerRedStain::Activate_0' has a wrong offset!");
...
static_assert(offsetof(DisciplineEffect_Cosmetic_ActivateSurvivorRedStain, Activate_0) == 0x000000, "Member 'DisciplineEffect_Cosmetic_ActivateSurvivorRedStain::Activate_0' has a wrong offset!");
...
static_assert(alignof(IllusionaryPalletComponent_GetOwningKiller) == 0x000008, "Wrong alignment on IllusionaryPalletComponent_GetOwningKiller");
static_assert(sizeof(IllusionaryPalletComponent_GetOwningKiller) == 0x000008, "Wrong size on IllusionaryPalletComponent_GetOwningKiller");
static_assert(offsetof(IllusionaryPalletComponent_GetOwningKiller, ReturnValue) == 0x000000, "Member 'IllusionaryPalletComponent_GetOwningKiller::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(StaticBlast_Multicast_StaticBlastShockSurvivors, shockedSurvivors) == 0x000000, "Member 'StaticBlast_Multicast_StaticBlastShockSurvivors::shockedSurvivors' has a wrong offset!");
...
static_assert(alignof(TheDoctorUtilities_WouldIncreaseMadnessTier) == 0x000008, "Wrong alignment on TheDoctorUtilities_WouldIncreaseMadnessTier");
static_assert(sizeof(TheDoctorUtilities_WouldIncreaseMadnessTier) == 0x000010, "Wrong size on TheDoctorUtilities_WouldIncreaseMadnessTier");
static_assert(offsetof(TheDoctorUtilities_WouldIncreaseMadnessTier, Player) == 0x000000, "Member 'TheDoctorUtilities_WouldIncreaseMadnessTier::Player' has a wrong offset!");
static_assert(offsetof(TheDoctorUtilities_WouldIncreaseMadnessTier, madnessAdded) == 0x000008, "Member 'TheDoctorUtilities_WouldIncreaseMadnessTier::madnessAdded' has a wrong offset!");
static_assert(offsetof(TheDoctorUtilities_WouldIncreaseMadnessTier, ReturnValue) == 0x00000C, "Member 'TheDoctorUtilities_WouldIncreaseMadnessTier::ReturnValue' has a wrong offset!");
