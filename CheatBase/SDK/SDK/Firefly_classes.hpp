...
static_assert(sizeof(UAISkill_FindCollectable_FireflyLanternOnGenerator) == 0x000518, "Wrong size on UAISkill_FindCollectable_FireflyLanternOnGenerator");
...
static_assert(sizeof(UFireflyCosmeticStatusEffect) == 0x0003A8, "Wrong size on UFireflyCosmeticStatusEffect");
static_assert(offsetof(UFireflyCosmeticStatusEffect, _heldFireflyLantern) == 0x0003A0, "Member 'UFireflyCosmeticStatusEffect::_heldFireflyLantern' has a wrong offset!");

// Class Firefly.CollectFireflyLanternFromGeneratorInteraction
// 0x0000 (0x07B0 - 0x07B0)
class UCollectFireflyLanternFromGeneratorInteraction final : public UCollectItemInteraction
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(sizeof(UDestroyFireflyLanternOnGeneratorInteraction) == 0x000770, "Wrong size on UDestroyFireflyLanternOnGeneratorInteraction");
...
static_assert(sizeof(AFireflyLantern) == 0x000660, "Wrong size on AFireflyLantern");
static_assert(offsetof(AFireflyLantern, _itemChargerComponent) == 0x0005A0, "Member 'AFireflyLantern::_itemChargerComponent' has a wrong offset!");
static_assert(offsetof(AFireflyLantern, _itemChargeableComponent) == 0x0005A8, "Member 'AFireflyLantern::_itemChargeableComponent' has a wrong offset!");
static_assert(offsetof(AFireflyLantern, _revealedGenerator) == 0x000600, "Member 'AFireflyLantern::_revealedGenerator' has a wrong offset!");
static_assert(offsetof(AFireflyLantern, _destroyingPlayer) == 0x000608, "Member 'AFireflyLantern::_destroyingPlayer' has a wrong offset!");
static_assert(offsetof(AFireflyLantern, _lanternSpawnedFromChest) == 0x000610, "Member 'AFireflyLantern::_lanternSpawnedFromChest' has a wrong offset!");
...
static_assert(sizeof(UFireflyLanternGeneratorComponent) == 0x000228, "Wrong size on UFireflyLanternGeneratorComponent");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _pickUpLanternFrontInteractionClass) == 0x0000B8, "Member 'UFireflyLanternGeneratorComponent::_pickUpLanternFrontInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _pickUpLanternBackInteractionClass) == 0x0000C0, "Member 'UFireflyLanternGeneratorComponent::_pickUpLanternBackInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _pickUpLanternLeftRightInteractionClass) == 0x0000C8, "Member 'UFireflyLanternGeneratorComponent::_pickUpLanternLeftRightInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _putDownLanternFrontInteractionClass) == 0x0000D0, "Member 'UFireflyLanternGeneratorComponent::_putDownLanternFrontInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _putDownLanternBackInteractionClass) == 0x0000D8, "Member 'UFireflyLanternGeneratorComponent::_putDownLanternBackInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _putDownLanternLeftRightInteractionClass) == 0x0000E0, "Member 'UFireflyLanternGeneratorComponent::_putDownLanternLeftRightInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _destroyLanternInteractionClass) == 0x0000E8, "Member 'UFireflyLanternGeneratorComponent::_destroyLanternInteractionClass' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _placedLanternPositionOffset) == 0x0000F0, "Member 'UFireflyLanternGeneratorComponent::_placedLanternPositionOffset' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _placedLanternRotation) == 0x000108, "Member 'UFireflyLanternGeneratorComponent::_placedLanternRotation' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _hideGeneratorAuraFromKillerEffect) == 0x000120, "Member 'UFireflyLanternGeneratorComponent::_hideGeneratorAuraFromKillerEffect' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _placedLanternGeneratorRevealRange) == 0x000128, "Member 'UFireflyLanternGeneratorComponent::_placedLanternGeneratorRevealRange' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _hideGeneratorAuraFromKillerEffectDuration) == 0x000150, "Member 'UFireflyLanternGeneratorComponent::_hideGeneratorAuraFromKillerEffectDuration' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _placeLanternScoreEventCooldownDuration) == 0x000178, "Member 'UFireflyLanternGeneratorComponent::_placeLanternScoreEventCooldownDuration' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _hideGeneratorAuraFromKillerEffects) == 0x0001A0, "Member 'UFireflyLanternGeneratorComponent::_hideGeneratorAuraFromKillerEffects' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _lanternOnGenerator) == 0x0001B0, "Member 'UFireflyLanternGeneratorComponent::_lanternOnGenerator' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _placedLanternPlayer) == 0x0001B8, "Member 'UFireflyLanternGeneratorComponent::_placedLanternPlayer' has a wrong offset!");
static_assert(offsetof(UFireflyLanternGeneratorComponent, _authority_placeLanternScoreTimers) == 0x0001C0, "Member 'UFireflyLanternGeneratorComponent::_authority_placeLanternScoreTimers' has a wrong offset!");
...
static_assert(sizeof(UFireflyLanternSFXEffect) == 0x000410, "Wrong size on UFireflyLanternSFXEffect");
static_assert(offsetof(UFireflyLanternSFXEffect, _isHoldingLantern) == 0x000398, "Member 'UFireflyLanternSFXEffect::_isHoldingLantern' has a wrong offset!");
static_assert(offsetof(UFireflyLanternSFXEffect, _distanceToNearestFireflyLantern) == 0x00039C, "Member 'UFireflyLanternSFXEffect::_distanceToNearestFireflyLantern' has a wrong offset!");
static_assert(offsetof(UFireflyLanternSFXEffect, _nearestFireflyLantern) == 0x0003A0, "Member 'UFireflyLanternSFXEffect::_nearestFireflyLantern' has a wrong offset!");
static_assert(offsetof(UFireflyLanternSFXEffect, _heldFireflyLantern) == 0x0003A8, "Member 'UFireflyLanternSFXEffect::_heldFireflyLantern' has a wrong offset!");
static_assert(offsetof(UFireflyLanternSFXEffect, _authority_trackedFireflyLanterns) == 0x0003B0, "Member 'UFireflyLanternSFXEffect::_authority_trackedFireflyLanterns' has a wrong offset!");

// Class Firefly.FireflySurvivorAnimInstance
// 0x0030 (0x0610 - 0x05E0)
class UFireflySurvivorAnimInstance final : public UBaseSurvivorAnimInstance
{
public:
...
static_assert(sizeof(UPutFireflyLanternOnGeneratorInteraction) == 0x000770, "Wrong size on UPutFireflyLanternOnGeneratorInteraction");
