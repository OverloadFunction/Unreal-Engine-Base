...
struct FDBDExcludableTableRowWithId : public FDBDTableRowBaseWithId
{
public:
	class FString                                 InclusionVersion;                                  // 0x0018(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDBDExcludableTableRowWithId) == 0x000008, "Wrong alignment on FDBDExcludableTableRowWithId");
static_assert(sizeof(FDBDExcludableTableRowWithId) == 0x000028, "Wrong size on FDBDExcludableTableRowWithId");
static_assert(offsetof(FDBDExcludableTableRowWithId, InclusionVersion) == 0x000018, "Member 'FDBDExcludableTableRowWithId::InclusionVersion' has a wrong offset!");
...
static_assert(alignof(FDBDExcludableTableRow) == 0x000008, "Wrong alignment on FDBDExcludableTableRow");
static_assert(sizeof(FDBDExcludableTableRow) == 0x000018, "Wrong size on FDBDExcludableTableRow");
static_assert(offsetof(FDBDExcludableTableRow, InclusionVersion) == 0x000008, "Member 'FDBDExcludableTableRow::InclusionVersion' has a wrong offset!");
...
static_assert(sizeof(FDBDTunableRowHandleOverride) == 0x000028, "Wrong size on FDBDTunableRowHandleOverride");
...
static_assert(offsetof(FDBDTunableRowHandleOverride, _isExportedToBackend) == 0x00001C, "Member 'FDBDTunableRowHandleOverride::_isExportedToBackend' has a wrong offset!");
