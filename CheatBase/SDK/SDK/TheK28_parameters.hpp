...
static_assert(alignof(K28LockerCosmeticHelperActor_Cosmetic_OnKillerEnteredLocker) == 0x000008, "Wrong alignment on K28LockerCosmeticHelperActor_Cosmetic_OnKillerEnteredLocker");
static_assert(sizeof(K28LockerCosmeticHelperActor_Cosmetic_OnKillerEnteredLocker) == 0x000008, "Wrong size on K28LockerCosmeticHelperActor_Cosmetic_OnKillerEnteredLocker");
static_assert(offsetof(K28LockerCosmeticHelperActor_Cosmetic_OnKillerEnteredLocker, Killer) == 0x000000, "Member 'K28LockerCosmeticHelperActor_Cosmetic_OnKillerEnteredLocker::Killer' has a wrong offset!");
...
static_assert(alignof(K28LockerCosmeticHelperActor_Cosmetic_OnKillerExitLocker) == 0x000008, "Wrong alignment on K28LockerCosmeticHelperActor_Cosmetic_OnKillerExitLocker");
static_assert(sizeof(K28LockerCosmeticHelperActor_Cosmetic_OnKillerExitLocker) == 0x000008, "Wrong size on K28LockerCosmeticHelperActor_Cosmetic_OnKillerExitLocker");
static_assert(offsetof(K28LockerCosmeticHelperActor_Cosmetic_OnKillerExitLocker, Killer) == 0x000000, "Member 'K28LockerCosmeticHelperActor_Cosmetic_OnKillerExitLocker::Killer' has a wrong offset!");
...
static_assert(alignof(K28Remnant_GetOwningKiller) == 0x000008, "Wrong alignment on K28Remnant_GetOwningKiller");
static_assert(sizeof(K28Remnant_GetOwningKiller) == 0x000008, "Wrong size on K28Remnant_GetOwningKiller");
static_assert(offsetof(K28Remnant_GetOwningKiller, ReturnValue) == 0x000000, "Member 'K28Remnant_GetOwningKiller::ReturnValue' has a wrong offset!");
...
static_assert(alignof(K28SurvivorCosmeticHelperActor_Cosmetic_OnNighttimeNearingActivation) == 0x000008, "Wrong alignment on K28SurvivorCosmeticHelperActor_Cosmetic_OnNighttimeNearingActivation");
static_assert(sizeof(K28SurvivorCosmeticHelperActor_Cosmetic_OnNighttimeNearingActivation) == 0x000008, "Wrong size on K28SurvivorCosmeticHelperActor_Cosmetic_OnNighttimeNearingActivation");
static_assert(offsetof(K28SurvivorCosmeticHelperActor_Cosmetic_OnNighttimeNearingActivation, Killer) == 0x000000, "Member 'K28SurvivorCosmeticHelperActor_Cosmetic_OnNighttimeNearingActivation::Killer' has a wrong offset!");
