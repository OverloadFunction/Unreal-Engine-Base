...
static_assert(alignof(Unhook_NativeAddSnapPoint) == 0x000008, "Wrong alignment on Unhook_NativeAddSnapPoint");
static_assert(sizeof(Unhook_NativeAddSnapPoint) == 0x000008, "Wrong size on Unhook_NativeAddSnapPoint");
static_assert(offsetof(Unhook_NativeAddSnapPoint, snapPoint) == 0x000000, "Member 'Unhook_NativeAddSnapPoint::snapPoint' has a wrong offset!");
...
static_assert(alignof(Unhook_NativeGetHook) == 0x000008, "Wrong alignment on Unhook_NativeGetHook");
static_assert(sizeof(Unhook_NativeGetHook) == 0x000008, "Wrong size on Unhook_NativeGetHook");
static_assert(offsetof(Unhook_NativeGetHook, ReturnValue) == 0x000000, "Member 'Unhook_NativeGetHook::ReturnValue' has a wrong offset!");
...
static_assert(alignof(DropInteraction_DispatchStunEvent) == 0x000008, "Wrong alignment on DropInteraction_DispatchStunEvent");
static_assert(sizeof(DropInteraction_DispatchStunEvent) == 0x000008, "Wrong size on DropInteraction_DispatchStunEvent");
static_assert(offsetof(DropInteraction_DispatchStunEvent, Killer) == 0x000000, "Member 'DropInteraction_DispatchStunEvent::Killer' has a wrong offset!");
...
static_assert(alignof(DropInteraction_GetSurvivor) == 0x000008, "Wrong alignment on DropInteraction_GetSurvivor");
static_assert(sizeof(DropInteraction_GetSurvivor) == 0x000008, "Wrong size on DropInteraction_GetSurvivor");
static_assert(offsetof(DropInteraction_GetSurvivor, ReturnValue) == 0x000000, "Member 'DropInteraction_GetSurvivor::ReturnValue' has a wrong offset!");
...
static_assert(alignof(DropInteraction_IsKillerCarryingOwner) == 0x000008, "Wrong alignment on DropInteraction_IsKillerCarryingOwner");
static_assert(sizeof(DropInteraction_IsKillerCarryingOwner) == 0x000010, "Wrong size on DropInteraction_IsKillerCarryingOwner");
static_assert(offsetof(DropInteraction_IsKillerCarryingOwner, Killer) == 0x000000, "Member 'DropInteraction_IsKillerCarryingOwner::Killer' has a wrong offset!");
static_assert(offsetof(DropInteraction_IsKillerCarryingOwner, ReturnValue) == 0x000008, "Member 'DropInteraction_IsKillerCarryingOwner::ReturnValue' has a wrong offset!");
