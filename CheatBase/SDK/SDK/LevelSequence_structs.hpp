...
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x0000D8, "Wrong size on FLevelSequencePlayerSnapshot");
...
static_assert(offsetof(FLevelSequencePlayerSnapshot, MasterName) == 0x0000B8, "Member 'FLevelSequencePlayerSnapshot::MasterName' has a wrong offset!");
static_assert(offsetof(FLevelSequencePlayerSnapshot, MasterTime) == 0x0000C8, "Member 'FLevelSequencePlayerSnapshot::MasterTime' has a wrong offset!");
