...
static_assert(offsetof(WBP_CoreSubtitles_C_SetConstrainAspectRatioChanged, AspectRatio_0) == 0x000004, "Member 'WBP_CoreSubtitles_C_SetConstrainAspectRatioChanged::AspectRatio_0' has a wrong offset!");
