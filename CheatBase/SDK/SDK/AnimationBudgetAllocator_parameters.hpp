...
static_assert(sizeof(AnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters) == 0x000068, "Wrong size on AnimationBudgetBlueprintLibrary_SetAnimationBudgetParameters");
