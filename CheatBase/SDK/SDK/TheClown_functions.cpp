...
class AKiller* ABaseGasCloudProjectile::GetKiller() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BaseGasCloudProjectile", "GetKiller");

	Params::BaseGasCloudProjectile_GetKiller Parms{};
...
void ABombProjectile::OnComponentHit(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComponent, const struct FVector& NormalImpulse, const struct FHitResult& HitResult)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BombProjectile", "OnComponentHit");

	Params::BombProjectile_OnComponentHit Parms{};
