...
static_assert(alignof(BitterMurmur_GetFixedRevealTime) == 0x000004, "Wrong alignment on BitterMurmur_GetFixedRevealTime");
static_assert(sizeof(BitterMurmur_GetFixedRevealTime) == 0x000004, "Wrong size on BitterMurmur_GetFixedRevealTime");
static_assert(offsetof(BitterMurmur_GetFixedRevealTime, ReturnValue) == 0x000000, "Member 'BitterMurmur_GetFixedRevealTime::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BitterMurmur_GetMaxDistanceFromGenerator) == 0x000004, "Wrong alignment on BitterMurmur_GetMaxDistanceFromGenerator");
static_assert(sizeof(BitterMurmur_GetMaxDistanceFromGenerator) == 0x000004, "Wrong size on BitterMurmur_GetMaxDistanceFromGenerator");
static_assert(offsetof(BitterMurmur_GetMaxDistanceFromGenerator, ReturnValue) == 0x000000, "Member 'BitterMurmur_GetMaxDistanceFromGenerator::ReturnValue' has a wrong offset!");
...
static_assert(alignof(BitterMurmur_GetRevealTime) == 0x000004, "Wrong alignment on BitterMurmur_GetRevealTime");
static_assert(sizeof(BitterMurmur_GetRevealTime) == 0x000004, "Wrong size on BitterMurmur_GetRevealTime");
static_assert(offsetof(BitterMurmur_GetRevealTime, ReturnValue) == 0x000000, "Member 'BitterMurmur_GetRevealTime::ReturnValue' has a wrong offset!");
...
static_assert(alignof(Breakout_OnKillerSet) == 0x000008, "Wrong alignment on Breakout_OnKillerSet");
static_assert(sizeof(Breakout_OnKillerSet) == 0x000008, "Wrong size on Breakout_OnKillerSet");
static_assert(offsetof(Breakout_OnKillerSet, Killer) == 0x000000, "Member 'Breakout_OnKillerSet::Killer' has a wrong offset!");
...
static_assert(alignof(CompromiseGeneratorManager_Cosmetic_OnCompromiseCompletedVFX) == 0x000008, "Wrong alignment on CompromiseGeneratorManager_Cosmetic_OnCompromiseCompletedVFX");
static_assert(sizeof(CompromiseGeneratorManager_Cosmetic_OnCompromiseCompletedVFX) == 0x000008, "Wrong size on CompromiseGeneratorManager_Cosmetic_OnCompromiseCompletedVFX");
static_assert(offsetof(CompromiseGeneratorManager_Cosmetic_OnCompromiseCompletedVFX, compromisedGenerator) == 0x000000, "Member 'CompromiseGeneratorManager_Cosmetic_OnCompromiseCompletedVFX::compromisedGenerator' has a wrong offset!");
...
static_assert(alignof(CompromiseGeneratorManager_Cosmetic_OnTriggerCompromiseVFX) == 0x000008, "Wrong alignment on CompromiseGeneratorManager_Cosmetic_OnTriggerCompromiseVFX");
static_assert(sizeof(CompromiseGeneratorManager_Cosmetic_OnTriggerCompromiseVFX) == 0x000008, "Wrong size on CompromiseGeneratorManager_Cosmetic_OnTriggerCompromiseVFX");
static_assert(offsetof(CompromiseGeneratorManager_Cosmetic_OnTriggerCompromiseVFX, compromisedGenerator) == 0x000000, "Member 'CompromiseGeneratorManager_Cosmetic_OnTriggerCompromiseVFX::compromisedGenerator' has a wrong offset!");
...
static_assert(alignof(CompromiseGeneratorManager_GetOwningPlayer) == 0x000008, "Wrong alignment on CompromiseGeneratorManager_GetOwningPlayer");
static_assert(sizeof(CompromiseGeneratorManager_GetOwningPlayer) == 0x000008, "Wrong size on CompromiseGeneratorManager_GetOwningPlayer");
static_assert(offsetof(CompromiseGeneratorManager_GetOwningPlayer, ReturnValue) == 0x000000, "Member 'CompromiseGeneratorManager_GetOwningPlayer::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DiminishingReturnBaseEffect_Authority_OnOriginatingEffectApplicableChanged, IsApplicable_0) == 0x000008, "Member 'DiminishingReturnBaseEffect_Authority_OnOriginatingEffectApplicableChanged::IsApplicable_0' has a wrong offset!");
...
static_assert(alignof(NoOneLeftBehind_GetUnhookHasteSpeedAdditive) == 0x000004, "Wrong alignment on NoOneLeftBehind_GetUnhookHasteSpeedAdditive");
static_assert(sizeof(NoOneLeftBehind_GetUnhookHasteSpeedAdditive) == 0x000004, "Wrong size on NoOneLeftBehind_GetUnhookHasteSpeedAdditive");
static_assert(offsetof(NoOneLeftBehind_GetUnhookHasteSpeedAdditive, ReturnValue) == 0x000000, "Member 'NoOneLeftBehind_GetUnhookHasteSpeedAdditive::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SpineChillPerk_Authority_OnIsLookingTowardsChanged, IsLookingTowards_0) == 0x000000, "Member 'SpineChillPerk_Authority_OnIsLookingTowardsChanged::IsLookingTowards_0' has a wrong offset!");
