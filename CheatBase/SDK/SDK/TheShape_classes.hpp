...
static_assert(sizeof(UKillStandingInteractionDefinition) == 0x000770, "Wrong size on UKillStandingInteractionDefinition");
static_assert(offsetof(UKillStandingInteractionDefinition, _slasherFacingTolerance) == 0x000768, "Member 'UKillStandingInteractionDefinition::_slasherFacingTolerance' has a wrong offset!");
...
static_assert(sizeof(USaveTheBestForLast) == 0x000478, "Wrong size on USaveTheBestForLast");
static_assert(offsetof(USaveTheBestForLast, TokensLostOnHit) == 0x000460, "Member 'USaveTheBestForLast::TokensLostOnHit' has a wrong offset!");
static_assert(offsetof(USaveTheBestForLast, _maxTokens) == 0x000464, "Member 'USaveTheBestForLast::_maxTokens' has a wrong offset!");
static_assert(offsetof(USaveTheBestForLast, _cooldownPerToken) == 0x000470, "Member 'USaveTheBestForLast::_cooldownPerToken' has a wrong offset!");
