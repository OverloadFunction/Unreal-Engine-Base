...
namespace Offsets
{
	constexpr int32 GObjects = 0x0A9FF990;
	constexpr int32 AppendString = 0x00000000;
	constexpr int32 GNames = 0x0A93D140;
	constexpr int32 GWorld = 0x0AB956E0;
	constexpr int32 ProcessEvent = 0x03CDA230;
...
public:
	inline std::uint64_t* InitGObjects()
	{
		GObjectsAddress = reinterpret_cast<uint64_t*>(InSDKUtils::GetImageBase() + Offsets::GObjects);
		return (std::uint64_t*)GObjectsAddress;
	}
