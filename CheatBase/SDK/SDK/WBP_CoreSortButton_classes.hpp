...
static_assert(sizeof(UWBP_CoreSortButton_C) == 0x000508, "Wrong size on UWBP_CoreSortButton_C");
static_assert(offsetof(UWBP_CoreSortButton_C, UberGraphFrame) == 0x0004B0, "Member 'UWBP_CoreSortButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_CoreSortButton_C, IconIMG) == 0x0004B8, "Member 'UWBP_CoreSortButton_C::IconIMG' has a wrong offset!");
static_assert(offsetof(UWBP_CoreSortButton_C, DefaultColor) == 0x0004C0, "Member 'UWBP_CoreSortButton_C::DefaultColor' has a wrong offset!");
static_assert(offsetof(UWBP_CoreSortButton_C, PressedColor) == 0x0004D0, "Member 'UWBP_CoreSortButton_C::PressedColor' has a wrong offset!");
static_assert(offsetof(UWBP_CoreSortButton_C, HoveredColor) == 0x0004E0, "Member 'UWBP_CoreSortButton_C::HoveredColor' has a wrong offset!");
static_assert(offsetof(UWBP_CoreSortButton_C, DisabledColor) == 0x0004F0, "Member 'UWBP_CoreSortButton_C::DisabledColor' has a wrong offset!");
static_assert(offsetof(UWBP_CoreSortButton_C, Background_IMG_Dynamic_Material) == 0x000500, "Member 'UWBP_CoreSortButton_C::Background_IMG_Dynamic_Material' has a wrong offset!");
