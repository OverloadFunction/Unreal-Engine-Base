...
void UHexUndying::Authority_OnSurvivorAdded(class ASurvivor* Survivor)
{
	static class UFunction* Func = nullptr;
...
void UHexUndying::Authority_OnSurvivorCleansedHexPerk(const struct FGameplayTag& GameplayTag, const struct FGameEventData& GameEventData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HexUndying", "Authority_OnSurvivorCleansedHexPerk");

	Params::HexUndying_Authority_OnSurvivorCleansedHexPerk Parms{};
...
void UHexUndying::Authority_UpdateHexPerkStatusView(class UGameplayModifierContainer* GameplayModifierContainer, bool IsApplicable_0)
{
	static class UFunction* Func = nullptr;
