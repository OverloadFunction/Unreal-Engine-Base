...
static_assert(sizeof(UAddon_Beartrap_05) == 0x000300, "Wrong size on UAddon_Beartrap_05");
...
static_assert(sizeof(UBearTrapOutlineUpdateStrategy) == 0x000118, "Wrong size on UBearTrapOutlineUpdateStrategy");
static_assert(offsetof(UBearTrapOutlineUpdateStrategy, UnrevealedColor) == 0x0000E0, "Member 'UBearTrapOutlineUpdateStrategy::UnrevealedColor' has a wrong offset!");
static_assert(offsetof(UBearTrapOutlineUpdateStrategy, RevealedColorToSurvivor) == 0x0000F0, "Member 'UBearTrapOutlineUpdateStrategy::RevealedColorToSurvivor' has a wrong offset!");
static_assert(offsetof(UBearTrapOutlineUpdateStrategy, KillerOutlineFadeCurve) == 0x000100, "Member 'UBearTrapOutlineUpdateStrategy::KillerOutlineFadeCurve' has a wrong offset!");
static_assert(offsetof(UBearTrapOutlineUpdateStrategy, _owningBearTrapMapActorComponent) == 0x000110, "Member 'UBearTrapOutlineUpdateStrategy::_owningBearTrapMapActorComponent' has a wrong offset!");
...
static_assert(sizeof(UAddon_Beartrap_DisarmRevealer) == 0x000360, "Wrong size on UAddon_Beartrap_DisarmRevealer");
static_assert(offsetof(UAddon_Beartrap_DisarmRevealer, _auraRevealDuration) == 0x000300, "Member 'UAddon_Beartrap_DisarmRevealer::_auraRevealDuration' has a wrong offset!");
static_assert(offsetof(UAddon_Beartrap_DisarmRevealer, _timedRevealToKillerStatusEffect) == 0x000308, "Member 'UAddon_Beartrap_DisarmRevealer::_timedRevealToKillerStatusEffect' has a wrong offset!");
static_assert(offsetof(UAddon_Beartrap_DisarmRevealer, _disarmedTrapMap) == 0x000310, "Member 'UAddon_Beartrap_DisarmRevealer::_disarmedTrapMap' has a wrong offset!");
...
static_assert(sizeof(UAddon_Beartrap_RustedJaws) == 0x000310, "Wrong size on UAddon_Beartrap_RustedJaws");
static_assert(offsetof(UAddon_Beartrap_RustedJaws, _mangledEffectClass) == 0x000300, "Member 'UAddon_Beartrap_RustedJaws::_mangledEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_Beartrap_RustedJaws, _mangledEffectLifetime) == 0x000308, "Member 'UAddon_Beartrap_RustedJaws::_mangledEffectLifetime' has a wrong offset!");
...
static_assert(sizeof(ABearTrap) == 0x0007B0, "Wrong size on ABearTrap");
static_assert(offsetof(ABearTrap, _interactionVolume) == 0x000568, "Member 'ABearTrap::_interactionVolume' has a wrong offset!");
static_assert(offsetof(ABearTrap, _trapPlayerDetectionZone) == 0x000570, "Member 'ABearTrap::_trapPlayerDetectionZone' has a wrong offset!");
static_assert(offsetof(ABearTrap, _killerSafetyZoneComponent) == 0x000578, "Member 'ABearTrap::_killerSafetyZoneComponent' has a wrong offset!");
static_assert(offsetof(ABearTrap, _outlineComponent) == 0x000580, "Member 'ABearTrap::_outlineComponent' has a wrong offset!");
static_assert(offsetof(ABearTrap, _outlineUpdateStrategy) == 0x000588, "Member 'ABearTrap::_outlineUpdateStrategy' has a wrong offset!");
static_assert(offsetof(ABearTrap, _mapActorComponent) == 0x000590, "Member 'ABearTrap::_mapActorComponent' has a wrong offset!");
static_assert(offsetof(ABearTrap, _mapActorCollision) == 0x000598, "Member 'ABearTrap::_mapActorCollision' has a wrong offset!");
static_assert(offsetof(ABearTrap, _trapBlocker) == 0x0005A0, "Member 'ABearTrap::_trapBlocker' has a wrong offset!");
static_assert(offsetof(ABearTrap, _montagePlayer) == 0x0005A8, "Member 'ABearTrap::_montagePlayer' has a wrong offset!");
static_assert(offsetof(ABearTrap, _onIsTrapSetChanged) == 0x0005B0, "Member 'ABearTrap::_onIsTrapSetChanged' has a wrong offset!");
static_assert(offsetof(ABearTrap, _ownerPlayer) == 0x0005C0, "Member 'ABearTrap::_ownerPlayer' has a wrong offset!");
static_assert(offsetof(ABearTrap, _revealWhileTrappedStatusEffectClass) == 0x0005C8, "Member 'ABearTrap::_revealWhileTrappedStatusEffectClass' has a wrong offset!");
static_assert(offsetof(ABearTrap, _dangerNavModifierComponent) == 0x0005D8, "Member 'ABearTrap::_dangerNavModifierComponent' has a wrong offset!");
static_assert(offsetof(ABearTrap, _isTrapperOutOfSafetyZone) == 0x0005E0, "Member 'ABearTrap::_isTrapperOutOfSafetyZone' has a wrong offset!");
static_assert(offsetof(ABearTrap, _maximumAttemptsForSelfUntrap) == 0x0005E4, "Member 'ABearTrap::_maximumAttemptsForSelfUntrap' has a wrong offset!");
static_assert(offsetof(ABearTrap, _untrapTargetEvents) == 0x0005E8, "Member 'ABearTrap::_untrapTargetEvents' has a wrong offset!");
static_assert(offsetof(ABearTrap, _slashedOutOfTrapEvents) == 0x000608, "Member 'ABearTrap::_slashedOutOfTrapEvents' has a wrong offset!");
static_assert(offsetof(ABearTrap, _selfUntrapAttemptsRemaining) == 0x000628, "Member 'ABearTrap::_selfUntrapAttemptsRemaining' has a wrong offset!");
static_assert(offsetof(ABearTrap, _mainInteractor) == 0x000630, "Member 'ABearTrap::_mainInteractor' has a wrong offset!");
static_assert(offsetof(ABearTrap, _trapSurvivor) == 0x000638, "Member 'ABearTrap::_trapSurvivor' has a wrong offset!");
static_assert(offsetof(ABearTrap, _trapKiller) == 0x000640, "Member 'ABearTrap::_trapKiller' has a wrong offset!");
static_assert(offsetof(ABearTrap, _trappedPlayer) == 0x000648, "Member 'ABearTrap::_trappedPlayer' has a wrong offset!");
static_assert(offsetof(ABearTrap, _animationMontageSlave) == 0x0006E0, "Member 'ABearTrap::_animationMontageSlave' has a wrong offset!");
static_assert(offsetof(ABearTrap, _baseBearTrapCarryCapacity) == 0x0006F8, "Member 'ABearTrap::_baseBearTrapCarryCapacity' has a wrong offset!");
static_assert(offsetof(ABearTrap, _honingStoneStatusEffect) == 0x000778, "Member 'ABearTrap::_honingStoneStatusEffect' has a wrong offset!");
static_assert(offsetof(ABearTrap, _owningPlayerState) == 0x0007A0, "Member 'ABearTrap::_owningPlayerState' has a wrong offset!");
...
static_assert(sizeof(UIridescentStone) == 0x000300, "Wrong size on UIridescentStone");
...
static_assert(sizeof(UResetBearTrapInteraction) == 0x0009D0, "Wrong size on UResetBearTrapInteraction");
...
static_assert(offsetof(UResetBearTrapInteraction, _setTrapHasteSpeedStat) == 0x000900, "Member 'UResetBearTrapInteraction::_setTrapHasteSpeedStat' has a wrong offset!");
static_assert(offsetof(UResetBearTrapInteraction, _hasteEffectDurationSeconds) == 0x000960, "Member 'UResetBearTrapInteraction::_hasteEffectDurationSeconds' has a wrong offset!");
...
static_assert(sizeof(USetBearTrap) == 0x000A40, "Wrong size on USetBearTrap");
...
static_assert(offsetof(USetBearTrap, _setTrapHasteSpeedStat) == 0x000980, "Member 'USetBearTrap::_setTrapHasteSpeedStat' has a wrong offset!");
static_assert(offsetof(USetBearTrap, _hasteEffectDurationSeconds) == 0x000A00, "Member 'USetBearTrap::_hasteEffectDurationSeconds' has a wrong offset!");
...
static_assert(sizeof(USlashedOutOfBearTrapInteraction) == 0x0007C0, "Wrong size on USlashedOutOfBearTrapInteraction");
static_assert(offsetof(USlashedOutOfBearTrapInteraction, _overridableInteractions) == 0x000768, "Member 'USlashedOutOfBearTrapInteraction::_overridableInteractions' has a wrong offset!");
static_assert(offsetof(USlashedOutOfBearTrapInteraction, _updateMontage) == 0x000778, "Member 'USlashedOutOfBearTrapInteraction::_updateMontage' has a wrong offset!");
static_assert(offsetof(USlashedOutOfBearTrapInteraction, _survivorDyingOutOfBearTrapMontageID) == 0x000780, "Member 'USlashedOutOfBearTrapInteraction::_survivorDyingOutOfBearTrapMontageID' has a wrong offset!");
static_assert(offsetof(USlashedOutOfBearTrapInteraction, _survivorInjuredOutOfBearTrapMontageID) == 0x0007A0, "Member 'USlashedOutOfBearTrapInteraction::_survivorInjuredOutOfBearTrapMontageID' has a wrong offset!");
...
static_assert(sizeof(UTrapKillerInteraction) == 0x000810, "Wrong size on UTrapKillerInteraction");
static_assert(offsetof(UTrapKillerInteraction, _overridableInteractions) == 0x000768, "Member 'UTrapKillerInteraction::_overridableInteractions' has a wrong offset!");
static_assert(offsetof(UTrapKillerInteraction, _caughtFootRotationOffset) == 0x000778, "Member 'UTrapKillerInteraction::_caughtFootRotationOffset' has a wrong offset!");
static_assert(offsetof(UTrapKillerInteraction, _openNotifyID) == 0x000790, "Member 'UTrapKillerInteraction::_openNotifyID' has a wrong offset!");
static_assert(offsetof(UTrapKillerInteraction, _footSocketName) == 0x00079C, "Member 'UTrapKillerInteraction::_footSocketName' has a wrong offset!");
...
// 0x00A0 (0x0810 - 0x0770)
class UTrapSurvivorInteraction final : public UInteractionDefinition
{
public:
...
static_assert(alignof(UTrapSurvivorInteraction) == 0x000010, "Wrong alignment on UTrapSurvivorInteraction");
static_assert(sizeof(UTrapSurvivorInteraction) == 0x000810, "Wrong size on UTrapSurvivorInteraction");
static_assert(offsetof(UTrapSurvivorInteraction, _nonOverridableInteractions) == 0x000768, "Member 'UTrapSurvivorInteraction::_nonOverridableInteractions' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _trapAttachSocket) == 0x000778, "Member 'UTrapSurvivorInteraction::_trapAttachSocket' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _updateMontageID) == 0x000784, "Member 'UTrapSurvivorInteraction::_updateMontageID' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _updateNoScreamMontageID) == 0x000790, "Member 'UTrapSurvivorInteraction::_updateNoScreamMontageID' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _loudNoiseRangeTunable) == 0x0007A0, "Member 'UTrapSurvivorInteraction::_loudNoiseRangeTunable' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _hemorrhageEffectDurationTunable) == 0x0007C8, "Member 'UTrapSurvivorInteraction::_hemorrhageEffectDurationTunable' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _hemorrhageStatusEffect) == 0x0007F0, "Member 'UTrapSurvivorInteraction::_hemorrhageStatusEffect' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _mangledStatusEffect) == 0x0007F8, "Member 'UTrapSurvivorInteraction::_mangledStatusEffect' has a wrong offset!");
static_assert(offsetof(UTrapSurvivorInteraction, _honingStoneWarningStatusEffect) == 0x000800, "Member 'UTrapSurvivorInteraction::_honingStoneWarningStatusEffect' has a wrong offset!");
