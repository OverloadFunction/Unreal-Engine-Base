...
static_assert(sizeof(UInterchangeAssetImportData) == 0x000058, "Wrong size on UInterchangeAssetImportData");
static_assert(offsetof(UInterchangeAssetImportData, NodeContainer) == 0x000030, "Member 'UInterchangeAssetImportData::NodeContainer' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, NodeUniqueID) == 0x000038, "Member 'UInterchangeAssetImportData::NodeUniqueID' has a wrong offset!");
static_assert(offsetof(UInterchangeAssetImportData, Pipelines) == 0x000048, "Member 'UInterchangeAssetImportData::Pipelines' has a wrong offset!");
...
static_assert(sizeof(UInterchangeProjectSettings) == 0x0002A0, "Wrong size on UInterchangeProjectSettings");
...
static_assert(offsetof(UInterchangeProjectSettings, SceneImportSettings) == 0x000188, "Member 'UInterchangeProjectSettings::SceneImportSettings' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, FilePickerClass) == 0x000228, "Member 'UInterchangeProjectSettings::FilePickerClass' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing) == 0x000260, "Member 'UInterchangeProjectSettings::bStaticMeshUseSmoothEdgesIfSmoothingInformationIsMissing' has a wrong offset!");
static_assert(offsetof(UInterchangeProjectSettings, GenericPipelineClass) == 0x000268, "Member 'UInterchangeProjectSettings::GenericPipelineClass' has a wrong offset!");
...
static_assert(sizeof(UInterchangePythonPipelineAsset) == 0x000080, "Wrong size on UInterchangePythonPipelineAsset");
...
static_assert(offsetof(UInterchangePythonPipelineAsset, GeneratedPipeline) == 0x000068, "Member 'UInterchangePythonPipelineAsset::GeneratedPipeline' has a wrong offset!");
static_assert(offsetof(UInterchangePythonPipelineAsset, JsonDefaultProperties) == 0x000070, "Member 'UInterchangePythonPipelineAsset::JsonDefaultProperties' has a wrong offset!");
...
static_assert(sizeof(UInterchangeManager) == 0x0001D0, "Wrong size on UInterchangeManager");
