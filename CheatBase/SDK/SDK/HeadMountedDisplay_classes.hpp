...
static_assert(offsetof(UMotionControllerComponent, PlayerIndex) == 0x0005A0, "Member 'UMotionControllerComponent::PlayerIndex' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, Hand) == 0x0005A4, "Member 'UMotionControllerComponent::Hand' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, MotionSource) == 0x0005A8, "Member 'UMotionControllerComponent::MotionSource' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x0005B8, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
...
static_assert(offsetof(UVRNotificationsComponent, XRInteractionProfileChangedDelegate) == 0x000168, "Member 'UVRNotificationsComponent::XRInteractionProfileChangedDelegate' has a wrong offset!");
...
static_assert(sizeof(UXRDeviceVisualizationComponent) == 0x0006E0, "Wrong size on UXRDeviceVisualizationComponent");
static_assert(offsetof(UXRDeviceVisualizationComponent, bIsVisualizationActive) == 0x000688, "Member 'UXRDeviceVisualizationComponent::bIsVisualizationActive' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, DisplayModelSource) == 0x00068C, "Member 'UXRDeviceVisualizationComponent::DisplayModelSource' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, CustomDisplayMesh) == 0x000698, "Member 'UXRDeviceVisualizationComponent::CustomDisplayMesh' has a wrong offset!");
static_assert(offsetof(UXRDeviceVisualizationComponent, DisplayMeshMaterialOverrides) == 0x0006A0, "Member 'UXRDeviceVisualizationComponent::DisplayMeshMaterialOverrides' has a wrong offset!");
