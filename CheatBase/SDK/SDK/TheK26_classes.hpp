...
static_assert(sizeof(AK26AttachedCrow) == 0x000460, "Wrong size on AK26AttachedCrow");
...
static_assert(offsetof(AK26AttachedCrow, _owningKiller) == 0x0003DC, "Member 'AK26AttachedCrow::_owningKiller' has a wrong offset!");
...
static_assert(sizeof(UHexPentimento) == 0x000548, "Wrong size on UHexPentimento");
static_assert(offsetof(UHexPentimento, _rekindleInteractionClass) == 0x0004E0, "Member 'UHexPentimento::_rekindleInteractionClass' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _survivorDebuffEffectClass) == 0x0004E8, "Member 'UHexPentimento::_survivorDebuffEffectClass' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _survivorDebuffIndicatorEffectClass) == 0x0004F0, "Member 'UHexPentimento::_survivorDebuffIndicatorEffectClass' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _baseActionSpeedPenalty) == 0x0004F8, "Member 'UHexPentimento::_baseActionSpeedPenalty' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _actionSpeedPenaltyPerRekindledTotem) == 0x000504, "Member 'UHexPentimento::_actionSpeedPenaltyPerRekindledTotem' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _totemAuraRevealRadius) == 0x000510, "Member 'UHexPentimento::_totemAuraRevealRadius' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _survivorDebuffEffects) == 0x000520, "Member 'UHexPentimento::_survivorDebuffEffects' has a wrong offset!");
static_assert(offsetof(UHexPentimento, _blockedTotems) == 0x000530, "Member 'UHexPentimento::_blockedTotems' has a wrong offset!");
...
static_assert(sizeof(UHinderOnCrowAttachStatusEffect) == 0x0004C0, "Wrong size on UHinderOnCrowAttachStatusEffect");
static_assert(offsetof(UHinderOnCrowAttachStatusEffect, _onCrowAttachStateTag) == 0x000408, "Member 'UHinderOnCrowAttachStatusEffect::_onCrowAttachStateTag' has a wrong offset!");
static_assert(offsetof(UHinderOnCrowAttachStatusEffect, _hinderOnIdleLingerTime) == 0x000418, "Member 'UHinderOnCrowAttachStatusEffect::_hinderOnIdleLingerTime' has a wrong offset!");
...
static_assert(sizeof(UHinderOnIdleAndAttachStatusEffect) == 0x000478, "Wrong size on UHinderOnIdleAndAttachStatusEffect");
static_assert(offsetof(UHinderOnIdleAndAttachStatusEffect, _onCrowAttachStateTag) == 0x000440, "Member 'UHinderOnIdleAndAttachStatusEffect::_onCrowAttachStateTag' has a wrong offset!");
...
static_assert(offsetof(UK26AmmoHandlerComponent, _onMaxAmmoSet) == 0x000120, "Member 'UK26AmmoHandlerComponent::_onMaxAmmoSet' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _rechargeEndTime) == 0x000130, "Member 'UK26AmmoHandlerComponent::_rechargeEndTime' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _isTunableInit) == 0x000134, "Member 'UK26AmmoHandlerComponent::_isTunableInit' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _projectileClass) == 0x000138, "Member 'UK26AmmoHandlerComponent::_projectileClass' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _expirationCooldownTime) == 0x000140, "Member 'UK26AmmoHandlerComponent::_expirationCooldownTime' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _firedCooldownTimesPerCrow) == 0x0001C0, "Member 'UK26AmmoHandlerComponent::_firedCooldownTimesPerCrow' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _cooldownReductionPerCrowFired) == 0x0001D0, "Member 'UK26AmmoHandlerComponent::_cooldownReductionPerCrowFired' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _expirationTime) == 0x000250, "Member 'UK26AmmoHandlerComponent::_expirationTime' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _expirationWarningBufferTime) == 0x0002D0, "Member 'UK26AmmoHandlerComponent::_expirationWarningBufferTime' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _maxAmmo) == 0x0002F8, "Member 'UK26AmmoHandlerComponent::_maxAmmo' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _currentAmmo) == 0x000378, "Member 'UK26AmmoHandlerComponent::_currentAmmo' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _lastCooldownReason) == 0x00037C, "Member 'UK26AmmoHandlerComponent::_lastCooldownReason' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _currentAmmoState) == 0x00037D, "Member 'UK26AmmoHandlerComponent::_currentAmmoState' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _pathHandler) == 0x000380, "Member 'UK26AmmoHandlerComponent::_pathHandler' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _statusHandler) == 0x000388, "Member 'UK26AmmoHandlerComponent::_statusHandler' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _authoritativeActorPoolComponent) == 0x000390, "Member 'UK26AmmoHandlerComponent::_authoritativeActorPoolComponent' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _isOutOfAmmo) == 0x000398, "Member 'UK26AmmoHandlerComponent::_isOutOfAmmo' has a wrong offset!");
static_assert(offsetof(UK26AmmoHandlerComponent, _fallbackFireCooldown) == 0x0003E0, "Member 'UK26AmmoHandlerComponent::_fallbackFireCooldown' has a wrong offset!");
...
static_assert(sizeof(UK26CooldownInteractionDefinition) == 0x0007F0, "Wrong size on UK26CooldownInteractionDefinition");
static_assert(offsetof(UK26CooldownInteractionDefinition, _cooldownTime) == 0x000768, "Member 'UK26CooldownInteractionDefinition::_cooldownTime' has a wrong offset!");
...
static_assert(offsetof(UK26CrowAttachmentSubAnimInstance, _isInsideLocker) == 0x0005EE, "Member 'UK26CrowAttachmentSubAnimInstance::_isInsideLocker' has a wrong offset!");
...
static_assert(sizeof(AK26CrowProjectile) == 0x0007A8, "Wrong size on AK26CrowProjectile");
static_assert(offsetof(AK26CrowProjectile, OnCrowProjectileStateChanged) == 0x0002C8, "Member 'AK26CrowProjectile::OnCrowProjectileStateChanged' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _originalFireLocation) == 0x0002D8, "Member 'AK26CrowProjectile::_originalFireLocation' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _projectileStateDetails) == 0x0002F0, "Member 'AK26CrowProjectile::_projectileStateDetails' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _summonTime) == 0x000340, "Member 'AK26CrowProjectile::_summonTime' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _detectionRadiusScaleX) == 0x000368, "Member 'AK26CrowProjectile::_detectionRadiusScaleX' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _detectionRadiusScaleY) == 0x0003E8, "Member 'AK26CrowProjectile::_detectionRadiusScaleY' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _detectionRadiusScaleZ) == 0x000468, "Member 'AK26CrowProjectile::_detectionRadiusScaleZ' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _crowFireAuraVisibilityForSurvivorsTime) == 0x0004E8, "Member 'AK26CrowProjectile::_crowFireAuraVisibilityForSurvivorsTime' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _crowSummonAuraVisibilityForSurvivorsTime) == 0x000510, "Member 'AK26CrowProjectile::_crowSummonAuraVisibilityForSurvivorsTime' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _detectionRadiusFromAbove) == 0x000538, "Member 'AK26CrowProjectile::_detectionRadiusFromAbove' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _baseSpeed) == 0x000560, "Member 'AK26CrowProjectile::_baseSpeed' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _selfDestructTimeOnDestroyed) == 0x000588, "Member 'AK26CrowProjectile::_selfDestructTimeOnDestroyed' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _rangeToTriggerNearSurvivorSFX) == 0x0005B0, "Member 'AK26CrowProjectile::_rangeToTriggerNearSurvivorSFX' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _onPathMovementSpeedModifierCurve) == 0x0005D8, "Member 'AK26CrowProjectile::_onPathMovementSpeedModifierCurve' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _offPathMovementSpeedModifierCurve) == 0x0005E0, "Member 'AK26CrowProjectile::_offPathMovementSpeedModifierCurve' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _projectileOffPathCurveDuration) == 0x0005E8, "Member 'AK26CrowProjectile::_projectileOffPathCurveDuration' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _path) == 0x0005F0, "Member 'AK26CrowProjectile::_path' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _pooledPathIndex) == 0x000600, "Member 'AK26CrowProjectile::_pooledPathIndex' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _currentProjectileState) == 0x000604, "Member 'AK26CrowProjectile::_currentProjectileState' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _outlineUpdateStrategy) == 0x000608, "Member 'AK26CrowProjectile::_outlineUpdateStrategy' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _crowFlockOutlineUpdateStrategy) == 0x000610, "Member 'AK26CrowProjectile::_crowFlockOutlineUpdateStrategy' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _outlineComponent) == 0x000618, "Member 'AK26CrowProjectile::_outlineComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _pathSplineComponent) == 0x000620, "Member 'AK26CrowProjectile::_pathSplineComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _collisionStaticMeshComponent) == 0x000628, "Member 'AK26CrowProjectile::_collisionStaticMeshComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _killerInstinctStaticMeshComponent) == 0x000630, "Member 'AK26CrowProjectile::_killerInstinctStaticMeshComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _visualSkeletalMeshComponent) == 0x000638, "Member 'AK26CrowProjectile::_visualSkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _rootComponent) == 0x000640, "Member 'AK26CrowProjectile::_rootComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _dangerNavModifierComponent) == 0x000648, "Member 'AK26CrowProjectile::_dangerNavModifierComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _k26ProjectileStateChangeDelegate) == 0x000650, "Member 'AK26CrowProjectile::_k26ProjectileStateChangeDelegate' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, OnAcquiredChanged) == 0x000660, "Member 'AK26CrowProjectile::OnAcquiredChanged' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _lockersWithSurvivorsInitiallyOnKillerInstinctRadius) == 0x000680, "Member 'AK26CrowProjectile::_lockersWithSurvivorsInitiallyOnKillerInstinctRadius' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _forwardDirection) == 0x000690, "Member 'AK26CrowProjectile::_forwardDirection' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _fireTime) == 0x0006A8, "Member 'AK26CrowProjectile::_fireTime' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _currentDistanceAlongSpline) == 0x0006AC, "Member 'AK26CrowProjectile::_currentDistanceAlongSpline' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _offPathTime) == 0x0006B0, "Member 'AK26CrowProjectile::_offPathTime' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _statusHandlerComponent) == 0x0006B8, "Member 'AK26CrowProjectile::_statusHandlerComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _ammoHandlerComponent) == 0x0006C0, "Member 'AK26CrowProjectile::_ammoHandlerComponent' has a wrong offset!");
static_assert(offsetof(AK26CrowProjectile, _pathHandlerComponent) == 0x0006C8, "Member 'AK26CrowProjectile::_pathHandlerComponent' has a wrong offset!");
...
static_assert(sizeof(UK26CrowProjectilePlacementValidationStrategy) == 0x0000C8, "Wrong size on UK26CrowProjectilePlacementValidationStrategy");
...
static_assert(sizeof(UK26FireCrowProjectileInteractionDefinition) == 0x0007C0, "Wrong size on UK26FireCrowProjectileInteractionDefinition");
static_assert(offsetof(UK26FireCrowProjectileInteractionDefinition, OnProjectileFired) == 0x000768, "Member 'UK26FireCrowProjectileInteractionDefinition::OnProjectileFired' has a wrong offset!");
static_assert(offsetof(UK26FireCrowProjectileInteractionDefinition, _cooldownInteraction) == 0x000778, "Member 'UK26FireCrowProjectileInteractionDefinition::_cooldownInteraction' has a wrong offset!");
static_assert(offsetof(UK26FireCrowProjectileInteractionDefinition, _ammoHandler) == 0x000780, "Member 'UK26FireCrowProjectileInteractionDefinition::_ammoHandler' has a wrong offset!");
static_assert(offsetof(UK26FireCrowProjectileInteractionDefinition, _pathHandler) == 0x000788, "Member 'UK26FireCrowProjectileInteractionDefinition::_pathHandler' has a wrong offset!");
...
static_assert(sizeof(UK26IsLastCrowRemovalReasonDueToInteraction) == 0x000108, "Wrong size on UK26IsLastCrowRemovalReasonDueToInteraction");
static_assert(offsetof(UK26IsLastCrowRemovalReasonDueToInteraction, _owningAttachedCrow) == 0x0000F0, "Member 'UK26IsLastCrowRemovalReasonDueToInteraction::_owningAttachedCrow' has a wrong offset!");
static_assert(offsetof(UK26IsLastCrowRemovalReasonDueToInteraction, _statusHandlerComponent) == 0x0000F8, "Member 'UK26IsLastCrowRemovalReasonDueToInteraction::_statusHandlerComponent' has a wrong offset!");
...
static_assert(sizeof(UK26IsSurvivorInRangeOfAnyIdleCrow) == 0x000120, "Wrong size on UK26IsSurvivorInRangeOfAnyIdleCrow");
static_assert(offsetof(UK26IsSurvivorInRangeOfAnyIdleCrow, OnIsTrueChanged) == 0x0000F0, "Member 'UK26IsSurvivorInRangeOfAnyIdleCrow::OnIsTrueChanged' has a wrong offset!");
static_assert(offsetof(UK26IsSurvivorInRangeOfAnyIdleCrow, _trackedSurvivor) == 0x000108, "Member 'UK26IsSurvivorInRangeOfAnyIdleCrow::_trackedSurvivor' has a wrong offset!");
...
static_assert(sizeof(UK26KillerInstinctStatusEffect) == 0x000428, "Wrong size on UK26KillerInstinctStatusEffect");
static_assert(offsetof(UK26KillerInstinctStatusEffect, _lingerDuration) == 0x000398, "Member 'UK26KillerInstinctStatusEffect::_lingerDuration' has a wrong offset!");
static_assert(offsetof(UK26KillerInstinctStatusEffect, _openExitGateInteractionClass) == 0x000418, "Member 'UK26KillerInstinctStatusEffect::_openExitGateInteractionClass' has a wrong offset!");
static_assert(offsetof(UK26KillerInstinctStatusEffect, _hasInitializedLingerDuration) == 0x000420, "Member 'UK26KillerInstinctStatusEffect::_hasInitializedLingerDuration' has a wrong offset!");
...
static_assert(sizeof(UK26OnCrowAttachLingeringStatusEffectBase) == 0x0003F8, "Wrong size on UK26OnCrowAttachLingeringStatusEffectBase");
static_assert(offsetof(UK26OnCrowAttachLingeringStatusEffectBase, _onCrowAttachStateTag) == 0x000398, "Member 'UK26OnCrowAttachLingeringStatusEffectBase::_onCrowAttachStateTag' has a wrong offset!");
static_assert(offsetof(UK26OnCrowAttachLingeringStatusEffectBase, _lingerTime) == 0x0003A8, "Member 'UK26OnCrowAttachLingeringStatusEffectBase::_lingerTime' has a wrong offset!");
...
static_assert(sizeof(UK26P01) == 0x0004F8, "Wrong size on UK26P01");
static_assert(offsetof(UK26P01, _generatorBlockDuration) == 0x000460, "Member 'UK26P01::_generatorBlockDuration' has a wrong offset!");
static_assert(offsetof(UK26P01, _hookedRange) == 0x00046C, "Member 'UK26P01::_hookedRange' has a wrong offset!");
static_assert(offsetof(UK26P01, _auraRevealDuration) == 0x000478, "Member 'UK26P01::_auraRevealDuration' has a wrong offset!");
static_assert(offsetof(UK26P01, _finalGeneratorBlockDuration) == 0x00047C, "Member 'UK26P01::_finalGeneratorBlockDuration' has a wrong offset!");
static_assert(offsetof(UK26P01, _generatorAuraColorForKiller) == 0x000480, "Member 'UK26P01::_generatorAuraColorForKiller' has a wrong offset!");
static_assert(offsetof(UK26P01, _survivorsToBeHooked) == 0x000490, "Member 'UK26P01::_survivorsToBeHooked' has a wrong offset!");
static_assert(offsetof(UK26P01, _timedRevealToKillerClass) == 0x000498, "Member 'UK26P01::_timedRevealToKillerClass' has a wrong offset!");
static_assert(offsetof(UK26P01, _blockedGenerators) == 0x0004A0, "Member 'UK26P01::_blockedGenerators' has a wrong offset!");
static_assert(offsetof(UK26P01, _hookedSurvivors) == 0x0004B0, "Member 'UK26P01::_hookedSurvivors' has a wrong offset!");
static_assert(offsetof(UK26P01, _timedRevealToKillerEffect) == 0x0004C0, "Member 'UK26P01::_timedRevealToKillerEffect' has a wrong offset!");
...
static_assert(sizeof(UK26P02) == 0x0004D0, "Wrong size on UK26P02");
static_assert(offsetof(UK26P02, _generatorRegressPercentage) == 0x000468, "Member 'UK26P02::_generatorRegressPercentage' has a wrong offset!");
static_assert(offsetof(UK26P02, _hookedPlayers) == 0x000478, "Member 'UK26P02::_hookedPlayers' has a wrong offset!");
...
static_assert(sizeof(UK26PowerChargePresentationItemProgressComponent) == 0x0000C8, "Wrong size on UK26PowerChargePresentationItemProgressComponent");
static_assert(offsetof(UK26PowerChargePresentationItemProgressComponent, _ammoHandler) == 0x0000C0, "Member 'UK26PowerChargePresentationItemProgressComponent::_ammoHandler' has a wrong offset!");
...
static_assert(sizeof(UK26PowerOutlineUpdateStrategy) == 0x0000F8, "Wrong size on UK26PowerOutlineUpdateStrategy");
static_assert(offsetof(UK26PowerOutlineUpdateStrategy, _k26ProjectileOutlineColour) == 0x0000E0, "Member 'UK26PowerOutlineUpdateStrategy::_k26ProjectileOutlineColour' has a wrong offset!");
static_assert(offsetof(UK26PowerOutlineUpdateStrategy, _isOutlineEnabled) == 0x0000F0, "Member 'UK26PowerOutlineUpdateStrategy::_isOutlineEnabled' has a wrong offset!");
static_assert(offsetof(UK26PowerOutlineUpdateStrategy, _isOnlyVisibleForKiller) == 0x0000F1, "Member 'UK26PowerOutlineUpdateStrategy::_isOnlyVisibleForKiller' has a wrong offset!");
...
static_assert(sizeof(UK26PowerStatusHandlerComponent) == 0x0001A8, "Wrong size on UK26PowerStatusHandlerComponent");
...
static_assert(offsetof(UK26PowerStatusHandlerComponent, _invincibilityTime) == 0x0000E8, "Member 'UK26PowerStatusHandlerComponent::_invincibilityTime' has a wrong offset!");
static_assert(offsetof(UK26PowerStatusHandlerComponent, _killerInstinctDelay) == 0x000110, "Member 'UK26PowerStatusHandlerComponent::_killerInstinctDelay' has a wrong offset!");
static_assert(offsetof(UK26PowerStatusHandlerComponent, _killerInstinctGracePeriod) == 0x000138, "Member 'UK26PowerStatusHandlerComponent::_killerInstinctGracePeriod' has a wrong offset!");
static_assert(offsetof(UK26PowerStatusHandlerComponent, _statusIndicatorClass) == 0x000160, "Member 'UK26PowerStatusHandlerComponent::_statusIndicatorClass' has a wrong offset!");
static_assert(offsetof(UK26PowerStatusHandlerComponent, _k26KillerInstinctStatusEffectClass) == 0x000168, "Member 'UK26PowerStatusHandlerComponent::_k26KillerInstinctStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UK26PowerStatusHandlerComponent, _survivorStatusList) == 0x000170, "Member 'UK26PowerStatusHandlerComponent::_survivorStatusList' has a wrong offset!");
...
static_assert(sizeof(URekindleTotemInteraction) == 0x000790, "Wrong size on URekindleTotemInteraction");
static_assert(offsetof(URekindleTotemInteraction, _slasherFacingTolerance) == 0x000768, "Member 'URekindleTotemInteraction::_slasherFacingTolerance' has a wrong offset!");
static_assert(offsetof(URekindleTotemInteraction, _rekindledTotemClass) == 0x000770, "Member 'URekindleTotemInteraction::_rekindledTotemClass' has a wrong offset!");
static_assert(offsetof(URekindleTotemInteraction, _rekindledTotem) == 0x000778, "Member 'URekindleTotemInteraction::_rekindledTotem' has a wrong offset!");
