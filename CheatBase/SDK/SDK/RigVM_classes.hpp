...
static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x0003B0, "Wrong size on URigVMBlueprintGeneratedClass");
static_assert(offsetof(URigVMBlueprintGeneratedClass, GraphFunctionStore) == 0x000388, "Member 'URigVMBlueprintGeneratedClass::GraphFunctionStore' has a wrong offset!");
...
static_assert(sizeof(URigVM) == 0x000400, "Wrong size on URigVM");
...
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x0003B8, "Member 'URigVM::DeferredVMToCopy' has a wrong offset!");
...
static_assert(sizeof(URigVMNativized) == 0x000428, "Wrong size on URigVMNativized");
