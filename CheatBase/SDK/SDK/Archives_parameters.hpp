...
static_assert(alignof(FragileObjectComponent_Authority_OnSurvivorRemoved) == 0x000008, "Wrong alignment on FragileObjectComponent_Authority_OnSurvivorRemoved");
static_assert(sizeof(FragileObjectComponent_Authority_OnSurvivorRemoved) == 0x000008, "Wrong size on FragileObjectComponent_Authority_OnSurvivorRemoved");
static_assert(offsetof(FragileObjectComponent_Authority_OnSurvivorRemoved, removedPlayer) == 0x000000, "Member 'FragileObjectComponent_Authority_OnSurvivorRemoved::removedPlayer' has a wrong offset!");
...
static_assert(alignof(InLockerNearKillerQEEvaluator_OnLockerHideEnter) == 0x000008, "Wrong alignment on InLockerNearKillerQEEvaluator_OnLockerHideEnter");
static_assert(sizeof(InLockerNearKillerQEEvaluator_OnLockerHideEnter) == 0x000040, "Wrong size on InLockerNearKillerQEEvaluator_OnLockerHideEnter");
static_assert(offsetof(InLockerNearKillerQEEvaluator_OnLockerHideEnter, gameEventType) == 0x000000, "Member 'InLockerNearKillerQEEvaluator_OnLockerHideEnter::gameEventType' has a wrong offset!");
static_assert(offsetof(InLockerNearKillerQEEvaluator_OnLockerHideEnter, GameEventData) == 0x000010, "Member 'InLockerNearKillerQEEvaluator_OnLockerHideEnter::GameEventData' has a wrong offset!");
...
static_assert(alignof(InLockerNearKillerQEEvaluator_OnLockerHideExit) == 0x000008, "Wrong alignment on InLockerNearKillerQEEvaluator_OnLockerHideExit");
static_assert(sizeof(InLockerNearKillerQEEvaluator_OnLockerHideExit) == 0x000040, "Wrong size on InLockerNearKillerQEEvaluator_OnLockerHideExit");
static_assert(offsetof(InLockerNearKillerQEEvaluator_OnLockerHideExit, gameEventType) == 0x000000, "Member 'InLockerNearKillerQEEvaluator_OnLockerHideExit::gameEventType' has a wrong offset!");
static_assert(offsetof(InLockerNearKillerQEEvaluator_OnLockerHideExit, GameEventData) == 0x000010, "Member 'InLockerNearKillerQEEvaluator_OnLockerHideExit::GameEventData' has a wrong offset!");
...
static_assert(alignof(PinkGlyphComponent_Authority_OnHealthStateChanged) == 0x000001, "Wrong alignment on PinkGlyphComponent_Authority_OnHealthStateChanged");
static_assert(sizeof(PinkGlyphComponent_Authority_OnHealthStateChanged) == 0x000002, "Wrong size on PinkGlyphComponent_Authority_OnHealthStateChanged");
static_assert(offsetof(PinkGlyphComponent_Authority_OnHealthStateChanged, oldHealthState) == 0x000000, "Member 'PinkGlyphComponent_Authority_OnHealthStateChanged::oldHealthState' has a wrong offset!");
static_assert(offsetof(PinkGlyphComponent_Authority_OnHealthStateChanged, newHealthState) == 0x000001, "Member 'PinkGlyphComponent_Authority_OnHealthStateChanged::newHealthState' has a wrong offset!");
