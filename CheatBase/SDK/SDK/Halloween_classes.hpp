...
static_assert(sizeof(UVoidEnergyChangeQEEvaluator) == 0x0000D8, "Wrong size on UVoidEnergyChangeQEEvaluator");
...
static_assert(sizeof(UDepositEnergyInMatchQEEvaluator) == 0x0000D8, "Wrong size on UDepositEnergyInMatchQEEvaluator");
...
static_assert(sizeof(UDepositVoidEnergyBySpecifiedReasonQEEvaluator) == 0x0000E0, "Wrong size on UDepositVoidEnergyBySpecifiedReasonQEEvaluator");
static_assert(offsetof(UDepositVoidEnergyBySpecifiedReasonQEEvaluator, _changeReason) == 0x0000D8, "Member 'UDepositVoidEnergyBySpecifiedReasonQEEvaluator::_changeReason' has a wrong offset!");
...
static_assert(sizeof(UDepositVoidEnergyTierQEEvaluator) == 0x0000D0, "Wrong size on UDepositVoidEnergyTierQEEvaluator");
...
static_assert(sizeof(UFloatingVoidEnergyOrb) == 0x000280, "Wrong size on UFloatingVoidEnergyOrb");
static_assert(offsetof(UFloatingVoidEnergyOrb, Cosmetic_OnOrbStartMoving) == 0x0000B8, "Member 'UFloatingVoidEnergyOrb::Cosmetic_OnOrbStartMoving' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, Cosmetic_OnOrbReachPlayer) == 0x0000C8, "Member 'UFloatingVoidEnergyOrb::Cosmetic_OnOrbReachPlayer' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _characterBoneName) == 0x0000F8, "Member 'UFloatingVoidEnergyOrb::_characterBoneName' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _travelTimeToPlayer) == 0x000108, "Member 'UFloatingVoidEnergyOrb::_travelTimeToPlayer' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _voidEnergyToGrantPlayer) == 0x000130, "Member 'UFloatingVoidEnergyOrb::_voidEnergyToGrantPlayer' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _trackerRadius) == 0x000158, "Member 'UFloatingVoidEnergyOrb::_trackerRadius' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _timeToWaitBeforeRespawnOrb) == 0x000180, "Member 'UFloatingVoidEnergyOrb::_timeToWaitBeforeRespawnOrb' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _timeToWaitBeforeRespawnOrbInVoid) == 0x0001A8, "Member 'UFloatingVoidEnergyOrb::_timeToWaitBeforeRespawnOrbInVoid' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _autoCollectorRadius) == 0x0001D0, "Member 'UFloatingVoidEnergyOrb::_autoCollectorRadius' has a wrong offset!");
static_assert(offsetof(UFloatingVoidEnergyOrb, _respawnableComponent) == 0x000208, "Member 'UFloatingVoidEnergyOrb::_respawnableComponent' has a wrong offset!");
...
static_assert(offsetof(UHalloweenEventComponent, _voidWorldTeleporterBP) == 0x0000B8, "Member 'UHalloweenEventComponent::_voidWorldTeleporterBP' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _voidZonePlayerComponentClass) == 0x0000C0, "Member 'UHalloweenEventComponent::_voidZonePlayerComponentClass' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _spawnHauntProjectileClass) == 0x0000C8, "Member 'UHalloweenEventComponent::_spawnHauntProjectileClass' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _hauntProjectilePlayerInventoryComponentClass) == 0x0000D0, "Member 'UHalloweenEventComponent::_hauntProjectilePlayerInventoryComponentClass' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _vfxHelperComponent) == 0x0000D8, "Member 'UHalloweenEventComponent::_vfxHelperComponent' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _eventCheatComponentClass) == 0x0000E0, "Member 'UHalloweenEventComponent::_eventCheatComponentClass' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _unstableRifts) == 0x0000E8, "Member 'UHalloweenEventComponent::_unstableRifts' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _voidWorldTeleporterActors) == 0x0000F8, "Member 'UHalloweenEventComponent::_voidWorldTeleporterActors' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _playersInVoid) == 0x000108, "Member 'UHalloweenEventComponent::_playersInVoid' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _previousPlayersInVoidZone) == 0x000118, "Member 'UHalloweenEventComponent::_previousPlayersInVoidZone' has a wrong offset!");
static_assert(offsetof(UHalloweenEventComponent, _localPlayerTracker) == 0x000138, "Member 'UHalloweenEventComponent::_localPlayerTracker' has a wrong offset!");
...
static_assert(sizeof(AHalloweenHauntProjectile) == 0x000508, "Wrong size on AHalloweenHauntProjectile");
static_assert(offsetof(AHalloweenHauntProjectile, _skeletalMesh) == 0x000338, "Member 'AHalloweenHauntProjectile::_skeletalMesh' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _worldCollider) == 0x000340, "Member 'AHalloweenHauntProjectile::_worldCollider' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _playerCollider) == 0x000348, "Member 'AHalloweenHauntProjectile::_playerCollider' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _travelingMovementCurve) == 0x000350, "Member 'AHalloweenHauntProjectile::_travelingMovementCurve' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _unitsToSpawnAboveGround) == 0x000360, "Member 'AHalloweenHauntProjectile::_unitsToSpawnAboveGround' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _unitsToSpawnInFrontOfKiller) == 0x000388, "Member 'AHalloweenHauntProjectile::_unitsToSpawnInFrontOfKiller' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _maximumTravelSpeed) == 0x0003B0, "Member 'AHalloweenHauntProjectile::_maximumTravelSpeed' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _totalTravelTime) == 0x0003D8, "Member 'AHalloweenHauntProjectile::_totalTravelTime' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _screamRangeForSurvivors) == 0x000400, "Member 'AHalloweenHauntProjectile::_screamRangeForSurvivors' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _tagsPreventingPlayerHit) == 0x000430, "Member 'AHalloweenHauntProjectile::_tagsPreventingPlayerHit' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _actorsToIgnore) == 0x000450, "Member 'AHalloweenHauntProjectile::_actorsToIgnore' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _cachedProjectilesInGame) == 0x000460, "Member 'AHalloweenHauntProjectile::_cachedProjectilesInGame' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _poolableComponent) == 0x0004C8, "Member 'AHalloweenHauntProjectile::_poolableComponent' has a wrong offset!");
static_assert(offsetof(AHalloweenHauntProjectile, _timeToDisappear) == 0x0004D4, "Member 'AHalloweenHauntProjectile::_timeToDisappear' has a wrong offset!");
...
static_assert(sizeof(UHauntProjectilePlayerInventoryComponent) == 0x000130, "Wrong size on UHauntProjectilePlayerInventoryComponent");
static_assert(offsetof(UHauntProjectilePlayerInventoryComponent, _currentHauntCount) == 0x0000D0, "Member 'UHauntProjectilePlayerInventoryComponent::_currentHauntCount' has a wrong offset!");
static_assert(offsetof(UHauntProjectilePlayerInventoryComponent, _hauntsToAddAtATime) == 0x0000D8, "Member 'UHauntProjectilePlayerInventoryComponent::_hauntsToAddAtATime' has a wrong offset!");
static_assert(offsetof(UHauntProjectilePlayerInventoryComponent, _maxHauntsCanHold) == 0x000100, "Member 'UHauntProjectilePlayerInventoryComponent::_maxHauntsCanHold' has a wrong offset!");
static_assert(offsetof(UHauntProjectilePlayerInventoryComponent, _hauntPool) == 0x000128, "Member 'UHauntProjectilePlayerInventoryComponent::_hauntPool' has a wrong offset!");
...
static_assert(sizeof(ULinkedTeleporterComponent) == 0x0001E8, "Wrong size on ULinkedTeleporterComponent");
static_assert(offsetof(ULinkedTeleporterComponent, Cosmetic_OnTeleporterEnabled) == 0x0000E8, "Member 'ULinkedTeleporterComponent::Cosmetic_OnTeleporterEnabled' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, Cosmetic_OnPlayerTeleported) == 0x0000F8, "Member 'ULinkedTeleporterComponent::Cosmetic_OnPlayerTeleported' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, Cosmetic_OnPlayerCooldownOver) == 0x000108, "Member 'ULinkedTeleporterComponent::Cosmetic_OnPlayerCooldownOver' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, _linkedTeleporter) == 0x000118, "Member 'ULinkedTeleporterComponent::_linkedTeleporter' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, _isAllowedToTeleport) == 0x000120, "Member 'ULinkedTeleporterComponent::_isAllowedToTeleport' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, _teleportationCooldownTime) == 0x000188, "Member 'ULinkedTeleporterComponent::_teleportationCooldownTime' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, _survivorTagsPreventingTeleport) == 0x0001B0, "Member 'ULinkedTeleporterComponent::_survivorTagsPreventingTeleport' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, _killerTagsPreventingTeleport) == 0x0001C0, "Member 'ULinkedTeleporterComponent::_killerTagsPreventingTeleport' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterComponent, _forceCamperDropSpecialItemOnTeleport) == 0x0001D0, "Member 'ULinkedTeleporterComponent::_forceCamperDropSpecialItemOnTeleport' has a wrong offset!");
...
static_assert(sizeof(ULinkedTeleporterOutlineStrategy) == 0x0001A8, "Wrong size on ULinkedTeleporterOutlineStrategy");
static_assert(offsetof(ULinkedTeleporterOutlineStrategy, _displayColor) == 0x000160, "Member 'ULinkedTeleporterOutlineStrategy::_displayColor' has a wrong offset!");
static_assert(offsetof(ULinkedTeleporterOutlineStrategy, _distanceToReveal) == 0x000170, "Member 'ULinkedTeleporterOutlineStrategy::_distanceToReveal' has a wrong offset!");
...
static_assert(sizeof(UPlayerVoidEnergy) == 0x0002C0, "Wrong size on UPlayerVoidEnergy");
...
static_assert(offsetof(UPlayerVoidEnergy, _currentVoidEnergy) == 0x00011C, "Member 'UPlayerVoidEnergy::_currentVoidEnergy' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _totalVoidEnergySpent) == 0x000120, "Member 'UPlayerVoidEnergy::_totalVoidEnergySpent' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _maxEnergyOnPlayerAllowed) == 0x000150, "Member 'UPlayerVoidEnergy::_maxEnergyOnPlayerAllowed' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _amountLostOnDownAsSurvivor) == 0x000178, "Member 'UPlayerVoidEnergy::_amountLostOnDownAsSurvivor' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _amountGainedOnDownAsKiller) == 0x0001A0, "Member 'UPlayerVoidEnergy::_amountGainedOnDownAsKiller' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _amountGainedOnStunAsSurvivor) == 0x0001C8, "Member 'UPlayerVoidEnergy::_amountGainedOnStunAsSurvivor' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _amountGainedOnBlindAsSurvivor) == 0x0001F0, "Member 'UPlayerVoidEnergy::_amountGainedOnBlindAsSurvivor' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _amountLostOnStunAsKiller) == 0x000218, "Member 'UPlayerVoidEnergy::_amountLostOnStunAsKiller' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _timeHasteEffectLasts) == 0x000240, "Member 'UPlayerVoidEnergy::_timeHasteEffectLasts' has a wrong offset!");
static_assert(offsetof(UPlayerVoidEnergy, _voidEnergyOrbSpawnerClass) == 0x000268, "Member 'UPlayerVoidEnergy::_voidEnergyOrbSpawnerClass' has a wrong offset!");
...
static_assert(sizeof(USpawnHauntProjectileInteraction) == 0x000850, "Wrong size on USpawnHauntProjectileInteraction");
static_assert(offsetof(USpawnHauntProjectileInteraction, _preventativeStateTags) == 0x000780, "Member 'USpawnHauntProjectileInteraction::_preventativeStateTags' has a wrong offset!");
static_assert(offsetof(USpawnHauntProjectileInteraction, _timeBetweenEachHauntLaunch) == 0x000790, "Member 'USpawnHauntProjectileInteraction::_timeBetweenEachHauntLaunch' has a wrong offset!");
static_assert(offsetof(USpawnHauntProjectileInteraction, _windUpTimeBeforeSpawn) == 0x0007B8, "Member 'USpawnHauntProjectileInteraction::_windUpTimeBeforeSpawn' has a wrong offset!");
static_assert(offsetof(USpawnHauntProjectileInteraction, _hauntInventoryComponent) == 0x0007E0, "Member 'USpawnHauntProjectileInteraction::_hauntInventoryComponent' has a wrong offset!");
...
static_assert(sizeof(UUnstableRiftOutlineStrategy) == 0x0001A8, "Wrong size on UUnstableRiftOutlineStrategy");
static_assert(offsetof(UUnstableRiftOutlineStrategy, _displayColor) == 0x000160, "Member 'UUnstableRiftOutlineStrategy::_displayColor' has a wrong offset!");
static_assert(offsetof(UUnstableRiftOutlineStrategy, _distanceToReveal) == 0x000170, "Member 'UUnstableRiftOutlineStrategy::_distanceToReveal' has a wrong offset!");
static_assert(offsetof(UUnstableRiftOutlineStrategy, _isAuraOfRiftNoTeleporter) == 0x000198, "Member 'UUnstableRiftOutlineStrategy::_isAuraOfRiftNoTeleporter' has a wrong offset!");
...
static_assert(sizeof(UVoidEnergyAmountInMatchQEEvaluator) == 0x0000E0, "Wrong size on UVoidEnergyAmountInMatchQEEvaluator");
...
static_assert(sizeof(UVoidEnergyProducer) == 0x000178, "Wrong size on UVoidEnergyProducer");
static_assert(offsetof(UVoidEnergyProducer, _hasMaxEnergyToGive) == 0x0000D0, "Member 'UVoidEnergyProducer::_hasMaxEnergyToGive' has a wrong offset!");
static_assert(offsetof(UVoidEnergyProducer, _maxEnergyCanAward) == 0x0000D8, "Member 'UVoidEnergyProducer::_maxEnergyCanAward' has a wrong offset!");
static_assert(offsetof(UVoidEnergyProducer, _energyToGiveOnEvent) == 0x000100, "Member 'UVoidEnergyProducer::_energyToGiveOnEvent' has a wrong offset!");
static_assert(offsetof(UVoidEnergyProducer, _gameEventToRewardEnergy) == 0x000128, "Member 'UVoidEnergyProducer::_gameEventToRewardEnergy' has a wrong offset!");
static_assert(offsetof(UVoidEnergyProducer, _totalEnergyGiven) == 0x000148, "Member 'UVoidEnergyProducer::_totalEnergyGiven' has a wrong offset!");
...
static_assert(offsetof(UVoidEnergyProducer, _spawnSceneComponent) == 0x000170, "Member 'UVoidEnergyProducer::_spawnSceneComponent' has a wrong offset!");
...
static_assert(sizeof(UVoidEnergyGeneratorComponent) == 0x0001F8, "Wrong size on UVoidEnergyGeneratorComponent");
static_assert(offsetof(UVoidEnergyGeneratorComponent, _timeWorkingOnGeneratorNeededToAwardEnergy) == 0x000178, "Member 'UVoidEnergyGeneratorComponent::_timeWorkingOnGeneratorNeededToAwardEnergy' has a wrong offset!");
...
static_assert(sizeof(UVoidEnergyMeatHookComponent) == 0x000178, "Wrong size on UVoidEnergyMeatHookComponent");
...
static_assert(offsetof(UVoidEnergyOrbSpawner, _slasherSpawnOffset) == 0x000194, "Member 'UVoidEnergyOrbSpawner::_slasherSpawnOffset' has a wrong offset!");
static_assert(offsetof(UVoidEnergyOrbSpawner, _slasherSpawnOffsetFarDown) == 0x000198, "Member 'UVoidEnergyOrbSpawner::_slasherSpawnOffsetFarDown' has a wrong offset!");
static_assert(offsetof(UVoidEnergyOrbSpawner, _voidEnergyOrbClass) == 0x0001B0, "Member 'UVoidEnergyOrbSpawner::_voidEnergyOrbClass' has a wrong offset!");
static_assert(offsetof(UVoidEnergyOrbSpawner, _killerDownGameEvents) == 0x0001B8, "Member 'UVoidEnergyOrbSpawner::_killerDownGameEvents' has a wrong offset!");
...
static_assert(sizeof(UVoidEnergyPumpkinComponent) == 0x0001F0, "Wrong size on UVoidEnergyPumpkinComponent");
static_assert(offsetof(UVoidEnergyPumpkinComponent, _treatVoidEnergyAmount) == 0x000178, "Member 'UVoidEnergyPumpkinComponent::_treatVoidEnergyAmount' has a wrong offset!");
static_assert(offsetof(UVoidEnergyPumpkinComponent, _trickVoidEnergyAmount) == 0x0001A0, "Member 'UVoidEnergyPumpkinComponent::_trickVoidEnergyAmount' has a wrong offset!");
static_assert(offsetof(UVoidEnergyPumpkinComponent, _neutralVoidEnergyAmount) == 0x0001C8, "Member 'UVoidEnergyPumpkinComponent::_neutralVoidEnergyAmount' has a wrong offset!");
...
static_assert(sizeof(UVoidZonePlayerComponent) == 0x0001A8, "Wrong size on UVoidZonePlayerComponent");
static_assert(offsetof(UVoidZonePlayerComponent, _voidWorldStatusEffects) == 0x0000C0, "Member 'UVoidZonePlayerComponent::_voidWorldStatusEffects' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _statusEffectClassesToApplyToKillersOnEnterVoid) == 0x0000D0, "Member 'UVoidZonePlayerComponent::_statusEffectClassesToApplyToKillersOnEnterVoid' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _statusEffectClassesToApplyToSurvivorsOnEnterVoid) == 0x0000E0, "Member 'UVoidZonePlayerComponent::_statusEffectClassesToApplyToSurvivorsOnEnterVoid' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _lastVoidZoneTeleporterUsed) == 0x0000F0, "Member 'UVoidZonePlayerComponent::_lastVoidZoneTeleporterUsed' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _voidWorldHauntInteractionStatusEffect) == 0x0000F8, "Member 'UVoidZonePlayerComponent::_voidWorldHauntInteractionStatusEffect' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _playerEventDispatcher) == 0x000100, "Member 'UVoidZonePlayerComponent::_playerEventDispatcher' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _stateTagsWaitForInteractionEndOnVoidClose) == 0x000108, "Member 'UVoidZonePlayerComponent::_stateTagsWaitForInteractionEndOnVoidClose' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _owningPlayerInteraction) == 0x000118, "Member 'UVoidZonePlayerComponent::_owningPlayerInteraction' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _localPlayerTracker) == 0x000120, "Member 'UVoidZonePlayerComponent::_localPlayerTracker' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _voidZoneLightingLocation) == 0x000138, "Member 'UVoidZonePlayerComponent::_voidZoneLightingLocation' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _cageAnimationWaitTime) == 0x000158, "Member 'UVoidZonePlayerComponent::_cageAnimationWaitTime' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _standardRealmGameTag) == 0x000190, "Member 'UVoidZonePlayerComponent::_standardRealmGameTag' has a wrong offset!");
static_assert(offsetof(UVoidZonePlayerComponent, _voidRealmGameTag) == 0x00019C, "Member 'UVoidZonePlayerComponent::_voidRealmGameTag' has a wrong offset!");
