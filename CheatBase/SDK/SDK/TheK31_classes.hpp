...
static_assert(sizeof(UK31PowerChargePresentationItemProgressComponent) == 0x0000E0, "Wrong size on UK31PowerChargePresentationItemProgressComponent");
static_assert(offsetof(UK31PowerChargePresentationItemProgressComponent, _originatingPower) == 0x0000D8, "Member 'UK31PowerChargePresentationItemProgressComponent::_originatingPower' has a wrong offset!");
...
static_assert(sizeof(UK31PowerCosmeticHelper) == 0x000108, "Wrong size on UK31PowerCosmeticHelper");
...
static_assert(sizeof(UActiveDroneZoneLingeringEffect) == 0x000408, "Wrong size on UActiveDroneZoneLingeringEffect");
...
static_assert(sizeof(UAddon_K31Power_01) == 0x000310, "Wrong size on UAddon_K31Power_01");
static_assert(offsetof(UAddon_K31Power_01, _modifySkillCheckDifficultyEffectClass) == 0x000300, "Member 'UAddon_K31Power_01::_modifySkillCheckDifficultyEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_01, _skillCheckDifficultyModifier) == 0x000308, "Member 'UAddon_K31Power_01::_skillCheckDifficultyModifier' has a wrong offset!");
...
static_assert(sizeof(UAddon_K31Power_02) == 0x000308, "Wrong size on UAddon_K31Power_02");
static_assert(offsetof(UAddon_K31Power_02, _blindnessEffectClass) == 0x000300, "Member 'UAddon_K31Power_02::_blindnessEffectClass' has a wrong offset!");
...
static_assert(sizeof(UAddon_K31Power_03) == 0x000310, "Wrong size on UAddon_K31Power_03");
static_assert(offsetof(UAddon_K31Power_03, _actionSpeedEffect) == 0x000300, "Member 'UAddon_K31Power_03::_actionSpeedEffect' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_03, _actionSpeedEffectDuration) == 0x000308, "Member 'UAddon_K31Power_03::_actionSpeedEffectDuration' has a wrong offset!");
...
static_assert(sizeof(UAddon_K31Power_13) == 0x000310, "Wrong size on UAddon_K31Power_13");
static_assert(offsetof(UAddon_K31Power_13, _exhaustedEffectClass) == 0x000300, "Member 'UAddon_K31Power_13::_exhaustedEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_13, _exhaustedEffectDurationSeconds) == 0x000308, "Member 'UAddon_K31Power_13::_exhaustedEffectDurationSeconds' has a wrong offset!");
...
static_assert(sizeof(UAddon_K31Power_18) == 0x000328, "Wrong size on UAddon_K31Power_18");
static_assert(offsetof(UAddon_K31Power_18, _batteryPercent) == 0x000320, "Member 'UAddon_K31Power_18::_batteryPercent' has a wrong offset!");
...
static_assert(sizeof(UAddon_K31Power_19) == 0x000300, "Wrong size on UAddon_K31Power_19");
...
static_assert(sizeof(UAddon_K31Power_20) == 0x000388, "Wrong size on UAddon_K31Power_20");
static_assert(offsetof(UAddon_K31Power_20, _terrorRadiusSize) == 0x000300, "Member 'UAddon_K31Power_20::_terrorRadiusSize' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _terrorRadiusDuration) == 0x000304, "Member 'UAddon_K31Power_20::_terrorRadiusDuration' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _allowedDroneStatesForEffectToApply) == 0x000308, "Member 'UAddon_K31Power_20::_allowedDroneStatesForEffectToApply' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _targetDrone) == 0x000318, "Member 'UAddon_K31Power_20::_targetDrone' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _terrorRadius) == 0x000320, "Member 'UAddon_K31Power_20::_terrorRadius' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _indicatorEffectClass) == 0x000358, "Member 'UAddon_K31Power_20::_indicatorEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _indicatorEffect) == 0x000360, "Member 'UAddon_K31Power_20::_indicatorEffect' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _undetectableEffectClass) == 0x000368, "Member 'UAddon_K31Power_20::_undetectableEffectClass' has a wrong offset!");
static_assert(offsetof(UAddon_K31Power_20, _undetectableEffect) == 0x000370, "Member 'UAddon_K31Power_20::_undetectableEffect' has a wrong offset!");
...
static_assert(sizeof(UDeployDroneInteraction) == 0x000780, "Wrong size on UDeployDroneInteraction");
static_assert(offsetof(UDeployDroneInteraction, _shouldDeploymentSetPowerOnCooldown) == 0x000768, "Member 'UDeployDroneInteraction::_shouldDeploymentSetPowerOnCooldown' has a wrong offset!");
static_assert(offsetof(UDeployDroneInteraction, _canPlaceDroneWhilePowerIsOnCooldown) == 0x000769, "Member 'UDeployDroneInteraction::_canPlaceDroneWhilePowerIsOnCooldown' has a wrong offset!");
...
static_assert(sizeof(UK31AnalyticsComponent) == 0x0000D0, "Wrong size on UK31AnalyticsComponent");
...
static_assert(sizeof(UK31DroneDangerPredictionComponent) == 0x0001A0, "Wrong size on UK31DroneDangerPredictionComponent");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _minimumTraverseAngle) == 0x000170, "Member 'UK31DroneDangerPredictionComponent::_minimumTraverseAngle' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _maximumTraverseAngle) == 0x000174, "Member 'UK31DroneDangerPredictionComponent::_maximumTraverseAngle' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _crouchRangeMargin) == 0x000178, "Member 'UK31DroneDangerPredictionComponent::_crouchRangeMargin' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _crouchingHeightDifference) == 0x00017C, "Member 'UK31DroneDangerPredictionComponent::_crouchingHeightDifference' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _crouchAngleNumerator) == 0x000180, "Member 'UK31DroneDangerPredictionComponent::_crouchAngleNumerator' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _crouchRotatingSpeedPercentAngleMargin) == 0x000184, "Member 'UK31DroneDangerPredictionComponent::_crouchRotatingSpeedPercentAngleMargin' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _maxCrouchRange) == 0x000188, "Member 'UK31DroneDangerPredictionComponent::_maxCrouchRange' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _activeUnhackableWeight) == 0x00018C, "Member 'UK31DroneDangerPredictionComponent::_activeUnhackableWeight' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _activeHackableWeight) == 0x000190, "Member 'UK31DroneDangerPredictionComponent::_activeHackableWeight' has a wrong offset!");
static_assert(offsetof(UK31DroneDangerPredictionComponent, _scoutingWeight) == 0x000194, "Member 'UK31DroneDangerPredictionComponent::_scoutingWeight' has a wrong offset!");
...
static_assert(sizeof(UK31DroneDebugComponent) == 0x0000F8, "Wrong size on UK31DroneDebugComponent");
...
static_assert(sizeof(UK31DroneFlightController) == 0x000128, "Wrong size on UK31DroneFlightController");
static_assert(offsetof(UK31DroneFlightController, _objectState) == 0x0000F8, "Member 'UK31DroneFlightController::_objectState' has a wrong offset!");
...
static_assert(sizeof(UK31DroneHackableAvoidanceSensor) == 0x000238, "Wrong size on UK31DroneHackableAvoidanceSensor");
...
static_assert(sizeof(UK31DroneHackableComponent) == 0x000140, "Wrong size on UK31DroneHackableComponent");
...
static_assert(sizeof(UK31DroneLaserController) == 0x000150, "Wrong size on UK31DroneLaserController");
...
static_assert(offsetof(UK31DroneLaserController, _laserActor) == 0x000108, "Member 'UK31DroneLaserController::_laserActor' has a wrong offset!");
...
static_assert(sizeof(UK31DroneLaserOutlineUpdateStrategy) == 0x000128, "Wrong size on UK31DroneLaserOutlineUpdateStrategy");
static_assert(offsetof(UK31DroneLaserOutlineUpdateStrategy, _laserOutlineDistance) == 0x000100, "Member 'UK31DroneLaserOutlineUpdateStrategy::_laserOutlineDistance' has a wrong offset!");
...
static_assert(sizeof(UK31DroneMovementComponent) == 0x000700, "Wrong size on UK31DroneMovementComponent");
static_assert(offsetof(UK31DroneMovementComponent, OnDeployLocationChangedEvent) == 0x000168, "Member 'UK31DroneMovementComponent::OnDeployLocationChangedEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnAttachToCharacterForDeployChangedEvent) == 0x000178, "Member 'UK31DroneMovementComponent::OnAttachToCharacterForDeployChangedEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnAccelerationChangedEvent) == 0x000188, "Member 'UK31DroneMovementComponent::OnAccelerationChangedEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnFlightHeightChangedBlueprintEvent) == 0x000198, "Member 'UK31DroneMovementComponent::OnFlightHeightChangedBlueprintEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, OnMovementModeChangedBlueprintEvent) == 0x0001A8, "Member 'UK31DroneMovementComponent::OnMovementModeChangedBlueprintEvent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _rotationRate) == 0x0001B8, "Member 'UK31DroneMovementComponent::_rotationRate' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _rotationRateStealthMode) == 0x000240, "Member 'UK31DroneMovementComponent::_rotationRateStealthMode' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _rotationLerpTime) == 0x0002C8, "Member 'UK31DroneMovementComponent::_rotationLerpTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _minHeightAboveGround) == 0x0002D0, "Member 'UK31DroneMovementComponent::_minHeightAboveGround' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxHeightAboveGround) == 0x0002F8, "Member 'UK31DroneMovementComponent::_maxHeightAboveGround' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _heightAdjustmentMovingTime) == 0x000320, "Member 'UK31DroneMovementComponent::_heightAdjustmentMovingTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _deployMovementSpeed) == 0x00034C, "Member 'UK31DroneMovementComponent::_deployMovementSpeed' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _replicationFrequency) == 0x000350, "Member 'UK31DroneMovementComponent::_replicationFrequency' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _smoothingTime) == 0x000354, "Member 'UK31DroneMovementComponent::_smoothingTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxSmoothUpdateDistance) == 0x000358, "Member 'UK31DroneMovementComponent::_maxSmoothUpdateDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _noSmoothUpdateDistance) == 0x00035C, "Member 'UK31DroneMovementComponent::_noSmoothUpdateDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _deployCharacterSocket) == 0x000360, "Member 'UK31DroneMovementComponent::_deployCharacterSocket' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxTravelDistance) == 0x00036C, "Member 'UK31DroneMovementComponent::_maxTravelDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _maxDeployTime) == 0x000374, "Member 'UK31DroneMovementComponent::_maxDeployTime' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _gravity) == 0x000378, "Member 'UK31DroneMovementComponent::_gravity' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _velocityInterpolationAlpha) == 0x00037C, "Member 'UK31DroneMovementComponent::_velocityInterpolationAlpha' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _constantSpeedToAccelerationCurve) == 0x000380, "Member 'UK31DroneMovementComponent::_constantSpeedToAccelerationCurve' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _gameState) == 0x000410, "Member 'UK31DroneMovementComponent::_gameState' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _localDeployDatum) == 0x000458, "Member 'UK31DroneMovementComponent::_localDeployDatum' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _interactingActor) == 0x0004A0, "Member 'UK31DroneMovementComponent::_interactingActor' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _additionalRotatingComponents) == 0x0004E8, "Member 'UK31DroneMovementComponent::_additionalRotatingComponents' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _updatedComponentOriginalParent) == 0x0004F8, "Member 'UK31DroneMovementComponent::_updatedComponentOriginalParent' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _replicatedMovement) == 0x000650, "Member 'UK31DroneMovementComponent::_replicatedMovement' has a wrong offset!");
static_assert(offsetof(UK31DroneMovementComponent, _repDeployDatum) == 0x0006A8, "Member 'UK31DroneMovementComponent::_repDeployDatum' has a wrong offset!");
...
static_assert(sizeof(UK31DroneOutlineUpdateStrategy) == 0x000150, "Wrong size on UK31DroneOutlineUpdateStrategy");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerColorNormal) == 0x0000E0, "Member 'UK31DroneOutlineUpdateStrategy::_killerColorNormal' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerColorActive) == 0x0000F0, "Member 'UK31DroneOutlineUpdateStrategy::_killerColorActive' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerColorSelected) == 0x000100, "Member 'UK31DroneOutlineUpdateStrategy::_killerColorSelected' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _survivorColor) == 0x000110, "Member 'UK31DroneOutlineUpdateStrategy::_survivorColor' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _invalidStates) == 0x000120, "Member 'UK31DroneOutlineUpdateStrategy::_invalidStates' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _killerMinimumDistance) == 0x000130, "Member 'UK31DroneOutlineUpdateStrategy::_killerMinimumDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _survivorMinimumDistance) == 0x000134, "Member 'UK31DroneOutlineUpdateStrategy::_survivorMinimumDistance' has a wrong offset!");
static_assert(offsetof(UK31DroneOutlineUpdateStrategy, _survivorMaximumDistanceXY) == 0x000138, "Member 'UK31DroneOutlineUpdateStrategy::_survivorMaximumDistanceXY' has a wrong offset!");
...
static_assert(offsetof(UK31DronePlacementRecaller, _maxDistanceXY) == 0x0000D0, "Member 'UK31DronePlacementRecaller::_maxDistanceXY' has a wrong offset!");
static_assert(offsetof(UK31DronePlacementRecaller, _maxDistanceZ) == 0x0000F8, "Member 'UK31DronePlacementRecaller::_maxDistanceZ' has a wrong offset!");
...
static_assert(sizeof(UK31DronePlacementStrategy) == 0x000198, "Wrong size on UK31DronePlacementStrategy");
static_assert(offsetof(UK31DronePlacementStrategy, _sphereSweepRadius) == 0x000120, "Member 'UK31DronePlacementStrategy::_sphereSweepRadius' has a wrong offset!");
static_assert(offsetof(UK31DronePlacementStrategy, _minHeightAboveGround) == 0x000148, "Member 'UK31DronePlacementStrategy::_minHeightAboveGround' has a wrong offset!");
static_assert(offsetof(UK31DronePlacementStrategy, _maxHeightAboveGround) == 0x000170, "Member 'UK31DronePlacementStrategy::_maxHeightAboveGround' has a wrong offset!");
...
static_assert(alignof(UK31DronePool) == 0x000008, "Wrong alignment on UK31DronePool");
static_assert(sizeof(UK31DronePool) == 0x000118, "Wrong size on UK31DronePool");
...
static_assert(sizeof(UK31DroneScoutDetectionComponent) == 0x0002E0, "Wrong size on UK31DroneScoutDetectionComponent");
...
static_assert(offsetof(UK31DroneScoutDetectionComponent, _baseDetectionConeYawHalfAngleDegrees) == 0x000220, "Member 'UK31DroneScoutDetectionComponent::_baseDetectionConeYawHalfAngleDegrees' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _baseDetectionHalfHeight) == 0x000248, "Member 'UK31DroneScoutDetectionComponent::_baseDetectionHalfHeight' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _baseDetectionRadius) == 0x000270, "Member 'UK31DroneScoutDetectionComponent::_baseDetectionRadius' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _sphereTraceRadius) == 0x000298, "Member 'UK31DroneScoutDetectionComponent::_sphereTraceRadius' has a wrong offset!");
static_assert(offsetof(UK31DroneScoutDetectionComponent, _stateTagsPreventingSurvivorDetection) == 0x0002C0, "Member 'UK31DroneScoutDetectionComponent::_stateTagsPreventingSurvivorDetection' has a wrong offset!");
...
static_assert(sizeof(UK31DroneStateController) == 0x000188, "Wrong size on UK31DroneStateController");
...
static_assert(offsetof(UK31DroneStateController, _states) == 0x000130, "Member 'UK31DroneStateController::_states' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _local_currentState) == 0x000150, "Member 'UK31DroneStateController::_local_currentState' has a wrong offset!");
static_assert(offsetof(UK31DroneStateController, _authority_RepCurrentState) == 0x000168, "Member 'UK31DroneStateController::_authority_RepCurrentState' has a wrong offset!");
...
static_assert(sizeof(UK31DroneTargeter) == 0x000150, "Wrong size on UK31DroneTargeter");
...
static_assert(offsetof(UK31DroneTargeter, _indicator) == 0x000128, "Member 'UK31DroneTargeter::_indicator' has a wrong offset!");
static_assert(offsetof(UK31DroneTargeter, _target) == 0x000138, "Member 'UK31DroneTargeter::_target' has a wrong offset!");
...
static_assert(sizeof(UK31DroneZoneComponent) == 0x000188, "Wrong size on UK31DroneZoneComponent");
...
static_assert(offsetof(UK31DroneZoneComponent, _maxDistanceZ_ScoutingLaser) == 0x000180, "Member 'UK31DroneZoneComponent::_maxDistanceZ_ScoutingLaser' has a wrong offset!");
...
static_assert(alignof(IK31FXInterface) == 0x000001, "Wrong alignment on IK31FXInterface");
static_assert(sizeof(IK31FXInterface) == 0x000001, "Wrong size on IK31FXInterface");
...
static_assert(sizeof(UK31HasteEffect) == 0x000398, "Wrong size on UK31HasteEffect");
...
static_assert(sizeof(UK31P01) == 0x000498, "Wrong size on UK31P01");
static_assert(offsetof(UK31P01, _hasteEffectMovementSpeedIncrease) == 0x000460, "Member 'UK31P01::_hasteEffectMovementSpeedIncrease' has a wrong offset!");
static_assert(offsetof(UK31P01, _hasteEffectDurationSeconds) == 0x000464, "Member 'UK31P01::_hasteEffectDurationSeconds' has a wrong offset!");
static_assert(offsetof(UK31P01, _authority_hasteStatusEffect) == 0x000470, "Member 'UK31P01::_authority_hasteStatusEffect' has a wrong offset!");
static_assert(offsetof(UK31P01, _hasteEffectClass) == 0x000478, "Member 'UK31P01::_hasteEffectClass' has a wrong offset!");
static_assert(offsetof(UK31P01, _isPerkActive) == 0x000480, "Member 'UK31P01::_isPerkActive' has a wrong offset!");
...
static_assert(sizeof(UK31P02) == 0x000480, "Wrong size on UK31P02");
static_assert(offsetof(UK31P02, _screamRevealSeconds) == 0x000460, "Member 'UK31P02::_screamRevealSeconds' has a wrong offset!");
static_assert(offsetof(UK31P02, _screamDistance) == 0x00046C, "Member 'UK31P02::_screamDistance' has a wrong offset!");
static_assert(offsetof(UK31P02, _revealAuraToKillerEffectClass) == 0x000470, "Member 'UK31P02::_revealAuraToKillerEffectClass' has a wrong offset!");
...
static_assert(sizeof(UK31P03) == 0x0004D8, "Wrong size on UK31P03");
static_assert(offsetof(UK31P03, _healPenalty) == 0x000460, "Member 'UK31P03::_healPenalty' has a wrong offset!");
static_assert(offsetof(UK31P03, _reduceHealingSpeedEffectSeconds) == 0x00046C, "Member 'UK31P03::_reduceHealingSpeedEffectSeconds' has a wrong offset!");
static_assert(offsetof(UK31P03, _reduceHealingSpeedEffectClass) == 0x000470, "Member 'UK31P03::_reduceHealingSpeedEffectClass' has a wrong offset!");
static_assert(offsetof(UK31P03, _survivorDebuffMap) == 0x000478, "Member 'UK31P03::_survivorDebuffMap' has a wrong offset!");
...
static_assert(sizeof(UK31PlayerZoneStatus) == 0x000198, "Wrong size on UK31PlayerZoneStatus");
...
static_assert(sizeof(AK31Power) == 0x0007E0, "Wrong size on AK31Power");
static_assert(offsetof(AK31Power, _powerChargePresentationItemProgressComponent) == 0x0005A0, "Member 'AK31Power::_powerChargePresentationItemProgressComponent' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerChargePresentationPowerFadeComponent) == 0x0005A8, "Member 'AK31Power::_powerChargePresentationPowerFadeComponent' has a wrong offset!");
static_assert(offsetof(AK31Power, _survivorDetectionClass) == 0x0005B0, "Member 'AK31Power::_survivorDetectionClass' has a wrong offset!");
static_assert(offsetof(AK31Power, _effects) == 0x0005B8, "Member 'AK31Power::_effects' has a wrong offset!");
static_assert(offsetof(AK31Power, _interactor) == 0x0005C8, "Member 'AK31Power::_interactor' has a wrong offset!");
static_assert(offsetof(AK31Power, _dronePoolInitializer) == 0x0005D0, "Member 'AK31Power::_dronePoolInitializer' has a wrong offset!");
static_assert(offsetof(AK31Power, _dronePool) == 0x0005D8, "Member 'AK31Power::_dronePool' has a wrong offset!");
static_assert(offsetof(AK31Power, _scanner) == 0x0005E0, "Member 'AK31Power::_scanner' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerState) == 0x000624, "Member 'AK31Power::_powerState' has a wrong offset!");
static_assert(offsetof(AK31Power, _effectSpawner) == 0x000630, "Member 'AK31Power::_effectSpawner' has a wrong offset!");
static_assert(offsetof(AK31Power, _survivorClawTrapComponentClass) == 0x000680, "Member 'AK31Power::_survivorClawTrapComponentClass' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerCooldownTimer) == 0x000688, "Member 'AK31Power::_powerCooldownTimer' has a wrong offset!");
static_assert(offsetof(AK31Power, _powerCooldownDuration) == 0x0006C8, "Member 'AK31Power::_powerCooldownDuration' has a wrong offset!");
static_assert(offsetof(AK31Power, _hasteCurveBasedOnScannedSurvivors) == 0x000750, "Member 'AK31Power::_hasteCurveBasedOnScannedSurvivors' has a wrong offset!");
static_assert(offsetof(AK31Power, _canRecallDisabledDrones) == 0x000758, "Member 'AK31Power::_canRecallDisabledDrones' has a wrong offset!");
...
static_assert(sizeof(UK31Scanner) == 0x000258, "Wrong size on UK31Scanner");
...
static_assert(offsetof(UK31Scanner, _owningActor) == 0x0001C0, "Member 'UK31Scanner::_owningActor' has a wrong offset!");
static_assert(offsetof(UK31Scanner, _playersShownOnRadar) == 0x0001D8, "Member 'UK31Scanner::_playersShownOnRadar' has a wrong offset!");
...
static_assert(offsetof(UK31SurvivorAnimInstance, _isInsideLocker) == 0x0005F5, "Member 'UK31SurvivorAnimInstance::_isInsideLocker' has a wrong offset!");
...
static_assert(sizeof(UK31SurvivorClawTrapComponent) == 0x000288, "Wrong size on UK31SurvivorClawTrapComponent");
...
static_assert(offsetof(UK31SurvivorClawTrapComponent, _clawTrapCosmeticDelayDuration) == 0x000100, "Member 'UK31SurvivorClawTrapComponent::_clawTrapCosmeticDelayDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _clawTrapAttachSocket) == 0x000104, "Member 'UK31SurvivorClawTrapComponent::_clawTrapAttachSocket' has a wrong offset!");
...
static_assert(offsetof(UK31SurvivorClawTrapComponent, _batteryMaxCharge) == 0x000160, "Member 'UK31SurvivorClawTrapComponent::_batteryMaxCharge' has a wrong offset!");
static_assert(offsetof(UK31SurvivorClawTrapComponent, _survivorMaxChargeModifier) == 0x0001E8, "Member 'UK31SurvivorClawTrapComponent::_survivorMaxChargeModifier' has a wrong offset!");
...
static_assert(sizeof(AK31SurvivorCosmeticHelperActor) == 0x0003D8, "Wrong size on AK31SurvivorCosmeticHelperActor");
static_assert(offsetof(AK31SurvivorCosmeticHelperActor, _playerZoneStatus) == 0x000358, "Member 'AK31SurvivorCosmeticHelperActor::_playerZoneStatus' has a wrong offset!");
static_assert(offsetof(AK31SurvivorCosmeticHelperActor, _enterActiveZoneCosmeticCooldown) == 0x000390, "Member 'AK31SurvivorCosmeticHelperActor::_enterActiveZoneCosmeticCooldown' has a wrong offset!");
...
static_assert(sizeof(UK31SurvivorDetectedEffect) == 0x000438, "Wrong size on UK31SurvivorDetectedEffect");
static_assert(offsetof(UK31SurvivorDetectedEffect, _hasteDuration) == 0x000398, "Member 'UK31SurvivorDetectedEffect::_hasteDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetectedEffect, _timeSinceLastDroneDeployedOrReversed) == 0x0003C0, "Member 'UK31SurvivorDetectedEffect::_timeSinceLastDroneDeployedOrReversed' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetectedEffect, _authority_droneTimerMap) == 0x0003E8, "Member 'UK31SurvivorDetectedEffect::_authority_droneTimerMap' has a wrong offset!");
...
static_assert(sizeof(UK31SurvivorDetection) == 0x0007D8, "Wrong size on UK31SurvivorDetection");
static_assert(offsetof(UK31SurvivorDetection, _hinderedStatusEffectClass) == 0x0000C0, "Member 'UK31SurvivorDetection::_hinderedStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _brokenStatusEffectClass) == 0x0000C8, "Member 'UK31SurvivorDetection::_brokenStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _killerInstinctStatusEffectClass) == 0x0000D0, "Member 'UK31SurvivorDetection::_killerInstinctStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _brokenStatusEffect) == 0x0000D8, "Member 'UK31SurvivorDetection::_brokenStatusEffect' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _secondsToCharge) == 0x0000E0, "Member 'UK31SurvivorDetection::_secondsToCharge' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _chargeRate) == 0x000168, "Member 'UK31SurvivorDetection::_chargeRate' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _chargeModifierWhenClawTrapped) == 0x0001F0, "Member 'UK31SurvivorDetection::_chargeModifierWhenClawTrapped' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _lockOnChargeStackPercent) == 0x000278, "Member 'UK31SurvivorDetection::_lockOnChargeStackPercent' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _hinderedEffectPercent) == 0x000300, "Member 'UK31SurvivorDetection::_hinderedEffectPercent' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _hinderedEffectDuration) == 0x000388, "Member 'UK31SurvivorDetection::_hinderedEffectDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _killerInstinctEffectDuration) == 0x000410, "Member 'UK31SurvivorDetection::_killerInstinctEffectDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _enableKillerInstinctRangeCheck) == 0x000498, "Member 'UK31SurvivorDetection::_enableKillerInstinctRangeCheck' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _killerInstinctEffectKillerRange) == 0x000520, "Member 'UK31SurvivorDetection::_killerInstinctEffectKillerRange' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _immuneToDroneDetectionDuration) == 0x0005A8, "Member 'UK31SurvivorDetection::_immuneToDroneDetectionDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _survivorIsBelowDroneDuration) == 0x000630, "Member 'UK31SurvivorDetection::_survivorIsBelowDroneDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _showSurvivorOnRadarDuration) == 0x0006B8, "Member 'UK31SurvivorDetection::_showSurvivorOnRadarDuration' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _originatingPower) == 0x000740, "Member 'UK31SurvivorDetection::_originatingPower' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _chargingLockedOnChargeableComponent) == 0x000748, "Member 'UK31SurvivorDetection::_chargingLockedOnChargeableComponent' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _immuneToDetectionTimer) == 0x000750, "Member 'UK31SurvivorDetection::_immuneToDetectionTimer' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _survivorIsBelowDroneTimer) == 0x000758, "Member 'UK31SurvivorDetection::_survivorIsBelowDroneTimer' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _showSurvivorOnRadarTimer) == 0x000760, "Member 'UK31SurvivorDetection::_showSurvivorOnRadarTimer' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _isFullyLockedOn) == 0x000768, "Member 'UK31SurvivorDetection::_isFullyLockedOn' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _overlappingDrones) == 0x000770, "Member 'UK31SurvivorDetection::_overlappingDrones' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _overlappingActiveDrones) == 0x000780, "Member 'UK31SurvivorDetection::_overlappingActiveDrones' has a wrong offset!");
static_assert(offsetof(UK31SurvivorDetection, _lastActiveTime) == 0x000790, "Member 'UK31SurvivorDetection::_lastActiveTime' has a wrong offset!");
...
static_assert(sizeof(UK31SurvivorExposedEffect) == 0x0003A8, "Wrong size on UK31SurvivorExposedEffect");
...
static_assert(sizeof(UK31SurvivorInActiveZoneCondition) == 0x0000F0, "Wrong size on UK31SurvivorInActiveZoneCondition");
...
static_assert(sizeof(UK31TrapProximitySensor) == 0x000160, "Wrong size on UK31TrapProximitySensor");
static_assert(offsetof(UK31TrapProximitySensor, _trappedPlayersInZone) == 0x0000F8, "Member 'UK31TrapProximitySensor::_trappedPlayersInZone' has a wrong offset!");
...
static_assert(sizeof(UK31UndetectableEffect) == 0x000420, "Wrong size on UK31UndetectableEffect");
...
static_assert(sizeof(USurvivorHackDroneInteraction) == 0x0008A0, "Wrong size on USurvivorHackDroneInteraction");
static_assert(offsetof(USurvivorHackDroneInteraction, _miniGameDefinition) == 0x000768, "Member 'USurvivorHackDroneInteraction::_miniGameDefinition' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _isHackingComplete) == 0x0007B0, "Member 'USurvivorHackDroneInteraction::_isHackingComplete' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _batteryStartingChargePercent) == 0x0007B8, "Member 'USurvivorHackDroneInteraction::_batteryStartingChargePercent' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _playerSnapSocket) == 0x0007E0, "Member 'USurvivorHackDroneInteraction::_playerSnapSocket' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _maximumTimeToAttemptDuration) == 0x0007F0, "Member 'USurvivorHackDroneInteraction::_maximumTimeToAttemptDuration' has a wrong offset!");
static_assert(offsetof(USurvivorHackDroneInteraction, _switchToScoutingModeDuration) == 0x000818, "Member 'USurvivorHackDroneInteraction::_switchToScoutingModeDuration' has a wrong offset!");
...
static_assert(sizeof(USurvivorRemoveClawTrapInteraction) == 0x000840, "Wrong size on USurvivorRemoveClawTrapInteraction");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _miniGameDefinition) == 0x000768, "Member 'USurvivorRemoveClawTrapInteraction::_miniGameDefinition' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _isHackingComplete) == 0x000788, "Member 'USurvivorRemoveClawTrapInteraction::_isHackingComplete' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _survivorClawTrapComponent) == 0x000790, "Member 'USurvivorRemoveClawTrapInteraction::_survivorClawTrapComponent' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _batteryRechargeOnFailedRemovalPercent) == 0x000798, "Member 'USurvivorRemoveClawTrapInteraction::_batteryRechargeOnFailedRemovalPercent' has a wrong offset!");
static_assert(offsetof(USurvivorRemoveClawTrapInteraction, _requiredTimeToRemainStillBeforeInteractingDuration) == 0x0007C0, "Member 'USurvivorRemoveClawTrapInteraction::_requiredTimeToRemainStillBeforeInteractingDuration' has a wrong offset!");
