...
static_assert(sizeof(UK25ProjectileReplicationComponent) == 0x0000C0, "Wrong size on UK25ProjectileReplicationComponent");
...
static_assert(sizeof(UK25UncontrolledProjectileReplicationComponent) == 0x0000C0, "Wrong size on UK25UncontrolledProjectileReplicationComponent");
...
static_assert(sizeof(UAddon_K25Power_16) == 0x000310, "Wrong size on UAddon_K25Power_16");
...
static_assert(sizeof(UAISkill_FindCollectable_LamentConfiguration) == 0x000448, "Wrong size on UAISkill_FindCollectable_LamentConfiguration");
static_assert(offsetof(UAISkill_FindCollectable_LamentConfiguration, StopChainHuntGoalWeight) == 0x000388, "Member 'UAISkill_FindCollectable_LamentConfiguration::StopChainHuntGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_LamentConfiguration, PreemptiveFindLamentGoalWeight) == 0x0003E8, "Member 'UAISkill_FindCollectable_LamentConfiguration::PreemptiveFindLamentGoalWeight' has a wrong offset!");
...
static_assert(sizeof(UAISkill_InteractionUseItem_LamentConfiguration) == 0x0003A0, "Wrong size on UAISkill_InteractionUseItem_LamentConfiguration");
...
static_assert(offsetof(UAISkill_InteractionUseItem_LamentConfiguration, SpecialGeneratorRemainPercent) == 0x0002F0, "Member 'UAISkill_InteractionUseItem_LamentConfiguration::SpecialGeneratorRemainPercent' has a wrong offset!");
static_assert(offsetof(UAISkill_InteractionUseItem_LamentConfiguration, _solveLamentMaxCharge) == 0x000378, "Member 'UAISkill_InteractionUseItem_LamentConfiguration::_solveLamentMaxCharge' has a wrong offset!");
...
static_assert(sizeof(ALamentConfiguration) == 0x000840, "Wrong size on ALamentConfiguration");
static_assert(offsetof(ALamentConfiguration, _interactable) == 0x000588, "Member 'ALamentConfiguration::_interactable' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _collectableInteractor) == 0x000590, "Member 'ALamentConfiguration::_collectableInteractor' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _survivorCollectItemInteraction) == 0x000598, "Member 'ALamentConfiguration::_survivorCollectItemInteraction' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _killerCollectItemInteraction) == 0x0005A0, "Member 'ALamentConfiguration::_killerCollectItemInteraction' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _outlineComponent) == 0x0005A8, "Member 'ALamentConfiguration::_outlineComponent' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _materialHelper) == 0x0005B0, "Member 'ALamentConfiguration::_materialHelper' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _outlineStrategy) == 0x0005B8, "Member 'ALamentConfiguration::_outlineStrategy' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _spawnStrategy) == 0x0005C0, "Member 'ALamentConfiguration::_spawnStrategy' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _chainHuntComponent) == 0x0005C8, "Member 'ALamentConfiguration::_chainHuntComponent' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _dotProductMinValue) == 0x0005D0, "Member 'ALamentConfiguration::_dotProductMinValue' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _survivorAttachmentSocket) == 0x0005D4, "Member 'ALamentConfiguration::_survivorAttachmentSocket' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _killerAttachmentSocket) == 0x0005D5, "Member 'ALamentConfiguration::_killerAttachmentSocket' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _montageFollower) == 0x0005D8, "Member 'ALamentConfiguration::_montageFollower' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _montagePlayer) == 0x0005E0, "Member 'ALamentConfiguration::_montagePlayer' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _chainAnimationActorClass) == 0x0005E8, "Member 'ALamentConfiguration::_chainAnimationActorClass' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _lamentConfigurationTeleportIndicatorClass) == 0x0005F0, "Member 'ALamentConfiguration::_lamentConfigurationTeleportIndicatorClass' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _chainAnimationFollowerAttachmentSocketName) == 0x0005F8, "Member 'ALamentConfiguration::_chainAnimationFollowerAttachmentSocketName' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _possessionSoundLoop) == 0x000608, "Member 'ALamentConfiguration::_possessionSoundLoop' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _respawnTimeAfterLamentConfigurationSolved) == 0x000648, "Member 'ALamentConfiguration::_respawnTimeAfterLamentConfigurationSolved' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _respawnTimeAfterKillerPickUp) == 0x000670, "Member 'ALamentConfiguration::_respawnTimeAfterKillerPickUp' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _respawnTimeAfterSurvivorFreeBySelf) == 0x000698, "Member 'ALamentConfiguration::_respawnTimeAfterSurvivorFreeBySelf' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _respawnTimeAfterSurvivorFreeByAttack) == 0x0006C0, "Member 'ALamentConfiguration::_respawnTimeAfterSurvivorFreeByAttack' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _numberChainsToLaunchUponKillerPickUpLamentConfiguration) == 0x0006E8, "Member 'ALamentConfiguration::_numberChainsToLaunchUponKillerPickUpLamentConfiguration' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _hostageInteractionTime) == 0x000710, "Member 'ALamentConfiguration::_hostageInteractionTime' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _localLamentConfigurationState) == 0x000740, "Member 'ALamentConfiguration::_localLamentConfigurationState' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _lamentconfigurationState) == 0x000741, "Member 'ALamentConfiguration::_lamentconfigurationState' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _chainAnimationActor) == 0x000748, "Member 'ALamentConfiguration::_chainAnimationActor' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _survivorHeldHostage) == 0x000790, "Member 'ALamentConfiguration::_survivorHeldHostage' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _standingOnLamentConfigurationCollisionChecker) == 0x000820, "Member 'ALamentConfiguration::_standingOnLamentConfigurationCollisionChecker' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _timeAllowedToStandOnCubeBeforeTeleport) == 0x000828, "Member 'ALamentConfiguration::_timeAllowedToStandOnCubeBeforeTeleport' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _solvedLamentConfigurationDropDistanceToCollectorCentimeters) == 0x00082C, "Member 'ALamentConfiguration::_solvedLamentConfigurationDropDistanceToCollectorCentimeters' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _failedLamentConfigurationSolveDropDistanceToCollectorCentimeters) == 0x000830, "Member 'ALamentConfiguration::_failedLamentConfigurationSolveDropDistanceToCollectorCentimeters' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _solved) == 0x000834, "Member 'ALamentConfiguration::_solved' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _releasedByAttack) == 0x000835, "Member 'ALamentConfiguration::_releasedByAttack' has a wrong offset!");
static_assert(offsetof(ALamentConfiguration, _lamentConfigurationTeleportIndicator) == 0x000838, "Member 'ALamentConfiguration::_lamentConfigurationTeleportIndicator' has a wrong offset!");
...
static_assert(sizeof(UChainAttachedGateBlockerEffect) == 0x0003F8, "Wrong size on UChainAttachedGateBlockerEffect");
static_assert(offsetof(UChainAttachedGateBlockerEffect, _blockGateLingeringTimeDyingState) == 0x0003D0, "Member 'UChainAttachedGateBlockerEffect::_blockGateLingeringTimeDyingState' has a wrong offset!");
...
static_assert(sizeof(ULamentConfigurationAnalyticsComponent) == 0x0000E8, "Wrong size on ULamentConfigurationAnalyticsComponent");
...
static_assert(sizeof(UIsChainHuntActive) == 0x000118, "Wrong size on UIsChainHuntActive");
...
static_assert(sizeof(ULamentConfigurationChainHuntComponent) == 0x000280, "Wrong size on ULamentConfigurationChainHuntComponent");
...
static_assert(sizeof(AK25Chain) == 0x0004F8, "Wrong size on AK25Chain");
static_assert(offsetof(AK25Chain, OnAcquiredChanged) == 0x0002C0, "Member 'AK25Chain::OnAcquiredChanged' has a wrong offset!");
static_assert(offsetof(AK25Chain, _attachedToProjectileInfluenceCurve) == 0x0002D0, "Member 'AK25Chain::_attachedToProjectileInfluenceCurve' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelbackInfluenceCurve) == 0x0002D8, "Member 'AK25Chain::_reelbackInfluenceCurve' has a wrong offset!");
static_assert(offsetof(AK25Chain, _offsetMultiplierInfluenceCurve) == 0x0002E0, "Member 'AK25Chain::_offsetMultiplierInfluenceCurve' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelingBackSpeed) == 0x000338, "Member 'AK25Chain::_reelingBackSpeed' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainOffsetMinValue) == 0x000360, "Member 'AK25Chain::_chainOffsetMinValue' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainOffsetMaxValue) == 0x000364, "Member 'AK25Chain::_chainOffsetMaxValue' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelbackChainOffsetMinValue) == 0x000368, "Member 'AK25Chain::_reelbackChainOffsetMinValue' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelbackChainOffsetMaxValue) == 0x00036C, "Member 'AK25Chain::_reelbackChainOffsetMaxValue' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainInstanceSpacing) == 0x000370, "Member 'AK25Chain::_chainInstanceSpacing' has a wrong offset!");
static_assert(offsetof(AK25Chain, _quickChainOffsetTimerLength) == 0x000374, "Member 'AK25Chain::_quickChainOffsetTimerLength' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reachingSurvivorAnchorTime) == 0x000378, "Member 'AK25Chain::_reachingSurvivorAnchorTime' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainScale) == 0x000380, "Member 'AK25Chain::_chainScale' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainOffsetTimerLength) == 0x000398, "Member 'AK25Chain::_chainOffsetTimerLength' has a wrong offset!");
static_assert(offsetof(AK25Chain, _currentChainPoints) == 0x0003A0, "Member 'AK25Chain::_currentChainPoints' has a wrong offset!");
static_assert(offsetof(AK25Chain, _isAcquiredFromPool) == 0x0003B0, "Member 'AK25Chain::_isAcquiredFromPool' has a wrong offset!");
static_assert(offsetof(AK25Chain, _sphereTraceRadius) == 0x0003B4, "Member 'AK25Chain::_sphereTraceRadius' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainStartPosition) == 0x0003B8, "Member 'AK25Chain::_chainStartPosition' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelBackPosition) == 0x0003D0, "Member 'AK25Chain::_reelBackPosition' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelbackStartPosition) == 0x0003E8, "Member 'AK25Chain::_reelbackStartPosition' has a wrong offset!");
static_assert(offsetof(AK25Chain, _projectileAttachedTo) == 0x000400, "Member 'AK25Chain::_projectileAttachedTo' has a wrong offset!");
static_assert(offsetof(AK25Chain, _survivorAnchorAttachedTo) == 0x000408, "Member 'AK25Chain::_survivorAnchorAttachedTo' has a wrong offset!");
static_assert(offsetof(AK25Chain, _targetAnchorToReach) == 0x000410, "Member 'AK25Chain::_targetAnchorToReach' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainSplineComponent) == 0x000418, "Member 'AK25Chain::_chainSplineComponent' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainInstancedMesh) == 0x000420, "Member 'AK25Chain::_chainInstancedMesh' has a wrong offset!");
static_assert(offsetof(AK25Chain, _currentInfluenceCurve) == 0x000428, "Member 'AK25Chain::_currentInfluenceCurve' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainCurveOffset) == 0x000430, "Member 'AK25Chain::_chainCurveOffset' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainState) == 0x000448, "Member 'AK25Chain::_chainState' has a wrong offset!");
static_assert(offsetof(AK25Chain, _curveOffsetStrengthTimer) == 0x000450, "Member 'AK25Chain::_curveOffsetStrengthTimer' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reelbackTimer) == 0x000480, "Member 'AK25Chain::_reelbackTimer' has a wrong offset!");
static_assert(offsetof(AK25Chain, _reachSurvivorAnchorPositionTimer) == 0x0004B0, "Member 'AK25Chain::_reachSurvivorAnchorPositionTimer' has a wrong offset!");
static_assert(offsetof(AK25Chain, _forcedPositions) == 0x0004E0, "Member 'AK25Chain::_forcedPositions' has a wrong offset!");
static_assert(offsetof(AK25Chain, _chainCreationStrategy) == 0x0004F0, "Member 'AK25Chain::_chainCreationStrategy' has a wrong offset!");
...
static_assert(sizeof(UK25ChainAttachedStatusEffect) == 0x0003B0, "Wrong size on UK25ChainAttachedStatusEffect");
static_assert(offsetof(UK25ChainAttachedStatusEffect, _percentageReductionSpeedPerChainCurve) == 0x000398, "Member 'UK25ChainAttachedStatusEffect::_percentageReductionSpeedPerChainCurve' has a wrong offset!");
static_assert(offsetof(UK25ChainAttachedStatusEffect, _chainAttachmentComponent) == 0x0003A0, "Member 'UK25ChainAttachedStatusEffect::_chainAttachmentComponent' has a wrong offset!");
static_assert(offsetof(UK25ChainAttachedStatusEffect, _cachedNumberOfChainsAttached) == 0x0003A8, "Member 'UK25ChainAttachedStatusEffect::_cachedNumberOfChainsAttached' has a wrong offset!");
...
static_assert(sizeof(UK25ChainHuntEffectsComponent) == 0x000118, "Wrong size on UK25ChainHuntEffectsComponent");
...
static_assert(sizeof(UK25ChainPool) == 0x000118, "Wrong size on UK25ChainPool");
...
static_assert(sizeof(UK25ChainStrikeImmunityEffect) == 0x0003F0, "Wrong size on UK25ChainStrikeImmunityEffect");
static_assert(offsetof(UK25ChainStrikeImmunityEffect, _chainStrikeImmunityDuration) == 0x0003C8, "Member 'UK25ChainStrikeImmunityEffect::_chainStrikeImmunityDuration' has a wrong offset!");
...
static_assert(sizeof(AK25Projectile) == 0x0004F0, "Wrong size on AK25Projectile");
static_assert(offsetof(AK25Projectile, _staticMesh) == 0x000420, "Member 'AK25Projectile::_staticMesh' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _characterCollider) == 0x000428, "Member 'AK25Projectile::_characterCollider' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _environmentCollider) == 0x000430, "Member 'AK25Projectile::_environmentCollider' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _projectileDodgeComponent) == 0x000438, "Member 'AK25Projectile::_projectileDodgeComponent' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _launchInfo) == 0x000440, "Member 'AK25Projectile::_launchInfo' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _attachedChain) == 0x000478, "Member 'AK25Projectile::_attachedChain' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _timeIgnoreSlasherCollision) == 0x000480, "Member 'AK25Projectile::_timeIgnoreSlasherCollision' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _isActive) == 0x000484, "Member 'AK25Projectile::_isActive' has a wrong offset!");
static_assert(offsetof(AK25Projectile, _lastDeactivationData) == 0x000488, "Member 'AK25Projectile::_lastDeactivationData' has a wrong offset!");
...
static_assert(sizeof(AK25ControlledProjectile) == 0x000770, "Wrong size on AK25ControlledProjectile");
static_assert(offsetof(AK25ControlledProjectile, _killerViewProjectileStaticMesh) == 0x0004F8, "Member 'AK25ControlledProjectile::_killerViewProjectileStaticMesh' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _killerSpringArm) == 0x000500, "Member 'AK25ControlledProjectile::_killerSpringArm' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _killerCameraPlacement) == 0x000508, "Member 'AK25ControlledProjectile::_killerCameraPlacement' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _pitchClampAngle) == 0x000510, "Member 'AK25ControlledProjectile::_pitchClampAngle' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _maximumYawTurnRate) == 0x000518, "Member 'AK25ControlledProjectile::_maximumYawTurnRate' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _maximumPitchTurnRate) == 0x000598, "Member 'AK25ControlledProjectile::_maximumPitchTurnRate' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _cameraRollSpeedMultiplier) == 0x000618, "Member 'AK25ControlledProjectile::_cameraRollSpeedMultiplier' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _cameraRollGoBackSpeedMultiplier) == 0x000640, "Member 'AK25ControlledProjectile::_cameraRollGoBackSpeedMultiplier' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _cameraMaximumRollDegree) == 0x000668, "Member 'AK25ControlledProjectile::_cameraMaximumRollDegree' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _numbExtraChainsOnControlledProjectileHit) == 0x000690, "Member 'AK25ControlledProjectile::_numbExtraChainsOnControlledProjectileHit' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _controlledProjectileMovementComponent) == 0x000710, "Member 'AK25ControlledProjectile::_controlledProjectileMovementComponent' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _currentRoll) == 0x000718, "Member 'AK25ControlledProjectile::_currentRoll' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _targetRoll) == 0x00071C, "Member 'AK25ControlledProjectile::_targetRoll' has a wrong offset!");
static_assert(offsetof(AK25ControlledProjectile, _lastAppliedAngularVelocity) == 0x000750, "Member 'AK25ControlledProjectile::_lastAppliedAngularVelocity' has a wrong offset!");
...
static_assert(sizeof(UK25ControlledProjectileMovementComponent) == 0x000430, "Wrong size on UK25ControlledProjectileMovementComponent");
static_assert(offsetof(UK25ControlledProjectileMovementComponent, _projectileBaseSpeed) == 0x0002F0, "Member 'UK25ControlledProjectileMovementComponent::_projectileBaseSpeed' has a wrong offset!");
static_assert(offsetof(UK25ControlledProjectileMovementComponent, _baseProjectileMaximumDistance) == 0x000318, "Member 'UK25ControlledProjectileMovementComponent::_baseProjectileMaximumDistance' has a wrong offset!");
static_assert(offsetof(UK25ControlledProjectileMovementComponent, _projectileSpeedIncreaseTime) == 0x000340, "Member 'UK25ControlledProjectileMovementComponent::_projectileSpeedIncreaseTime' has a wrong offset!");
static_assert(offsetof(UK25ControlledProjectileMovementComponent, _maximumTravelDistanceStat) == 0x000368, "Member 'UK25ControlledProjectileMovementComponent::_maximumTravelDistanceStat' has a wrong offset!");
static_assert(offsetof(UK25ControlledProjectileMovementComponent, _projectileSpeedIncreaseMultiplier) == 0x0003E8, "Member 'UK25ControlledProjectileMovementComponent::_projectileSpeedIncreaseMultiplier' has a wrong offset!");
static_assert(offsetof(UK25ControlledProjectileMovementComponent, _totalDistanceTravelled) == 0x0003F0, "Member 'UK25ControlledProjectileMovementComponent::_totalDistanceTravelled' has a wrong offset!");
...
static_assert(sizeof(AK25Gateway) == 0x000548, "Wrong size on AK25Gateway");
static_assert(offsetof(AK25Gateway, _gatewayPlacement) == 0x0002C0, "Member 'AK25Gateway::_gatewayPlacement' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _distancePercentLocations) == 0x0002D0, "Member 'AK25Gateway::_distancePercentLocations' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _survivorGatewayRotationSpeed) == 0x0002E0, "Member 'AK25Gateway::_survivorGatewayRotationSpeed' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _minimumIndicatorVelocity) == 0x0002E4, "Member 'AK25Gateway::_minimumIndicatorVelocity' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _indicatorVelocityEasingFactor) == 0x0002E8, "Member 'AK25Gateway::_indicatorVelocityEasingFactor' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _minimumTimeBeforeTargetLocationMulticast) == 0x0002EC, "Member 'AK25Gateway::_minimumTimeBeforeTargetLocationMulticast' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _gatewayNoiseEventTimeInterval) == 0x0002F8, "Member 'AK25Gateway::_gatewayNoiseEventTimeInterval' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _gatewayNoiseEventRange) == 0x0002FC, "Member 'AK25Gateway::_gatewayNoiseEventRange' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _minDistanceFromPlayer) == 0x000300, "Member 'AK25Gateway::_minDistanceFromPlayer' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _maxDistanceFromPlayer) == 0x000328, "Member 'AK25Gateway::_maxDistanceFromPlayer' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _gatewayPlacementSpeed) == 0x0003A8, "Member 'AK25Gateway::_gatewayPlacementSpeed' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _pitchLevelChangeAngleThreshold) == 0x0003D0, "Member 'AK25Gateway::_pitchLevelChangeAngleThreshold' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _pitchLevelChangeZoneThreshold) == 0x0003F8, "Member 'AK25Gateway::_pitchLevelChangeZoneThreshold' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _maximumCameraPitchOrientationAngle) == 0x000420, "Member 'AK25Gateway::_maximumCameraPitchOrientationAngle' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _minimumCameraPitchOrientationAngle) == 0x000448, "Member 'AK25Gateway::_minimumCameraPitchOrientationAngle' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _maxGatewayPossessionDuration) == 0x000470, "Member 'AK25Gateway::_maxGatewayPossessionDuration' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _visualComponent) == 0x000498, "Member 'AK25Gateway::_visualComponent' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _targetLocation) == 0x0004A0, "Member 'AK25Gateway::_targetLocation' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _cameraPlacementComponent) == 0x0004B8, "Member 'AK25Gateway::_cameraPlacementComponent' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _isGatewayPossessed) == 0x0004C0, "Member 'AK25Gateway::_isGatewayPossessed' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _isBeingPositionned) == 0x0004DC, "Member 'AK25Gateway::_isBeingPositionned' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _possessionTimer) == 0x000508, "Member 'AK25Gateway::_possessionTimer' has a wrong offset!");
static_assert(offsetof(AK25Gateway, _perceptionStimuliComponent) == 0x000540, "Member 'AK25Gateway::_perceptionStimuliComponent' has a wrong offset!");
...
static_assert(sizeof(AK25Husk) == 0x0007A0, "Wrong size on AK25Husk");
static_assert(offsetof(AK25Husk, _customizedSkeletalMeshComponent) == 0x000770, "Member 'AK25Husk::_customizedSkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(AK25Husk, _montageFollower) == 0x000778, "Member 'AK25Husk::_montageFollower' has a wrong offset!");
static_assert(offsetof(AK25Husk, _k25CharacterOverrideID) == 0x000780, "Member 'AK25Husk::_k25CharacterOverrideID' has a wrong offset!");
...
static_assert(sizeof(UK25KillerChainHuntEffectsComponent) == 0x000118, "Wrong size on UK25KillerChainHuntEffectsComponent");
...
static_assert(sizeof(UK25KillerTeleportationPositionFinderComponent) == 0x0001C8, "Wrong size on UK25KillerTeleportationPositionFinderComponent");
...
static_assert(sizeof(UK25LamentConfigurationPossessionChainAttacksEffect) == 0x000430, "Wrong size on UK25LamentConfigurationPossessionChainAttacksEffect");
static_assert(offsetof(UK25LamentConfigurationPossessionChainAttacksEffect, _timeBetweenChainTargettingAttempt) == 0x000398, "Member 'UK25LamentConfigurationPossessionChainAttacksEffect::_timeBetweenChainTargettingAttempt' has a wrong offset!");
static_assert(offsetof(UK25LamentConfigurationPossessionChainAttacksEffect, _numberOfChainsToTriggerTowardsSurvivor) == 0x0003C0, "Member 'UK25LamentConfigurationPossessionChainAttacksEffect::_numberOfChainsToTriggerTowardsSurvivor' has a wrong offset!");
...
static_assert(sizeof(UK25P01) == 0x0004B0, "Wrong size on UK25P01");
static_assert(offsetof(UK25P01, _generatorBlockDuration) == 0x000460, "Member 'UK25P01::_generatorBlockDuration' has a wrong offset!");
static_assert(offsetof(UK25P01, _allowPerkToBlockZeroProgressionGenerators) == 0x00046C, "Member 'UK25P01::_allowPerkToBlockZeroProgressionGenerators' has a wrong offset!");
static_assert(offsetof(UK25P01, _generatorAuraColorForKiller) == 0x000470, "Member 'UK25P01::_generatorAuraColorForKiller' has a wrong offset!");
static_assert(offsetof(UK25P01, _generatorBlockingTimers) == 0x000480, "Member 'UK25P01::_generatorBlockingTimers' has a wrong offset!");
static_assert(offsetof(UK25P01, _generatorsBlocked) == 0x000490, "Member 'UK25P01::_generatorsBlocked' has a wrong offset!");
static_assert(offsetof(UK25P01, _local_generatorsBlocked) == 0x0004A0, "Member 'UK25P01::_local_generatorsBlocked' has a wrong offset!");
...
static_assert(sizeof(UK25P02) == 0x000570, "Wrong size on UK25P02");
static_assert(offsetof(UK25P02, _totemAuraRevealRadius) == 0x0004E0, "Member 'UK25P02::_totemAuraRevealRadius' has a wrong offset!");
static_assert(offsetof(UK25P02, _totemBlockerHasLifetime) == 0x0004EC, "Member 'UK25P02::_totemBlockerHasLifetime' has a wrong offset!");
static_assert(offsetof(UK25P02, _totemBlockerDuration) == 0x0004F0, "Member 'UK25P02::_totemBlockerDuration' has a wrong offset!");
static_assert(offsetof(UK25P02, _obliviousStatusEffectClass) == 0x000500, "Member 'UK25P02::_obliviousStatusEffectClass' has a wrong offset!");
static_assert(offsetof(UK25P02, _cursedSurvivors) == 0x000510, "Member 'UK25P02::_cursedSurvivors' has a wrong offset!");
static_assert(offsetof(UK25P02, _hookedSurvivors) == 0x000530, "Member 'UK25P02::_hookedSurvivors' has a wrong offset!");
static_assert(offsetof(UK25P02, _previouslyBoundTotems) == 0x000540, "Member 'UK25P02::_previouslyBoundTotems' has a wrong offset!");
static_assert(offsetof(UK25P02, _lastPlayerTotemPair) == 0x000550, "Member 'UK25P02::_lastPlayerTotemPair' has a wrong offset!");
static_assert(offsetof(UK25P02, _obliviousStatusEffects) == 0x000560, "Member 'UK25P02::_obliviousStatusEffects' has a wrong offset!");
...
static_assert(sizeof(UK25P03) == 0x0004A0, "Wrong size on UK25P03");
static_assert(offsetof(UK25P03, _hemorrhageEffect) == 0x000460, "Member 'UK25P03::_hemorrhageEffect' has a wrong offset!");
static_assert(offsetof(UK25P03, _mangledEffect) == 0x000468, "Member 'UK25P03::_mangledEffect' has a wrong offset!");
static_assert(offsetof(UK25P03, _K25P03SurvivorStateTwoEffect) == 0x000470, "Member 'UK25P03::_K25P03SurvivorStateTwoEffect' has a wrong offset!");
static_assert(offsetof(UK25P03, _numberOfSurvivorsWaitingForDamageStateChange) == 0x000480, "Member 'UK25P03::_numberOfSurvivorsWaitingForDamageStateChange' has a wrong offset!");
static_assert(offsetof(UK25P03, _state2ActionSpeedDebuffPercentage) == 0x000484, "Member 'UK25P03::_state2ActionSpeedDebuffPercentage' has a wrong offset!");
static_assert(offsetof(UK25P03, _mangledHemorrhageEffectLifetime) == 0x000490, "Member 'UK25P03::_mangledHemorrhageEffectLifetime' has a wrong offset!");
...
static_assert(sizeof(UK25PounceAttack) == 0x000460, "Wrong size on UK25PounceAttack");
...
static_assert(sizeof(AK25Power) == 0x0006B8, "Wrong size on AK25Power");
static_assert(offsetof(AK25Power, _k25ChainStrikeInteractionChargeableComponent) == 0x000570, "Member 'AK25Power::_k25ChainStrikeInteractionChargeableComponent' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25TeleportChargeableComponent) == 0x000578, "Member 'AK25Power::_k25TeleportChargeableComponent' has a wrong offset!");
static_assert(offsetof(AK25Power, _customKillerInstinctDatas) == 0x000580, "Member 'AK25Power::_customKillerInstinctDatas' has a wrong offset!");
static_assert(offsetof(AK25Power, _survivorStatusEffectClasses) == 0x000590, "Member 'AK25Power::_survivorStatusEffectClasses' has a wrong offset!");
static_assert(offsetof(AK25Power, _killerStatusEffectClasses) == 0x0005A0, "Member 'AK25Power::_killerStatusEffectClasses' has a wrong offset!");
static_assert(offsetof(AK25Power, _survivorChainAttachmentComponentClass) == 0x0005B0, "Member 'AK25Power::_survivorChainAttachmentComponentClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _survivorChainTargetterComponentClass) == 0x0005B8, "Member 'AK25Power::_survivorChainTargetterComponentClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25GatewayClass) == 0x0005C0, "Member 'AK25Power::_k25GatewayClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _controlledProjectileClass) == 0x0005C8, "Member 'AK25Power::_controlledProjectileClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _lamentConfigurationClass) == 0x0005D0, "Member 'AK25Power::_lamentConfigurationClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25HuskClass) == 0x0005D8, "Member 'AK25Power::_k25HuskClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _killerTeleportFinderComponentClass) == 0x0005E0, "Member 'AK25Power::_killerTeleportFinderComponentClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _chainAnimationActorClass) == 0x0005E8, "Member 'AK25Power::_chainAnimationActorClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _chainAnimationMappingsTables) == 0x0005F0, "Member 'AK25Power::_chainAnimationMappingsTables' has a wrong offset!");
static_assert(offsetof(AK25Power, _pillarAnimationActorClass) == 0x000600, "Member 'AK25Power::_pillarAnimationActorClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _chainsAttachedStatusEffectClass) == 0x000608, "Member 'AK25Power::_chainsAttachedStatusEffectClass' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25ProjectileLauncher) == 0x000610, "Member 'AK25Power::_k25ProjectileLauncher' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25ProjectilePool) == 0x000618, "Member 'AK25Power::_k25ProjectilePool' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25ChainPool) == 0x000620, "Member 'AK25Power::_k25ChainPool' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25PowerChargeComponent) == 0x000628, "Member 'AK25Power::_k25PowerChargeComponent' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25ProjectileProvider) == 0x000630, "Member 'AK25Power::_k25ProjectileProvider' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25PowerPresentationItemProgressComponent) == 0x000638, "Member 'AK25Power::_k25PowerPresentationItemProgressComponent' has a wrong offset!");
static_assert(offsetof(AK25Power, _gateway) == 0x000640, "Member 'AK25Power::_gateway' has a wrong offset!");
static_assert(offsetof(AK25Power, _controlledProjectileInstance) == 0x000648, "Member 'AK25Power::_controlledProjectileInstance' has a wrong offset!");
static_assert(offsetof(AK25Power, _lamentConfiguration) == 0x000650, "Member 'AK25Power::_lamentConfiguration' has a wrong offset!");
static_assert(offsetof(AK25Power, _k25Husk) == 0x000658, "Member 'AK25Power::_k25Husk' has a wrong offset!");
static_assert(offsetof(AK25Power, _chainAttachmentReplicationComponent) == 0x000660, "Member 'AK25Power::_chainAttachmentReplicationComponent' has a wrong offset!");
static_assert(offsetof(AK25Power, _interactionAttacherComponent) == 0x000668, "Member 'AK25Power::_interactionAttacherComponent' has a wrong offset!");
static_assert(offsetof(AK25Power, _isPowerCharged) == 0x0006B0, "Member 'AK25Power::_isPowerCharged' has a wrong offset!");
...
static_assert(sizeof(UK25PowerChargePresentationItemProgressComponent) == 0x0000D0, "Wrong size on UK25PowerChargePresentationItemProgressComponent");
static_assert(offsetof(UK25PowerChargePresentationItemProgressComponent, _powerChargeComponent) == 0x0000C0, "Member 'UK25PowerChargePresentationItemProgressComponent::_powerChargeComponent' has a wrong offset!");
static_assert(offsetof(UK25PowerChargePresentationItemProgressComponent, _k25Power) == 0x0000C8, "Member 'UK25PowerChargePresentationItemProgressComponent::_k25Power' has a wrong offset!");
...
static_assert(sizeof(UK25ProjectileLauncher) == 0x0001F8, "Wrong size on UK25ProjectileLauncher");
static_assert(offsetof(UK25ProjectileLauncher, _controlledProjectileInitialSpeed) == 0x0001A8, "Member 'UK25ProjectileLauncher::_controlledProjectileInitialSpeed' has a wrong offset!");
static_assert(offsetof(UK25ProjectileLauncher, _isControlledProjectileRequested) == 0x0001D0, "Member 'UK25ProjectileLauncher::_isControlledProjectileRequested' has a wrong offset!");
static_assert(offsetof(UK25ProjectileLauncher, _controlledProjectile) == 0x0001D8, "Member 'UK25ProjectileLauncher::_controlledProjectile' has a wrong offset!");
static_assert(offsetof(UK25ProjectileLauncher, _authority_uncontrolledLaunchLocation) == 0x0001E0, "Member 'UK25ProjectileLauncher::_authority_uncontrolledLaunchLocation' has a wrong offset!");
...
static_assert(sizeof(UK25ProjectilePool) == 0x000118, "Wrong size on UK25ProjectilePool");
...
static_assert(sizeof(UK25RemoveChainInteraction) == 0x000910, "Wrong size on UK25RemoveChainInteraction");
...
static_assert(offsetof(UK25RemoveChainInteraction, _chainBeingRemoved) == 0x000900, "Member 'UK25RemoveChainInteraction::_chainBeingRemoved' has a wrong offset!");
static_assert(offsetof(UK25RemoveChainInteraction, _chainAttachmentComponent) == 0x000908, "Member 'UK25RemoveChainInteraction::_chainAttachmentComponent' has a wrong offset!");
...
static_assert(sizeof(UK25SurvivorChainAttachmentComponent) == 0x0001C0, "Wrong size on UK25SurvivorChainAttachmentComponent");
...
static_assert(offsetof(UK25SurvivorChainAttachmentComponent, _survivorChainRotationStrategy) == 0x000168, "Member 'UK25SurvivorChainAttachmentComponent::_survivorChainRotationStrategy' has a wrong offset!");
static_assert(offsetof(UK25SurvivorChainAttachmentComponent, _chainAttachmentReplicationComponent) == 0x000170, "Member 'UK25SurvivorChainAttachmentComponent::_chainAttachmentReplicationComponent' has a wrong offset!");
static_assert(offsetof(UK25SurvivorChainAttachmentComponent, _gameEventsListToForceDetachChains) == 0x0001B0, "Member 'UK25SurvivorChainAttachmentComponent::_gameEventsListToForceDetachChains' has a wrong offset!");
...
static_assert(sizeof(UK25SurvivorChainHuntEffectsComponent) == 0x000120, "Wrong size on UK25SurvivorChainHuntEffectsComponent");
...
static_assert(sizeof(UK25SurvivorChainTargetterComponent) == 0x0001C8, "Wrong size on UK25SurvivorChainTargetterComponent");
...
static_assert(sizeof(AK25UncontrolledProjectile) == 0x000690, "Wrong size on AK25UncontrolledProjectile");
static_assert(offsetof(AK25UncontrolledProjectile, OnAcquiredChanged) == 0x000510, "Member 'AK25UncontrolledProjectile::OnAcquiredChanged' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _minimumTimeBeforeProjectileLaunch) == 0x000520, "Member 'AK25UncontrolledProjectile::_minimumTimeBeforeProjectileLaunch' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _maximumTimeBeforeProjectileLaunch) == 0x000548, "Member 'AK25UncontrolledProjectile::_maximumTimeBeforeProjectileLaunch' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _projectileSpeed) == 0x000570, "Member 'AK25UncontrolledProjectile::_projectileSpeed' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _projectileMaximumTravelDistance) == 0x000598, "Member 'AK25UncontrolledProjectile::_projectileMaximumTravelDistance' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _maximumInactiveProjectileTime) == 0x0005C0, "Member 'AK25UncontrolledProjectile::_maximumInactiveProjectileTime' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _isAcquiredFromPool) == 0x0005E8, "Member 'AK25UncontrolledProjectile::_isAcquiredFromPool' has a wrong offset!");
static_assert(offsetof(AK25UncontrolledProjectile, _targetSurvivor) == 0x000650, "Member 'AK25UncontrolledProjectile::_targetSurvivor' has a wrong offset!");
...
static_assert(sizeof(ULamentConfigurationOutlineStrategy) == 0x000148, "Wrong size on ULamentConfigurationOutlineStrategy");
static_assert(offsetof(ULamentConfigurationOutlineStrategy, _noChainHuntProgressColor) == 0x0000E0, "Member 'ULamentConfigurationOutlineStrategy::_noChainHuntProgressColor' has a wrong offset!");
static_assert(offsetof(ULamentConfigurationOutlineStrategy, _chainHuntActiveColor) == 0x0000F0, "Member 'ULamentConfigurationOutlineStrategy::_chainHuntActiveColor' has a wrong offset!");
static_assert(offsetof(ULamentConfigurationOutlineStrategy, _killerColor) == 0x000100, "Member 'ULamentConfigurationOutlineStrategy::_killerColor' has a wrong offset!");
...
static_assert(sizeof(ULamentConfigurationSpawnStrategy) == 0x000150, "Wrong size on ULamentConfigurationSpawnStrategy");
...
static_assert(offsetof(ULamentConfigurationSpawnStrategy, _lastUsedSpawnPoint) == 0x000120, "Member 'ULamentConfigurationSpawnStrategy::_lastUsedSpawnPoint' has a wrong offset!");
static_assert(offsetof(ULamentConfigurationSpawnStrategy, _actorsInMapToAvoid) == 0x000128, "Member 'ULamentConfigurationSpawnStrategy::_actorsInMapToAvoid' has a wrong offset!");
static_assert(offsetof(ULamentConfigurationSpawnStrategy, _minDistanceFromActorsToAvoid) == 0x000138, "Member 'ULamentConfigurationSpawnStrategy::_minDistanceFromActorsToAvoid' has a wrong offset!");
static_assert(offsetof(ULamentConfigurationSpawnStrategy, _hatches) == 0x000140, "Member 'ULamentConfigurationSpawnStrategy::_hatches' has a wrong offset!");
