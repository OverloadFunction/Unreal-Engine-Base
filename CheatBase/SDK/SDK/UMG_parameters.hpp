...
static_assert(sizeof(Image_SetBrushFromSoftMaterial) == 0x000038, "Wrong size on Image_SetBrushFromSoftMaterial");
...
static_assert(sizeof(Image_SetBrushFromSoftTexture) == 0x000040, "Wrong size on Image_SetBrushFromSoftTexture");
...
static_assert(offsetof(Image_SetBrushFromSoftTexture, bMatchSize) == 0x000038, "Member 'Image_SetBrushFromSoftTexture::bMatchSize' has a wrong offset!");
...
static_assert(alignof(DragDropOperation_DraggedVisual) == 0x000008, "Wrong alignment on DragDropOperation_DraggedVisual");
static_assert(sizeof(DragDropOperation_DraggedVisual) == 0x000020, "Wrong size on DragDropOperation_DraggedVisual");
...
static_assert(offsetof(DragDropOperation_DraggedVisual, desiredSize) == 0x000010, "Member 'DragDropOperation_DraggedVisual::desiredSize' has a wrong offset!");
