...
static_assert(sizeof(URedEnvelopeOutlineUpdateStrategy) == 0x000100, "Wrong size on URedEnvelopeOutlineUpdateStrategy");
static_assert(offsetof(URedEnvelopeOutlineUpdateStrategy, _auraColorOwner) == 0x0000E0, "Member 'URedEnvelopeOutlineUpdateStrategy::_auraColorOwner' has a wrong offset!");
static_assert(offsetof(URedEnvelopeOutlineUpdateStrategy, _auraColorNonOwner) == 0x0000F0, "Member 'URedEnvelopeOutlineUpdateStrategy::_auraColorNonOwner' has a wrong offset!");
