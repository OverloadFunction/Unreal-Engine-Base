...
static_assert(alignof(PhysicsUtilities_SetClothPhysicsEnabled) == 0x000008, "Wrong alignment on PhysicsUtilities_SetClothPhysicsEnabled");
static_assert(sizeof(PhysicsUtilities_SetClothPhysicsEnabled) == 0x000010, "Wrong size on PhysicsUtilities_SetClothPhysicsEnabled");
static_assert(offsetof(PhysicsUtilities_SetClothPhysicsEnabled, SkeletalMeshComponent) == 0x000000, "Member 'PhysicsUtilities_SetClothPhysicsEnabled::SkeletalMeshComponent' has a wrong offset!");
static_assert(offsetof(PhysicsUtilities_SetClothPhysicsEnabled, Enabled) == 0x000008, "Member 'PhysicsUtilities_SetClothPhysicsEnabled::Enabled' has a wrong offset!");
