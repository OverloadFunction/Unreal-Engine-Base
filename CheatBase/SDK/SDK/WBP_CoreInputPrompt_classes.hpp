...
static_assert(sizeof(UWBP_CoreInputPrompt_C) == 0x000460, "Wrong size on UWBP_CoreInputPrompt_C");
...
static_assert(offsetof(UWBP_CoreInputPrompt_C, GlobalSizeBox) == 0x000390, "Member 'UWBP_CoreInputPrompt_C::GlobalSizeBox' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, HighlightIMG) == 0x000398, "Member 'UWBP_CoreInputPrompt_C::HighlightIMG' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, LeftSpacerForRect) == 0x0003A0, "Member 'UWBP_CoreInputPrompt_C::LeftSpacerForRect' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, PromptIcon) == 0x0003A8, "Member 'UWBP_CoreInputPrompt_C::PromptIcon' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, RightSpacerForRect) == 0x0003B0, "Member 'UWBP_CoreInputPrompt_C::RightSpacerForRect' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, TextLabel) == 0x0003B8, "Member 'UWBP_CoreInputPrompt_C::TextLabel' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, ControlModeDataMap) == 0x0003C0, "Member 'UWBP_CoreInputPrompt_C::ControlModeDataMap' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, IsPromptFound) == 0x000410, "Member 'UWBP_CoreInputPrompt_C::IsPromptFound' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, DefaultMouseKBIcon) == 0x000418, "Member 'UWBP_CoreInputPrompt_C::DefaultMouseKBIcon' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, PaddingAlignment) == 0x000420, "Member 'UWBP_CoreInputPrompt_C::PaddingAlignment' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, PaddingValue) == 0x000428, "Member 'UWBP_CoreInputPrompt_C::PaddingValue' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, WideIcons) == 0x000430, "Member 'UWBP_CoreInputPrompt_C::WideIcons' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, IconSizeWide) == 0x000440, "Member 'UWBP_CoreInputPrompt_C::IconSizeWide' has a wrong offset!");
static_assert(offsetof(UWBP_CoreInputPrompt_C, IconSizeSquare) == 0x000450, "Member 'UWBP_CoreInputPrompt_C::IconSizeSquare' has a wrong offset!");
