...
static_assert(offsetof(GeometryCollectionActor_RaycastSingle, ReturnValue) == 0x000120, "Member 'GeometryCollectionActor_RaycastSingle::ReturnValue' has a wrong offset!");
