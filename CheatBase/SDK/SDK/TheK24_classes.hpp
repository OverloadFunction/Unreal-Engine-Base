...
static_assert(sizeof(UK24WhipAttack) == 0x0004C0, "Wrong size on UK24WhipAttack");
static_assert(offsetof(UK24WhipAttack, _attackSphereTraceRadius) == 0x000430, "Member 'UK24WhipAttack::_attackSphereTraceRadius' has a wrong offset!");
static_assert(offsetof(UK24WhipAttack, _attackMinDistanceToObstruction) == 0x000458, "Member 'UK24WhipAttack::_attackMinDistanceToObstruction' has a wrong offset!");
static_assert(offsetof(UK24WhipAttack, _whipMovementFromOffset) == 0x000480, "Member 'UK24WhipAttack::_whipMovementFromOffset' has a wrong offset!");
static_assert(offsetof(UK24WhipAttack, _whipMovementToOffset) == 0x000498, "Member 'UK24WhipAttack::_whipMovementToOffset' has a wrong offset!");
...
static_assert(sizeof(UAddon_K24_18) == 0x000330, "Wrong size on UAddon_K24_18");
static_assert(offsetof(UAddon_K24_18, _zombieEscapeDoorPointsActor) == 0x000328, "Member 'UAddon_K24_18::_zombieEscapeDoorPointsActor' has a wrong offset!");
...
static_assert(sizeof(UZombiesPatrolAreaManager) == 0x0000F8, "Wrong size on UZombiesPatrolAreaManager");
...
static_assert(offsetof(UZombiesPatrolAreaManager, _allPatrolAreas) == 0x0000D8, "Member 'UZombiesPatrolAreaManager::_allPatrolAreas' has a wrong offset!");
static_assert(offsetof(UZombiesPatrolAreaManager, _maxDistanceBetweenMeatHookAndPlayers) == 0x0000EC, "Member 'UZombiesPatrolAreaManager::_maxDistanceBetweenMeatHookAndPlayers' has a wrong offset!");
...
static_assert(alignof(UAISkill_Find_AttackZombie) == 0x000008, "Wrong alignment on UAISkill_Find_AttackZombie");
static_assert(sizeof(UAISkill_Find_AttackZombie) == 0x0003B0, "Wrong size on UAISkill_Find_AttackZombie");
static_assert(offsetof(UAISkill_Find_AttackZombie, WeightBonusPerRemainingLevel) == 0x000300, "Member 'UAISkill_Find_AttackZombie::WeightBonusPerRemainingLevel' has a wrong offset!");
static_assert(offsetof(UAISkill_Find_AttackZombie, BlockedWeightBonus) == 0x000360, "Member 'UAISkill_Find_AttackZombie::BlockedWeightBonus' has a wrong offset!");
static_assert(offsetof(UAISkill_Find_AttackZombie, BlockedSpeedPercent) == 0x000364, "Member 'UAISkill_Find_AttackZombie::BlockedSpeedPercent' has a wrong offset!");
static_assert(offsetof(UAISkill_Find_AttackZombie, MinimumBlockedTime) == 0x000368, "Member 'UAISkill_Find_AttackZombie::MinimumBlockedTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Find_AttackZombie, MaximumBlockedDistance) == 0x00036C, "Member 'UAISkill_Find_AttackZombie::MaximumBlockedDistance' has a wrong offset!");
...
static_assert(sizeof(UAddon_K24_04) == 0x000328, "Wrong size on UAddon_K24_04");
static_assert(offsetof(UAddon_K24_04, _effectTime) == 0x000310, "Member 'UAddon_K24_04::_effectTime' has a wrong offset!");
static_assert(offsetof(UAddon_K24_04, OutlineColor) == 0x000314, "Member 'UAddon_K24_04::OutlineColor' has a wrong offset!");
...
static_assert(sizeof(UAISkill_FindCollectable_SupplyCrate) == 0x000460, "Wrong size on UAISkill_FindCollectable_SupplyCrate");
static_assert(offsetof(UAISkill_FindCollectable_SupplyCrate, UrgencyGoalWeight) == 0x0003A0, "Member 'UAISkill_FindCollectable_SupplyCrate::UrgencyGoalWeight' has a wrong offset!");
static_assert(offsetof(UAISkill_FindCollectable_SupplyCrate, OpenedWeightMultiplier) == 0x000400, "Member 'UAISkill_FindCollectable_SupplyCrate::OpenedWeightMultiplier' has a wrong offset!");
...
static_assert(alignof(UAISkill_Interaction_K24Whip) == 0x000008, "Wrong alignment on UAISkill_Interaction_K24Whip");
static_assert(sizeof(UAISkill_Interaction_K24Whip) == 0x000608, "Wrong size on UAISkill_Interaction_K24Whip");
static_assert(offsetof(UAISkill_Interaction_K24Whip, ObstructionCheckHeight) == 0x0002A0, "Member 'UAISkill_Interaction_K24Whip::ObstructionCheckHeight' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, ClearAimVariablesAfterTime) == 0x0002A4, "Member 'UAISkill_Interaction_K24Whip::ClearAimVariablesAfterTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, InfectedTargetRerollTime) == 0x0002A8, "Member 'UAISkill_Interaction_K24Whip::InfectedTargetRerollTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, UseWhipAgainstInfectedTargetChance) == 0x0002B0, "Member 'UAISkill_Interaction_K24Whip::UseWhipAgainstInfectedTargetChance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, UseWhipAgainstNonInfectedTargetChance) == 0x000310, "Member 'UAISkill_Interaction_K24Whip::UseWhipAgainstNonInfectedTargetChance' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, EvadeInteractableProximityRange) == 0x000370, "Member 'UAISkill_Interaction_K24Whip::EvadeInteractableProximityRange' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, StartChargeChaseRangeMargin) == 0x0003D0, "Member 'UAISkill_Interaction_K24Whip::StartChargeChaseRangeMargin' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, StartChargeDestroyRangeMargin) == 0x000430, "Member 'UAISkill_Interaction_K24Whip::StartChargeDestroyRangeMargin' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, MaxAimInaccuracy) == 0x000490, "Member 'UAISkill_Interaction_K24Whip::MaxAimInaccuracy' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, AimVelocityPercentage) == 0x0004F0, "Member 'UAISkill_Interaction_K24Whip::AimVelocityPercentage' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, CameraLerpOverride) == 0x000550, "Member 'UAISkill_Interaction_K24Whip::CameraLerpOverride' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, InteractionRequestCancelTime) == 0x0005B0, "Member 'UAISkill_Interaction_K24Whip::InteractionRequestCancelTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, MaxInteractionRequestTime) == 0x0005B4, "Member 'UAISkill_Interaction_K24Whip::MaxInteractionRequestTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, MinChargeTime) == 0x0005B8, "Member 'UAISkill_Interaction_K24Whip::MinChargeTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, MaxChargeTime) == 0x0005BC, "Member 'UAISkill_Interaction_K24Whip::MaxChargeTime' has a wrong offset!");
static_assert(offsetof(UAISkill_Interaction_K24Whip, ForceAttackAfterTime) == 0x0005C0, "Member 'UAISkill_Interaction_K24Whip::ForceAttackAfterTime' has a wrong offset!");
...
static_assert(alignof(UContaminationInfectedSubAnimInstance) == 0x000010, "Wrong alignment on UContaminationInfectedSubAnimInstance");
static_assert(sizeof(UContaminationInfectedSubAnimInstance) == 0x000650, "Wrong size on UContaminationInfectedSubAnimInstance");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isContaminated) == 0x0005E8, "Member 'UContaminationInfectedSubAnimInstance::_isContaminated' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isBeingHealed) == 0x0005E9, "Member 'UContaminationInfectedSubAnimInstance::_isBeingHealed' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isFirstContaminationHit) == 0x0005EA, "Member 'UContaminationInfectedSubAnimInstance::_isFirstContaminationHit' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _triggerCough) == 0x0005EB, "Member 'UContaminationInfectedSubAnimInstance::_triggerCough' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _timeBetweenCough) == 0x0005EC, "Member 'UContaminationInfectedSubAnimInstance::_timeBetweenCough' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isIdle) == 0x0005F0, "Member 'UContaminationInfectedSubAnimInstance::_isIdle' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isCrouched) == 0x0005F1, "Member 'UContaminationInfectedSubAnimInstance::_isCrouched' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isInsideLocker) == 0x0005F2, "Member 'UContaminationInfectedSubAnimInstance::_isInsideLocker' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isInteracting) == 0x0005F3, "Member 'UContaminationInfectedSubAnimInstance::_isInteracting' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isHoldingAimItem) == 0x0005F4, "Member 'UContaminationInfectedSubAnimInstance::_isHoldingAimItem' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isCrawling) == 0x0005F5, "Member 'UContaminationInfectedSubAnimInstance::_isCrawling' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isHooked) == 0x0005F6, "Member 'UContaminationInfectedSubAnimInstance::_isHooked' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isDead) == 0x0005F7, "Member 'UContaminationInfectedSubAnimInstance::_isDead' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isFrightScreaming) == 0x0005F8, "Member 'UContaminationInfectedSubAnimInstance::_isFrightScreaming' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isHoldingSmallItem) == 0x0005F9, "Member 'UContaminationInfectedSubAnimInstance::_isHoldingSmallItem' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isUsingAimItem) == 0x0005FA, "Member 'UContaminationInfectedSubAnimInstance::_isUsingAimItem' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isHoldingHandleItem) == 0x0005FB, "Member 'UContaminationInfectedSubAnimInstance::_isHoldingHandleItem' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isInjured) == 0x0005FC, "Member 'UContaminationInfectedSubAnimInstance::_isInjured' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _isCarried) == 0x0005FD, "Member 'UContaminationInfectedSubAnimInstance::_isCarried' has a wrong offset!");
static_assert(offsetof(UContaminationInfectedSubAnimInstance, _interactionType) == 0x0005FE, "Member 'UContaminationInfectedSubAnimInstance::_interactionType' has a wrong offset!");
...
static_assert(sizeof(UZombieBlindableComponent) == 0x000278, "Wrong size on UZombieBlindableComponent");
static_assert(offsetof(UZombieBlindableComponent, _ownerObjectState) == 0x000270, "Member 'UZombieBlindableComponent::_ownerObjectState' has a wrong offset!");
...
static_assert(sizeof(AContaminationSerumCollectable) == 0x0005B8, "Wrong size on AContaminationSerumCollectable");
...
static_assert(sizeof(UContaminationSubAnimInstance) == 0x0005F0, "Wrong size on UContaminationSubAnimInstance");
static_assert(offsetof(UContaminationSubAnimInstance, _isInjectingSerumSelf) == 0x0005E8, "Member 'UContaminationSubAnimInstance::_isInjectingSerumSelf' has a wrong offset!");
static_assert(offsetof(UContaminationSubAnimInstance, _isInjectingSerumOther) == 0x0005E9, "Member 'UContaminationSubAnimInstance::_isInjectingSerumOther' has a wrong offset!");
static_assert(offsetof(UContaminationSubAnimInstance, _isBeingInjectedWithSerum) == 0x0005EA, "Member 'UContaminationSubAnimInstance::_isBeingInjectedWithSerum' has a wrong offset!");
static_assert(offsetof(UContaminationSubAnimInstance, _isBeingHealed) == 0x0005EB, "Member 'UContaminationSubAnimInstance::_isBeingHealed' has a wrong offset!");
static_assert(offsetof(UContaminationSubAnimInstance, _isIdle) == 0x0005EC, "Member 'UContaminationSubAnimInstance::_isIdle' has a wrong offset!");
...
static_assert(sizeof(UEruption) == 0x0004B8, "Wrong size on UEruption");
static_assert(offsetof(UEruption, _server_affectedGenerators) == 0x000460, "Member 'UEruption::_server_affectedGenerators' has a wrong offset!");
static_assert(offsetof(UEruption, _isPerkEnabled) == 0x000470, "Member 'UEruption::_isPerkEnabled' has a wrong offset!");
static_assert(offsetof(UEruption, _generatorRegressPercentage) == 0x000474, "Member 'UEruption::_generatorRegressPercentage' has a wrong offset!");
static_assert(offsetof(UEruption, _survivorImposedStatusEffectDuration) == 0x000480, "Member 'UEruption::_survivorImposedStatusEffectDuration' has a wrong offset!");
static_assert(offsetof(UEruption, _perkCooldownDuration) == 0x00048C, "Member 'UEruption::_perkCooldownDuration' has a wrong offset!");
static_assert(offsetof(UEruption, _screamRevealLocationDuration) == 0x000498, "Member 'UEruption::_screamRevealLocationDuration' has a wrong offset!");
static_assert(offsetof(UEruption, _survivorEffectClass) == 0x0004A0, "Member 'UEruption::_survivorEffectClass' has a wrong offset!");
...
static_assert(sizeof(UHysteria) == 0x0004D8, "Wrong size on UHysteria");
static_assert(offsetof(UHysteria, _obliviousEffectDuration) == 0x000460, "Member 'UHysteria::_obliviousEffectDuration' has a wrong offset!");
static_assert(offsetof(UHysteria, _perkCooldownDuration) == 0x00046C, "Member 'UHysteria::_perkCooldownDuration' has a wrong offset!");
static_assert(offsetof(UHysteria, _obliviousEffectClass) == 0x000480, "Member 'UHysteria::_obliviousEffectClass' has a wrong offset!");
static_assert(offsetof(UHysteria, _obliviousEffectPerSurvivorMap) == 0x000488, "Member 'UHysteria::_obliviousEffectPerSurvivorMap' has a wrong offset!");
...
static_assert(sizeof(UIncreaseZombiesSpeedStatusEffect) == 0x0003A0, "Wrong size on UIncreaseZombiesSpeedStatusEffect");
static_assert(offsetof(UIncreaseZombiesSpeedStatusEffect, _zombieSpeedAdditive) == 0x000398, "Member 'UIncreaseZombiesSpeedStatusEffect::_zombieSpeedAdditive' has a wrong offset!");
...
static_assert(sizeof(UZombieFallDetectorComponent) == 0x0000F8, "Wrong size on UZombieFallDetectorComponent");
...
static_assert(sizeof(UInjectSerumInteraction) == 0x0008F0, "Wrong size on UInjectSerumInteraction");
...
static_assert(sizeof(UZombieOutlineUpdateStrategy) == 0x000168, "Wrong size on UZombieOutlineUpdateStrategy");
static_assert(offsetof(UZombieOutlineUpdateStrategy, _zombieCharacter) == 0x000160, "Member 'UZombieOutlineUpdateStrategy::_zombieCharacter' has a wrong offset!");
...
static_assert(sizeof(UInjectSerumOther) == 0x0008F0, "Wrong size on UInjectSerumOther");
...
static_assert(sizeof(UZombieResurrector) == 0x000118, "Wrong size on UZombieResurrector");
static_assert(offsetof(UZombieResurrector, _powerLevelToSpawnZombie) == 0x0000C8, "Member 'UZombieResurrector::_powerLevelToSpawnZombie' has a wrong offset!");
static_assert(offsetof(UZombieResurrector, _delayedSpawnZombies) == 0x000100, "Member 'UZombieResurrector::_delayedSpawnZombies' has a wrong offset!");
...
static_assert(sizeof(UInjectSerumSelf) == 0x0008F0, "Wrong size on UInjectSerumSelf");
...
static_assert(sizeof(AZombiesManagement) == 0x000378, "Wrong size on AZombiesManagement");
static_assert(offsetof(AZombiesManagement, _zombiePool) == 0x0002A8, "Member 'AZombiesManagement::_zombiePool' has a wrong offset!");
static_assert(offsetof(AZombiesManagement, _zombiesPatrolAreaManagerClass) == 0x0002B0, "Member 'AZombiesManagement::_zombiesPatrolAreaManagerClass' has a wrong offset!");
...
static_assert(offsetof(AZombiesManagement, _owningPlayerState) == 0x0002D0, "Member 'AZombiesManagement::_owningPlayerState' has a wrong offset!");
...
static_assert(sizeof(UK24CharacterFXComponent) == 0x000108, "Wrong size on UK24CharacterFXComponent");
...
static_assert(sizeof(UK24PounceAttack) == 0x000430, "Wrong size on UK24PounceAttack");
...
static_assert(sizeof(AK24Power) == 0x0009A8, "Wrong size on AK24Power");
static_assert(offsetof(AK24Power, _powerWalkSpeed) == 0x000608, "Member 'AK24Power::_powerWalkSpeed' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerWalkSpeedLevel3) == 0x000630, "Member 'AK24Power::_powerWalkSpeedLevel3' has a wrong offset!");
static_assert(offsetof(AK24Power, _normalWalkSpeed) == 0x000658, "Member 'AK24Power::_normalWalkSpeed' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerMouseYawScale) == 0x000680, "Member 'AK24Power::_powerMouseYawScale' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerYawAdjustTime) == 0x0006A8, "Member 'AK24Power::_powerYawAdjustTime' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerGamePadYawScale) == 0x0006D0, "Member 'AK24Power::_powerGamePadYawScale' has a wrong offset!");
static_assert(offsetof(AK24Power, _activateK24PowerCharge) == 0x0006F8, "Member 'AK24Power::_activateK24PowerCharge' has a wrong offset!");
static_assert(offsetof(AK24Power, _activateK24PowerSecondsToCharge) == 0x000700, "Member 'AK24Power::_activateK24PowerSecondsToCharge' has a wrong offset!");
static_assert(offsetof(AK24Power, _activatePowerChargeSpeedCurve) == 0x000728, "Member 'AK24Power::_activatePowerChargeSpeedCurve' has a wrong offset!");
static_assert(offsetof(AK24Power, _activatePowerChargeLvl3SpeedCurve) == 0x000730, "Member 'AK24Power::_activatePowerChargeLvl3SpeedCurve' has a wrong offset!");
static_assert(offsetof(AK24Power, _playedPowerChargeSpeedCurve) == 0x000738, "Member 'AK24Power::_playedPowerChargeSpeedCurve' has a wrong offset!");
static_assert(offsetof(AK24Power, _k24PowerCooldownInteraction) == 0x000740, "Member 'AK24Power::_k24PowerCooldownInteraction' has a wrong offset!");
static_assert(offsetof(AK24Power, _whipLengthLevel1) == 0x000748, "Member 'AK24Power::_whipLengthLevel1' has a wrong offset!");
static_assert(offsetof(AK24Power, _whipLengthLevel2) == 0x000770, "Member 'AK24Power::_whipLengthLevel2' has a wrong offset!");
static_assert(offsetof(AK24Power, _whipLengthLevel3) == 0x000798, "Member 'AK24Power::_whipLengthLevel3' has a wrong offset!");
static_assert(offsetof(AK24Power, _contaminationComponentBP) == 0x0007C0, "Member 'AK24Power::_contaminationComponentBP' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerChargeSurvivorContaminatedPoint) == 0x0007C8, "Member 'AK24Power::_powerChargeSurvivorContaminatedPoint' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerChargeZombieKilledPoint) == 0x000848, "Member 'AK24Power::_powerChargeZombieKilledPoint' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerChargeSurvivorHitPoint) == 0x0008C8, "Member 'AK24Power::_powerChargeSurvivorHitPoint' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerLevelPoints) == 0x000948, "Member 'AK24Power::_powerLevelPoints' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerLevelPointsToLevel2) == 0x000950, "Member 'AK24Power::_powerLevelPointsToLevel2' has a wrong offset!");
static_assert(offsetof(AK24Power, _powerLevelPointsToLevel3) == 0x000978, "Member 'AK24Power::_powerLevelPointsToLevel3' has a wrong offset!");
...
static_assert(sizeof(Uk24PowerCooldownInteraction) == 0x0007B0, "Wrong size on Uk24PowerCooldownInteraction");
static_assert(offsetof(Uk24PowerCooldownInteraction, _k24PowerCooldownTime) == 0x000768, "Member 'Uk24PowerCooldownInteraction::_k24PowerCooldownTime' has a wrong offset!");
static_assert(offsetof(Uk24PowerCooldownInteraction, _cooldownSpeedCurve) == 0x000790, "Member 'Uk24PowerCooldownInteraction::_cooldownSpeedCurve' has a wrong offset!");
static_assert(offsetof(Uk24PowerCooldownInteraction, _cooldownLvl3SpeedCurve) == 0x000798, "Member 'Uk24PowerCooldownInteraction::_cooldownLvl3SpeedCurve' has a wrong offset!");
static_assert(offsetof(Uk24PowerCooldownInteraction, _playedCooldownSpeedCurve) == 0x0007A0, "Member 'Uk24PowerCooldownInteraction::_playedCooldownSpeedCurve' has a wrong offset!");
...
static_assert(sizeof(UK24PowerPresentationItemProgressComponent) == 0x0000C8, "Wrong size on UK24PowerPresentationItemProgressComponent");
static_assert(offsetof(UK24PowerPresentationItemProgressComponent, _k24Power) == 0x0000C0, "Member 'UK24PowerPresentationItemProgressComponent::_k24Power' has a wrong offset!");
...
static_assert(sizeof(UK24SlashAttack) == 0x000430, "Wrong size on UK24SlashAttack");
...
static_assert(alignof(AK24SurvivorCosmeticHelperActor) == 0x000008, "Wrong alignment on AK24SurvivorCosmeticHelperActor");
static_assert(sizeof(AK24SurvivorCosmeticHelperActor) == 0x000390, "Wrong size on AK24SurvivorCosmeticHelperActor");
...
static_assert(sizeof(ULethalPursuer) == 0x000478, "Wrong size on ULethalPursuer");
static_assert(offsetof(ULethalPursuer, _survivorRevealDuration) == 0x000460, "Member 'ULethalPursuer::_survivorRevealDuration' has a wrong offset!");
static_assert(offsetof(ULethalPursuer, _timedRevealEffect) == 0x000470, "Member 'ULethalPursuer::_timedRevealEffect' has a wrong offset!");
...
static_assert(sizeof(USupplyCrateOutlineUpdateStrategy) == 0x000100, "Wrong size on USupplyCrateOutlineUpdateStrategy");
...
static_assert(sizeof(USurvivorContaminationComponent) == 0x000220, "Wrong size on USurvivorContaminationComponent");
...
static_assert(offsetof(USurvivorContaminationComponent, _injectSerumChargeable) == 0x000118, "Member 'USurvivorContaminationComponent::_injectSerumChargeable' has a wrong offset!");
static_assert(offsetof(USurvivorContaminationComponent, _injectSerumSecondsToCharge) == 0x000120, "Member 'USurvivorContaminationComponent::_injectSerumSecondsToCharge' has a wrong offset!");
static_assert(offsetof(USurvivorContaminationComponent, _hinderedEffect) == 0x000148, "Member 'USurvivorContaminationComponent::_hinderedEffect' has a wrong offset!");
static_assert(offsetof(USurvivorContaminationComponent, _contaminationHinderedSeconds) == 0x000150, "Member 'USurvivorContaminationComponent::_contaminationHinderedSeconds' has a wrong offset!");
static_assert(offsetof(USurvivorContaminationComponent, _contaminationHinderedValue) == 0x0001D0, "Member 'USurvivorContaminationComponent::_contaminationHinderedValue' has a wrong offset!");
static_assert(offsetof(USurvivorContaminationComponent, _injectSerumInteractionsClasses) == 0x0001F8, "Member 'USurvivorContaminationComponent::_injectSerumInteractionsClasses' has a wrong offset!");
static_assert(offsetof(USurvivorContaminationComponent, _injectSerumInteractions) == 0x000208, "Member 'USurvivorContaminationComponent::_injectSerumInteractions' has a wrong offset!");
...
static_assert(alignof(UZombieAttackableComponent) == 0x000008, "Wrong alignment on UZombieAttackableComponent");
static_assert(sizeof(UZombieAttackableComponent) == 0x0000B8, "Wrong size on UZombieAttackableComponent");
...
static_assert(sizeof(AZombieCharacter) == 0x0009F0, "Wrong size on AZombieCharacter");
static_assert(offsetof(AZombieCharacter, _zombieWalkSpeed) == 0x000698, "Member 'AZombieCharacter::_zombieWalkSpeed' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _poolableComponent) == 0x000720, "Member 'AZombieCharacter::_poolableComponent' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieAttackDetector) == 0x000728, "Member 'AZombieCharacter::_zombieAttackDetector' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _attackDamageZone) == 0x000730, "Member 'AZombieCharacter::_attackDamageZone' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieState) == 0x000738, "Member 'AZombieCharacter::_zombieState' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieRespawnTimeKilledBySlasher) == 0x000778, "Member 'AZombieCharacter::_zombieRespawnTimeKilledBySlasher' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieRespawnTimeKilledBySurvivor) == 0x0007F8, "Member 'AZombieCharacter::_zombieRespawnTimeKilledBySurvivor' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _respawnPositionBehindGate) == 0x000880, "Member 'AZombieCharacter::_respawnPositionBehindGate' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieGender) == 0x0008E0, "Member 'AZombieCharacter::_zombieGender' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _owningKiller) == 0x0008E8, "Member 'AZombieCharacter::_owningKiller' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _femaleSkeletalMesh) == 0x0008F0, "Member 'AZombieCharacter::_femaleSkeletalMesh' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _audioSwitchState) == 0x0008F8, "Member 'AZombieCharacter::_audioSwitchState' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _blindableComponent) == 0x000908, "Member 'AZombieCharacter::_blindableComponent' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _blindingChargeableComponent) == 0x000910, "Member 'AZombieCharacter::_blindingChargeableComponent' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _rangedExplosiveEffectHandlerComponent) == 0x000918, "Member 'AZombieCharacter::_rangedExplosiveEffectHandlerComponent' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _flashLightableComponent) == 0x000920, "Member 'AZombieCharacter::_flashLightableComponent' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieStunBaseTime) == 0x000978, "Member 'AZombieCharacter::_zombieStunBaseTime' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _objectState) == 0x0009A0, "Member 'AZombieCharacter::_objectState' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _positionRecorder) == 0x0009B0, "Member 'AZombieCharacter::_positionRecorder' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _authoritativeMovementComponent) == 0x0009B8, "Member 'AZombieCharacter::_authoritativeMovementComponent' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _otherCharactersVerticalCollisionsHandler) == 0x0009C0, "Member 'AZombieCharacter::_otherCharactersVerticalCollisionsHandler' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _ignoreActors) == 0x0009C8, "Member 'AZombieCharacter::_ignoreActors' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _zombieStunnedCapsuleRadius) == 0x0009DC, "Member 'AZombieCharacter::_zombieStunnedCapsuleRadius' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _minFallHeight) == 0x0009E0, "Member 'AZombieCharacter::_minFallHeight' has a wrong offset!");
static_assert(offsetof(AZombieCharacter, _afterInAirAttackCooldown) == 0x0009EC, "Member 'AZombieCharacter::_afterInAirAttackCooldown' has a wrong offset!");
...
static_assert(sizeof(UZombiesInterestEventManager) == 0x0000E0, "Wrong size on UZombiesInterestEventManager");
static_assert(offsetof(UZombiesInterestEventManager, _zombieInterestEvents) == 0x0000C8, "Member 'UZombiesInterestEventManager::_zombieInterestEvents' has a wrong offset!");
