...
static_assert(sizeof(UBatchMeshCommands) == 0x000360, "Wrong size on UBatchMeshCommands");
static_assert(offsetof(UBatchMeshCommands, Groups) == 0x000330, "Member 'UBatchMeshCommands::Groups' has a wrong offset!");
static_assert(offsetof(UBatchMeshCommands, TargetMeshes) == 0x000340, "Member 'UBatchMeshCommands::TargetMeshes' has a wrong offset!");
static_assert(offsetof(UBatchMeshCommands, _materialGroupName) == 0x000350, "Member 'UBatchMeshCommands::_materialGroupName' has a wrong offset!");
...
static_assert(sizeof(UClonedMeshComponent) == 0x000400, "Wrong size on UClonedMeshComponent");
static_assert(offsetof(UClonedMeshComponent, _originalToClone) == 0x000360, "Member 'UClonedMeshComponent::_originalToClone' has a wrong offset!");
static_assert(offsetof(UClonedMeshComponent, _cloneToOriginal) == 0x0003B0, "Member 'UClonedMeshComponent::_cloneToOriginal' has a wrong offset!");
...
static_assert(sizeof(UClonedMeshComponentTranslucentOutline) == 0x000400, "Wrong size on UClonedMeshComponentTranslucentOutline");
...
static_assert(sizeof(UClonedStaticMeshComponent) == 0x000690, "Wrong size on UClonedStaticMeshComponent");
...
static_assert(sizeof(UClonedSplineMeshComponent) == 0x000790, "Wrong size on UClonedSplineMeshComponent");
...
static_assert(sizeof(UClonedSkeletalMeshComponent) == 0x0010B0, "Wrong size on UClonedSkeletalMeshComponent");
...
static_assert(sizeof(UDBDReflectionCaptureSpawnerComponent) == 0x000340, "Wrong size on UDBDReflectionCaptureSpawnerComponent");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, ReflectionSourceType) == 0x0002D0, "Member 'UDBDReflectionCaptureSpawnerComponent::ReflectionSourceType' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, Cubemap) == 0x0002D8, "Member 'UDBDReflectionCaptureSpawnerComponent::Cubemap' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, SourceCubemapAngle) == 0x0002E0, "Member 'UDBDReflectionCaptureSpawnerComponent::SourceCubemapAngle' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, Brightness) == 0x0002E4, "Member 'UDBDReflectionCaptureSpawnerComponent::Brightness' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, ContributionFactor) == 0x0002E8, "Member 'UDBDReflectionCaptureSpawnerComponent::ContributionFactor' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, IBLMultiplicator) == 0x0002EC, "Member 'UDBDReflectionCaptureSpawnerComponent::IBLMultiplicator' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, bCanBeTinted) == 0x0002F0, "Member 'UDBDReflectionCaptureSpawnerComponent::bCanBeTinted' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, CaptureOffset) == 0x0002F8, "Member 'UDBDReflectionCaptureSpawnerComponent::CaptureOffset' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, SpawnedReflectionCaptures) == 0x000318, "Member 'UDBDReflectionCaptureSpawnerComponent::SpawnedReflectionCaptures' has a wrong offset!");
static_assert(offsetof(UDBDReflectionCaptureSpawnerComponent, SpawnedReflectionCaptureComponents) == 0x000328, "Member 'UDBDReflectionCaptureSpawnerComponent::SpawnedReflectionCaptureComponents' has a wrong offset!");
...
static_assert(sizeof(UDBDBoxReflectionCaptureSpawnerComponent) == 0x000370, "Wrong size on UDBDBoxReflectionCaptureSpawnerComponent");
static_assert(offsetof(UDBDBoxReflectionCaptureSpawnerComponent, InfluenceBox) == 0x000340, "Member 'UDBDBoxReflectionCaptureSpawnerComponent::InfluenceBox' has a wrong offset!");
static_assert(offsetof(UDBDBoxReflectionCaptureSpawnerComponent, BoxTransitionDistance) == 0x000358, "Member 'UDBDBoxReflectionCaptureSpawnerComponent::BoxTransitionDistance' has a wrong offset!");
static_assert(offsetof(UDBDBoxReflectionCaptureSpawnerComponent, PreviewInfluenceBox) == 0x000360, "Member 'UDBDBoxReflectionCaptureSpawnerComponent::PreviewInfluenceBox' has a wrong offset!");
static_assert(offsetof(UDBDBoxReflectionCaptureSpawnerComponent, PreviewCaptureBox) == 0x000368, "Member 'UDBDBoxReflectionCaptureSpawnerComponent::PreviewCaptureBox' has a wrong offset!");
...
static_assert(sizeof(UDBDCullDistanceVolumeComponent) == 0x000310, "Wrong size on UDBDCullDistanceVolumeComponent");
static_assert(offsetof(UDBDCullDistanceVolumeComponent, CullDistances) == 0x0002D0, "Member 'UDBDCullDistanceVolumeComponent::CullDistances' has a wrong offset!");
static_assert(offsetof(UDBDCullDistanceVolumeComponent, InfluenceBox) == 0x0002E0, "Member 'UDBDCullDistanceVolumeComponent::InfluenceBox' has a wrong offset!");
static_assert(offsetof(UDBDCullDistanceVolumeComponent, Enabled) == 0x0002F8, "Member 'UDBDCullDistanceVolumeComponent::Enabled' has a wrong offset!");
static_assert(offsetof(UDBDCullDistanceVolumeComponent, Unbound) == 0x0002F9, "Member 'UDBDCullDistanceVolumeComponent::Unbound' has a wrong offset!");
static_assert(offsetof(UDBDCullDistanceVolumeComponent, _previewInfluenceBox) == 0x000300, "Member 'UDBDCullDistanceVolumeComponent::_previewInfluenceBox' has a wrong offset!");
...
static_assert(sizeof(UDBDSphereReflectionCaptureSpawnerComponent) == 0x000350, "Wrong size on UDBDSphereReflectionCaptureSpawnerComponent");
static_assert(offsetof(UDBDSphereReflectionCaptureSpawnerComponent, InfluenceRadius) == 0x000340, "Member 'UDBDSphereReflectionCaptureSpawnerComponent::InfluenceRadius' has a wrong offset!");
static_assert(offsetof(UDBDSphereReflectionCaptureSpawnerComponent, PreviewInfluenceRadius) == 0x000348, "Member 'UDBDSphereReflectionCaptureSpawnerComponent::PreviewInfluenceRadius' has a wrong offset!");
...
static_assert(sizeof(UMaterialHelper) == 0x000360, "Wrong size on UMaterialHelper");
...
static_assert(sizeof(UMaterialHelperUnaffectedStaticMeshComponent) == 0x000690, "Wrong size on UMaterialHelperUnaffectedStaticMeshComponent");
...
static_assert(sizeof(UMaterialHelperUnaffectedNiagaraComponent) == 0x000850, "Wrong size on UMaterialHelperUnaffectedNiagaraComponent");
...
static_assert(sizeof(UMeshCloningFactory) == 0x000360, "Wrong size on UMeshCloningFactory");
...
static_assert(sizeof(UOuterlineComponent) == 0x000300, "Wrong size on UOuterlineComponent");
static_assert(offsetof(UOuterlineComponent, CloneCustomDepthMaterial) == 0x0002D0, "Member 'UOuterlineComponent::CloneCustomDepthMaterial' has a wrong offset!");
static_assert(offsetof(UOuterlineComponent, CloneTranslucentMaterial) == 0x0002D8, "Member 'UOuterlineComponent::CloneTranslucentMaterial' has a wrong offset!");
static_assert(offsetof(UOuterlineComponent, _cloneCustomDepthMaterialDynamic) == 0x0002E0, "Member 'UOuterlineComponent::_cloneCustomDepthMaterialDynamic' has a wrong offset!");
static_assert(offsetof(UOuterlineComponent, _cloneTranslucentMaterialDynamic) == 0x0002E8, "Member 'UOuterlineComponent::_cloneTranslucentMaterialDynamic' has a wrong offset!");
static_assert(offsetof(UOuterlineComponent, _customDepthSkeletalMesh) == 0x0002F0, "Member 'UOuterlineComponent::_customDepthSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UOuterlineComponent, _overlaySkeletalMesh) == 0x0002F8, "Member 'UOuterlineComponent::_overlaySkeletalMesh' has a wrong offset!");
