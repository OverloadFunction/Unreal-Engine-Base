...
static_assert(sizeof(AISense_Hearing_Authority_ReportNoiseEventBHVR) == 0x000040, "Wrong size on AISense_Hearing_Authority_ReportNoiseEventBHVR");
...
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, Loudness) == 0x000020, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::Loudness' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, Instigator) == 0x000028, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::Instigator' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, MaxRange) == 0x000030, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::MaxRange' has a wrong offset!");
static_assert(offsetof(AISense_Hearing_Authority_ReportNoiseEventBHVR, Tag) == 0x000034, "Member 'AISense_Hearing_Authority_ReportNoiseEventBHVR::Tag' has a wrong offset!");
