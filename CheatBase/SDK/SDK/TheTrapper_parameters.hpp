...
static_assert(alignof(BearTrap_OnTrappedInjuredBleedoutKO) == 0x000008, "Wrong alignment on BearTrap_OnTrappedInjuredBleedoutKO");
static_assert(sizeof(BearTrap_OnTrappedInjuredBleedoutKO) == 0x000008, "Wrong size on BearTrap_OnTrappedInjuredBleedoutKO");
static_assert(offsetof(BearTrap_OnTrappedInjuredBleedoutKO, injuredBleedoutInstigator) == 0x000000, "Member 'BearTrap_OnTrappedInjuredBleedoutKO::injuredBleedoutInstigator' has a wrong offset!");
...
static_assert(alignof(SetBearTrap_GetSetTrapHasteSpeed) == 0x000004, "Wrong alignment on SetBearTrap_GetSetTrapHasteSpeed");
static_assert(sizeof(SetBearTrap_GetSetTrapHasteSpeed) == 0x000004, "Wrong size on SetBearTrap_GetSetTrapHasteSpeed");
static_assert(offsetof(SetBearTrap_GetSetTrapHasteSpeed, ReturnValue) == 0x000000, "Member 'SetBearTrap_GetSetTrapHasteSpeed::ReturnValue' has a wrong offset!");
