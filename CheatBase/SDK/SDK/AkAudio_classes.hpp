...
static_assert(sizeof(UAkGameObject) == 0x0002E0, "Wrong size on UAkGameObject");
static_assert(offsetof(UAkGameObject, AkAudioEvent) == 0x0002D0, "Member 'UAkGameObject::AkAudioEvent' has a wrong offset!");
...
static_assert(sizeof(UAkComponent) == 0x000550, "Wrong size on UAkComponent");
static_assert(offsetof(UAkComponent, bUseSpatialAudio) == 0x0002E0, "Member 'UAkComponent::bUseSpatialAudio' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionCollisionChannel) == 0x0002E8, "Member 'UAkComponent::OcclusionCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionRefreshInterval) == 0x0002EC, "Member 'UAkComponent::OcclusionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkComponent, EnableSpotReflectors) == 0x0002F0, "Member 'UAkComponent::EnableSpotReflectors' has a wrong offset!");
static_assert(offsetof(UAkComponent, OuterRadius) == 0x0002F4, "Member 'UAkComponent::OuterRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, InnerRadius) == 0x0002F8, "Member 'UAkComponent::InnerRadius' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBus) == 0x000300, "Member 'UAkComponent::EarlyReflectionAuxBus' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionAuxBusName) == 0x000308, "Member 'UAkComponent::EarlyReflectionAuxBusName' has a wrong offset!");
static_assert(offsetof(UAkComponent, EarlyReflectionBusSendGain) == 0x000318, "Member 'UAkComponent::EarlyReflectionBusSendGain' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawFirstOrderReflections) == 0x00031C, "Member 'UAkComponent::DrawFirstOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawSecondOrderReflections) == 0x00031D, "Member 'UAkComponent::DrawSecondOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawHigherOrderReflections) == 0x00031E, "Member 'UAkComponent::DrawHigherOrderReflections' has a wrong offset!");
static_assert(offsetof(UAkComponent, DrawDiffraction) == 0x00031F, "Member 'UAkComponent::DrawDiffraction' has a wrong offset!");
static_assert(offsetof(UAkComponent, StopWhenOwnerDestroyed) == 0x000320, "Member 'UAkComponent::StopWhenOwnerDestroyed' has a wrong offset!");
static_assert(offsetof(UAkComponent, AttenuationScalingFactor) == 0x000324, "Member 'UAkComponent::AttenuationScalingFactor' has a wrong offset!");
static_assert(offsetof(UAkComponent, bUseReverbVolumes) == 0x000328, "Member 'UAkComponent::bUseReverbVolumes' has a wrong offset!");
static_assert(offsetof(UAkComponent, OcclusionAffect) == 0x00032C, "Member 'UAkComponent::OcclusionAffect' has a wrong offset!");
static_assert(offsetof(UAkComponent, MaxDistance) == 0x000330, "Member 'UAkComponent::MaxDistance' has a wrong offset!");
static_assert(offsetof(UAkComponent, AutoPostOnBeginPlay) == 0x000334, "Member 'UAkComponent::AutoPostOnBeginPlay' has a wrong offset!");
static_assert(offsetof(UAkComponent, StaticAmbientEmitter) == 0x0004E0, "Member 'UAkComponent::StaticAmbientEmitter' has a wrong offset!");
static_assert(offsetof(UAkComponent, StaticAmbientEmitterFadeDuration) == 0x0004E4, "Member 'UAkComponent::StaticAmbientEmitterFadeDuration' has a wrong offset!");
static_assert(offsetof(UAkComponent, StaticAmbientEmitterInterpolationCurve) == 0x0004E8, "Member 'UAkComponent::StaticAmbientEmitterInterpolationCurve' has a wrong offset!");
static_assert(offsetof(UAkComponent, ListenersInRange) == 0x0004F8, "Member 'UAkComponent::ListenersInRange' has a wrong offset!");
...
static_assert(sizeof(UAkPortalComponent) == 0x0004C0, "Wrong size on UAkPortalComponent");
static_assert(offsetof(UAkPortalComponent, bDynamic) == 0x0002D0, "Member 'UAkPortalComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, InitialState) == 0x0002D1, "Member 'UAkPortalComponent::InitialState' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, InitialOcclusion) == 0x0002D4, "Member 'UAkPortalComponent::InitialOcclusion' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, ObstructionRefreshInterval) == 0x0002D8, "Member 'UAkPortalComponent::ObstructionRefreshInterval' has a wrong offset!");
static_assert(offsetof(UAkPortalComponent, ObstructionCollisionChannel) == 0x0002DC, "Member 'UAkPortalComponent::ObstructionCollisionChannel' has a wrong offset!");
...
static_assert(sizeof(UAkAcousticTextureSetComponent) == 0x0002F0, "Wrong size on UAkAcousticTextureSetComponent");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x000580, "Wrong size on UAkAudioInputComponent");
...
static_assert(offsetof(UAkRoomComponent, bEnable) == 0x0002E0, "Member 'UAkRoomComponent::bEnable' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, bDynamic) == 0x0002E1, "Member 'UAkRoomComponent::bDynamic' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, Priority) == 0x0002E4, "Member 'UAkRoomComponent::Priority' has a wrong offset!");
...
static_assert(offsetof(UAkRoomComponent, bEnableReverbZone) == 0x0002F1, "Member 'UAkRoomComponent::bEnableReverbZone' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, ParentRoomActor) == 0x0002F8, "Member 'UAkRoomComponent::ParentRoomActor' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, ParentRoomName) == 0x000300, "Member 'UAkRoomComponent::ParentRoomName' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, TransitionRegionWidth) == 0x000310, "Member 'UAkRoomComponent::TransitionRegionWidth' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, GeometryComponent) == 0x000320, "Member 'UAkRoomComponent::GeometryComponent' has a wrong offset!");
static_assert(offsetof(UAkRoomComponent, ParentRoom) == 0x000380, "Member 'UAkRoomComponent::ParentRoom' has a wrong offset!");
...
static_assert(sizeof(UDrawPortalComponent) == 0x0005A0, "Wrong size on UDrawPortalComponent");
...
static_assert(sizeof(UDrawRoomComponent) == 0x0005A0, "Wrong size on UDrawRoomComponent");
...
static_assert(sizeof(UAkGeometryComponent) == 0x000470, "Wrong size on UAkGeometryComponent");
static_assert(offsetof(UAkGeometryComponent, MeshType) == 0x0002E8, "Member 'UAkGeometryComponent::MeshType' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, LOD) == 0x0002EC, "Member 'UAkGeometryComponent::LOD' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, WeldingThreshold) == 0x0002F0, "Member 'UAkGeometryComponent::WeldingThreshold' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, StaticMeshSurfaceOverride) == 0x0002F8, "Member 'UAkGeometryComponent::StaticMeshSurfaceOverride' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, CollisionMeshSurfaceOverride) == 0x000348, "Member 'UAkGeometryComponent::CollisionMeshSurfaceOverride' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, bEnableDiffraction) == 0x000360, "Member 'UAkGeometryComponent::bEnableDiffraction' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, bEnableDiffractionOnBoundaryEdges) == 0x000361, "Member 'UAkGeometryComponent::bEnableDiffractionOnBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, AssociatedRoom) == 0x000368, "Member 'UAkGeometryComponent::AssociatedRoom' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, GeometryData) == 0x000380, "Member 'UAkGeometryComponent::GeometryData' has a wrong offset!");
static_assert(offsetof(UAkGeometryComponent, SurfaceAreas) == 0x0003D0, "Member 'UAkGeometryComponent::SurfaceAreas' has a wrong offset!");
...
static_assert(sizeof(UAkLateReverbComponent) == 0x000360, "Wrong size on UAkLateReverbComponent");
static_assert(offsetof(UAkLateReverbComponent, bEnable) == 0x0002D0, "Member 'UAkLateReverbComponent::bEnable' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, SendLevel) == 0x0002D4, "Member 'UAkLateReverbComponent::SendLevel' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, FadeRate) == 0x0002D8, "Member 'UAkLateReverbComponent::FadeRate' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, Priority) == 0x0002DC, "Member 'UAkLateReverbComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, AutoAssignAuxBus) == 0x0002E0, "Member 'UAkLateReverbComponent::AutoAssignAuxBus' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, AuxBus) == 0x0002E8, "Member 'UAkLateReverbComponent::AuxBus' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, AuxBusName) == 0x0002F0, "Member 'UAkLateReverbComponent::AuxBusName' has a wrong offset!");
static_assert(offsetof(UAkLateReverbComponent, AuxBusManual) == 0x000308, "Member 'UAkLateReverbComponent::AuxBusManual' has a wrong offset!");
...
static_assert(sizeof(UAkSubmixInputComponent) == 0x0005A0, "Wrong size on UAkSubmixInputComponent");
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x000578, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
...
static_assert(sizeof(UAkSurfaceReflectorSetComponent) == 0x000320, "Wrong size on UAkSurfaceReflectorSetComponent");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableSurfaceReflectors) == 0x0002E8, "Member 'UAkSurfaceReflectorSetComponent::bEnableSurfaceReflectors' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, AcousticPolys) == 0x0002F0, "Member 'UAkSurfaceReflectorSetComponent::AcousticPolys' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableDiffraction) == 0x000300, "Member 'UAkSurfaceReflectorSetComponent::bEnableDiffraction' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, bEnableDiffractionOnBoundaryEdges) == 0x000301, "Member 'UAkSurfaceReflectorSetComponent::bEnableDiffractionOnBoundaryEdges' has a wrong offset!");
static_assert(offsetof(UAkSurfaceReflectorSetComponent, AssociatedRoom) == 0x000308, "Member 'UAkSurfaceReflectorSetComponent::AssociatedRoom' has a wrong offset!");
