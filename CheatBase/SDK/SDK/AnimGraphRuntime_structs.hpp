...
static_assert(offsetof(FAnimNode_ModifyBone, Translation) == 0x0000E8, "Member 'FAnimNode_ModifyBone::Translation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Rotation) == 0x000100, "Member 'FAnimNode_ModifyBone::Rotation' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, Scale) == 0x000118, "Member 'FAnimNode_ModifyBone::Scale' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, TranslationMode) == 0x000130, "Member 'FAnimNode_ModifyBone::TranslationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, RotationMode) == 0x000131, "Member 'FAnimNode_ModifyBone::RotationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, ScaleMode) == 0x000132, "Member 'FAnimNode_ModifyBone::ScaleMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, TranslationSpace) == 0x000133, "Member 'FAnimNode_ModifyBone::TranslationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, RotationSpace) == 0x000134, "Member 'FAnimNode_ModifyBone::RotationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_ModifyBone, ScaleSpace) == 0x000135, "Member 'FAnimNode_ModifyBone::ScaleSpace' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x000150, "Member 'FAnimNode_AimOffsetLookAt::PivotSocketName' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x000160, "Member 'FAnimNode_AimOffsetLookAt::LookAtLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x000178, "Member 'FAnimNode_AimOffsetLookAt::SocketAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_AimOffsetLookAt, alpha) == 0x000190, "Member 'FAnimNode_AimOffsetLookAt::alpha' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, GroupRole) == 0x000074, "Member 'FAnimNode_BlendSpacePlayer_Standalone::GroupRole' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, Method) == 0x000075, "Member 'FAnimNode_BlendSpacePlayer_Standalone::Method' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bIgnoreForRelevancyTest) == 0x000076, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bIgnoreForRelevancyTest' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, X) == 0x000078, "Member 'FAnimNode_BlendSpacePlayer_Standalone::X' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, Y) == 0x00007C, "Member 'FAnimNode_BlendSpacePlayer_Standalone::Y' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, PlayRate) == 0x000080, "Member 'FAnimNode_BlendSpacePlayer_Standalone::PlayRate' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bLoop) == 0x000084, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bLoop' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bResetPlayTimeWhenBlendSpaceChanges) == 0x000085, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bResetPlayTimeWhenBlendSpaceChanges' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, StartPosition) == 0x000088, "Member 'FAnimNode_BlendSpacePlayer_Standalone::StartPosition' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, bEvalFromRefPose) == 0x00011C, "Member 'FAnimNode_PoseDriver::bEvalFromRefPose' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x0000E4, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x000118, "Member 'FAnimNode_RotationOffsetBlendSpace::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, bAlphaBoolEnabled) == 0x000119, "Member 'FAnimNode_RotationOffsetBlendSpace::bAlphaBoolEnabled' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaScaleBiasClamp) == 0x0000DC, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaScaleBiasClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, AlphaInputType) == 0x000110, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpaceGraph, bAlphaBoolEnabled) == 0x000111, "Member 'FAnimNode_RotationOffsetBlendSpaceGraph::bAlphaBoolEnabled' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_SequenceEvaluator_Standalone, GroupRole) == 0x00004C, "Member 'FAnimNode_SequenceEvaluator_Standalone::GroupRole' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator_Standalone, Method) == 0x00004D, "Member 'FAnimNode_SequenceEvaluator_Standalone::Method' has a wrong offset!");
static_assert(offsetof(FAnimNode_SequenceEvaluator_Standalone, bIgnoreForRelevancyTest) == 0x00004E, "Member 'FAnimNode_SequenceEvaluator_Standalone::bIgnoreForRelevancyTest' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_Sync, GroupRole) == 0x00002C, "Member 'FAnimNode_Sync::GroupRole' has a wrong offset!");
...
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000D10, "Wrong size on FAnimSequencerInstanceProxy");
...
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x000540, "Wrong size on FAnimNode_AnimDynamics");
...
static_assert(offsetof(FAnimNode_AnimDynamics, bHardLinkChain) == 0x0001B4, "Member 'FAnimNode_AnimDynamics::bHardLinkChain' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, BoundBone) == 0x0001B8, "Member 'FAnimNode_AnimDynamics::BoundBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ChainEnd) == 0x0001CC, "Member 'FAnimNode_AnimDynamics::ChainEnd' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, PhysicsBodyDefinitions) == 0x0001E0, "Member 'FAnimNode_AnimDynamics::PhysicsBodyDefinitions' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_AnimDynamics, SphericalLimits) == 0x000278, "Member 'FAnimNode_AnimDynamics::SphericalLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, ExternalForce) == 0x000288, "Member 'FAnimNode_AnimDynamics::ExternalForce' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, PlanarLimits) == 0x0002A0, "Member 'FAnimNode_AnimDynamics::PlanarLimits' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, SimulationSpace) == 0x0002B0, "Member 'FAnimNode_AnimDynamics::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_AnimDynamics, RetargetingSettings) == 0x0002C0, "Member 'FAnimNode_AnimDynamics::RetargetingSettings' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_BoneDrivenController) == 0x000140, "Wrong size on FAnimNode_BoneDrivenController");
...
static_assert(offsetof(FAnimNode_BoneDrivenController, RangeMin) == 0x0000F8, "Member 'FAnimNode_BoneDrivenController::RangeMin' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_BoneDrivenController, RemappedMin) == 0x000108, "Member 'FAnimNode_BoneDrivenController::RemappedMin' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetBone) == 0x000124, "Member 'FAnimNode_BoneDrivenController::TargetBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, DestinationMode) == 0x000138, "Member 'FAnimNode_BoneDrivenController::DestinationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, ModificationMode) == 0x000139, "Member 'FAnimNode_BoneDrivenController::ModificationMode' has a wrong offset!");
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceComponent) == 0x00013A, "Member 'FAnimNode_BoneDrivenController::SourceComponent' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_CCDIK) == 0x0001E0, "Wrong size on FAnimNode_CCDIK");
...
static_assert(offsetof(FAnimNode_CCDIK, TipBone) == 0x000190, "Member 'FAnimNode_CCDIK::TipBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, RootBone) == 0x0001A4, "Member 'FAnimNode_CCDIK::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, Precision) == 0x0001B8, "Member 'FAnimNode_CCDIK::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, MaxIterations) == 0x0001BC, "Member 'FAnimNode_CCDIK::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, bStartFromTail) == 0x0001C0, "Member 'FAnimNode_CCDIK::bStartFromTail' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, bEnableRotationLimit) == 0x0001C1, "Member 'FAnimNode_CCDIK::bEnableRotationLimit' has a wrong offset!");
static_assert(offsetof(FAnimNode_CCDIK, RotationLimitPerJoints) == 0x0001C8, "Member 'FAnimNode_CCDIK::RotationLimitPerJoints' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_Fabrik) == 0x000210, "Wrong size on FAnimNode_Fabrik");
...
static_assert(offsetof(FAnimNode_Fabrik, TipBone) == 0x0001D0, "Member 'FAnimNode_Fabrik::TipBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, RootBone) == 0x0001E4, "Member 'FAnimNode_Fabrik::RootBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, Precision) == 0x0001F8, "Member 'FAnimNode_Fabrik::Precision' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, MaxIterations) == 0x0001FC, "Member 'FAnimNode_Fabrik::MaxIterations' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorTransformSpace) == 0x000200, "Member 'FAnimNode_Fabrik::EffectorTransformSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_Fabrik, EffectorRotationSource) == 0x000201, "Member 'FAnimNode_Fabrik::EffectorRotationSource' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_LookAt, LookAt_Axis) == 0x0001A8, "Member 'FAnimNode_LookAt::LookAt_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, bUseLookUpAxis) == 0x0001C8, "Member 'FAnimNode_LookAt::bUseLookUpAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationType) == 0x0001C9, "Member 'FAnimNode_LookAt::InterpolationType' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookUp_Axis) == 0x0001D0, "Member 'FAnimNode_LookAt::LookUp_Axis' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, LookAtClamp) == 0x0001F0, "Member 'FAnimNode_LookAt::LookAtClamp' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationTime) == 0x0001F4, "Member 'FAnimNode_LookAt::InterpolationTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_LookAt, InterpolationTriggerThreashold) == 0x0001F8, "Member 'FAnimNode_LookAt::InterpolationTriggerThreashold' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SpringBone) == 0x000178, "Wrong size on FAnimNode_SpringBone");
...
static_assert(offsetof(FAnimNode_SpringBone, MaxDisplacement) == 0x0000E8, "Member 'FAnimNode_SpringBone::MaxDisplacement' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_SpringBone, SpringDamping) == 0x0000F8, "Member 'FAnimNode_SpringBone::SpringDamping' has a wrong offset!");
static_assert(offsetof(FAnimNode_SpringBone, ErrorResetThresh) == 0x000100, "Member 'FAnimNode_SpringBone::ErrorResetThresh' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_Trail, ChainLength) == 0x000144, "Member 'FAnimNode_Trail::ChainLength' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, ChainBoneAxis) == 0x000148, "Member 'FAnimNode_Trail::ChainBoneAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, MaxDeltaTime) == 0x00014C, "Member 'FAnimNode_Trail::MaxDeltaTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, RelaxationSpeedScale) == 0x000150, "Member 'FAnimNode_Trail::RelaxationSpeedScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_Trail, TrailRelaxationSpeed) == 0x000158, "Member 'FAnimNode_Trail::TrailRelaxationSpeed' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_Trail, LastBoneRotationAnimAlphaBlend) == 0x000274, "Member 'FAnimNode_Trail::LastBoneRotationAnimAlphaBlend' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwistCorrectiveNode) == 0x000188, "Wrong size on FAnimNode_TwistCorrectiveNode");
...
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RangeMax) == 0x000160, "Member 'FAnimNode_TwistCorrectiveNode::RangeMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RemappedMin) == 0x000164, "Member 'FAnimNode_TwistCorrectiveNode::RemappedMin' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, RemappedMax) == 0x000168, "Member 'FAnimNode_TwistCorrectiveNode::RemappedMax' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, Curve) == 0x00016C, "Member 'FAnimNode_TwistCorrectiveNode::Curve' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_TwoBoneIK) == 0x0002B0, "Wrong size on FAnimNode_TwoBoneIK");
static_assert(offsetof(FAnimNode_TwoBoneIK, IKBone) == 0x0000D0, "Member 'FAnimNode_TwoBoneIK::IKBone' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, StartStretchRatio) == 0x0000E8, "Member 'FAnimNode_TwoBoneIK::StartStretchRatio' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocation) == 0x0000F8, "Member 'FAnimNode_TwoBoneIK::EffectorLocation' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocation) == 0x0001C0, "Member 'FAnimNode_TwoBoneIK::JointTargetLocation' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTarget) == 0x0001E0, "Member 'FAnimNode_TwoBoneIK::JointTarget' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, TwistAxis) == 0x000280, "Member 'FAnimNode_TwoBoneIK::TwistAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x0002A0, "Member 'FAnimNode_TwoBoneIK::EffectorLocationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x0002A1, "Member 'FAnimNode_TwoBoneIK::JointTargetLocationSpace' has a wrong offset!");
