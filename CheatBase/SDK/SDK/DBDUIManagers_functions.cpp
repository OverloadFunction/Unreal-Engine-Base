...
// Parameters:
// const EChallengeSetType                 ChallengeSetType                                       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const class FString&                    EventThemeLabel                                        (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FAlertRewardEventSkinData        ReturnValue                                            (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct FAlertRewardEventSkinData UUIDataManager::GetAlertRewardEventSkinData(const class FString& EventThemeLabel) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIDataManager", "GetAlertRewardEventSkinData");

	Params::UIDataManager_GetAlertRewardEventSkinData Parms{};
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const class FString&                    inboxSkinLabel                                         (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FInboxSkinUIData                 ReturnValue                                            (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct FInboxSkinUIData UUIDataManager::GetInboxSkinUIData(const class FString& inboxSkinLabel) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIDataManager", "GetInboxSkinUIData");

	Params::UIDataManager_GetInboxSkinUIData Parms{};

	Parms.inboxSkinLabel = std::move(inboxSkinLabel);
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const EControlMode                      controlMode                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TMap<struct FKey, struct FInputPromptDataRow>ReturnValue                                            (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

TMap<struct FKey, struct FInputPromptDataRow> UUIDataManager::GetInputPromptControlModeData(const EControlMode controlMode) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIDataManager", "GetInputPromptControlModeData");

	Params::UIDataManager_GetInputPromptControlModeData Parms{};
...
// Parameters:
// EItemRarity                             Rarity                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// ELoadoutSlot                            slotIndex                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
TSoftObjectPtr<class UMaterialInterface> UUIDataManager::GetLoadoutPartRarityMaterial(EItemRarity Rarity, ELoadoutSlot slotIndex) const
{
	static class UFunction* Func = nullptr;
...
TSoftObjectPtr<class UMaterialInterface> UUIDataManager::GetLoadoutPartStatusEffectMaterial(EStatusEffectType StatusEffect, ELoadoutSlot slotIndex) const
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const EProgressionType                  ProgressionType                                        (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSoftObjectPtr<class UTexture2D>        ReturnValue                                            (Parm, OutParm, ReturnParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FLinearColor UUIDataManager::GetRarityTextColor(EItemRarity Rarity) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIDataManager", "GetRarityTextColor");

	Params::UIDataManager_GetRarityTextColor Parms{};
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// const class FString&                    EventBannerLabel                                       (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
