...
static_assert(alignof(ConditionFactory_CreateNumericalConstraintCondition_Double) == 0x000008, "Wrong alignment on ConditionFactory_CreateNumericalConstraintCondition_Double");
static_assert(sizeof(ConditionFactory_CreateNumericalConstraintCondition_Double) == 0x000070, "Wrong size on ConditionFactory_CreateNumericalConstraintCondition_Double");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Double, ConditionReceiver) == 0x000000, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Double::ConditionReceiver' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Double, conditionType) == 0x000010, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Double::conditionType' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Double, numericalConstraints) == 0x000018, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Double::numericalConstraints' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Double, ReturnValue) == 0x000068, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Double::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ConditionFactory_CreateNumericalConstraintCondition_Float) == 0x000008, "Wrong alignment on ConditionFactory_CreateNumericalConstraintCondition_Float");
static_assert(sizeof(ConditionFactory_CreateNumericalConstraintCondition_Float) == 0x000070, "Wrong size on ConditionFactory_CreateNumericalConstraintCondition_Float");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Float, ConditionReceiver) == 0x000000, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Float::ConditionReceiver' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Float, conditionType) == 0x000010, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Float::conditionType' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Float, numericalConstraints) == 0x000018, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Float::numericalConstraints' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Float, ReturnValue) == 0x000068, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Float::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ConditionFactory_CreateNumericalConstraintCondition_Int) == 0x000008, "Wrong alignment on ConditionFactory_CreateNumericalConstraintCondition_Int");
static_assert(sizeof(ConditionFactory_CreateNumericalConstraintCondition_Int) == 0x000070, "Wrong size on ConditionFactory_CreateNumericalConstraintCondition_Int");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Int, ConditionReceiver) == 0x000000, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Int::ConditionReceiver' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Int, conditionType) == 0x000010, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Int::conditionType' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Int, numericalConstraints) == 0x000018, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Int::numericalConstraints' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintCondition_Int, ReturnValue) == 0x000068, "Member 'ConditionFactory_CreateNumericalConstraintCondition_Int::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double) == 0x000008, "Wrong alignment on ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double");
static_assert(sizeof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double) == 0x000078, "Wrong size on ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double, ConditionReceiver) == 0x000000, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double::ConditionReceiver' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double, conditionType) == 0x000010, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double::conditionType' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double, numericalConstraints) == 0x000018, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double::numericalConstraints' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double, subjectProviderClass) == 0x000068, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double::subjectProviderClass' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double, ReturnValue) == 0x000070, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Double::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float) == 0x000008, "Wrong alignment on ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float");
static_assert(sizeof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float) == 0x000078, "Wrong size on ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float, ConditionReceiver) == 0x000000, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float::ConditionReceiver' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float, conditionType) == 0x000010, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float::conditionType' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float, numericalConstraints) == 0x000018, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float::numericalConstraints' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float, subjectProviderClass) == 0x000068, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float::subjectProviderClass' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float, ReturnValue) == 0x000070, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Float::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int) == 0x000008, "Wrong alignment on ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int");
static_assert(sizeof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int) == 0x000078, "Wrong size on ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int, ConditionReceiver) == 0x000000, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int::ConditionReceiver' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int, conditionType) == 0x000010, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int::conditionType' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int, numericalConstraints) == 0x000018, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int::numericalConstraints' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int, subjectProviderClass) == 0x000068, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int::subjectProviderClass' has a wrong offset!");
static_assert(offsetof(ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int, ReturnValue) == 0x000070, "Member 'ConditionFactory_CreateNumericalConstraintConditionWithSubject_Int::ReturnValue' has a wrong offset!");
