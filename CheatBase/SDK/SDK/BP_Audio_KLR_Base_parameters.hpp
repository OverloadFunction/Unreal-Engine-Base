...
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, Temp_delegate_Variable) == 0x000004, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::Temp_delegate_Variable' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_GetGameInstanceSubsystem_ReturnValue) == 0x000018, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_GetGameInstanceSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_Event_survivor) == 0x000020, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_Event_survivor' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_Event_attackType) == 0x000028, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_Event_attackType' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_Event_isWeaponHit) == 0x000029, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_Event_isWeaponHit' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_Event_survivor_1) == 0x000030, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_Event_survivor_1' has a wrong offset!");
...
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_Audio_Survivor_Grunt_Hurt_Light_Return_Value) == 0x00003C, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_Audio_Survivor_Grunt_Hurt_Light_Return_Value' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_IsValid_ReturnValue) == 0x00003D, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_GetCanScreamAndPreventNextScreamIfNeeded_ReturnValue) == 0x00003E, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_GetCanScreamAndPreventNextScreamIfNeeded_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_TriggerScreamEventsIfPossible_ReturnValue) == 0x00003F, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_TriggerScreamEventsIfPossible_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_GetAudioComponent_ReturnValue) == 0x000040, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_GetAudioComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_PostAkEvent_ReturnValue) == 0x000048, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_PostAkEvent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_GetOwningKiller_ReturnValue) == 0x000050, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_GetOwningKiller_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_GetOwner_ReturnValue) == 0x000058, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_DynamicCast_AsDBDBase_Player) == 0x000060, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_DynamicCast_AsDBDBase_Player' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_DynamicCast_bSuccess) == 0x000068, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_DBD_LoadAudioBankSynchronous_ReturnValue) == 0x000069, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_DBD_LoadAudioBankSynchronous_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, K2Node_Event_EndPlayReason) == 0x00006A, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::K2Node_Event_EndPlayReason' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_DBD_LoadAudioBankSynchronous_ReturnValue_1) == 0x00006B, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_DBD_LoadAudioBankSynchronous_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base, CallFunc_IsValid_ReturnValue_1) == 0x00006C, "Member 'BP_Audio_KLR_Base_C_ExecuteUbergraph_BP_Audio_KLR_Base::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_Audio_KLR_Base_C_HitImpactOnSurvivorSFX, Survivor) == 0x000000, "Member 'BP_Audio_KLR_Base_C_HitImpactOnSurvivorSFX::Survivor' has a wrong offset!");
...
static_assert(offsetof(BP_Audio_KLR_Base_C_InititializeComponent, K2Node_DynamicCast_AsKiller) == 0x000010, "Member 'BP_Audio_KLR_Base_C_InititializeComponent::K2Node_DynamicCast_AsKiller' has a wrong offset!");
...
static_assert(offsetof(BP_Audio_KLR_Base_C_TriggerSurvivorDamageHitAudioSFX, Survivor) == 0x000000, "Member 'BP_Audio_KLR_Base_C_TriggerSurvivorDamageHitAudioSFX::Survivor' has a wrong offset!");
