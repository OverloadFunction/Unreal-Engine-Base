...
static_assert(offsetof(FCustomGamePresetData, idleCrowsAllowed) == 0x00001D, "Member 'FCustomGamePresetData::idleCrowsAllowed' has a wrong offset!");
static_assert(offsetof(FCustomGamePresetData, privateMatch) == 0x00001E, "Member 'FCustomGamePresetData::privateMatch' has a wrong offset!");
...
static_assert(offsetof(FPartyMatchmakingSettings, _modeBonus) == 0x00002C, "Member 'FPartyMatchmakingSettings::_modeBonus' has a wrong offset!");
static_assert(offsetof(FPartyMatchmakingSettings, _isInFinalCountdown) == 0x000030, "Member 'FPartyMatchmakingSettings::_isInFinalCountdown' has a wrong offset!");
static_assert(offsetof(FPartyMatchmakingSettings, _postMatchmakingTransitionId) == 0x000034, "Member 'FPartyMatchmakingSettings::_postMatchmakingTransitionId' has a wrong offset!");
...
static_assert(sizeof(FSocialPartyState) == 0x0001B0, "Wrong size on FSocialPartyState");
...
static_assert(offsetof(FSocialPartyState, _chatHistory) == 0x000178, "Member 'FSocialPartyState::_chatHistory' has a wrong offset!");
static_assert(offsetof(FSocialPartyState, _version) == 0x000198, "Member 'FSocialPartyState::_version' has a wrong offset!");
static_assert(offsetof(FSocialPartyState, _lastUpdatedTime) == 0x0001A8, "Member 'FSocialPartyState::_lastUpdatedTime' has a wrong offset!");
static_assert(offsetof(FSocialPartyState, _lastSentTime) == 0x0001AC, "Member 'FSocialPartyState::_lastSentTime' has a wrong offset!");
