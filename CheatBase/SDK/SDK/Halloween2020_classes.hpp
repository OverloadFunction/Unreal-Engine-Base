...
static_assert(sizeof(UBlightedSerumAddon) == 0x000378, "Wrong size on UBlightedSerumAddon");
static_assert(offsetof(UBlightedSerumAddon, _blightedSerumCollectable) == 0x000300, "Member 'UBlightedSerumAddon::_blightedSerumCollectable' has a wrong offset!");
static_assert(offsetof(UBlightedSerumAddon, _dashInteraction) == 0x000308, "Member 'UBlightedSerumAddon::_dashInteraction' has a wrong offset!");
static_assert(offsetof(UBlightedSerumAddon, _blightPowerPickedUp) == 0x000310, "Member 'UBlightedSerumAddon::_blightPowerPickedUp' has a wrong offset!");
static_assert(offsetof(UBlightedSerumAddon, _theBlightExtraTokens) == 0x000314, "Member 'UBlightedSerumAddon::_theBlightExtraTokens' has a wrong offset!");
static_assert(offsetof(UBlightedSerumAddon, _numberOfDashesPerEvent) == 0x000318, "Member 'UBlightedSerumAddon::_numberOfDashesPerEvent' has a wrong offset!");
...
static_assert(sizeof(UBlightedSerumCollisionInteraction) == 0x000790, "Wrong size on UBlightedSerumCollisionInteraction");
static_assert(offsetof(UBlightedSerumCollisionInteraction, _cooldownInteraction) == 0x000768, "Member 'UBlightedSerumCollisionInteraction::_cooldownInteraction' has a wrong offset!");
static_assert(offsetof(UBlightedSerumCollisionInteraction, _bounceTime) == 0x000770, "Member 'UBlightedSerumCollisionInteraction::_bounceTime' has a wrong offset!");
...
static_assert(sizeof(UBlightedSerumCooldownInteraction) == 0x000780, "Wrong size on UBlightedSerumCooldownInteraction");
static_assert(offsetof(UBlightedSerumCooldownInteraction, _cooldownTime) == 0x000768, "Member 'UBlightedSerumCooldownInteraction::_cooldownTime' has a wrong offset!");
static_assert(offsetof(UBlightedSerumCooldownInteraction, _cameraPitchRecenterTime) == 0x00076C, "Member 'UBlightedSerumCooldownInteraction::_cameraPitchRecenterTime' has a wrong offset!");
...
static_assert(sizeof(UBlightedSerumDashInteraction) == 0x000820, "Wrong size on UBlightedSerumDashInteraction");
static_assert(offsetof(UBlightedSerumDashInteraction, _cooldownInteraction) == 0x000768, "Member 'UBlightedSerumDashInteraction::_cooldownInteraction' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _collisionInteraction) == 0x000770, "Member 'UBlightedSerumDashInteraction::_collisionInteraction' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _dashSpeedCurve) == 0x000778, "Member 'UBlightedSerumDashInteraction::_dashSpeedCurve' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _lookAngleToTurnRateCurveController) == 0x000780, "Member 'UBlightedSerumDashInteraction::_lookAngleToTurnRateCurveController' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _lookAngleToTurnRateCurveMouse) == 0x000788, "Member 'UBlightedSerumDashInteraction::_lookAngleToTurnRateCurveMouse' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _dashDuration) == 0x000790, "Member 'UBlightedSerumDashInteraction::_dashDuration' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _vectorInterpToSpeed) == 0x000794, "Member 'UBlightedSerumDashInteraction::_vectorInterpToSpeed' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _wallDashAccelerationMultiplier) == 0x000798, "Member 'UBlightedSerumDashInteraction::_wallDashAccelerationMultiplier' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _cameraPitchRecenterTime) == 0x00079C, "Member 'UBlightedSerumDashInteraction::_cameraPitchRecenterTime' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _lookAngleTurnRateModifier) == 0x0007A0, "Member 'UBlightedSerumDashInteraction::_lookAngleTurnRateModifier' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _wallDashCollisionRadius) == 0x0007A4, "Member 'UBlightedSerumDashInteraction::_wallDashCollisionRadius' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _wallDashCollisionHeight) == 0x0007A8, "Member 'UBlightedSerumDashInteraction::_wallDashCollisionHeight' has a wrong offset!");
static_assert(offsetof(UBlightedSerumDashInteraction, _wallDashCollisionRange) == 0x0007AC, "Member 'UBlightedSerumDashInteraction::_wallDashCollisionRange' has a wrong offset!");
