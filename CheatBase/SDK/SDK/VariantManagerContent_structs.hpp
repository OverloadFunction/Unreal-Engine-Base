...
static_assert(sizeof(FVariantDependency) == 0x000078, "Wrong size on FVariantDependency");
static_assert(offsetof(FVariantDependency, VariantSet) == 0x000000, "Member 'FVariantDependency::VariantSet' has a wrong offset!");
static_assert(offsetof(FVariantDependency, Variant) == 0x000038, "Member 'FVariantDependency::Variant' has a wrong offset!");
static_assert(offsetof(FVariantDependency, bEnabled) == 0x000070, "Member 'FVariantDependency::bEnabled' has a wrong offset!");
