...
static_assert(offsetof(FNiagaraFunctionSignature, ContextStageIndex) == 0x000044, "Member 'FNiagaraFunctionSignature::ContextStageIndex' has a wrong offset!");
static_assert(offsetof(FNiagaraFunctionSignature, RequiredInputs) == 0x000048, "Member 'FNiagaraFunctionSignature::RequiredInputs' has a wrong offset!");
static_assert(offsetof(FNiagaraFunctionSignature, RequiredOutputs) == 0x00004A, "Member 'FNiagaraFunctionSignature::RequiredOutputs' has a wrong offset!");
...
static_assert(sizeof(FNiagaraDataChannelReference) == 0x00000C, "Wrong size on FNiagaraDataChannelReference");
...
static_assert(sizeof(FNiagaraComponentPropertyBinding) == 0x0000D8, "Wrong size on FNiagaraComponentPropertyBinding");
...
static_assert(offsetof(FNiagaraEmitterHandle, VersionedInstance) == 0x000038, "Member 'FNiagaraEmitterHandle::VersionedInstance' has a wrong offset!");
...
static_assert(sizeof(FNiagaraVariableMetaData) == 0x000168, "Wrong size on FNiagaraVariableMetaData");
...
static_assert(offsetof(FNiagaraVariableMetaData, VariableGuid) == 0x000150, "Member 'FNiagaraVariableMetaData::VariableGuid' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, bIsStaticSwitch) == 0x000160, "Member 'FNiagaraVariableMetaData::bIsStaticSwitch' has a wrong offset!");
static_assert(offsetof(FNiagaraVariableMetaData, StaticSwitchDefaultValue) == 0x000164, "Member 'FNiagaraVariableMetaData::StaticSwitchDefaultValue' has a wrong offset!");
