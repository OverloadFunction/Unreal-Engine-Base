...
static_assert(alignof(MrMarch_Cosmetic_OnDestroyed) == 0x000001, "Wrong alignment on MrMarch_Cosmetic_OnDestroyed");
static_assert(sizeof(MrMarch_Cosmetic_OnDestroyed) == 0x000001, "Wrong size on MrMarch_Cosmetic_OnDestroyed");
static_assert(offsetof(MrMarch_Cosmetic_OnDestroyed, isImmediate) == 0x000000, "Member 'MrMarch_Cosmetic_OnDestroyed::isImmediate' has a wrong offset!");
...
static_assert(alignof(MrMarch_Multicast_StartMrMarchDestruction) == 0x000001, "Wrong alignment on MrMarch_Multicast_StartMrMarchDestruction");
static_assert(sizeof(MrMarch_Multicast_StartMrMarchDestruction) == 0x000001, "Wrong size on MrMarch_Multicast_StartMrMarchDestruction");
static_assert(offsetof(MrMarch_Multicast_StartMrMarchDestruction, destroyImmediate) == 0x000000, "Member 'MrMarch_Multicast_StartMrMarchDestruction::destroyImmediate' has a wrong offset!");
...
static_assert(alignof(SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved) == 0x000008, "Wrong alignment on SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved");
static_assert(sizeof(SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved) == 0x000010, "Wrong size on SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved");
static_assert(offsetof(SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved, Player) == 0x000000, "Member 'SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved::Player' has a wrong offset!");
static_assert(offsetof(SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved, added) == 0x000008, "Member 'SnowballPlayerComponent_Cosmetic_OnPlayerVFXTagAddedOrRemoved::added' has a wrong offset!");
