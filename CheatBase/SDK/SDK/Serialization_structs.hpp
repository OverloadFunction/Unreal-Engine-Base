...
static_assert(sizeof(FStructSerializerObjectTestStruct) == 0x0000F0, "Wrong size on FStructSerializerObjectTestStruct");
...
static_assert(offsetof(FStructSerializerObjectTestStruct, RawObject) == 0x000050, "Member 'FStructSerializerObjectTestStruct::RawObject' has a wrong offset!");
static_assert(offsetof(FStructSerializerObjectTestStruct, WrappedObject) == 0x000058, "Member 'FStructSerializerObjectTestStruct::WrappedObject' has a wrong offset!");
static_assert(offsetof(FStructSerializerObjectTestStruct, WeakObject) == 0x000060, "Member 'FStructSerializerObjectTestStruct::WeakObject' has a wrong offset!");
static_assert(offsetof(FStructSerializerObjectTestStruct, SoftObject) == 0x000068, "Member 'FStructSerializerObjectTestStruct::SoftObject' has a wrong offset!");
static_assert(offsetof(FStructSerializerObjectTestStruct, ClassPath) == 0x0000A0, "Member 'FStructSerializerObjectTestStruct::ClassPath' has a wrong offset!");
static_assert(offsetof(FStructSerializerObjectTestStruct, ObjectPath) == 0x0000C8, "Member 'FStructSerializerObjectTestStruct::ObjectPath' has a wrong offset!");
...
static_assert(sizeof(FStructSerializerTestStruct) == 0x000840, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Builtins) == 0x000130, "Member 'FStructSerializerTestStruct::Builtins' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Arrays) == 0x000200, "Member 'FStructSerializerTestStruct::Arrays' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Maps) == 0x000260, "Member 'FStructSerializerTestStruct::Maps' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, Sets) == 0x0003A0, "Member 'FStructSerializerTestStruct::Sets' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, LWCTypes) == 0x0004E0, "Member 'FStructSerializerTestStruct::LWCTypes' has a wrong offset!");
