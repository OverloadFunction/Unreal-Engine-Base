...
static_assert(sizeof(FHoudiniOutputObject) == 0x000160, "Wrong size on FHoudiniOutputObject");
...
static_assert(offsetof(FHoudiniOutputObject, ProxyObject) == 0x000028, "Member 'FHoudiniOutputObject::ProxyObject' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, ProxyComponent) == 0x000030, "Member 'FHoudiniOutputObject::ProxyComponent' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, bProxyIsCurrent) == 0x000038, "Member 'FHoudiniOutputObject::bProxyIsCurrent' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, bIsImplicit) == 0x000039, "Member 'FHoudiniOutputObject::bIsImplicit' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, bIsInvisibleCollisionMesh) == 0x00003A, "Member 'FHoudiniOutputObject::bIsInvisibleCollisionMesh' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, bIsGeometryCollectionPiece) == 0x00003B, "Member 'FHoudiniOutputObject::bIsGeometryCollectionPiece' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, GeometryCollectionPieceName) == 0x000040, "Member 'FHoudiniOutputObject::GeometryCollectionPieceName' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, BakeName) == 0x000050, "Member 'FHoudiniOutputObject::BakeName' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, CurveOutputProperty) == 0x000060, "Member 'FHoudiniOutputObject::CurveOutputProperty' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, CachedAttributes) == 0x000070, "Member 'FHoudiniOutputObject::CachedAttributes' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, CachedTokens) == 0x0000C0, "Member 'FHoudiniOutputObject::CachedTokens' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, UserFoliageType) == 0x000110, "Member 'FHoudiniOutputObject::UserFoliageType' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, FoliageType) == 0x000118, "Member 'FHoudiniOutputObject::FoliageType' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, World) == 0x000120, "Member 'FHoudiniOutputObject::World' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, DataLayers) == 0x000128, "Member 'FHoudiniOutputObject::DataLayers' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, HLODLayers) == 0x000138, "Member 'FHoudiniOutputObject::HLODLayers' has a wrong offset!");
static_assert(offsetof(FHoudiniOutputObject, LevelInstanceParams) == 0x000148, "Member 'FHoudiniOutputObject::LevelInstanceParams' has a wrong offset!");
...
static_assert(sizeof(FHoudiniAssetBlueprintOutput) == 0x000168, "Wrong size on FHoudiniAssetBlueprintOutput");
...
static_assert(sizeof(FHoudiniInstancedOutput) == 0x000098, "Wrong size on FHoudiniInstancedOutput");
...
static_assert(offsetof(FHoudiniInstancedOutput, OriginalObjectIndex) == 0x000038, "Member 'FHoudiniInstancedOutput::OriginalObjectIndex' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, OriginalTransforms) == 0x000040, "Member 'FHoudiniInstancedOutput::OriginalTransforms' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, VariationObjects) == 0x000050, "Member 'FHoudiniInstancedOutput::VariationObjects' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, VariationTransformOffsets) == 0x000060, "Member 'FHoudiniInstancedOutput::VariationTransformOffsets' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, TransformVariationIndices) == 0x000070, "Member 'FHoudiniInstancedOutput::TransformVariationIndices' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, OriginalInstanceIndices) == 0x000080, "Member 'FHoudiniInstancedOutput::OriginalInstanceIndices' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, bChanged) == 0x000090, "Member 'FHoudiniInstancedOutput::bChanged' has a wrong offset!");
static_assert(offsetof(FHoudiniInstancedOutput, bStale) == 0x000091, "Member 'FHoudiniInstancedOutput::bStale' has a wrong offset!");
...
static_assert(sizeof(FHoudiniBakedOutputObject) == 0x000118, "Wrong size on FHoudiniBakedOutputObject");
...
static_assert(offsetof(FHoudiniBakedOutputObject, FoliageActors) == 0x0000D8, "Member 'FHoudiniBakedOutputObject::FoliageActors' has a wrong offset!");
static_assert(offsetof(FHoudiniBakedOutputObject, LevelInstanceActors) == 0x0000E8, "Member 'FHoudiniBakedOutputObject::LevelInstanceActors' has a wrong offset!");
static_assert(offsetof(FHoudiniBakedOutputObject, Landscape) == 0x0000F8, "Member 'FHoudiniBakedOutputObject::Landscape' has a wrong offset!");
static_assert(offsetof(FHoudiniBakedOutputObject, BakedSkeleton) == 0x000108, "Member 'FHoudiniBakedOutputObject::BakedSkeleton' has a wrong offset!");
