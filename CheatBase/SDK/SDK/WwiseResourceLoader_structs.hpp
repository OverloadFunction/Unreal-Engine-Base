...
static_assert(sizeof(FWwiseAcousticTextureCookedData) == 0x000020, "Wrong size on FWwiseAcousticTextureCookedData");
...
static_assert(sizeof(FWwiseLocalizedSoundBankCookedData) == 0x000070, "Wrong size on FWwiseLocalizedSoundBankCookedData");
...
static_assert(offsetof(FWwiseLocalizedSoundBankCookedData, IncludedEventNames) == 0x000060, "Member 'FWwiseLocalizedSoundBankCookedData::IncludedEventNames' has a wrong offset!");
