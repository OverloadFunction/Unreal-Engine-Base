...
static_assert(alignof(FAkEGSAdvancedInitializationSettings) == 0x000004, "Wrong alignment on FAkEGSAdvancedInitializationSettings");
static_assert(sizeof(FAkEGSAdvancedInitializationSettings) == 0x000040, "Wrong size on FAkEGSAdvancedInitializationSettings");
static_assert(offsetof(FAkEGSAdvancedInitializationSettings, UseHeadMountedDisplayAudioDevice) == 0x000038, "Member 'FAkEGSAdvancedInitializationSettings::UseHeadMountedDisplayAudioDevice' has a wrong offset!");
static_assert(offsetof(FAkEGSAdvancedInitializationSettings, MaxSystemAudioObjects) == 0x00003C, "Member 'FAkEGSAdvancedInitializationSettings::MaxSystemAudioObjects' has a wrong offset!");
...
static_assert(sizeof(FAkGeometrySurfacePropertiesToMap) == 0x000040, "Wrong size on FAkGeometrySurfacePropertiesToMap");
...
static_assert(offsetof(FAkGeometrySurfacePropertiesToMap, OcclusionValue) == 0x000038, "Member 'FAkGeometrySurfacePropertiesToMap::OcclusionValue' has a wrong offset!");
