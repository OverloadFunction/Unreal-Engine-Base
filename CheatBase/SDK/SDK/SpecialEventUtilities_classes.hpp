...
static_assert(sizeof(UDisableActorOnEventsComponent) == 0x0000D8, "Wrong size on UDisableActorOnEventsComponent");
static_assert(offsetof(UDisableActorOnEventsComponent, _triggerEvents) == 0x0000C8, "Member 'UDisableActorOnEventsComponent::_triggerEvents' has a wrong offset!");
...
static_assert(sizeof(UDebugTimedRespawnableTriggerCountdownTimer) == 0x0000C0, "Wrong size on UDebugTimedRespawnableTriggerCountdownTimer");
static_assert(offsetof(UDebugTimedRespawnableTriggerCountdownTimer, _countdownTimeRemaining) == 0x0000B8, "Member 'UDebugTimedRespawnableTriggerCountdownTimer::_countdownTimeRemaining' has a wrong offset!");
...
static_assert(sizeof(UPlayerEventDispatcher) == 0x000148, "Wrong size on UPlayerEventDispatcher");
...
static_assert(sizeof(URespawnFurthestFromPlayersStrategy) == 0x0000C8, "Wrong size on URespawnFurthestFromPlayersStrategy");
static_assert(offsetof(URespawnFurthestFromPlayersStrategy, _collisionCapsuleHalfHeight) == 0x0000B8, "Member 'URespawnFurthestFromPlayersStrategy::_collisionCapsuleHalfHeight' has a wrong offset!");
static_assert(offsetof(URespawnFurthestFromPlayersStrategy, _collisionCapsuleRadius) == 0x0000BC, "Member 'URespawnFurthestFromPlayersStrategy::_collisionCapsuleRadius' has a wrong offset!");
...
static_assert(sizeof(USpecialEventInteractableCooldownComponent) == 0x000128, "Wrong size on USpecialEventInteractableCooldownComponent");
static_assert(offsetof(USpecialEventInteractableCooldownComponent, _cooldownTime) == 0x0000C8, "Member 'USpecialEventInteractableCooldownComponent::_cooldownTime' has a wrong offset!");
static_assert(offsetof(USpecialEventInteractableCooldownComponent, _isOnCooldown) == 0x0000F0, "Member 'USpecialEventInteractableCooldownComponent::_isOnCooldown' has a wrong offset!");
...
static_assert(sizeof(USpecialEventPlayerComponent) == 0x0000D8, "Wrong size on USpecialEventPlayerComponent");
static_assert(offsetof(USpecialEventPlayerComponent, _componentsAddToSurvivor) == 0x0000B8, "Member 'USpecialEventPlayerComponent::_componentsAddToSurvivor' has a wrong offset!");
static_assert(offsetof(USpecialEventPlayerComponent, _componentsAddToKiller) == 0x0000C8, "Member 'USpecialEventPlayerComponent::_componentsAddToKiller' has a wrong offset!");
...
static_assert(sizeof(USpecialEventVFXHelperComponent) == 0x0001E8, "Wrong size on USpecialEventVFXHelperComponent");
static_assert(offsetof(USpecialEventVFXHelperComponent, OnHideVFXTagAddedOrRemoved) == 0x0000B8, "Member 'USpecialEventVFXHelperComponent::OnHideVFXTagAddedOrRemoved' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, OnHideVignetteTagAddedOrRemoved) == 0x0000C8, "Member 'USpecialEventVFXHelperComponent::OnHideVignetteTagAddedOrRemoved' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, OnLocallyObservedChanged) == 0x0000D8, "Member 'USpecialEventVFXHelperComponent::OnLocallyObservedChanged' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, _hideVFXTags) == 0x0000E8, "Member 'USpecialEventVFXHelperComponent::_hideVFXTags' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, _killerOnlyHideVFXTags) == 0x000108, "Member 'USpecialEventVFXHelperComponent::_killerOnlyHideVFXTags' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, _survivorOnlyHideVFXTags) == 0x000128, "Member 'USpecialEventVFXHelperComponent::_survivorOnlyHideVFXTags' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, _hideVignetteTags) == 0x000148, "Member 'USpecialEventVFXHelperComponent::_hideVignetteTags' has a wrong offset!");
static_assert(offsetof(USpecialEventVFXHelperComponent, _componentsToSpawnOnHusk) == 0x000168, "Member 'USpecialEventVFXHelperComponent::_componentsToSpawnOnHusk' has a wrong offset!");
