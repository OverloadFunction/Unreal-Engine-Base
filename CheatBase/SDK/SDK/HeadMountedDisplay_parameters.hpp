...
static_assert(sizeof(HeadMountedDisplayFunctionLibrary_GetDevicePose) == 0x000050, "Wrong size on HeadMountedDisplayFunctionLibrary_GetDevicePose");
...
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetDevicePose, Orientation) == 0x000018, "Member 'HeadMountedDisplayFunctionLibrary_GetDevicePose::Orientation' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetDevicePose, bHasPositionalTracking) == 0x000030, "Member 'HeadMountedDisplayFunctionLibrary_GetDevicePose::bHasPositionalTracking' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetDevicePose, Position) == 0x000038, "Member 'HeadMountedDisplayFunctionLibrary_GetDevicePose::Position' has a wrong offset!");
...
static_assert(sizeof(HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose) == 0x000058, "Wrong size on HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose");
...
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose, Orientation) == 0x000020, "Member 'HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose::Orientation' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose, bHasPositionalTracking) == 0x000038, "Member 'HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose::bHasPositionalTracking' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose, Position) == 0x000040, "Member 'HeadMountedDisplayFunctionLibrary_GetDeviceWorldPose::Position' has a wrong offset!");
...
static_assert(sizeof(XRAssetFunctionLibrary_AddNamedDeviceVisualizationComponentBlocking) == 0x0000B0, "Wrong size on XRAssetFunctionLibrary_AddNamedDeviceVisualizationComponentBlocking");
...
static_assert(offsetof(XRAssetFunctionLibrary_AddNamedDeviceVisualizationComponentBlocking, XRDeviceId) == 0x000090, "Member 'XRAssetFunctionLibrary_AddNamedDeviceVisualizationComponentBlocking::XRDeviceId' has a wrong offset!");
static_assert(offsetof(XRAssetFunctionLibrary_AddNamedDeviceVisualizationComponentBlocking, ReturnValue) == 0x0000A0, "Member 'XRAssetFunctionLibrary_AddNamedDeviceVisualizationComponentBlocking::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync) == 0x0000B0, "Wrong size on AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync");
...
static_assert(offsetof(AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync, XRDeviceId) == 0x000090, "Member 'AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync::XRDeviceId' has a wrong offset!");
static_assert(offsetof(AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync, NewComponent) == 0x0000A0, "Member 'AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync::NewComponent' has a wrong offset!");
static_assert(offsetof(AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync, ReturnValue) == 0x0000A8, "Member 'AsyncTask_LoadXRDeviceVisComponent_AddNamedDeviceVisualizationComponentAsync::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(XRDeviceVisualizationComponent_SetDisplayModelSource) == 0x00000C, "Wrong size on XRDeviceVisualizationComponent_SetDisplayModelSource");
