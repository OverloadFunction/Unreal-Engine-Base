...
static_assert(alignof(FLookingAtData) == 0x000008, "Wrong alignment on FLookingAtData");
static_assert(sizeof(FLookingAtData) == 0x000038, "Wrong size on FLookingAtData");
...
static_assert(offsetof(FKillerPowerSpawnableComponents, AllowMultipleComponentsOfSameClass) == 0x00000A, "Member 'FKillerPowerSpawnableComponents::AllowMultipleComponentsOfSameClass' has a wrong offset!");
...
static_assert(sizeof(FFootstep) == 0x000058, "Wrong size on FFootstep");
...
static_assert(offsetof(FFootstep, _decal) == 0x000048, "Member 'FFootstep::_decal' has a wrong offset!");
...
static_assert(alignof(FGroundTargetPlacement) == 0x000004, "Wrong alignment on FGroundTargetPlacement");
static_assert(sizeof(FGroundTargetPlacement) == 0x00000C, "Wrong size on FGroundTargetPlacement");
static_assert(offsetof(FGroundTargetPlacement, _raycastZOffset) == 0x000000, "Member 'FGroundTargetPlacement::_raycastZOffset' has a wrong offset!");
static_assert(offsetof(FGroundTargetPlacement, _raycastLength) == 0x000004, "Member 'FGroundTargetPlacement::_raycastLength' has a wrong offset!");
static_assert(offsetof(FGroundTargetPlacement, _maxGroundAngle) == 0x000008, "Member 'FGroundTargetPlacement::_maxGroundAngle' has a wrong offset!");
...
static_assert(alignof(FLockerJumpScarePropStruct) == 0x000008, "Wrong alignment on FLockerJumpScarePropStruct");
static_assert(sizeof(FLockerJumpScarePropStruct) == 0x000018, "Wrong size on FLockerJumpScarePropStruct");
static_assert(offsetof(FLockerJumpScarePropStruct, PropActorClass) == 0x000000, "Member 'FLockerJumpScarePropStruct::PropActorClass' has a wrong offset!");
static_assert(offsetof(FLockerJumpScarePropStruct, SocketName) == 0x000008, "Member 'FLockerJumpScarePropStruct::SocketName' has a wrong offset!");
...
static_assert(alignof(FActorFailsafeTeleportationData) == 0x000008, "Wrong alignment on FActorFailsafeTeleportationData");
static_assert(sizeof(FActorFailsafeTeleportationData) == 0x000030, "Wrong size on FActorFailsafeTeleportationData");
...
static_assert(alignof(FActorTeleportationData) == 0x000008, "Wrong alignment on FActorTeleportationData");
static_assert(sizeof(FActorTeleportationData) == 0x000050, "Wrong size on FActorTeleportationData");
static_assert(offsetof(FActorTeleportationData, TeleportLocationStatus) == 0x000000, "Member 'FActorTeleportationData::TeleportLocationStatus' has a wrong offset!");
static_assert(offsetof(FActorTeleportationData, BestTeleportLocation) == 0x000008, "Member 'FActorTeleportationData::BestTeleportLocation' has a wrong offset!");
