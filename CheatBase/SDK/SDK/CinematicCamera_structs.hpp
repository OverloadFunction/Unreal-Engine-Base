...
static_assert(sizeof(FCameraLookatTrackingSettings) == 0x000078, "Wrong size on FCameraLookatTrackingSettings");
...
static_assert(offsetof(FCameraLookatTrackingSettings, RelativeOffset) == 0x000058, "Member 'FCameraLookatTrackingSettings::RelativeOffset' has a wrong offset!");
...
static_assert(sizeof(FCameraTrackingFocusSettings) == 0x000058, "Wrong size on FCameraTrackingFocusSettings");
...
static_assert(offsetof(FCameraTrackingFocusSettings, RelativeOffset) == 0x000038, "Member 'FCameraTrackingFocusSettings::RelativeOffset' has a wrong offset!");
...
static_assert(sizeof(FCameraFocusSettings) == 0x000070, "Wrong size on FCameraFocusSettings");
...
static_assert(offsetof(FCameraFocusSettings, FocusSmoothingInterpSpeed) == 0x000064, "Member 'FCameraFocusSettings::FocusSmoothingInterpSpeed' has a wrong offset!");
static_assert(offsetof(FCameraFocusSettings, FocusOffset) == 0x000068, "Member 'FCameraFocusSettings::FocusOffset' has a wrong offset!");
