...
static_assert(sizeof(FPaperSpriteAtlasSlot) == 0x000050, "Wrong size on FPaperSpriteAtlasSlot");
...
static_assert(offsetof(FPaperSpriteAtlasSlot, AtlasIndex) == 0x000038, "Member 'FPaperSpriteAtlasSlot::AtlasIndex' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, X) == 0x00003C, "Member 'FPaperSpriteAtlasSlot::X' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Y) == 0x000040, "Member 'FPaperSpriteAtlasSlot::Y' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Width) == 0x000044, "Member 'FPaperSpriteAtlasSlot::Width' has a wrong offset!");
static_assert(offsetof(FPaperSpriteAtlasSlot, Height) == 0x000048, "Member 'FPaperSpriteAtlasSlot::Height' has a wrong offset!");
