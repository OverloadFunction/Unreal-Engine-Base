...
namespace ImGui
{
    ...
    inline void RenderNotifications()
    {
        ...
        for (size_t i = 0; i < notifications.size(); ++i)
        {
            ...
            SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + main_viewport->WorkSize.x - NOTIFY_PADDING_X,
                main_viewport->WorkPos.y + main_viewport->WorkSize.y - NOTIFY_PADDING_Y - height),
